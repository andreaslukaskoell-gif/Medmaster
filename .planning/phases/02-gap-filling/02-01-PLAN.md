...
must_haves:
  truths:
    - SelfTestQuestion interface includes tags field for question tagging
  ...
  artifacts:
    - path: "src/data/bmsKapitel/types.ts"
      provides: "SelfTestQuestion interface with tags field"
...
<objective>
Create Kapitel 7 (Methoden der Genetik) with 6 Unterkapitel covering high-priority neu2026 topics, add tags field to SelfTestQuestion interface for question tracking.
...
Output: Complete chapter file with 30+ questions, 18-30 merksätze, tags field support
</objective>
...
<task type="auto">
  <name>Add tags field to SelfTestQuestion and QuizItem interfaces</name>
  <files>src/data/bmsKapitel/types.ts</files>
  <action>
Update SelfTestQuestion and QuizItem interfaces to include optional tags field:
...
Add JSDoc comment explaining tags field purpose and usage from Stichwortliste linkedQuestionTags.
  </action>
  <verify>Grep for "tags?: string\[\]" in types.ts confirms both interfaces updated</verify>
  <done>SelfTestQuestion and QuizItem interfaces include tags field with JSDoc documentation</done>
</task>
...
1. **bio-7-01: PCR** (linkedQuestionTags: ["pcr", "polymerase-kettenreaktion"])
   ...
   - Merksätze: 3-5 highlighting cycle steps, exponential growth, applications
...
2. **bio-7-02: DNA-Sequenzierung** (linkedQuestionTags: ["sequenzierung", "sanger"])
   ...
   - Merksätze: 3-5 on Sanger principle, applications
...
3. **bio-7-03: Genomanalyse** (linkedQuestionTags: ["genomanalyse"])
   ...
   - Merksätze: 3-5 on analysis methods, applications
...
4. **bio-7-04: Genetischer Fingerabdruck** (linkedQuestionTags: ["genetischer-fingerabdruck", "str"])
   ...
   - Merksätze: 3-5 on STR principle, forensic use
   - SelfTest: 5+ questions tagged ["genetischer-fingerabdruck", "str"]

5. **bio-7-05: Gentechnisch veränderte Organismen** (linkedQuestionTags: ["gvo", "gentechnik"])
   - Content: GMO creation, restriction enzymes, vectors, plasmids, transformation
   - Merksätze: 3-5 on GMO creation steps, applications
...
6. **bio-7-06: Klonierung** (linkedQuestionTags: ["klonierung"])
   ...
   - Merksätze: 3-5 on cloning methods, ethical considerations
...
3. Count questions: minimum 30 total (5+ per Unterkapitel × 6)
...
<success_criteria>
- SelfTestQuestion and QuizItem interfaces include tags?: string[] field
