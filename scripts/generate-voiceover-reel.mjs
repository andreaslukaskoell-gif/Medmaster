...
const TOPICS = [
  ...
  },
  {
    ...
    name: "Herz-Kreislauf",
    subject: "Biologie",
    hook: "Dein Herz schlägt\nhunderttausend Mal am Tag.",
    topicTitle: "Herz-Kreislauf",
    images: ["bio-herz-kreislauf.jpg", "bio-herz-position.jpg", "bio-herzwand.jpg"],
    script: [
      { text: "Dein Herz pumpt fünf Liter Blut pro Minute durch deinen Körper.", pause: "short" },
      { text: "Aber viele verwechseln, welche Seite was macht.", pause: "long" },
      { text: "Hier kommt der Aha-Moment.", pause: "dramatic" },
      { text: "Das Herz hat vier Kammern: zwei Vorhöfe oben, zwei Ventrikel unten.", pause: "long" },
      { text: "Die rechte Seite pumpt sauerstoffarmes Blut zur Lunge.", pause: "short" },
      { text: "Das ist der Lungenkreislauf, der kleine Kreislauf.", pause: "long" },
      { text: "Die linke Seite pumpt sauerstoffreiches Blut in den ganzen Körper.", pause: "short" },
      { text: "Das ist der Körperkreislauf, der große Kreislauf.", pause: "dramatic" },
      { text: "Deshalb ist die linke Herzwand viel dicker, sie muss weiter pumpen.", pause: "long" },
      { text: "Der Taktgeber ist der Sinusknoten im rechten Vorhof.", pause: "short" },
      { text: "Er gibt den Rhythmus vor, siebzig Mal pro Minute.", pause: "long" },
      { text: "Rechts zur Lunge, links zum Körper.", pause: "short" },
      { text: "Merk dir das. Mehr auf mett, master, punkt, ah, teh.", pause: "long" },
    ],
  },
  {
