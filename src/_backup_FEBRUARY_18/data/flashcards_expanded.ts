...
export const bioEvolution: Flashcard[] = [
  {
    id: "fc-bio-ev1",
    front: "Was ist natürliche Selektion?",
    back: "Individuen mit vorteilhaften Merkmalen überleben und pflanzen sich häufiger fort.\nDarwin: 'Survival of the fittest' = Überleben der Bestangepassten (nicht der Stärksten!).",
    category: "bio",
    topic: "Evolution",
    difficulty: "leicht",
  },
  {
    id: "fc-bio-ev2",
    front: "Arten der Selektion?",
    back: "1. Stabilisierende: Extreme werden eliminiert → Mittelwert bevorzugt\n2. Gerichtete: Ein Extrem wird bevorzugt → Merkmalsverschiebung\n3. Disruptive: Beide Extreme bevorzugt → Merkmalsspaltung",
    category: "bio",
    topic: "Evolution",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ev3",
    front: "Hardy-Weinberg-Gleichung?",
    back: "p² + 2pq + q² = 1\np + q = 1\np = Frequenz dominantes Allel\nq = Frequenz rezessives Allel\nGilt nur bei: kein Drift, keine Mutation, keine Selektion, keine Migration, Panmixie.",
    category: "bio",
    topic: "Evolution",
    difficulty: "schwer",
  },
  {
    id: "fc-bio-ev4",
    front: "Homologie vs Analogie?",
    back: "Homolog: gleicher Ursprung, verschiedene Funktion (Arm/Flosse/Flügel)\nAnalog: verschiedener Ursprung, gleiche Funktion (Vogelflügel/Insektenflügel)\nHomologie = Beleg für Verwandtschaft, Analogie = konvergente Evolution.",
    category: "bio",
    topic: "Evolution",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ev5",
    front: "Was ist Gendrift?",
    back: "Zufällige Änderung der Allelfrequenz, besonders in kleinen Populationen.\nFlaschenhalseffekt: Population drastisch reduziert → Allelverlust\nGründereffekt: Kleine Gruppe gründet neue Population → wenige Allele.",
    category: "bio",
    topic: "Evolution",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ev6",
    front: "Allopatrische vs sympatrische Artbildung?",
    back: "Allopatrisch: Geografische Isolation trennt Population → getrennte Evolution\nSympatrisch: Artbildung OHNE räumliche Trennung (z. B. durch Polyploidie, ökologische Nischen).",
    category: "bio",
    topic: "Evolution",
    difficulty: "mittel",
  },
  ...
  {
    id: "fc-bio-ev9",
    front: "Was ist Koevolution?",
    back: "Wechselseitige Anpassung zweier Arten aneinander.\nBeispiele: Blüten ↔ Bestäuber, Parasit ↔ Wirt, Räuber ↔ Beute.\nFührt zu immer besserer Anpassung (evolutionäres Wettrüsten).",
    category: "bio",
    topic: "Evolution",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ev10",
    front: "Adaptive Radiation?",
    back: "Auffächerung einer Stammform in viele verschiedene Arten durch Anpassung an unterschiedliche ökologische Nischen.\nKlassisches Beispiel: Darwinfinken auf Galápagos — unterschiedliche Schnabelformen für verschiedene Nahrung.",
    category: "bio",
    topic: "Evolution",
    difficulty: "mittel",
  },
...
export const bioOekologie: Flashcard[] = [
  {
    id: "fc-bio-ok1",
    front: "Biotische vs abiotische Faktoren?",
    back: "Biotisch: Lebewesen (Konkurrenz, Prädation, Symbiose)\nAbiotisch: Unbelebt (Temperatur, Licht, Wasser, pH, Boden).",
    category: "bio",
    topic: "Ökologie",
    difficulty: "leicht",
  },
  {
    id: "fc-bio-ok2",
    front: "Ökologische Nische vs Habitat?",
    back: "Habitat: Wo ein Organismus lebt (Lebensraum)\nÖkologische Nische: Gesamtheit aller Umweltbeziehungen einer Art (Nahrung, Feinde, Temperaturbereich, Aktivitätszeit).\nKonkurrenzausschlussprinzip: Zwei Arten können nicht die gleiche Nische besetzen.",
    category: "bio",
    topic: "Ökologie",
    difficulty: "mittel",
  },
  ...
  {
    id: "fc-bio-ok4",
    front: "Symbiose-Formen?",
    back: "Mutualismus: beide profitieren (Biene ↔ Blüte)\nKommensalismus: einer profitiert, anderer neutral (Epiphyten)\nParasitismus: einer profitiert, anderer geschädigt (Zecke).",
    category: "bio",
    topic: "Ökologie",
    difficulty: "leicht",
  },
  {
    id: "fc-bio-ok5",
    front: "Populationswachstum: J- vs S-Kurve?",
    back: "J-Kurve: Exponentielles Wachstum (unbegrenzte Ressourcen)\nS-Kurve: Logistisches Wachstum mit Kapazitätsgrenze K\nFormel: dN/dt = r·N·(K-N)/K\nr = Wachstumsrate, K = Kapazitätsgrenze.",
    category: "bio",
    topic: "Ökologie",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ok6",
    front: "r- vs K-Strategen?",
    back: "r-Strategen: Viele Nachkommen, wenig Pflege, kurze Lebensdauer (Insekten, Bakterien)\nK-Strategen: Wenige Nachkommen, viel Pflege, lange Lebensdauer (Elefant, Mensch)\nr nahe Kapazitätsgrenze: K-Strategen überlegen.",
    category: "bio",
    topic: "Ökologie",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ok7",
    front: "Kohlenstoffkreislauf: Grundprinzip?",
    back: "CO₂ → Photosynthese → Biomasse → Zellatmung/Verbrennung → CO₂\nSenken: Ozeane, Wälder, Böden\nQuellen: Verbrennung, Vulkane, Atmung\nTreibhauseffekt: CO₂, CH₄, N₂O absorbieren Infrarotstrahlung.",
    category: "bio",
    topic: "Ökologie",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ok8",
    front: "Stickstoffkreislauf: Schlüsselprozesse?",
    back: "1. N₂-Fixierung: N₂ → NH₃ (Rhizobien, Blitz)\n2. Nitrifikation: NH₃ → NO₂⁻ → NO₃⁻\n3. Assimilation: NO₃⁻ → Aminosäuren\n4. Ammonifikation: org. N → NH₃\n5. Denitrifikation: NO₃⁻ → N₂ (anärob)",
    category: "bio",
    topic: "Ökologie",
    difficulty: "schwer",
  },
...
export const bioFortpflanzung: Flashcard[] = [
  {
    id: "fc-bio-fp1",
    front: "Spermatogenese: Wo und wie?",
    back: "Im Hoden (Tubuli seminiferi).\nSpermatogonie (2n) → Spermatozyte I → Meiose I → Spermatozyte II → Meiose II → Spermatiden → Spermien.\nDauer: ~74 Tage. Ab Pubertät kontinuierlich.",
    category: "bio",
    topic: "Fortpflanzung",
    difficulty: "mittel",
  },
  ...
  {
    id: "fc-bio-fp3",
    front: "Menstruationszyklus: 4 Phasen?",
    back: "1. Menstruation (Tag 1-5): Abstoßung Endometrium\n2. Follikelphase (Tag 1-14): FSH → Follikelreifung, Östrogen ↑\n3. Ovulation (Tag 14): LH-Peak → Eisprung\n4. Lutealphase (Tag 15-28): Gelbkörper → Progesteron ↑",
    category: "bio",
    topic: "Fortpflanzung",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-fp4",
    front: "Hormone des Menstruationszyklus?",
    back: "GnRH (Hypothalamus) → FSH + LH (Hypophyse)\nFSH: Follikelreifung\nLH: Auslösung Ovulation + Gelbkörperbildung\nÖstrogen: Endometriumaufbau (Follikelphase)\nProgesteron: Endometrium-Erhalt (Lutealphase)",
    category: "bio",
    topic: "Fortpflanzung",
    difficulty: "mittel",
  },
  ...
  {
    id: "fc-bio-fp7",
    front: "Plazenta: Funktionen?",
    back: "1. Gasaustausch (O₂/CO₂)\n2. Nährstofftransport\n3. Hormonproduktion (hCG, Östrogen, Progesteron)\n4. Immunschutz (IgG-Transfer)\n5. Abfallentsorgung\nPlazentaschranke: Schützt teilweise vor Schadstoffen (nicht alle!).",
    category: "bio",
    topic: "Fortpflanzung",
    difficulty: "mittel",
  },
...
export const bioMolekulargenetik: Flashcard[] = [
  {
    id: "fc-bio-mg1",
    front: "Genexpression: Zentrales Dogma?",
    back: "DNA → (Transkription) → mRNA → (Translation) → Protein\nAusnahmen: Reverse Transkription (RNA → DNA bei Retroviren), RNA-Replikation.",
    category: "bio",
  ...
  {
    id: "fc-bio-mg2",
    front: "mRNA-Prozessierung (Eukaryoten)?",
    back: "1. 5'-Capping: 7-Methylguanosin-Kappe → Schutz + Ribosomenerkennung\n2. 3'-Polyadenylierung: Poly-A-Schwanz → Stabilität\n3. Spleißen: Introns raus, Exons zusammen\nAlternatives Spleißen → verschiedene Proteine aus einem Gen.",
    category: "bio",
    topic: "Molekulargenetik",
    difficulty: "schwer",
  },
  {
    id: "fc-bio-mg3",
    front: "PCR: Polymerase-Kettenreaktion?",
    back: "1. Denaturierung (95°C): DNA-Stränge trennen\n2. Annealing (55-65°C): Primer binden\n3. Elongation (72°C): Taq-Polymerase verlängert\nNach n Zyklen: 2ⁿ Kopien.\n30 Zyklen = ~1 Milliarde Kopien!",
    category: "bio",
    topic: "Molekulargenetik",
    difficulty: "mittel",
  },
  ...
  },
  {
    ...
    back: "1. DNA-Methylierung: CH₃ an Cytosin → Gen-Stilllegung\n2. Histonmodifikation: Acetylierung (aktiv), Methylierung (variabel)\n3. miRNA: Bindet mRNA → verhindert Translation\nVererbbar, aber reversibel. Beeinflusst durch Umwelt.",
    category: "bio",
    topic: "Molekulargenetik",
    difficulty: "schwer",
  },
  ...
  {
    id: "fc-bio-mg7",
    front: "CRISPR-Cas9: Wie funktioniert es?",
    back: "1. Guide-RNA erkennt Zielsequenz auf der DNA\n2. Cas9-Nuklease schneidet beide DNA-Stränge\n3. Zelle repariert: NHEJ (fehlerhaft → Knockout) oder HDR (mit Vorlage → Korrektur)\nAnwendung: Gentherapie, Pflanzenzucht, Forschung.",
    category: "bio",
    topic: "Molekulargenetik",
    difficulty: "schwer",
  },
...
export const bioNervensystem: Flashcard[] = [
  {
    id: "fc-bio-ns1",
    front: "Sympathikus vs Parasympathikus?",
    back: "Sympathikus: 'Fight or Flight' — Herzfrequenz↑, Bronchien weit, Pupillen weit, Verdauung↓\nParasympathikus: 'Rest and Digest' — Herzfrequenz↓, Bronchien eng, Pupillen eng, Verdauung↑\nTransmitter: Sympathikus=Noradrenalin, Para=Acetylcholin.",
    category: "bio",
    topic: "Nervensystem",
    difficulty: "leicht",
  },
  {
    id: "fc-bio-ns2",
    front: "Synapsentypen?",
    back: "Chemische Synapse: Neurotransmitter über synaptischen Spalt (langsamer, modulierbar)\nElektrische Synapse (Gap Junctions): Direkte Ionenübertragung (schneller, bidirektional)\nErregende Synapse: EPSP (Na⁺-Einstrom)\nHemmende Synapse: IPSP (Cl⁻-Einstrom/K⁺-Ausstrom).",
    category: "bio",
    topic: "Nervensystem",
    difficulty: "mittel",
  },
  ...
  {
    id: "fc-bio-ns5",
    front: "Aufbau des Gehirns: 5 Hauptteile?",
    back: "1. Großhirn (Cerebrum): Bewusstsein, Denken, Motorik\n2. Zwischenhirn (Diencephalon): Thalamus, Hypothalamus\n3. Mittelhirn (Mesencephalon): Reflexe, Augen\n4. Kleinhirn (Cerebellum): Koordination, Gleichgewicht\n5. Hirnstamm (Medulla): Vitalfunktionen (Atmung, Herzschlag)",
    category: "bio",
    topic: "Nervensystem",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ns6",
    front: "Reflex vs bewusste Reaktion?",
    back: "Reflex: Reiz → Sensor → afferent → Rückenmark → efferent → Effektor\nSchnell, unwillkürlich, angeboren oder erlernt.\nBeispiel: Kniesehnenreflex (monosynaptisch)\nBewusste Reaktion: Über Großhirn, langsamer, willentlich steuerbar.",
    category: "bio",
    topic: "Nervensystem",
    difficulty: "leicht",
  },
  {
    id: "fc-bio-ns7",
    front: "Na⁺/K⁺-ATPase: Funktion?",
    back: "Transportiert 3 Na⁺ RAUS und 2 K⁺ REIN pro ATP.\nErhält das Ruhepotential (-70 mV).\nElektrogen: Netto 1 positive Ladung nach außen.\nVerbraucht ~30% der Gesamt-ATP-Produktion des Körpers.",
    category: "bio",
    topic: "Nervensystem",
    difficulty: "mittel",
  },
...
export const bioImmunsystem: Flashcard[] = [
  {
    id: "fc-bio-im1",
    front: "Angeborene vs adaptive Immunität?",
    back: "Angeboren: Sofort, unspezifisch (Haut, Makrophagen, NK-Zellen, Komplement)\nAdaptiv: Verzögert, spezifisch (T-Zellen, B-Zellen, Antikörper)\nAngeboren → Brücke → Adaptiv über APCs (dendritische Zellen).",
    category: "bio",
    topic: "Immunbiologie",
    difficulty: "leicht",
  },
  {
    id: "fc-bio-im2",
    front: "T-Zellen: CD4 vs CD8?",
    back: "CD4+ (T-Helferzellen): Aktivieren B-Zellen und Makrophagen, Th1/Th2-Differenzierung\nCD8+ (Zytotoxische T-Zellen): Töten virusinfizierte Zellen + Tumorzellen direkt\nMHC I: Alle kernhaltigen Zellen → CD8\nMHC II: Nur APCs → CD4.",
    category: "bio",
    topic: "Immunbiologie",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-im3",
    front: "Antikörper-Klassen: Ig-Typen?",
    back: "IgG: Häufigster, Sekundärantwort, plazentagängig\nIgM: Erstantwort, Pentamer (10 Bindungsstellen)\nIgA: Schleimhäute, Muttermilch (Dimer)\nIgE: Allergien, Parasiten\nIgD: B-Zell-Rezeptor (Oberfläche)",
    category: "bio",
    topic: "Immunbiologie",
    difficulty: "mittel",
  },
...
export const bioVerdauung: Flashcard[] = [
  {
    id: "fc-bio-vd1",
    front: "Enzyme der Verdauung: Mund → Magen → Darm?",
    back: "Mund: Amylase (Stärke→Maltose), Lipase (lingual)\nMagen: Pepsin (Proteine, pH 2), HCl, Intrinsic Factor\nPankreas: Trypsin, Lipase, Amylase, Nukleasen\nDünndarm: Laktase, Maltase, Peptidasen (Bürstensaum).",
    category: "bio",
    topic: "Verdauung",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-vd2",
    front: "Dünndarm: Aufbau und Resorption?",
    back: "3 Abschnitte: Duodenum, Jejunum, Ileum\nOberflächenvergrößerung: Kerckring-Falten → Zotten → Mikrovilli (200m²!)\nResorption: Glucose/AS über Na⁺-Symporter, Fette über Mizellen → Chylomikronen, Vit. B12 im Ileum.",
    category: "bio",
    topic: "Verdauung",
    difficulty: "mittel",
  },
  ...
  {
    id: "fc-bio-vd4",
    front: "Pankreas: Exokrin vs endokrin?",
    back: "Exokrin (99%): Verdauungsenzyme → Ductus pancreaticus → Duodenum\n- Trypsinogen → Trypsin (durch Enterokinase aktiviert)\nEndokrin (Langerhans-Inseln):\n- α-Zellen: Glucagon (BZ↑)\n- β-Zellen: Insulin (BZ↓)\n- δ-Zellen: Somatostatin (hemmt beides)",
    category: "bio",
    topic: "Verdauung",
    difficulty: "mittel",
  },
...
export const bioNiere: Flashcard[] = [
  {
    id: "fc-bio-ni1",
    front: "Nephron: Aufbau?",
    back: "Nierenkörperchen: Glomerulus + Bowman-Kapsel\nTubuläres System: Prox. Tubulus → Henle-Schleife → Dist. Tubulus → Sammelrohr\nPrimärharn: ~180 L/Tag\nEndharn: ~1,5 L/Tag (99% Rückresorption!).",
    category: "bio",
    topic: "Niere",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ni2",
    front: "Gegenstromprinzip in der Henle-Schleife?",
    back: "Absteigender Schenkel: Wasserdurchlässig, NaCl-undurchlässig → Wasser strömt ins Interstitium\nAufsteigender Schenkel: Wasserundurchlässig, NaCl wird aktiv resorbiert\n→ Erzeugt Osmolaritätsgradienten im Mark (bis 1200 mOsm/L)\n→ Ermöglicht Harnkonzentrierung im Sammelrohr (ADH-abhängig).",
    category: "bio",
    topic: "Niere",
    difficulty: "schwer",
  },
  {
    id: "fc-bio-ni3",
    front: "RAAS: Renin-Angiotensin-Aldosteron-System?",
    back: "Nierendurchblutung↓ → Renin (Juxtaglomeruläre Zellen)\nAngiotensinogen → Angiotensin I (Renin) → Angiotensin II (ACE in Lunge)\nAngiotensin II: Vasokonstriktion + Aldosteron-Freisetzung\nAldosteron: Na⁺-Rückresorption↑, K⁺-Sekretion↑ → Blutdruck↑.",
    category: "bio",
    topic: "Niere",
    difficulty: "schwer",
  },
...
export const bioHormonSystem: Flashcard[] = [
  {
    id: "fc-bio-hs1",
    front: "Hypothalamus-Hypophysen-Achse: Prinzip?",
    back: "Hypothalamus → Releasing-/Inhibiting-Hormone → Hypophysenvorderlappen (HVL)\nHVL → glandotrope Hormone → periphere Drüsen\nNegative Rückkopplung: Periphere Hormone hemmen Hypothalamus + HVL.\nBeispiel: TRH → TSH → T3/T4 → hemmt TRH/TSH.",
    category: "bio",
    topic: "Hormonsystem",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-hs2",
    front: "Hypophysenvorderlappen: 6 Hormone?",
    back: "1. TSH (→ Schilddrüse)\n2. ACTH (→ Nebennierenrinde)\n3. LH (→ Gonaden)\n4. FSH (→ Gonaden)\n5. STH/GH (Wachstumshormon → Knochen, Muskeln)\n6. Prolaktin (→ Milchproduktion)\nMerke: 'FLAT PiG' — FSH, LH, ACTH, TSH, Prolaktin, GH.",
    category: "bio",
    topic: "Hormonsystem",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-hs3",
    front: "Hypophysenhinterlappen: Welche Hormone?",
    back: "Oxytocin: Uteruskontraktion (Geburt), Milchejektion, Bonding\nADH (Vasopressin): Wasserrückresorption im Sammelrohr → konzentrierter Urin\nBeide im Hypothalamus synthetisiert, im HHL nur gespeichert + freigesetzt!\nADH-Mangel → Diabetes insipidus (massiver Wasserverlust).",
    category: "bio",
    topic: "Hormonsystem",
    difficulty: "mittel",
  },
  ...
  {
    id: "fc-bio-hs6",
    front: "Cortisol: Wirkungen?",
    back: "Gluconeogenese↑ (Blutzucker↑)\nProteolyse↑, Lipolyse↑\nEntzündungshemmend + Immunsuppressiv\nPermissive Wirkung auf Katecholamine\nStresshormon: Circadianer Rhythmus (Maximum morgens)\nCushing-Syndrom: Cortisol-Überproduktion → Stammfettsucht, Striae, Hyperglykämie.",
    category: "bio",
    topic: "Hormonsystem",
    difficulty: "schwer",
  },
  ...
  {
    id: "fc-bio-hs8",
    front: "Diabetes mellitus Typ 1 vs Typ 2?",
    back: "Typ 1: Autoimmune Zerstörung der β-Zellen → absoluter Insulinmangel, juvenil, insulinpflichtig\nTyp 2: Insulinresistenz + relative Insuffizienz, Adipositas-assoziiert, >90% aller Fälle\nKomplikationen: Mikroangiopathie (Retina, Niere), Makroangiopathie (Herzinfarkt, Schlaganfall), Neuropathie.",
    category: "bio",
    topic: "Hormonsystem",
    difficulty: "mittel",
  },
  ...
  {
    id: "fc-bio-hs11",
    front: "Stressreaktion: Akut vs chronisch?",
    back: "Akut: Sympathikus + NNM → Adrenalin/Noradrenalin\n→ HF↑, RR↑, BZ↑, Bronchodilatation, Durchblutung Muskulatur↑\nChronisch: HPA-Achse → CRH → ACTH → Cortisol\n→ Immunsuppression, Proteinabbau, Hyperglykämie\nChronischer Stress: Risikörhöhung für KHK, Depression, metabolisches Syndrom.",
    category: "bio",
    topic: "Hormonsystem",
    difficulty: "schwer",
  },
...
export const bioBlut: Flashcard[] = [
  {
    id: "fc-bio-bl1",
    front: "Blutzusammensetzung?",
    back: "Plasma (~55%): Wasser, Proteine (Albumin, Globuline, Fibrinogen), Elektrolyte, Glukose\nZelluläre Bestandteile (~45% = Hämatokrit):\n• Erythrozyten: ~5 Mio/µL\n• Leukozyten: 4.000–10.000/µL\n• Thrombozyten: 150.000–400.000/µL\nBlutvolumen: ~4–6 L beim Erwachsenen.",
    category: "bio",
    topic: "Blut",
    difficulty: "leicht",
  },
  ...
  {
    id: "fc-bio-bl5",
    front: "Thrombozyten und primäre Hämostase?",
    back: "Thrombozyten: Kernlose Zellfragmente aus Megakaryozyten\nLebensdauer: 7–10 Tage\nPrimäre Hämostase (Minuten):\n1. Vasokonstriktion\n2. Thrombozytenadhäsion (vWF an Kollagen)\n3. Thrombozytenaktivierung (Formänderung, ADP/TXA₂-Freisetzung)\n4. Thrombozytenaggregation (GPIIb/IIIa + Fibrinogen).",
    category: "bio",
    topic: "Blut",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-bl6",
    front: "Sekundäre Hämostase: Gerinnungskaskade?",
    back: "Extrinsischer Weg: Gewebefaktor (TF) → VII → X\nIntrinsischer Weg: XII → XI → IX → (VIIIa) → X\nGemeinsame Endstrecke: X → Va → Prothrombin → Thrombin → Fibrinogen → Fibrin\nFibrin wird durch Faktor XIII quervernetzt\nAntikoagulation: Antithrombin III, Protein C/S, Heparin, Cumarine (Vitamin-K-Antagonisten).",
    category: "bio",
    topic: "Blut",
    difficulty: "schwer",
  },
...
export const bioPflanzen: Flashcard[] = [
  {
    id: "fc-bio-pf1",
    front: "Photosynthese: Überblick und Bilanz?",
    back: "6 CO₂ + 6 H₂O → C₆H₁₂O₆ + 6 O₂ (Lichtenergie nötig)\nOrt: Chloroplasten\nLichtreaktion: Thylakoidmembran → ATP + NADPH + O₂\nDunkelreaktion (Calvin-Zyklus): Stroma → CO₂-Fixierung → Glucose\nChlorophyll a/b: Absorbiert Rot + Blau, reflektiert Grün.",
    category: "bio",
  ...
  {
    id: "fc-bio-pf7",
    front: "Stomata: Regulation der Spaltöffnungen?",
    back: "Schließzellen: Bohnenförmig, regulieren Gasaustausch + Transpiration\nÖffnung: K⁺-Aufnahme → Osmose → Turgordruck↑ → Porus öffnet\nSchließung: K⁺-Abgabe → Turgor↓ → Porus schließt\nRegulation: Licht↑ → offen, CO₂↓ → offen, ABA (Trockenstress) → geschlossen\nDilemma: Offen = CO₂ rein, aber H₂O raus (Transpiration).",
    category: "bio",
    topic: "Pflanzenbiologie",
    difficulty: "mittel",
  },
...
export const bioStoffwechsel: Flashcard[] = [
  ...
  {
    id: "fc-bio-sw8",
    front: "Cori-Zyklus: Laktat-Recycling?",
    back: "Muskel (anärob): Glucose → Pyruvat → Laktat (Lactatdehydrogenase)\nLaktat → Blut → Leber\nLeber: Laktat → Pyruvat → Glucose (Gluconeogenese)\nGlucose → Blut → Muskel\nEnergetisch 'teuer': Muskel gewinnt 2 ATP, Leber verbraucht 6 ATP\nBedeutung: Ermöglicht anärobe Muskelarbeit ohne Laktat-Akkumulation.",
    category: "bio",
    topic: "Stoffwechsel",
    difficulty: "mittel",
  },
...
export const bioSinnesorgane: Flashcard[] = [
  ...
  {
    id: "fc-bio-so2",
    front: "Photorezeptoren: Stäbchen vs Zapfen?",
    back: "Stäbchen (~120 Mio): Skotopisches Sehen (Dämmerung), sehr lichtempfindlich, kein Farbsehen\n→ Rhodopsin (Retinal + Opsin)\nZapfen (~6 Mio): Photopisches Sehen (Tag), Farbsehen\n→ 3 Typen: S (blau, 420nm), M (grün, 534nm), L (rot, 564nm)\nFovea centralis: Nur Zapfen → schärfstes Sehen\nBlinder Fleck: Austritt Sehnerv → keine Rezeptoren.",
    category: "bio",
    topic: "Sinnesorgane",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-so3",
    front: "Phototransduktion: Signalweg im Stäbchen?",
    back: "Dunkel: cGMP hoch → Na⁺-Kanäle offen → Dunkelstrom → Glutamat-Freisetzung\nLicht: Photon → Retinal-Isomerisierung (11-cis → all-trans) → Rhodopsin → Transducin (G-Protein) → Phosphodiesterase → cGMP↓ → Na⁺-Kanäle schließen → Hyperpolarisation → Glutamat↓\nBesonderheit: Licht = Hemmung (Hyperpolarisation), nicht Depolarisation!",
    category: "bio",
    topic: "Sinnesorgane",
    difficulty: "schwer",
  },
...
export const chemieStoechiometrie: Flashcard[] = [
  {
    id: "fc-ch-st1",
    front: "Mol: Definition?",
    back: "1 Mol = 6,022 × 10²³ Teilchen (Avogadro-Konstante NA)\nn = m/M (Stoffmenge = Masse / Molare Masse)\nBsp: 1 Mol H₂O = 18 g, enthält 6,022 × 10²³ Moleküle.",
    category: "chemie",
    topic: "Stöchiometrie",
    difficulty: "leicht",
  },
  {
    id: "fc-ch-st2",
    front: "Konzentration berechnen?",
    back: "c = n/V (Stoffmengenkonzentration, mol/L)\nMassenkonzentration: β = m/V (g/L)\nMassenprozent: w = m(Stoff)/m(Lösung) × 100%\nVerdünnung: c₁·V₁ = c₂·V₂",
    category: "chemie",
    topic: "Stöchiometrie",
    difficulty: "leicht",
  },
  ...
  {
    id: "fc-ch-st4",
    front: "Ideales Gasgesetz?",
    back: "p·V = n·R·T\np = Druck (Pa), V = Volumen (m³)\nn = Stoffmenge (mol), T = Temperatur (K)\nR = 8,314 J/(mol·K)\nNormalbedingungen: 0°C, 1 atm → 1 mol Gas = 22,4 L.",
    category: "chemie",
    topic: "Stöchiometrie",
    difficulty: "mittel",
  },
  {
    id: "fc-ch-st5",
    front: "Limitierender Reaktant?",
    back: "Der Reaktant, der zürst verbraucht wird → bestimmt max. Produktmenge.\nBerechnung:\n1. Stoffmengen aller Reaktanten berechnen\n2. Stöchiometrisches Verhältnis vergleichen\n3. Kleineres Verhältnis → limitierend.",
    category: "chemie",
    topic: "Stöchiometrie",
    difficulty: "mittel",
  },
...
export const chemieOrganik: Flashcard[] = [
  {
    id: "fc-ch-or1",
    front: "Alkane, Alkene, Alkine: Unterschied?",
    back: "Alkane: C-C Einfachbindung (CₙH₂ₙ₊₂), gesättigt\nAlkene: C=C Doppelbindung (CₙH₂ₙ), ungesättigt\nAlkine: C≡C Dreifachbindung (CₙH₂ₙ₋₂)\nReaktivität: Alkin > Alken > Alkan.",
    category: "chemie",
    topic: "Organik",
    difficulty: "leicht",
  },
  {
    id: "fc-ch-or2",
    front: "Funktionelle Gruppen: Die 6 wichtigsten?",
    back: "-OH: Hydroxyl (Alkohole)\n-CHO: Aldehyd\n-CO-: Keton\n-COOH: Carboxyl (Carbonsäuren)\n-NH₂: Amino\n-CO-NH-: Amid (Peptidbindung)\nMerke: 'Alkohole Aldehyde Ketone Säuren Amine Amide'",
    category: "chemie",
    topic: "Organik",
    difficulty: "leicht",
  },
  {
    ...
    back: "Strukturisomerie: Gleiche Summenformel, verschiedene Verknüpfung\nStereoisomerie:\n- Enantiomere: Spiegelbild (R/S, D/L)\n- Diastereomere: Nicht-Spiegelbild (cis/trans, Z/E)\nChirales Zentrum: C-Atom mit 4 verschiedenen Substituenten.",
    category: "chemie",
    topic: "Organik",
    difficulty: "mittel",
  },
  {
    id: "fc-ch-or4",
    front: "Aminosäuren: Grundstruktur?",
    back: "H₂N-CH(R)-COOH\nα-C mit: Aminogruppe, Carboxylgruppe, H, Seitenkette R\n20 proteinogene AS\nBeim physiologischen pH (7,4): Zwitterion (NH₃⁺ und COO⁻)\nEssenzielle AS: Können nicht selbst synthetisiert werden (8 beim Erwachsenen).",
    category: "chemie",
    topic: "Organik",
    difficulty: "mittel",
  },
  {
    id: "fc-ch-or5",
    front: "Peptidbindung: Eigenschaften?",
    back: "Kondensationsreaktion: -COOH + H₂N- → -CO-NH- + H₂O\nPlanar (partieller Doppelbindungscharakter durch Mesomerie)\nTrans-Konfiguration bevorzugt\nProteinstruktur: Primär (Sequenz) → Sekundär (α-Helix, β-Faltblatt) → Tertiär (3D) → Quartär (Untereinheiten).",
    category: "chemie",
    topic: "Organik",
    difficulty: "mittel",
  },
...
export const chemieBiochemie: Flashcard[] = [
  {
    id: "fc-ch-bc1",
    front: "Glykolyse: Zusammenfassung?",
    back: "Glucose → 2 Pyruvat\nOrt: Cytoplasma\nErtrag: 2 ATP + 2 NADH\nSchlüsselenzyme: Hexokinase, PFK-1 (limitierend!), Pyruvatkinase\nAnärob: Pyruvat → Lactat (Milchsäuregärung).",
    category: "chemie",
    topic: "Biochemie",
    difficulty: "mittel",
  },
  ...
  {
    id: "fc-ch-bc4",
    front: "Enzyme: Michaelis-Menten-Kinetik?",
  ...
  {
    id: "fc-ch-bc5",
    front: "Enzymhemmung: Kompetitiv vs allosterisch?",
    back: "Kompetitiv: Hemmer bindet im aktiven Zentrum, Km↑, Vmax gleich\nNichtkompetitiv: Hemmer bindet anderswo, Km gleich, Vmax↓\nAllosterisch: Hemmer/Aktivator bindet an regulatorische Stelle → Konformationsänderung\nIrreversibel: Kovalente Bindung (z. B. Aspirin hemmt COX).",
    category: "chemie",
    topic: "Biochemie",
    difficulty: "schwer",
  },
...
export const chemieRedox: Flashcard[] = [
  ...
  },
  {
    ...
    back: "Je negativer E°, desto stärkeres Reduktionsmittel:\nLi (-3,04V) < Na (-2,71V) < Zn (-0,76V) < Fe (-0,44V) < H₂ (0V) < Cu (+0,34V) < Ag (+0,80V) < Au (+1,50V)\nEdle Metalle: Positives E° → schwer zu oxidieren.",
    category: "chemie",
    topic: "Redox",
    difficulty: "mittel",
  },
  {
    id: "fc-ch-rx3",
    front: "Galvanische Zelle: Wie funktioniert sie?",
    back: "Zwei Halbzellen mit verschiedenen Metallen in Elektrolytlösung.\nAnode (Oxidation): Unedleres Metall gibt e⁻ ab (Minus-Pol)\nKathode (Reduktion): Edleres Metall nimmt e⁻ auf (Plus-Pol)\nSalzbrücke: Ionenausgleich\nSpannung = E°(Kathode) - E°(Anode).",
    category: "chemie",
    topic: "Redox",
    difficulty: "mittel",
  },
  {
    id: "fc-ch-rx4",
    front: "Elektrolyse vs Galvanische Zelle?",
    back: "Galvanische Zelle: Spontane Redoxreaktion → erzeugt Strom (ΔG < 0)\nElektrolyse: Erzwungene Redoxreaktion → verbraucht Strom (ΔG > 0)\nBei Elektrolyse: Anode = Plus-Pol (umgekehrt!)\nAnwendungen: Aluminiumgewinnung, Galvanisierung, Wasserstoffproduktion.",
    category: "chemie",
    topic: "Redox",
    difficulty: "mittel",
  },
...
export const physikKinematik: Flashcard[] = [
  {
    id: "fc-ph-k1",
    front: "Gleichförmige Bewegung: Formeln?",
    back: "v = s/t = konstant\ns = v · t\na = 0\nIm s-t-Diagramm: Gerade\nIm v-t-Diagramm: Horizontale Linie.",
    category: "physik",
    topic: "Kinematik",
    difficulty: "leicht",
  },
  {
    id: "fc-ph-k2",
    front: "Gleichmäßig beschleunigte Bewegung?",
    back: "a = Δv/Δt = konstant\nv(t) = v₀ + a·t\ns(t) = v₀·t + ½·a·t²\nv² = v₀² + 2·a·s\nIm v-t-Diagramm: Gerade mit Steigung a\nFläche unter v-t-Kurve = zurückgelegter Weg.",
    category: "physik",
    topic: "Kinematik",
    difficulty: "leicht",
  },
  ...
  {
    id: "fc-ph-k4",
    front: "Kreisbewegung: Zentripetalbeschleunigung?",
...
export const physikWaerme: Flashcard[] = [
  ...
  {
    id: "fc-ph-w4",
    front: "Wärmeübertragung: 3 Arten?",
    back: "Konduktion: Wärmeleitung durch Material (Stab, Wand)\nKonvektion: Wärmetransport durch Strömung (Heizung, Wind)\nStrahlung: Elektromagnetische Wellen (Sonne, Infrarot)\nVakuum: Nur Strahlung möglich!",
    category: "physik",
    topic: "Wärmelehre",
    difficulty: "leicht",
  },
  {
    id: "fc-ph-w5",
    front: "Phasenübergänge und latente Wärme?",
    back: "Schmelzen/Erstarren: Q = m·L_f (Schmelzwärme)\nVerdampfen/Kondensieren: Q = m·L_v (Verdampfungswärme)\nWährend Phasenübergang: Temperatur bleibt KONSTANT!\nL_v(Wasser) = 2260 kJ/kg — erklärt Kühleffekt von Schweiß.",
    category: "physik",
    topic: "Wärmelehre",
    difficulty: "mittel",
  },
...
export const physikWellen: Flashcard[] = [
  {
    id: "fc-ph-wl1",
    front: "Wellengrößen: Zusammenhang?",
    back: "v = f · λ (Geschwindigkeit = Frequenz × Wellenlänge)\nT = 1/f (Periode = 1/Frequenz)\nf in Hz, λ in m, v in m/s\nSchall in Luft: ~343 m/s\nLicht im Vakuum: c = 3×10⁸ m/s.",
    category: "physik",
    topic: "Wellen",
    difficulty: "leicht",
  },
  ...
  {
    id: "fc-ph-wl3",
    front: "Doppler-Effekt?",
    back: "Annäherung: Frequenz HÖHER (Wellenlänge kürzer)\nEntfernung: Frequenz TIEFER (Wellenlänge länger)\nFormel: f' = f · (v ± v_E) / (v ∓ v_S)\nAnwendung: Ultraschall-Doppler (Blutfluss), Rotverschiebung (Astronomie).",
    category: "physik",
    topic: "Wellen",
    difficulty: "mittel",
  },
  {
    ...
    back: "Radiowellen > Mikrowellen > Infrarot > sichtbares Licht > UV > Röntgen > Gammastrahlung\nEnergie: E = h·f (steigt mit Frequenz)\nSichtbar: 380 nm (violett) — 780 nm (rot)\nAlle EM-Wellen: c = 3×10⁸ m/s im Vakuum.",
    category: "physik",
    topic: "Wellen",
    difficulty: "mittel",
  },
  {
    id: "fc-ph-wl5",
    front: "Brechungsgesetz (Snellius)?",
    back: "n₁ · sin(α₁) = n₂ · sin(α₂)\nn = c/v (Brechungsindex)\nn(Wasser) ≈ 1,33, n(Glas) ≈ 1,5\nVom dichten ins dünne Medium: Brechung vom Lot WEG\nTotalreflexion: Wenn α > Grenzwinkel (nur dünn→dicht).",
    category: "physik",
    topic: "Wellen",
    difficulty: "mittel",
  },
...
export const physikAtomphysik: Flashcard[] = [
  ...
  {
    id: "fc-ph-ap2",
    front: "Halbwertszeit: Formel?",
    back: "N(t) = N₀ · (½)^(t/t½)\nNach 1 HWZ: 50% übrig\nNach 2 HWZ: 25% übrig\nNach 3 HWZ: 12,5% übrig\nBeispiele: C-14: 5730 Jahre, I-131: 8 Tage, Ra-226: 1600 Jahre.",
    category: "physik",
    topic: "Atomphysik",
    difficulty: "mittel",
  },
  {
    id: "fc-ph-ap3",
    front: "Photölektrischer Effekt?",
    back: "Licht schlägt Elektronen aus Metall heraus.\nEinstein: E_photon = h·f\nNur wenn h·f ≥ W_A (Austrittsarbeit)\nE_kin = h·f - W_A\nHöhere Intensität → mehr Elektronen (nicht schnellere!)\nHöhere Frequenz → schnellere Elektronen.",
    category: "physik",
    topic: "Atomphysik",
    difficulty: "schwer",
  },
  {
    id: "fc-ph-ap4",
    front: "Strahlenbelastung: Einheiten?",
    back: "Aktivität: Becquerel (Bq) = Zerfälle/s\nEnergiedosis: Gray (Gy) = J/kg\nÄquivalentdosis: Sievert (Sv) = Gy × Strahlungswichtungsfaktor\nα: Faktor 20, β/γ: Faktor 1\nNatürliche Belastung: ~2,4 mSv/Jahr.",
    category: "physik",
    topic: "Atomphysik",
    difficulty: "schwer",
  },
...
export const matheTrigonometrie: Flashcard[] = [
  {
    id: "fc-ma-t1",
    front: "Sinus, Cosinus, Tangens im rechtwinkligen Dreieck?",
    back: "sin(α) = Gegenkathete / Hypotenuse\ncos(α) = Ankathete / Hypotenuse\ntan(α) = Gegenkathete / Ankathete = sin/cos\nMerke: 'SOHCAHTOA' oder 'GAGA HüHü GAGA'",
    category: "mathe",
    topic: "Trigonometrie",
    difficulty: "leicht",
  },
  {
    id: "fc-ma-t2",
    front: "Wichtige Winkelwerte?",
    back: "sin(0°)=0, sin(30°)=½, sin(45°)=√2/2, sin(60°)=√3/2, sin(90°)=1\ncos(0°)=1, cos(30°)=√3/2, cos(45°)=√2/2, cos(60°)=½, cos(90°)=0\ntan(0°)=0, tan(45°)=1, tan(90°)=∞\nMerke: sin und cos sind um 90° verschoben.",
    category: "mathe",
    topic: "Trigonometrie",
    difficulty: "leicht",
  },
  {
    id: "fc-ma-t3",
    front: "Trigonometrische Identitäten?",
    back: "sin²(x) + cos²(x) = 1\nsin(2x) = 2·sin(x)·cos(x)\ncos(2x) = cos²(x) - sin²(x)\ntan(x) = sin(x)/cos(x)\nBogenmaß: 360° = 2π rad → 180° = π rad.",
    category: "mathe",
    topic: "Trigonometrie",
    difficulty: "mittel",
  },
  {
    id: "fc-ma-t4",
    front: "Sinussatz und Kosinussatz?",
    back: "Sinussatz: a/sin(A) = b/sin(B) = c/sin(C)\nKosinussatz: c² = a² + b² - 2ab·cos(C)\n→ Verallgemeinerung des Pythagoras (wenn C=90°: cos(90°)=0 → c²=a²+b²).",
    category: "mathe",
    topic: "Trigonometrie",
    difficulty: "mittel",
  },
...
export const matheStochastik: Flashcard[] = [
  ...
  {
    id: "fc-ma-s4",
    front: "Normalverteilung: 68-95-99,7-Regel?",
    back: "~68% der Werte liegen innerhalb ±1σ vom Mittelwert\n~95% innerhalb ±2σ\n~99,7% innerhalb ±3σ\nσ = Standardabweichung\nN(μ, σ²), Glockenkurve, symmetrisch um μ.",
    category: "mathe",
    topic: "Stochastik",
    difficulty: "mittel",
  },
...
export const matheProzent: Flashcard[] = [
  {
    id: "fc-ma-p1",
    front: "Prozent: Grundformel?",
    back: "Prozentwert W = Grundwert G × Prozentsatz p/100\nGrundwert G = W / (p/100)\nProzentsatz p = (W/G) × 100\nMerke: 'Drei Größen, eine gesucht → Dreisatz!'",
    category: "mathe",
    topic: "Prozent",
    difficulty: "leicht",
  },
  {
    id: "fc-ma-p2",
    front: "Prozentuale Veränderung?",
    back: "Änderung = (Neuwert - Altwert) / Altwert × 100%\nZunahme um p%: Neuwert = Altwert × (1 + p/100)\nAbnahme um p%: Neuwert = Altwert × (1 - p/100)\nACHTUNG: 20% Zunahme + 20% Abnahme ≠ Ausgangswert! (100→120→96)",
    category: "mathe",
    topic: "Prozent",
    difficulty: "leicht",
  },
  {
    ...
    back: "Proportional: Mehr → Mehr (Preis steigt mit Menge)\n3 Äpfel → 6€, 5 Äpfel → ?\nAntiproportional: Mehr → Weniger (Mehr Arbeiter → weniger Zeit)\n4 Arbeiter → 12h, 6 Arbeiter → ?\nProportional: Kreuzweise gleich, Anti: Gerade gleich.",
    category: "mathe",
    topic: "Prozent",
    difficulty: "leicht",
  },
  ...
  {
    id: "fc-ma-p5",
    front: "Verdünnungsrechnung (MedAT-typisch)?",
    back: "c₁·V₁ = c₂·V₂\n10 ml einer 5%-Lösung + 40 ml Wasser:\nc₂ = (5% × 10ml) / 50ml = 1%\nRegel: Konzentration × Volumen = konstante Stoffmenge.",
    category: "mathe",
    topic: "Prozent",
    difficulty: "mittel",
  },
...
export const matheEinheiten: Flashcard[] = [
  ...
  {
    id: "fc-ma-e3",
    front: "Kraft, Energie, Leistung: Einheiten?",
    back: "Kraft: Newton (N) = kg·m/s²\nEnergie/Arbeit: Joule (J) = N·m = kg·m²/s²\nLeistung: Watt (W) = J/s\nDruck: Pascal (Pa) = N/m²\n1 bar = 10⁵ Pa, 1 atm = 101.325 Pa.",
    category: "mathe",
    topic: "Einheiten",
    difficulty: "leicht",
  },
...
export const bioZellbiologieExtra: Flashcard[] = [
  ...
  {
    id: "fc-bio-ze2",
    front: "Zellzyklus: Checkpoints?",
    back: "G1/S-Checkpoint (Restriktionspunkt): Zelle groß genug? DNA intakt?\nG2/M-Checkpoint: DNA vollständig repliziert?\nSpindel-Checkpoint (Metaphase): Alle Chromosomen am Spindelapparat?\nRegulation: Cycline + CDKs, p53 = 'Wächter des Genoms'.",
    category: "bio",
    topic: "Zellbiologie",
    difficulty: "mittel",
  },
  {
    id: "fc-bio-ze3",
    front: "Apoptose: Intrinsisch vs Extrinsisch?",
    back: "Intrinsisch: DNA-Schaden → Cytochrom c aus Mito → Caspase-9 → Caspase-3\nExtrinsisch: Todesligand (FasL, TNF) → Todesrezeptor → Caspase-8 → Caspase-3\nApoptose: kontrolliert, keine Entzündung\nNekrose: unkontrolliert, Entzündung.",
    category: "bio",
    topic: "Zellbiologie",
    difficulty: "schwer",
  },
  {
    id: "fc-bio-ze4",
    front: "Crossing-over: Wann und warum?",
    back: "Wann: Pachytän der Prophase I (Meiose)\nWas: Austausch von DNA zwischen nicht-schwesterlichen Chromatiden\nWo: An Chiasmata\nWarum: Erhöht genetische Vielfalt → rekombinante Chromosomen\nZusammen mit Independent Assortment = enorme Variation.",
    category: "bio",
    topic: "Zellbiologie",
    difficulty: "mittel",
  },
...
export const chemieAtombauExtra: Flashcard[] = [
  {
    id: "fc-ch-ae1",
    front: "Ionisierungsenergie: Trend im PSE?",
    back: "In der Periode: Nimmt ZU (stärkere Kernladung)\nIn der Gruppe: Nimmt AB (äußere Elektronen weiter vom Kern)\nAusnahmen: Halbgefüllte/vollgefüllte Unterschalen sind besonders stabil (N vs O).",
    category: "chemie",
    topic: "Atombau",
    difficulty: "mittel",
  },
  ...
  },
  {
    ...
    back: "sp³: 4 Orbitale, tetraedrisch, 109,5° (CH₄)\nsp²: 3 Orbitale, trigonal-planar, 120° (C₂H₄, BF₃)\nsp: 2 Orbitale, linear, 180° (CO₂, C₂H₂)\nAnzahl Hybridorbitale = σ-Bindungen + freie EP am Zentralatom.",
    category: "chemie",
    topic: "Atombau",
    difficulty: "schwer",
  },
...
export const physikElektExtra: Flashcard[] = [
  {
    id: "fc-ph-ee1",
    front: "Kondensator: Kapazität?",
    back: "C = Q/U = ε₀·ε_r·A/d\nC in Farad (F), Q = Ladung, U = Spannung\nEnergie: W = ½·C·U²\nReihenschaltung: 1/C_ges = 1/C₁ + 1/C₂\nParallelschaltung: C_ges = C₁ + C₂ (umgekehrt wie Widerstände!).",
    category: "physik",
    topic: "Elektrizität",
    difficulty: "mittel",
  },
  {
    id: "fc-ph-ee2",
    front: "Elektrische Leistung?",
    back: "P = U·I = I²·R = U²/R\nEinheit: Watt (W)\nEnergie: W = P·t\n1 kWh = 3,6 MJ\nSicherung: Begrenzt den Strom I = P/U.",
    category: "physik",
    topic: "Elektrizität",
    difficulty: "leicht",
  },
