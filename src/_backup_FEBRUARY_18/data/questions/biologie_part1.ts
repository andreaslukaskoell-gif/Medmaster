export const fragenPart1 = [
  ...
  },
  {
    ...
    optionen: [
      "Die Fähigkeit zur sexuellen Fortpflanzung",
  ...
  },
  {
    ...
    strategieTipp:
      "70S = prokaryotisch (Bakterien, Mitochondrien, Chloroplasten). 80S = eukaryotisch (Zytoplasma, ER). S = Svedberg-Einheit (Sedimentationskoeffizient).",
  },
  {
    id: "bio-q-011",
    stichwortId: "bio-1-02",
