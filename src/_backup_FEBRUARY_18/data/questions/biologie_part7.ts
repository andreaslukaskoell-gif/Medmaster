export const fragenPart7 = [
  ...
  },
  {
    ...
    optionen: [
      ...
      "Die unterschiedliche Ausprägungsstärke eines Merkmals bei verschiedenen Individuen mit gleichem Genotyp",
  ...
  },
  {
    ...
    korrekteAntwort: 2,
    erklärung:
      'Charles Darwin entwickelte 1859 in seinem Werk "On the Origin of Species" die Theorie der Evolution durch natürliche Selektion. Individuen mit vorteilhaften Merkmalen haben bessere Überlebens- und Fortpflanzungschancen, sodass sich diese Merkmale in der Population durchsetzen. Alfred Russel Wallace entwickelte unabhängig eine ähnliche Theorie.',
    strategieTipp:
  ...
  },
  {
    ...
    strategieTipp:
      'Lamarck: "Gebrauch vererbt sich" (falsch). Darwin: "Selektion filtert Variation" (richtig). Beispiel Giraffe: Nicht Strecken führte zu langem Hals, sondern Individuen mit längerem Hals überlebten besser.',
  },
  {
    id: "bio-q-334",
    stichwortId: "bio-9-04",
  ...
  },
  {
    ...
    strategieTipp:
      "Biologischer Artbegriff: Fortpflanzungsgemeinschaft mit fruchtbaren Nachkommen. Problem: nicht anwendbar auf asexuelle Organismen oder Fossilien.",
  },
  {
    id: "bio-q-338",
    stichwortId: "bio-9-05",
  ...
  },
  {
    ...
    optionen: [
      ...
      "Die Wanderung von Individuen und Austausch von Genen zwischen Populationen",
