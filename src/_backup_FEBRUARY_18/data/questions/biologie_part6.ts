export const fragenPart6 = [
  ...
  },
  {
    ...
    korrekteAntwort: 1,
    erklärung:
      "STRs sind kurze DNA-Sequenzen (2-6 Basenpaare), die sich mehrfach wiederholen. Die Anzahl der Wiederholungen variiert stark zwischen Individuen (Polymorphismus), ist aber bei einem Individuum konstant und vererbt. Analyse von 13-20 STR-Loci ergibt hochspezifisches DNA-Profil.",
    strategieTipp:
