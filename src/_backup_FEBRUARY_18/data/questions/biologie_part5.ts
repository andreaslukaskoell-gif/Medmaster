export const fragenPart5 = [
  {
    id: 'bio-q-201',
    stichwortId: 'bio-4-01',
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Welche Aussage zur Akrosomreaktion bei der Befruchtung ist korrekt?',
    optionen: [
      'Sie ermöglicht der Eizelle das Eindringen in den Hoden',
      'Sie führt zur Freisetzung von Enzymen, die die Zona pellucida durchdringen',
      'Sie findet erst nach der Verschmelzung der Zellkerne statt',
      'Sie verhindert die Polyspermie durch Depolarisation',
  ...
  },
  {
    ...
    fragetext: 'Was entsteht unmittelbar nach der Verschmelzung von Ei- und Samenzelle?',
    optionen: [
      'Morula',
      'Blastozyste',
      'Zygote',
  ...
  },
  {
    ...
    fragetext: 'Welcher Prozess findet während der Furchung NICHT statt?',
    optionen: [
      'Mitotische Zellteilungen',
      'Zunahme der Zellzahl',
      'Größenzunahme des Gesamtembryos',
      'Bildung von Blastomeren',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Wann erfolgt die Implantation der Blastozyste in die Uterusschleimhaut?',
    optionen: [
      'Unmittelbar nach der Befruchtung',
      'Im Morula-Stadium',
      'Etwa 6-7 Tage nach der Befruchtung',
      'Erst nach der Neurulation',
  ...
  {
    id: 'bio-q-205',
    stichwortId: 'bio-4-02',
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Welche Strukturen entwickeln sich aus dem Ektoderm?',
    optionen: [
      'Herz, Nieren und Skelettmuskulatur',
      'Nervensystem, Epidermis und Sinnesorgane',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Wie viele Keimblätter entstehen bei der Gastrulation beim Menschen?',
    optionen: [
      'Eins',
      'Zwei',
      'Drei',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Welche Aussage zu den Derivaten des Mesoderms ist FALSCH?',
    optionen: [
      'Das Herz entwickelt sich aus dem Mesoderm',
      'Die Skelettmuskulatur stammt aus dem Mesoderm',
      'Die Epidermis der Haut ist mesodermalen Ursprungs',
      'Die Nieren entstehen aus dem Mesoderm',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was ist die Neurulation?',
    optionen: [
      'Die Bildung der Neuralplatte aus dem Mesoderm',
      'Die Bildung des Neuralrohrs aus dem Ektoderm',
      'Die Verschmelzung der Keimblätter',
      'Die Bildung von Nervenzellen im Rückenmark',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Aus welchem Keimblatt entwickelt sich die Lunge?',
    optionen: [
      'Ektoderm',
      'Mesoderm',
      'Endoderm',
  ...
  {
    id: 'bio-q-210',
    stichwortId: 'bio-4-03',
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Wie lange dauert die Embryonalperiode beim Menschen?',
    optionen: [
      'Bis zur 4. Woche nach Befruchtung',
      'Bis zur 8. Woche nach Befruchtung',
      'Bis zur 12. Woche nach Befruchtung',
      'Bis zur 20. Woche nach Befruchtung',
      'Bis zur Geburt'
    ],
    korrekteAntwort: 1,
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was ist das Hauptmerkmal der Fetalperiode?',
    optionen: [
      'Bildung der drei Keimblätter',
      'Organogenese',
      'Wachstum und Reifung bereits angelegter Organe',
      'Implantation',
      'Neurulation'
    ],
    korrekteAntwort: 2,
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Warum ist die 3. bis 8. Woche der Schwangerschaft besonders kritisch?',
    optionen: [
      'In dieser Phase erfolgt die Implantation',
      'In dieser Phase findet die Organogenese statt, wodurch Teratogene besonders gefährlich sind',
      'In dieser Phase ist die Plazenta noch nicht funktionsfähig',
      'In dieser Phase können noch Mehrlingsbildungen auftreten',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Ab welcher Schwangerschaftswoche spricht man von einem Fetus?',
    optionen: [
      'Ab der 4. Woche',
      'Ab der 6. Woche',
      'Ab der 9. Woche',
  ...
  {
    id: 'bio-q-214',
    stichwortId: 'bio-4-04',
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Welche Funktion hat die Plazenta NICHT?',
    optionen: [
      'Gasaustausch zwischen Mutter und Fetus',
      'Nährstoffversorgung des Fetus',
      'Produktion von Schwangerschaftshormonen',
      'Direkte Durchmischung von mütterlichem und fetalem Blut',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Welche Struktur verbindet den Fetus mit der Plazenta?',
    optionen: [
      'Amnion',
      'Chorion',
      'Nabelschnur',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Welche Substanz kann die Plazentaschranke NICHT passieren?',
    optionen: [
      'Sauerstoff',
      'Glukose',
      'IgG-Antikörper der Mutter',
      'IgM-Antikörper der Mutter',
      'Alkohol'
    ],
    korrekteAntwort: 3,
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Welche Eihaut bildet die mit Fruchtwasser gefüllte Amnionhöhle?',
    optionen: [
      'Chorion',
      'Allantois',
      'Amnion',
  ...
  {
    id: 'bio-q-218',
    stichwortId: 'bio-5-01',
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Was besagt die 1. Mendelsche Regel (Uniformitätsregel)?',
    optionen: [
      'Die F2-Generation spaltet im Verhältnis 3:1 auf',
      'Die F1-Generation ist uniform (einheitlich)',
      'Gene werden unabhängig voneinander vererbt',
      'Dominante Allele setzen sich immer durch',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Eine heterozygote F1-Generation wird gekreuzt. Wie lautet das Aufspaltungsverhältnis im Phänotyp bei dominant-rezessiver Vererbung?',
    optionen: [
      '1:1',
      '1:2:1',
      '3:1',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Bei einer Dihybridkreuzung (AaBb × AaBb) mit unabhängiger Vererbung, welches Aufspaltungsverhältnis erwartet man im Phänotyp?',
    optionen: [
      '3:1',
      '1:2:1',
      '9:3:3:1',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was ist intermediäre Vererbung?',
    optionen: [
      'Beide Allele werden gleichzeitig exprimiert',
      'Der Phänotyp der Heterozygoten liegt zwischen beiden Homozygoten',
      'Das rezessive Allel setzt sich durch',
      'Es gibt keine F2-Aufspaltung',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Welches Beispiel zeigt Kodominanz?',
    optionen: [
      'Erbsenfarbe (gelb/grün) bei Mendel',
      'AB0-Blutgruppensystem (Allele A und B)',
      'Blütenfarbe bei Wunderblume (rot/weiß → rosa)',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Was bedeutet der Begriff "dominant" in der Genetik?',
    optionen: [
      'Das Allel ist häufiger in der Population',
      'Das Allel setzt sich im heterozygoten Zustand phänotypisch durch',
      'Das Allel wird nur vom Vater vererbt',
      'Das Allel ist gesünder als das rezessive',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Bei welchem Kreuzungsschema erwartet man ein 1:1 Phänotyp-Verhältnis?',
    optionen: [
      'AA × AA',
      'Aa × Aa',
      'Aa × aa',
  ...
  {
    id: 'bio-q-225',
    stichwortId: 'bio-5-02',
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was versteht man unter Genkopplung?',
    optionen: [
      'Gene auf verschiedenen Chromosomen werden gemeinsam vererbt',
      'Gene auf demselben Chromosom werden tendenziell gemeinsam vererbt',
      'Gene können nur in Paaren vererbt werden',
      'Gene können sich gegenseitig beeinflussen',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Wie nennt man die Austauschrate von Chromosomensegmenten während der Meiose?',
    optionen: [
      'Crossing-over-Häufigkeit',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Wann findet Crossing-over statt?',
    optionen: [
      'Während der Mitose',
      'Während der Prophase I der Meiose',
      'Während der Metaphase II der Meiose',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Was ist eine Kopplungsgruppe?',
    optionen: [
      'Eine Gruppe von Chromosomen',
      'Alle Gene auf einem Chromosom',
      'Gene, die immer dominant vererbt werden',
      'Gene, die auf dem X-Chromosom liegen',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Zwei Gene auf demselben Chromosom zeigen eine Rekombinationsfrequenz von 20%. Was kann man daraus schließen?',
    optionen: [
      'Die Gene liegen 20 nm voneinander entfernt',
      'Die Gene liegen 20 Kartierungseinheiten voneinander entfernt',
      'In 80% der Fälle findet Crossing-over statt',
      'Die Gene sind nicht gekoppelt',
  ...
  {
    id: 'bio-q-230',
    stichwortId: 'bio-5-03',
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was ist das Charakteristikum der mitochondrialen Vererbung?',
    optionen: [
      'Vererbung erfolgt ausschließlich über die Mutter',
      'Vererbung erfolgt nur über den Vater',
      'Vererbung folgt den Mendelschen Regeln',
      'Vererbung ist geschlechtsgebunden',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Wo befindet sich die DNA bei nichtchromosomaler Vererbung?',
    optionen: [
      'Im Zellkern',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Ein Mann mit einer mitochondrialen Erkrankung bekommt Kinder. Welche Aussage ist korrekt?',
    optionen: [
      'Alle Kinder werden erkranken',
      '50% der Kinder werden erkranken',
      'Nur die Söhne werden erkranken',
      'Keines der Kinder wird die Mutation erben',
  ...
  {
    id: 'bio-q-233',
    stichwortId: 'bio-5-04',
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Wie viele Chromosomen hat eine diploide menschliche Körperzelle?',
    optionen: [
      '23',
      '44',
      '46',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was sind Autosomen?',
    optionen: [
      'Geschlechtschromosomen',
      'Chromosomen, die nur bei Männern vorkommen',
      'Körperchromosomen (alle Chromosomen außer den Geschlechtschromosomen)',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was ist Heterochromatin?',
    optionen: [
      'Locker gepacktes, transkriptionell aktives Chromatin',
      'Dicht gepacktes, transkriptionell inaktives Chromatin',
      'Chromatin in den Mitochondrien',
      'Chromatin während der Mitose',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Was zeigt ein Karyogramm?',
    optionen: [
      'Die DNA-Sequenz eines Organismus',
      'Die Genexpression in einer Zelle',
      'Die geordnete Darstellung aller Chromosomen einer Zelle',
      'Die Proteinzusammensetzung des Kerns',
  ...
  {
    id: 'bio-q-237',
    stichwortId: 'bio-5-05',
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Was ist eine Genmutation?',
    optionen: [
      'Veränderung der Chromosomenanzahl',
      'Veränderung der DNA-Sequenz innerhalb eines Gens',
      'Umlagerung von Chromosomenabschnitten',
      'Verdopplung eines ganzen Chromosoms',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was ist eine Frameshift-Mutation?',
    optionen: [
      'Austausch eines Nukleotids',
      'Deletion oder Insertion von Nukleotiden, die nicht durch 3 teilbar ist',
      'Verdopplung eines Chromosomenabschnitts',
      'Austausch ganzer Chromosomenarme',
      'Mutation im Intron'
    ],
    korrekteAntwort: 1,
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Welche Chromosomenmutation liegt bei einer Trisomie 21 vor?',
    optionen: [
      'Deletion',
      'Translokation',
      'Inversion',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was sind Mutagene?',
    optionen: [
      'Mutierte Gene',
      'Faktoren, die Mutationen auslösen können',
      'Proteine, die Mutationen reparieren',
      'Chromosomen mit Mutationen',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Was ist eine Translokation?',
    optionen: [
      'Austausch eines Nukleotids',
      'Verdopplung eines Chromosomenabschnitts',
      'Übertragung eines Chromosomenabschnitts auf ein anderes Chromosom',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was versteht man unter einer Punktmutation?',
    optionen: [
      'Mutation an einem bestimmten Punkt des Chromosoms',
  ...
  {
    id: 'bio-q-243',
    stichwortId: 'bio-5-06',
    fach: 'biologie' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Welches Geschlechtschromosomenpaar haben menschliche Männer?',
    optionen: [
      'XX',
      'XY',
      'YY',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was ist ein Barr-Körperchen?',
    optionen: [
      'Ein zusätzliches Y-Chromosom bei Männern',
      'Ein inaktiviertes X-Chromosom bei Frauen',
      'Ein mutiertes Chromosom',
      'Ein Chromosom während der Meiose',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Ein Vater mit X-chromosomal rezessiver Rot-Grün-Blindheit hat Kinder. Welche Aussage ist korrekt?',
    optionen: [
      'Alle Söhne werden farbenblind sein',
      'Alle Töchter werden Konduktorinnen sein',
      '50% der Söhne werden farbenblind sein',
      'Keine Tochter wird das Allel erhalten',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was bewirkt das SRY-Gen?',
    optionen: [
      'Es codiert für X-Inaktivierung',
      'Es initiiert die männliche Geschlechtsentwicklung',
      'Es verhindert Mutationen auf dem Y-Chromosom',
      'Es codiert für Spermienproduktion',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Eine Frau ist heterozygot für ein X-chromosomal rezessives Merkmal. Warum kann sie trotzdem Symptome zeigen?',
    optionen: [
      'Weil X-chromosomale Merkmale immer dominant sind',
      'Wegen zufälliger X-Inaktivierung in verschiedenen Zellen',
      'Weil das Y-Chromosom fehlt',
      'Weil das rezessive Allel mutiert ist',
  ...
  {
    id: 'bio-q-248',
    stichwortId: 'bio-5-07',
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was sind Onkogene?',
    optionen: [
      'Gene, die Krebs verhindern',
      'Mutierte Gene, die Zellwachstum fördern',
      'Gene, die Apoptose einleiten',
      'Gene, die DNA-Schäden reparieren',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Welche Funktion hat das p53-Protein?',
    optionen: [
      'Es fördert die Zellteilung',
      'Es ist ein Tumorsuppressor, der bei DNA-Schäden den Zellzyklus stoppt oder Apoptose einleitet',
      'Es repariert direkt DNA-Schäden',
      'Es initiiert die Metastasierung',
  ...
  },
  {
    ...
    fach: 'biologie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Was besagt das Mehrstufenmodell der Krebsentstehung?',
    optionen: [
      'Krebs entsteht durch eine einzelne Mutation',
      'Krebs entsteht durch die Akkumulation mehrerer Mutationen über die Zeit',
      'Krebs kann nur durch Viren entstehen',
      'Krebs entsteht nur durch Umweltfaktoren',
