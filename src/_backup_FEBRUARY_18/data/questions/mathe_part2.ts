export const fragenPart2 = [
  ...
  },
  {
    ...
    schwierigkeit: "schwer" as const,
    fragetext:
      "Ein regelmäßiges Tetraeder hat eine Kantenlänge von 6 cm. Die Oberfläche besteht aus 4 gleichseitigen Dreiecken. Wie groß ist die gesamte Oberfläche? (Höhe eines gleichseitigen Dreiecks mit Seite a: h ≈ 0,866·a)",
    ...
    strategieTipp:
      "Ein Tetraeder hat 4 gleichseitige Dreiecksflächen. Berechne die Fläche einer Seite und multipliziere mit 4.",
  },
  {
    id: "ma-q-064",
    stichwortId: "ma-3-01",
