export const fragenPart5 = [
  ...
  },
  {
    ...
    fach: 'chemie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Welches Disaccharid wird durch α-1,4-glykosidische Bindung zwischen zwei Glucosemolekülen gebildet?',
    optionen: [
      'Saccharose',
      'Lactose',
      'Maltose',
  ...
  },
  {
    ...
    fach: 'chemie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Welche Sekundärstruktur wird hauptsächlich durch Wasserstoffbrücken zwischen der C=O-Gruppe einer Aminosäure und der N-H-Gruppe vier Reste weiter stabilisiert?',
    optionen: [
      'β-Faltblatt',
      'α-Helix',
      'Random Coil',
  ...
  },
  {
    ...
    fach: 'chemie' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Warum haben ungesättigte Fette einen niedrigeren Schmelzpunkt als gesättigte Fette?',
    optionen: [
  ...
  },
  {
    ...
    fach: 'chemie' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Welches Vitamin wird als Vorstufe (Provitamin) in der Haut durch UV-Licht gebildet?',
    optionen: [
      'Vitamin A',
      'Vitamin D',
      'Vitamin E',
