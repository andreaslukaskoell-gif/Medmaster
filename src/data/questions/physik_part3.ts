export const fragenPart3 = [
  {
    ...
    fragetext: 'Ein Kupferdraht mit einer Länge von 2 m und einem Querschnitt von 1 mm² hat einen spezifischen Widerstand von 0,017 Ω·mm²/m. Welcher Widerstand ergibt sich?',
    optionen: [
      '0,017 Ω',
      '0,034 Ω',
      '0,068 Ω',
  ...
  },
  {
    ...
    fragetext: 'Zwei Punktladungen mit gleicher Ladung stoßen sich ab. Was passiert mit der Kraft zwischen ihnen, wenn ihr Abstand verdoppelt wird?',
    optionen: [
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Eine Glühbirne mit 60 W wird an eine Spannung von 230 V angeschlossen. Welche Stromstärke fließt durch die Glühbirne?',
    optionen: [
      '0,15 A',
      '0,26 A',
      '0,38 A',
  ...
  },
  {
    ...
    fragetext: 'In einer Schaltung sind drei Widerstände R₁ = 10 Ω, R₂ = 20 Ω und R₃ = 30 Ω parallel geschaltet. Welcher Gesamtwiderstand ergibt sich?',
    optionen: [
      '60 Ω',
      '20 Ω',
      '5,45 Ω',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Ein elektrisches Feld zeigt von der positiven zur negativen Ladung. In welche Richtung würde sich ein freies Elektron in diesem Feld bewegen?',
    optionen: [
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Nach der ersten Kirchhoffschen Regel (Knotenregel) gilt an einem Verzweigungspunkt:',
    optionen: [
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Ein Heizgerät hat einen Widerstand von 50 Ω und wird an 230 V angeschlossen. Welche elektrische Leistung nimmt es auf?',
    optionen: [
      '460 W',
      '1058 W',
      '4,6 W',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Zwei Widerstände R₁ = 40 Ω und R₂ = 60 Ω sind in Reihe geschaltet und an 200 V angeschlossen. Welche Spannung fällt über R₁ ab?',
    optionen: [
      '80 V',
      '100 V',
      '120 V',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Ein Magnetfeld wird durch einen stromdurchflossenen Leiter erzeugt. Wie verläuft das Magnetfeld um einen geraden Leiter?',
    optionen: [
      'Parallel zum Leiter',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Eine Spule mit 200 Windungen hat eine Induktivität von 50 mH. Wenn der Strom in 0,1 s von 0 auf 2 A ansteigt, welche Selbstinduktionsspannung entsteht?',
    optionen: [
      '0,1 V',
      '0,5 V',
      '1,0 V',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Eine elektromagnetische Welle hat eine Frequenz von 600 THz. Welche Wellenlänge hat sie im Vakuum?',
    optionen: [
      '200 nm',
      '500 nm',
      '800 nm',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Ein elektrischer Schwingkreis hat eine Kapazität von 10 nF und eine Induktivität von 100 μH. Welche Resonanzfrequenz ergibt sich?',
    optionen: [
      '50,3 kHz',
      '159 kHz',
      '503 kHz',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Ein Transformator hat ein Windungsverhältnis von 10:1 (Primär- zu Sekundärseite). An der Primärseite liegen 230 V an. Welche Spannung liegt an der Sekundärseite?',
    optionen: [
      '23 V',
      '230 V',
      '2300 V',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Ein Plattenkondensator hat einen Plattenabstand von 2 mm und eine Fläche von 100 cm². Die Dielektrizitätskonstante des Dielektrikums ist ε_r = 4. Welche Kapazität ergibt sich? (ε₀ = 8,85·10⁻¹² F/m)',
    optionen: [
      '17,7 pF',
      '177 pF',
      '1,77 nF',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Welche Energie wird in einem Kondensator mit 220 μF gespeichert, der auf 12 V aufgeladen ist?',
    optionen: [
      '0,0158 J',
      '0,158 J',
      '1,58 J',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Nach der zweiten Kirchhoffschen Regel (Maschenregel) gilt für eine geschlossene Schleife:',
    optionen: [
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Licht geht von Luft (n = 1,0) in Glas (n = 1,5) über. Der Einfallswinkel beträgt 60°. Wie groß ist der Brechungswinkel ungefähr?',
    optionen: [
      '35°',
      '40°',
      '45°',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Ab welchem Grenzwinkel tritt Totalreflexion auf, wenn Licht von Wasser (n = 1,33) in Luft (n = 1,0) übergeht?',
    optionen: [
      '42°',
      '48,6°',
      '53°',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Eine Sammellinse hat eine Brennweite von 20 cm. Ein Gegenstand wird 30 cm vor der Linse platziert. Wo entsteht das Bild?',
    optionen: [
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Bei einem Doppelspaltexperiment beträgt der Spaltabstand 0,2 mm, die Wellenlänge 600 nm und der Abstand zum Schirm 2 m. Wie groß ist der Abstand zwischen zwei benachbarten hellen Streifen?',
    optionen: [
      '0,6 mm',
      '6 mm',
      '60 mm',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Ein Mikroskop verwendet eine Objektivlinse mit 40-facher Vergrößerung und ein Okular mit 10-facher Vergrößerung. Welche Gesamtvergrößerung ergibt sich?',
    optionen: [
      '50-fach',
      '400-fach',
      '4-fach',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Das menschliche Auge hat in Ruhe eine Brechkraft von etwa 60 Dioptrien. Welcher Brennweite entspricht das?',
    optionen: [
      '1,67 cm',
      '6,0 cm',
      '16,7 mm',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Bei welcher Fehlsichtigkeit ist der Augapfel zu lang und das Bild entsteht vor der Netzhaut?',
    optionen: [
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Ein Teleskop hat ein Objektiv mit 1000 mm Brennweite und ein Okular mit 25 mm Brennweite. Welche Vergrößerung ergibt sich?',
    optionen: [
      '25-fach',
      '40-fach',
      '100-fach',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Bei der Beugung am Einzelspalt beträgt die Spaltbreite 0,1 mm, die Wellenlänge 500 nm und der Abstand zum Schirm 1 m. Wie weit ist das erste Minimum vom zentralen Maximum entfernt?',
    optionen: [
      '0,5 cm',
      '5 mm',
      '0,5 mm',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'leicht' as const,
    fragetext: 'Welches optische Gerät verwendet zwei Linsensysteme, um weit entfernte Objekte zu vergrößern?',
    optionen: [
      'Mikroskop',
      'Lupe',
      'Teleskop',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'schwer' as const,
    fragetext: 'Ein Prisma mit brechendem Winkel 60° und Brechungsindex 1,5 wird von einem Lichtstrahl senkrecht auf eine Fläche getroffen. Unter welchem Winkel tritt der Strahl aus der zweiten Fläche aus?',
    optionen: [
      '30°',
      '38,9°',
      '45°',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Eine Zerstreuungslinse hat eine Brennweite von -15 cm. Ein Gegenstand steht 30 cm vor der Linse. Wo entsteht das Bild?',
    optionen: [
      '10 cm vor der Linse',
  ...
  },
  {
    ...
    fach: 'physik' as const,
    schwierigkeit: 'mittel' as const,
    fragetext: 'Die Brechkraft einer Brille beträgt +2,5 Dioptrien. Welche Art von Fehlsichtigkeit wird damit korrigiert?',
    optionen: [
      'Kurzsichtigkeit',
      'Weitsichtigkeit',
      'Astigmatismus',
