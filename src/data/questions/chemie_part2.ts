export const fragenPart2 = [
  ...
  },
  {
    ...
    optionen: ["Linear", "Gewinkelt", "Trigonal planar", "Teträdrisch", "Trigonal pyramidal"],
    korrekteAntwort: 3,
    erklärung:
      "Methan hat eine teträdrische Geometrie mit Bindungswinkeln von 109,5°. Die vier C-H-Bindungen sind räumlich gleichmäßig verteilt, wodurch CH₄ unpolar ist.",
    strategieTipp:
      "VSEPR-Theorie: 4 bindende Elektronenpaare ohne freie Paare → Teträder. Dies ist die optimale räumliche Anordnung zur Minimierung der Abstoßung.",
  },
  {
    id: "ch-q-067",
    stichwortId: "ch-6-01",
  ...
  },
  {
    ...
    strategieTipp:
      "Beim Ausgleichen: Zähle jede Atomsorte links und rechts. Passe Köffizienten (nie Indizes!) an, bis beide Seiten gleich sind.",
  },
  {
    id: "ch-q-073",
    stichwortId: "ch-7-01",
  ...
  },
  {
    ...
    korrekteAntwort: 1,
    erklärung:
      "Die Zahl vor der Formel (Köffizient) gibt die Anzahl der Moleküle an. 2H₂O bedeutet 2 Wassermoleküle, also insgesamt 4 H-Atome und 2 O-Atome.",
    strategieTipp:
      "Unterscheide: Köffizient vor Formel = Anzahl Moleküle; Index nach Symbol = Anzahl Atome im Molekül. H₂O: 2 H pro Molekül; 2H₂O: 2 Moleküle.",
  },
  {
    id: "ch-q-077",
    stichwortId: "ch-7-01",
  ...
  },
  {
    ...
    strategieTipp:
      'Stöchiometrie = "Rechnen in der Chemie". Die Köffizienten in der Reaktionsgleichung geben das Molverhältnis an.',
  },
  {
    id: "ch-q-080",
    stichwortId: "ch-7-01",
  ...
  },
  {
    ...
    strategieTipp:
      "Druckerhöhung: Gleichgewicht zur Seite mit weniger Gasmolekülen. Zähle Köffizienten der gasförmigen Stoffe.",
  },
  {
    id: "ch-q-093",
    stichwortId: "ch-8-01",
