...
export const sequenceQuestions: SequenceQuestion[] = [
  {
    ...
    explanation:
      "Das sauerstoffreiche Blut kommt aus der Lunge in den linken Vorhof, passiert die Mitralklappe in die linke Kammer und wird über die Aortenklappe in die Aorta gepumpt.",
  },
  {
    id: "seq-bio-herz-2",
    subject: "biologie",
    ...
    explanation:
      "Sauerstoffarmes Blut aus dem Körper gelangt in den rechten Vorhof, durch die Trikuspidalklappe in die rechte Kammer und über die Pulmonalklappe in die Lungenarterie zur Lunge.",
  },
  {
    id: "seq-bio-zelle-1",
    subject: "biologie",
    ...
    explanation:
      "Die DNA wird abgelesen (Transkription), es entsteht mRNA, die zum Ribosom gelangt, wo die Translation zum Protein erfolgt.",
  },
  {
    ...
    correctOrder: [
      ...
      "Nettofluss zum niedrigen Bereich",
      "Gleichgewicht",
    ],
    explanation:
      "Teilchen bewegen sich entlang des Konzentrationsgefälles von hoch nach niedrig, bis ein Gleichgewicht erreicht ist.",
  },
  {
    ...
    explanation:
      "Edukte müssen die Aktivierungsenergie aufnehmen, durchlaufen den Übergangszustand und werden zu Produkten.",
  },
];
