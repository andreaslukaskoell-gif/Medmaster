...
Die Folgen für die Eigenschaften sind gravierend: MgO schmilzt erst bei 2852 °C (NaCl: 801 °C), ist praktisch wasserunlöslich (NaCl sehr gut löslich) und findet daher Verwendung als Hochtemperaturwerkstoff. Medizinisch wird MgO als Antazidum eingesetzt, da es magensäureneutralisierend wirkt, ohne sich vollständig zu lösen.`,
      ...
      selfTest: [
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: 'Nach dem Coulombschen Gesetz ist die Gitterenergie proportional zu q₁·q₂/r. Mg²⁺ und O²⁻ tragen die doppelte Ladung verglichen mit Na⁺ und Cl⁻ (Faktor 4 im Zähler) und haben zudem kleinere Ionenradien (kleineres r). Beides zusammen führt zu einer rund fünffach höheren Gitterenergie von MgO (~3795 kJ/mol vs. ~786 kJ/mol für NaCl) und damit zu einem Schmelzpunkt von 2852 °C statt 801 °C.',
          hints: ['Coulombsches Gesetz: E ∝ q₁·q₂/r.', 'Betrachten Sie Ladungszahlen und Ionenradien im Vergleich.'],
          difficulty: 2,
          tags: [],
        },
        {
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: 'Im NaCl-Gitter (kubisch-flächenzentriert) beträgt die Koordinationszahl 6: Jedes Na⁺-Ion ist von 6 Cl⁻-Ionen oktaedrisch umgeben und umgekehrt. Dies ergibt sich aus dem Radienverhältnis r⁺/r⁻ = 102/181 ≈ 0,56, das im Bereich 0,41–0,73 liegt (oktaedrische Koordination). Im CsCl-Gitter hingegen beträgt die Koordinationszahl 8, da das Radienverhältnis über 0,73 liegt.',
          hints: ['NaCl-Gitter: kubisch-flächenzentriert.', 'Koordinationszahl hängt vom Radienverhältnis ab.'],
          difficulty: 2,
          tags: [],
        },
        {
          question: 'Welcher Schritt im Born-Haber-Kreisprozess für NaCl ist stark exotherm und macht die Gesamtreaktion günstig?',
          options: [
          ...
          correctIndex: 3,
          explanation: 'Im Born-Haber-Kreisprozess sind Sublimation, Ionisierung und Bindungsspaltung endotherm, während die Elektronenaffinität von Chlor moderat exotherm ist. Der mit Abstand größte exotherme Beitrag kommt von der Gitterenergie (−786 kJ/mol für NaCl), die beim Zusammenfügen der gasförmigen Ionen zum Kristallgitter freigesetzt wird. Ohne diesen Beitrag wäre die Bildung von NaCl aus den Elementen thermodynamisch ungünstig.',
          hints: ['Zerlegen Sie den Kreisprozess in seine Teilschritte.', 'Welcher Schritt setzt Energie frei statt aufzunehmen?'],
          difficulty: 2,
          tags: [],
        },
        {
          question: 'Welche klinische Bedeutung hat die Ionenbindung von Calciumfluorid (CaF₂) für den Zahnschmelz?',
          options: [
      ...
      selfTest: [
        {
          ...
          correctIndex: 3,
          explanation: 'Stickstoff in NH₃ hat 4 Elektronenpaare in der Valenzschale: 3 bindende (N–H) und 1 freies Elektronenpaar. Gemäß VSEPR nehmen 4 Elektronenpaare tetraedrische Anordnung ein (ideal 109,5°). Da ein Paar frei ist, ist die resultierende Molekülgeometrie (Atomanordnung) trigonal pyramidal. Das freie Elektronenpaar drückt die drei bindenden Paare etwas zusammen → Winkel 107° statt 109,5°. Ammoniak ist deshalb polar (μ = 1,47 D).',
          hints: ['Zählen Sie bindende + freie Elektronenpaare am Zentralatom.', 'Ein freies Elektronenpaar → Geometrie ≠ Elektronenanordnung.'],
          difficulty: 1,
          tags: [],
        },
        {
      ...
      sections: [
        {
          ...
          merksatz: 'Je größer und unverzweigter das Molekül, desto stärker die London-Kräfte und höher der Siedepunkt.',
        },
        {
          ...
          merksatz: 'H-Brücke: H kovalent an N/O/F → wechselwirkt mit freiem Elektronenpaar an N/O/F.',
        },
        {
          ...
          merksatz: 'Wasser: 4 H-Brücken pro Molekül → Anomalien in Siedepunkt, Dichte, Wärmekapazität.',
        },
        {
...
Zusätzlich zu den H-Brücken stabilisieren π-π-Stapelwechselwirkungen (London-Kräfte zwischen aromatischen Ringen der Basen) die Doppelhelix. Beide Kräfte zusammen machen die DNA-Helix hochstabil, aber dennoch durch Enzyme (Helikasen, Topoisomerasen) kontrolliert entwindbar.`,
      ...
      klinischerBezug: 'Wasserstoffbrücken in der DNA-Doppelhelix (A-T: 2; G-C: 3) sind die molekulare Grundlage für die Spezifität der Basenpaarung bei Replikation und Transkription; GC-reiche Promotor-Bereiche und die thermische Stabilität von DNA werden durch H-Brücken-Statistik bestimmt und sind klinisch relevant für PCR-Diagnostik und Gentechnik. Die hohe Wärmekapazität und Verdampfungswärme des Wassers ermöglichen die Thermoregulation des Menschen durch Schwitzen (Verdampfung von ~580 kcal/L Schweiß).',
      ...
      selfTest: [
        {
          ...
          correctIndex: 3,
          explanation: 'Edelgasatome sind unpolar, besitzen keine permanenten Dipole und bilden keine Wasserstoffbrücken. Die einzige intermolekulare Kraft zwischen ihnen sind London-Dispersionskräfte (van-der-Waals), die durch instantane Elektronenfluktuation entstehen. Obwohl diese Kräfte sehr schwach sind (He siedet bei −269 °C, nahe 0 K), sind sie die Ursache dafür, dass Edelgase überhaupt verflüssigt werden können. Mit größerer Elektronenzahl (Kr, Xe) werden London-Kräfte stärker und die Siedepunkte steigen.',
          hints: ['Edelgase sind vollständig unpolar.', 'Welche Kraft wirkt auch bei komplett unpolaren Teilchen?'],
          difficulty: 1,
          tags: [],
        },
        {
          question: 'Warum hat n-Pentan (unverzweigt) einen höheren Siedepunkt als Neopentan (stark verzweigt), obwohl beide die Summenformel C₅H₁₂ haben?',
          options: [
          ...
          correctIndex: 2,
          explanation: 'n-Pentan und Neopentan (2,2-Dimethylpropan) haben identische Summenformel C₅H₁₂, also gleiche Elektronenzahl und Polarisierbarkeit. Der Unterschied liegt in der Gestalt: n-Pentan ist kettenartig gestreckt und bietet eine große Kontaktfläche für London-Kräfte. Neopentan ist kugelförmig kompakt (niedrige Kontaktfläche). Stärkere London-Kräfte bei n-Pentan → höherer Siedepunkt (36 °C vs. 9,5 °C für Neopentan). Dieses Prinzip erklärt auch, warum unverzweigte Fettsäuren höhere Schmelzpunkte haben.',
          hints: ['Beide Moleküle sind unpolar → nur London-Kräfte.', 'Was beeinflusst die Stärke von London-Kräften außer der Elektronenzahl?'],
          difficulty: 2,
          tags: [],
        },
        {
          question: 'Welche Bedingungen muss ein Atom erfüllen, um als Wasserstoffbrücken-Donor zu fungieren?',
          options: [
          ...
          correctIndex: 1,
          explanation: 'Ein Wasserstoffbrücken-Donor ist ein Atom, das ein Wasserstoffatom kovalent an ein hochelektronegatives Atom (N, O oder F) gebunden trägt. Das H-Atom ist durch die starke Elektronegativität des gebundenen Atoms stark positiv polarisiert (δ+) und kann dann elektrostatisch mit einem freien Elektronenpaar eines Akzeptors (ebenfalls N, O oder F) wechselwirken. Ohne die kovalente D–H-Bindung (D = N, O, F) wäre H nicht ausreichend polarisiert und könnte keine echte H-Brücke bilden.',
          hints: ['Donor = liefert das H; Akzeptor = liefert das freie Elektronenpaar.', 'Nur N, O, F sind elektronegativ genug für H-Brücken.'],
          difficulty: 1,
          tags: [],
        },
        {
          question: 'Warum bildet Guanin-Cytosin (G-C) ein stabileres Basenpaar als Adenin-Thymin (A-T) in der DNA?',
          options: [
          ...
          correctIndex: 1,
          explanation: 'In der Watson-Crick-Basenpaarung bildet Guanin mit Cytosin 3 Wasserstoffbrücken, während Adenin mit Thymin nur 2 H-Brücken ausbildet. Da jede Wasserstoffbrücke etwa 10–20 kJ/mol Energie liefert, ist das G-C-Paar stabiler. DNA-Segmente mit hohem GC-Gehalt haben daher eine höhere Schmelztemperatur (Tm). Dies ist relevant für das Primerdesign in der PCR: GC-reiche Primer benötigen höhere Anlagerungstemperaturen.',
          hints: ['Zählen Sie die H-Brücken pro Basenpaar.', 'Mehr H-Brücken = mehr Energie zum Trennen nötig.'],
          difficulty: 1,
          tags: [],
        },
        {
          question: 'Welche Eigenschaft der Metallbindung erklärt, dass Metalle elektrischen Strom leiten?',
          options: [
        ...
        },
        {
          ...
          correctIndex: 0,
          explanation: 'Die korrekte Reihenfolge nach aufsteigender Stärke ist: London-Dispersionskräfte (0,1–10 kJ/mol) < Wasserstoffbrücken (10–40 kJ/mol) < Ionenbindung (200–1000 kJ/mol) < kovalente Bindung (150–1000 kJ/mol, je nach Bindung). Hinweis: Ionenbindung und kovalente Bindung überlappen sich im Bereich, aber starke kovalente Mehrfachbindungen können Ionenbindungen übertreffen. Wasserstoffbrücken sind trotz ihrer geringen Einzelstärke kollektiv in biologischen Makromolekülen dominierend.',
          hints: ['London: instantane Dipole, sehr schwach.', 'H-Brücken: stärker als London, aber schwächer als echte Bindungen.'],
          difficulty: 2,
          tags: [],
        },
      ],
      ...
      sections: [
        {
          ...
          merksatz: 'α-glycosidisch = verdaulich (Stärke/Glykogen); β-glycosidisch = unverdaulich (Cellulose).',
        },
        {
          ...
          merksatz: 'Hydrophober Effekt: Aggregation unpolarer Gruppen → Entropiegewinn des Wassers → treibt Membranbildung und Proteinfaltung.',
        },
        {
          ...
          merksatz: 'Primär: kovalent; Sekundär: H-Brücken; Tertiär: alles zusammen; Quartär: mehrere Ketten.',
        },
        {
          ...
          merksatz: 'Reversible Hemmung: nichtkovalent, steuerbar; irreversibel: kovalent, dauerhaft (z. B. Aspirin-COX).',
        },
      ],
...
Denaturierung: Wird ein Protein erhitzt, mit Säure/Base, Harnstoff oder Detergenzien behandelt, werden die nichtkovalenten Wechselwirkungen gestört. Das Protein entfaltet sich — es verliert seine Sekundär- und Tertiärstruktur sowie seine Funktion. Die Primärstruktur (Sequenz, kovalente Peptidbindungen) bleibt intakt. Nach Entfernung des Denaturierungsmittels kann das Protein theoretisch renaturieren (Anfinsen-Experiment mit RNase A). In der Klinik nutzt man Denaturierung bei Sterilisation (Hitze, Autoklavieren) und in der Diagnostik (SDS-PAGE).`,
      ...
      selfTest: [
        ...
        },
        {
          ...
          correctIndex: 2,
          explanation: 'Der hydrophobe Effekt ist primär entropisch getrieben, nicht enthalpisch. Wenn unpolare Moleküle in Wasser gelöst sind, ordnen sich die umgebenden Wassermoleküle in hochgeordneten Hydratationsschalen (Käfigstrukturen) um sie herum — das kostet Entropie (ΔS < 0). Wenn unpolare Moleküle aggregieren, werden diese geordneten Wasserschalen aufgelöst und die Wassermoleküle gewinnen Freiheitsgrade (ΔS > 0). Dieser Entropiegewinn des Wassers ist die treibende Kraft, die Lipide zur Aggregation in Membranen und hydrophobe Aminosäuren ins Proteininnere treibt.',
          hints: ['Hydrophober Effekt: über Entropie des Wassers, nicht Anziehung der unpolaren Gruppen.', 'Was passiert mit geordneten Hydratationsschalen bei Aggregation?'],
          difficulty: 2,
          tags: [],
        },
        {
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: "Lipinski's Rule of Five (1997) ist eine Faustregel für die orale Bioverfügbarkeit von Arzneimitteln. Ein Pharmakon mit MW > 500 Da, logP > 5 (zu lipophil), > 5 H-Brücken-Donoren (NH, OH) oder > 10 H-Brücken-Akzeptoren (N, O) wird wahrscheinlich schlecht resorbiert. Zu polare Moleküle (viele HBD/HBA) können Zellmembranen nicht passieren; zu unpolare (hoher logP) lösen sich nicht ausreichend in wässriger Körperflüssigkeit. Ausnahmen: Substrate für Transporter (Antibiotika, Vitamine). Biologika (Antikörper) fallen nicht unter die Ro5.",
          hints: ['Ro5 = Gleichgewicht zwischen Wasser- und Fettlöslichkeit.', 'Was limitiert die orale Aufnahme — zu polar oder zu unpolar?'],
          difficulty: 2,
          tags: [],
        },
        {
        ...
        },
        {
          ...
          correctIndex: 2,
          explanation: 'Cystein (Cys) besitzt eine Thiolgruppe (–SH) in seiner Seitenkette. Zwei Cysteine können unter oxidativen Bedingungen durch Oxidation ihrer Thiolgruppen eine kovalente Disulfidbrücke (–S–S–) bilden: 2 R–SH → R–S–S–R + 2H⁺ + 2e⁻. Disulfidbrücken sind die einzigen kovalenten (nicht-Peptidrückgrat) Querverbindungen in Proteinen und sind besonders häufig in sekretierten und extrazellulären Proteinen (Antikörper, Insulin, RNase A), da das extrazelluläre Milieu oxidativer ist als das Zytoplasma. Sie verleihen dem Protein erhöhte thermische und chemische Stabilität.',
          hints: ['Welche Aminosäure hat eine –SH-Gruppe?', 'Oxidation zweier Thiole ergibt eine Disulfidbrücke.'],
          difficulty: 1,
          tags: [],
        },
      ],
