...
**Stabile Isotope** haben ein günstiges N/Z-Verhältnis (bei leichten Elementen N ≈ Z; bei schwereren Z wird größer: bei Z = 82 ist N ≈ 1,5 × Z). Instabile Nuklide sind radioaktiv.`,
      ...
      sections: [
        {
          ...
          merksatz: 'Rutherford-Experiment: Meiste Teilchen durch – wenige stark abgelenkt → Kern ist winzig, schwer und positiv geladen.',
        },
        {
          ...
          merksatz: 'Orbital ≠ Bahn. Ein Orbital ist ein Raumbereich mit 90 % Aufenthaltswahrscheinlichkeit des Elektrons.',
        },
        {
          ...
          merksatz: 'Isotope: gleiche Z (gleiches Element), verschiedene N → verschiedene A. Chemisch fast identisch, physikalisch unterschiedlich.',
        },
      ],
      ...
      selfTest: [
        ...
        {
          question: 'Welches Ion ist korrekt beschrieben: ²³Na⁺ hat 11 Protonen, 12 Neutronen und 10 Elektronen.',
          options: [
        ...
        {
          question: 'Chlor besteht natürlicherweise aus ³⁵Cl (75 %) und ³⁷Cl (25 %). Welche relative Atommasse hat Chlor?',
          options: [
            '35,0 u',
            '36,0 u',
            '35,5 u',
        ...
        {
          question: 'Welches Orbital hat die Form einer Hantel (Dumbbell) mit zwei Keulen entlang einer Achse?',
          options: [
            's-Orbital',
            'p-Orbital',
            'd-Orbital',
        ...
        {
          question: 'Welches Nuklid wird in der Positronen-Emissions-Tomographie (PET) als Tracer verwendet und warum?',
          options: [
        ...
        {
          question: 'Ein Atom besitzt 17 Protonen und die Massenzahl 35. Als welches Element und Ion wurde es beschrieben, wenn es 18 Elektronen hat?',
          options: [
            'Schwefel-Anion S²⁻',
            'Argon-Atom Ar',
            'Chlorid-Ion Cl⁻',
      ...
      sections: [
        {
          ...
          merksatz: 'n bestimmt Schale, l bestimmt Form, mₗ bestimmt Richtung, mₛ bestimmt Spin. Pauli: kein doppeltes Quartett.',
        },
        {
          ...
          merksatz: 'Aufbau: energetisch günstigste Orbitale zuerst. Hund: erst alle einfach besetzen, dann paaren. Ausnahmen: Cr und Cu.',
        },
        {
      ...
      selfTest: [
        {
          ...
          correctIndex: 3,
          explanation: 'Die maximale Elektronenzahl pro Schale berechnet sich mit 2n². Für n = 3: 2 × 3² = 2 × 9 = 18. Die dritte Schale enthält die Unterschalen 3s (1 Orbital, max. 2e⁻), 3p (3 Orbitale, max. 6e⁻) und 3d (5 Orbitale, max. 10e⁻), zusammen 9 Orbitale × 2 = 18 Elektronen. Zum Vergleich: n=1→2, n=2→8, n=3→18, n=4→32. Die vollständige M-Schale spielt z. B. bei Chlor (Z=17: [Ne]3s²3p⁵) eine zentrale Rolle.',
          hints: [
        ...
        },
        {
          ...
          correctIndex: 3,
          explanation: 'Die Nebenquantenzahl l (auch Bahndrehimpulsquantenzahl) bestimmt die Unterschale und damit die Form des Orbitals: l = 0 → kugelförmiges s-Orbital; l = 1 → hantelförmiges p-Orbital; l = 2 → kleeblattförmiges d-Orbital; l = 3 → f-Orbital. Die Hauptschale n beschreibt Antwort A, den Spin beschreibt mₛ (Antwort B), die Raumausrichtung beschreibt mₗ (Antwort C). Die Ladung (Antwort E) ist eine feste Eigenschaft aller Elektronen (−1e) und keine Quantenzahl.',
          hints: [
        ...
        },
        {
          ...
          correctIndex: 2,
          explanation: 'Die Hundsche Regel (Friedrich Hund, 1925) gilt für energiegleiche (entartete) Orbitale derselben Unterschale. Sie werden zunächst mit je einem Elektron (paralleler Spin ↑) besetzt, bevor ein zweites Elektron mit antiparallelem Spin (↓) hinzukommt. Dies minimiert die elektrostatische Abstoßung zwischen Elektronen. Beispiel: Im Kohlenstoff-Atom (1s²2s²2p²) besetzen die zwei 2p-Elektronen zwei verschiedene p-Orbitale mit parallelem Spin. Antwort A ist falsch (widerspricht Pauli), B beschreibt das Aufbauprinzip, D ist das Pauliprinzip, E ist falsch (mₛ = ±½).',
          hints: [
        ...
        {
          question: 'Warum hat Kupfer (Cu, Z = 29) die Konfiguration [Ar]3d¹⁰4s¹ und nicht die erwartete [Ar]3d⁹4s²?',
          options: [
      ...
      sections: [
        {
          ...
          merksatz: 'α: Papier stoppt es. β: Aluminium stoppt es. γ: Blei/Beton stoppt es. PET = β⁺ + Annihilation → 2×γ (511 keV).',
        },
        {
          ...
          merksatz: 'Nach n Halbwertszeiten: Restmenge = N₀/2ⁿ. Nach 10 HWZ: < 0,1 % des Ausgangswerts.',
        },
        {
          ...
          merksatz: 'KI-Prophylaxe nach Atomunfall: Schilddrüse mit stabilem Iod sättigen → kein radioaktives ¹³¹I eingebaut.',
        },
      ],
      ...
      selfTest: [
        {
          ...
          correctIndex: 2,
          explanation: 'Beim Alpha-Zerfall wird ein Alphateilchen (⁴₂He) emittiert, das aus 2 Protonen und 2 Neutronen besteht. Daher sinkt Z um 2 und A um 4. Beispiel: ²³⁸₉₂U → ²³⁴₉₀Th + ⁴₂He. Das Alphateilchen ist identisch mit einem Helium-4-Kern. Die Gleichung muss bezüglich Z (Ladungserhaltung) und A (Massenerhaltung) auf beiden Seiten ausgeglichen sein.',
          hints: [
        ...
        {
          question: 'Nach 3 Halbwertszeiten ist noch welcher Bruchteil der ursprünglichen Aktivität vorhanden?',
          options: [
            '1/3',
            '1/4',
            '1/6',
        ...
        {
          question: '¹³¹I wird zur Therapie von Schilddrüsenerkrankungen eingesetzt. Welche Eigenschaft macht es dafür geeignet?',
          options: [
        ...
        {
          question: 'Welche Maßnahme schützt die Schilddrüse nach einem Kernkraftwerksunfall am wirksamsten vor radioaktivem Iod?',
          options: [
        ...
        {
          question: 'Welcher Strahlungstyp hat das höchste biologische Schädigungspotenzial pro absorbierter Energiedosis (Gray)?',
          options: [
            'Gammastrahlung (γ)',
            'Betastrahlung (β)',
            'Röntgenstrahlung',
...
1 mol Glukose (180 g) reagiert mit 6 mol O₂ (192 g) und liefert 6 mol CO₂ + 6 mol H₂O.`,
      ...
      sections: [
        {
          ...
          merksatz: '1 u ≈ 1 g/mol (numerisch gleich). Elektronen haben vernachlässigbare Masse. Molare Masse = Atommasse in g/mol.',
        },
        {
          ...
          merksatz: 'n = m/M. 1 Mol = 6,022 × 10²³ Teilchen = M Gramm. Klinisch: Na⁺ normal 135–145 mmol/L.',
        },
        {
          ...
          merksatz: 'Osmolarität Plasma ≈ 290 mosmol/L. 0,9 % NaCl ≈ 308 mosmol/L (leicht hyperton, klinisch als isoton bezeichnet).',
        },
      ],
      ...
      selfTest: [
        ...
        {
          question: 'Ein Patient erhält eine Infusion mit 500 mL 0,9 % NaCl-Lösung. M(NaCl) = 58,5 g/mol. Wie viele mmol Na⁺ werden zugeführt?',
          options: [
            '9 mmol',
            '15,4 mmol',
            '77 mmol',
          ...
          correctIndex: 2,
          explanation: '0,9 % NaCl bedeutet 0,9 g NaCl pro 100 mL = 9 g pro 1000 mL. In 500 mL: 4,5 g NaCl. n(NaCl) = 4,5 g ÷ 58,5 g/mol = 0,0769 mol = 76,9 mmol ≈ 77 mmol. Da NaCl vollständig dissoziiert (NaCl → Na⁺ + Cl⁻), sind auch 77 mmol Na⁺ und 77 mmol Cl⁻ enthalten. Zum Vergleich: 1 Liter 0,9 % NaCl enthält 154 mmol Na⁺; 500 mL = 77 mmol. Die physiologische Natriumkonzentration im Serum beträgt 135–145 mmol/L.',
          hints: [
        ...
        {
          question: 'Die molare Masse von Aspirin (Acetylsalicylsäure, C₉H₈O₄) beträgt ca. 180 g/mol. Wie viele Millimol enthält eine Tablette mit 500 mg Aspirin?',
          options: [
            '0,278 mmol',
            '2,78 mmol',
            '27,8 mmol',
        ...
        {
          question: 'Bei der vollständigen Verbrennung von Glukose: C₆H₁₂O₆ + 6 O₂ → 6 CO₂ + 6 H₂O. Wie viel Gramm O₂ (M = 32 g/mol) werden für 18 g Glukose (M = 180 g/mol) benötigt?',
          options: [
            '3,2 g',
            '6,4 g',
            '19,2 g',
          ...
          correctIndex: 2,
          explanation: 'Zunächst n(Glukose) = 18 g ÷ 180 g/mol = 0,1 mol. Laut Reaktionsgleichung reagieren 1 mol Glukose mit 6 mol O₂ (stöchiometrisches Verhältnis 1:6). Für 0,1 mol Glukose: n(O₂) = 0,1 × 6 = 0,6 mol. m(O₂) = 0,6 mol × 32 g/mol = 19,2 g. Stöchiometrische Berechnungen folgen immer dem Schema: (1) mol des Ausgangsstoffs berechnen, (2) Koeffizientenverhältnis anwenden, (3) mol des Zielprodukts in Gramm umrechnen. Diese Oxidation liefert 0,1 × 2870 = 287 kJ Energie.',
          hints: [
