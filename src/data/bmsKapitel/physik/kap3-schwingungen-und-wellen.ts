      ...
      selfTest: [
        {
          ...
          correctIndex: 1,
          explanation: 'Die Frequenz f ist der Kehrwert der Periodendauer T: f = 1/T = 1/(2 s) = 0,5 Hz. Eine Frequenz von 0,5 Hz bedeutet, dass das Pendel eine halbe Vollschwingung pro Sekunde ausführt. Verwechslung mit T selbst (2 Hz) ist ein typischer Fehler – Frequenz und Periode sind reziprok, nicht gleich.',
          hints: [
        ...
        {
          question: 'Die Länge eines Fadenpendels wird vervierfacht. Wie ändert sich die Periodendauer?',
          options: [
            'A) Sie bleibt gleich.',
            'B) Sie verdoppelt sich.',
            'C) Sie vervierfacht sich.',
            'D) Sie halbiert sich.',
            'E) Sie wird achtmal so gross.',
          ],
          correctIndex: 1,
          explanation: 'Die Periodendauer lautet T = 2π√(l/g). T ist proportional zur Wurzel der Länge l. Wenn l auf 4l steigt, gilt T_neu = 2π√(4l/g) = 2·2π√(l/g) = 2·T_alt. Die Periodendauer verdoppelt sich, weil √4 = 2. Eine Vervierfachung von T würde eine 16-fache Länge erfordern.',
          hints: [
            'T ∝ √l – also nicht linear, sondern Wurzelbeziehung.',
            '√4 = ?',
          ],
          difficulty: 2,
          tags: [],
        ...
        {
          question: 'Ein Federpendel (m = 200 g, k = 50 N/m) schwingt harmonisch. Welche Periodendauer hat es?',
          options: [
            'A) T ≈ 0,13 s',
            'B) T ≈ 0,40 s',
            'C) T ≈ 0,63 s',
          ...
          correctIndex: 1,
          explanation: 'Mit T = 2π√(m/k) und m = 0,2 kg, k = 50 N/m: T = 2π√(0,2/50) = 2π√(0,004 s²) = 2π × 0,0632 s ≈ 0,397 s ≈ 0,40 s. Häufiger Fehler: m in Gramm einsetzen statt in Kilogramm – immer SI-Einheiten verwenden.',
          hints: [
        ...
        {
          question: 'Bei welcher Auslenkung eines Federpendels (Amplitude A = 10 cm) sind kinetische und potentielle Energie gleich gross?',
          options: [
            'A) x = 0 cm (Ruhelage)',
            'B) x = ±7,07 cm',
            'C) x = ±5 cm',
            'D) x = ±10 cm (maximale Auslenkung)',
            'E) x = ±8,66 cm',
          ],
          correctIndex: 1,
          explanation: 'E_pot = ½kx² und E_kin = E_ges − E_pot = ½kA² − ½kx². Gleichstand: ½kx² = ½kA² − ½kx², also kx² = kA²/2, x² = A²/2, x = A/√2 = 10/√2 ≈ 7,07 cm. In der Ruhelage ist E_kin maximal; bei maximaler Auslenkung ist E_pot maximal.',
          hints: [
        ...
        {
          question: 'Was charakterisiert eine gedämpfte Schwingung im Vergleich zur ungedämpften harmonischen Schwingung?',
          options: [
            'A) Die Frequenz nimmt kontinuierlich zu.',
            'B) Die Amplitude nimmt mit der Zeit ab.',
            'C) Die Periodendauer wird kürzer.',
            'D) Die Gesamtenergie des Systems nimmt zu.',
            'E) Die Schwingung wird schneller.',
          ],
          correctIndex: 1,
          explanation: 'Bei gedämpften Schwingungen wird mechanische Energie durch Reibungskräfte (Luftwiderstand, innere Reibung) in Wärme umgewandelt. Dadurch nimmt die Amplitude exponentiell mit der Zeit ab: A(t) = A₀·e^(−δt). Die Frequenz bleibt nahezu konstant (für schwache Dämpfung). Energie nimmt ab, nicht zu. In biologischen Systemen erfüllt Dämpfung wichtige Schutzfunktionen (Gelenke, Ohrmechanik).',
          hints: [
        ...
        {
          question: 'Ein Pendel auf der Erde hat T = 2 s. Welche Periodendauer hat es auf dem Mond (g_Mond ≈ g_Erde/6)?',
          options: [
            'A) 0,82 s',
            'B) 4,90 s',
            'C) 3,46 s',
          ...
          correctIndex: 1,
          explanation: 'T = 2π√(l/g), also T ∝ 1/√g. Wenn g um den Faktor 6 kleiner wird, steigt T um den Faktor √6 ≈ 2,449: T_Mond = 2 s × √6 ≈ 4,90 s. Auf dem Mond schwingt das Pendel deutlich langsamer, weil die Rückstellkomponente (Schwerkraft) geringer ist.',
          hints: [
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: 'Die Kreisfrequenz ω gibt an, welchen Winkel in Radiant die Schwingung pro Zeiteinheit durchläuft. Eine volle Schwingung entspricht 2π Radiant und dauert T Sekunden, daher ω = 2π/T = 2πf. Typischer Fehler: ω = 1/T (das ist die normale Frequenz f, nicht ω).',
          hints: [
      ...
      selfTest: [
        {
          ...
          correctIndex: 1,
          explanation: 'Mit c = f·λ ergibt sich λ = c/f = 340 m/s ÷ 1700 Hz = 0,20 m = 20 cm. 1700 Hz liegt im mittleren Hörbereich und entspricht einem Ton leicht über einem Standardton A (440 Hz). Die Wellenlänge von 20 cm ist im Bereich typischer Körperstrukturen – deshalb eignet sich dieser Frequenzbereich nicht zur hochauflösenden Bildgebung; Ultraschall mit MHz braucht Wellenlängen im Submillimeterbereich.',
          hints: [
        ...
        {
          question: 'Was ist der entscheidende Unterschied zwischen Schallwellen und elektromagnetischen Wellen?',
          options: [
            'A) Schallwellen haben stets eine höhere Frequenz.',
            'B) Schallwellen benötigen ein Medium zur Ausbreitung, EM-Wellen nicht.',
            'C) EM-Wellen sind Longitudinalwellen.',
            'D) Schallwellen breiten sich schneller aus als Licht.',
            'E) EM-Wellen können nicht reflektiert werden.',
          ],
          correctIndex: 1,
          explanation: 'Schall ist eine mechanische Welle, die ein materielles Medium (Gas, Flüssigkeit, Festkörper) braucht, um sich fortzupflanzen – im Vakuum gibt es keinen Schall. Elektromagnetische Wellen (Licht, Radiowellen, Röntgen) sind Felder, die sich auch im Vakuum mit c = 3×10⁸ m/s ausbreiten. Schall ist ausserdem eine Longitudinalwelle, EM-Wellen sind Transversalwellen.',
          hints: [
        ...
        {
          question: 'Ultraschall für oberflächennahe Strukturen verwendet eine höhere Frequenz als für tiefe Strukturen. Was ist der physikalische Grund dafür?',
          options: [
            'A) Höhere Frequenz bedeutet höhere Schallgeschwindigkeit.',
            'B) Höhere Frequenz ergibt kürzere Wellenlänge und damit bessere Auflösung, aber auch stärkere Dämpfung.',
            'C) Tiefe Strukturen reflektieren hohe Frequenzen stärker.',
            'D) Niedrige Frequenz hat eine kürzere Wellenlänge.',
            'E) Die Frequenz bestimmt die Richtung des Ultraschallstrahls.',
          ],
          correctIndex: 1,
          explanation: 'Die Ortsauflösung einer Welle ist durch die Wellenlänge begrenzt: nur Strukturen, die grösser als etwa λ/2 sind, können aufgelöst werden. Bei c ≈ 1540 m/s und f = 10 MHz ist λ = 0,154 mm – ausreichend für kleine Strukturen. Höhere Frequenzen werden jedoch im Gewebe stärker absorbiert (Dämpfung ∝ f²), sodass die Eindringtiefe abnimmt. Deshalb wählt man: hohe Frequenz (≥ 10 MHz) für oberflächliche Strukturen (Schilddrüse, Venen), niedrige Frequenz (3–5 MHz) für tiefliegende Organe (Leber, Nieren).',
          hints: [
        ...
        {
          question: 'Schall breitet sich in Wasser (c = 1480 m/s) mit einer Frequenz von 5 MHz aus. Welche Wellenlänge hat er?',
          options: [
            'A) 0,030 mm',
            'B) 0,296 mm',
            'C) 2,96 mm',
          ...
          correctIndex: 1,
          explanation: 'λ = c/f = 1480 m/s ÷ 5×10⁶ Hz = 2,96×10⁻⁴ m = 0,296 mm. Diese sehr kurze Wellenlänge erklärt die hohe Auflösung medizinischer Ultraschallgeräte bei 5 MHz. Zum Vergleich: hörbarer Schall bei 1000 Hz in Luft hat λ ≈ 34 cm – also Faktor ~1000 grösser.',
          hints: [
        ...
        {
          question: 'Eine Welle tritt von Medium 1 (c₁ = 340 m/s) in Medium 2 (c₂ = 1480 m/s) über. Die Frequenz bleibt 1000 Hz. Was ändert sich?',
          options: [
            'A) Die Frequenz verdoppelt sich.',
            'B) Die Wellenlänge nimmt zu (von 0,34 m auf 1,48 m).',
            'C) Die Frequenz nimmt ab.',
            'D) Die Wellenlänge bleibt gleich.',
            'E) Sowohl Frequenz als auch Wellenlänge ändern sich.',
          ],
          correctIndex: 1,
          explanation: 'Beim Medienwechsel bleibt die Frequenz konstant (sie wird von der Quelle vorgegeben). Die Ausbreitungsgeschwindigkeit ändert sich (c₁ = 340 → c₂ = 1480 m/s), daher ändert sich die Wellenlänge: λ₁ = 340/1000 = 0,34 m; λ₂ = 1480/1000 = 1,48 m. Die Wellenlänge steigt um den Faktor c₂/c₁ ≈ 4,35. Dies ist das Prinzip hinter der Brechung von Wellen.',
          hints: [
        ...
        },
        {
          ...
          options: [
            'A) Die Schwingungsrichtung ist parallel zur Ausbreitungsrichtung.',
            'B) Die Schwingungsrichtung ist senkrecht zur Ausbreitungsrichtung.',
            'C) Transversalwellen können sich nicht in Festkörpern ausbreiten.',
            'D) Schallwellen in Luft sind Transversalwellen.',
            'E) Transversalwellen können nicht polarisiert werden.',
          ],
          correctIndex: 1,
          explanation: 'Bei Transversalwellen schwingen die Teilchen senkrecht zur Ausbreitungsrichtung. Beispiele: Licht (elektromagnetisch), Seilwellen, seismische S-Wellen. Longitudinalwellen (Schall in Gasen, seismische P-Wellen) schwingen parallel. Nur Transversalwellen können polarisiert werden – das ist eine direkte Konsequenz der senkrechten Schwingung. Schallwellen in Luft sind Longitudinalwellen.',
          hints: [
        ...
        {
          question: 'Eine elektromagnetische Welle hat im Vakuum eine Frequenz von 6×10¹⁴ Hz (sichtbares Licht). Welche Wellenlänge hat sie?',
          options: [
            'A) 200 nm',
            'B) 500 nm',
            'C) 1000 nm',
          ...
          correctIndex: 1,
          explanation: 'λ = c/f = (3×10⁸ m/s) ÷ (6×10¹⁴ Hz) = 5×10⁻⁷ m = 500 nm. 500 nm liegt im grünen Bereich des sichtbaren Lichts. Zum Vergleich: UV beginnt bei ~400 nm (höhere Frequenz), IR beginnt bei ~700 nm (niedrigere Frequenz). Die Formel c = f·λ gilt für alle elektromagnetischen Wellen im Vakuum.',
          hints: [
            'λ = c/f mit c = 3×10⁸ m/s.',
            'Ergebnis in Nanometern: 1 nm = 10⁻⁹ m.',
          ],
          difficulty: 2,
          tags: [],
        },
...
**Brechung**: Änderung der Ausbreitungsrichtung beim Übergang zwischen Medien mit verschiedenen Ausbreitungsgeschwindigkeiten. Snellius'sches Brechungsgesetz: n₁·sin(α₁) = n₂·sin(α₂), wobei n = c₀/c (Brechungsindex).`,
      ...
      sections: [
        ...
        },
        {
          ...
          merksatz: 'Doppler-Shift ∝ Blutflussgeschwindigkeit → Diagnose von Stenosen und Embolien.',
        },
      ],
      ...
      altfrage: {
        question: 'Erläutern Sie den Doppler-Effekt und seine Anwendung in der medizinischen Diagnostik. Beschreiben Sie dabei auch, wie Interferenzphänomene in der Medizintechnik genutzt werden.',
        answer: 'Der Doppler-Effekt beschreibt die scheinbare Frequenzverschiebung, die entsteht, wenn sich Schallquelle und Beobachter relativ zueinander bewegen. Bei Annäherung steigt die wahrgenommene Frequenz, bei Entfernung sinkt sie. Die Formel lautet f_obs = f_Q · (c ± v_Beob)/(c ∓ v_Q). In der Doppler-Sonographie sendet ein Schallkopf Ultraschall (1–10 MHz) auf Blutgefässe. Bewegte Erythrozyten reflektieren den Schall mit einer Frequenzverschiebung Δf proportional zur Flussgeschwindigkeit und dem Winkel zwischen Schallstrahl und Blutgefäss. Aus Δf = 2·f₀·v·cos θ/c berechnet man die Flussgeschwindigkeit v. Das Vorzeichen von Δf zeigt die Flussrichtung an – dies ermöglicht die Diagnose von Stenosen (erhöhte Flussgeschwindigkeit) und Thrombosen (fehlendes Signal). Interferenzphänomene spielen bei stehenden Wellen in Körperhöhlen, bei Beugung am Trommelfell und bei konstruktiver Interferenz in Hohlraumresonatoren (Lungen-Perkussion) eine Rolle. Destruktive Interferenz wird in Noise-Cancelling-Geräten und zur Dämpfungsoptimierung in medizinischen Schallkopf-Designs genutzt.',
      },

      klinischerBezug: 'Doppler-Sonographie: Frequenzverschiebung reflektierter Ultraschallwellen zeigt Blutflussgeschwindigkeit und -richtung an → Diagnose von Stenosen, Embolien. Herzgeräusche entstehen durch Turbulenzen (destruktive Interferenz normaler Laminarströmung).',

      selfTest: [
        {
          question: 'Zwei kohärente Wellen gleicher Amplitude überlagern sich. Der Gangunterschied beträgt λ/2. Was beobachtet man?',
          options: [
            'A) Konstruktive Interferenz mit doppelter Amplitude.',
            'B) Destruktive Interferenz, Amplitude = 0.',
            'C) Teilweise konstruktive Interferenz.',
            'D) Die Wellen bewegen sich aneinander vorbei ohne Wechselwirkung.',
            'E) Eine stehende Welle mit einem Bauch.',
          ],
          correctIndex: 1,
          explanation: 'Ein Gangunterschied von λ/2 entspricht einem Phasenunterschied von π (180°). Die Wellen sind exakt gegenphasig: Wenn eine Welle den Wert +A hat, hat die andere −A. Die algebraische Summe ist null → vollständige destruktive Interferenz bei gleichen Amplituden. Dieses Prinzip nutzen Noise-Cancelling-Kopfhörer: Ein Mikrofon nimmt den Umgebungslärm auf, der Kopfhörer erzeugt eine gegenphasige Welle.',
          hints: [
        ...
        {
          question: 'Eine Saite der Länge L = 80 cm schwingt in der Grundschwingung. Welche Wellenlänge hat die stehende Welle?',
          options: [
            'A) 40 cm',
            'B) 80 cm',
            'C) 160 cm',
        ...
        {
          question: 'Auf einer 60 cm langen Saite bildet sich die 3. Harmonische aus. Wie viele Knoten liegen innerhalb der Saite (ohne die Enden)?',
          options: [
            'A) 1',
            'B) 2',
            'C) 3',
          ...
          correctIndex: 1,
          explanation: 'Die n-te Harmonische hat (n−1) Knoten innerhalb der Saite. Für n = 3 sind das 3−1 = 2 innere Knoten. Die Saite wird in drei gleichlange Segmente geteilt, jedes ein halber Wellenberg. Wellenlänge: λ₃ = 2L/3 = 2×60/3 = 40 cm. Die 3. Harmonische hat dreimal die Frequenz der Grundschwingung.',
          hints: [
        ...
        {
          question: 'Ein Rettungswagen (Sirene: 700 Hz) fährt mit 20 m/s auf einen stehenden Beobachter zu. c_Schall = 340 m/s. Welche Frequenz hört der Beobachter?',
          options: [
            'A) 658 Hz',
            'B) 741 Hz',
            'C) 700 Hz',
          ...
          correctIndex: 1,
          explanation: 'Doppler-Formel bei bewegter Quelle (Beobachter ruht): f_obs = f_Q · c/(c − v_Q) = 700 × 340/(340−20) = 700 × 340/320 = 700 × 1,0625 ≈ 743,75 Hz. Am nächsten liegt Antwort B mit 741 Hz (geringe Rundungsabweichung je nach Genauigkeit). Nähert sich die Quelle, kommen Wellenkämme komprimiert an → höhere Frequenz. Nach Passieren des Beobachters: f_obs = 700 × 340/360 ≈ 661 Hz (tieferer Ton).',
          hints: [
        ...
        },
        {
          ...
          options: [
            'A) Beugung tritt nur bei Licht auf, nicht bei Schall.',
            'B) Beugungseffekte sind am stärksten, wenn die Hindernisbreite in der Größenordnung der Wellenlänge liegt.',
            'C) Beugung verändert die Frequenz der Welle.',
            'D) Beugung ist nur bei Longitudinalwellen möglich.',
            'E) Beugung verhindert, dass Wellen in Schattenbereiche gelangen.',
          ],
          correctIndex: 1,
          explanation: 'Beugung (Diffraktion) ist ein universelles Wellenphänomen – es tritt bei Schall, Licht und allen anderen Wellen auf. Der Effekt ist am ausgeprägtesten, wenn die Grösse des Hindernisses oder der Öffnung vergleichbar mit der Wellenlänge ist. Licht (λ ≈ 500 nm) beugt an Mikrostrukturen deutlich; Schall (λ ≈ 34 cm bei 1000 Hz) beugt um grosse Hindernisse wie Häuserecken. Die Frequenz bleibt bei Beugung unverändert.',
          hints: [
        ...
        {
          question: 'Zwei Wellen gleicher Amplitude A überlagern sich mit einem Phasenunterschied von π/2. Welche Resultante haben sie?',
          options: [
            'A) 0',
            'B) A·√2',
            'C) 2A',
          ...
          correctIndex: 1,
          explanation: 'Bei einem Phasenunterschied von π/2 (90°) sind die Vektoren senkrecht. Die vektorielle Addition ergibt: A_res = √(A² + A²) = A√2 ≈ 1,41·A. Dies liegt zwischen konstruktiver (A_res = 2A bei Δφ = 0) und destruktiver Interferenz (A_res = 0 bei Δφ = π). Der Phasenunterschied von π/2 ergibt also eine teilweise Verstärkung.',
          hints: [
        ...
        {
          question: 'Welche physikalische Grösse misst die Doppler-Sonographie beim Blutfluss direkt?',
          options: [
            'A) Die Dichte des Blutes',
            'B) Die Frequenzverschiebung der reflektierten Ultraschallwellen',
            'C) Die Amplitude des reflektierten Schalls',
            'D) Die Wellenlänge des Ultraschalls im Blut',
            'E) Den Blutdruck',
          ],
          correctIndex: 1,
          explanation: 'Die Doppler-Sonographie misst direkt die Frequenzverschiebung Δf zwischen gesendeten und reflektierten Ultraschallwellen. Aus Δf = 2·f₀·v·cos θ/c berechnet man die Blutflussgeschwindigkeit v. Das Vorzeichen von Δf zeigt die Flussrichtung an (auf den Schallkopf zu = positives Δf = Farbkodierung rot; weg vom Schallkopf = negatives Δf = blau in der Farbdoppler-Sonographie). Diese Methode ist fundamental für die Diagnose von Gefässstenosen, Herzfehlern und tiefen Venenthrombosen.',
          hints: [
      ...
      sections: [
        {
          ...
          merksatz: 'L = 20·log(p/p₀) dB; +6 dB → doppelter Schalldruck; +20 dB → 10-facher Schalldruck.',
        },
        {
      ...
      selfTest: [
        {
          ...
          correctIndex: 3,
          explanation: 'L = 20·log(p/p₀) → 60 = 20·log(p/p₀) → log(p/p₀) = 3 → p/p₀ = 10³ = 1000. Bei 60 dB ist der Schalldruck also 1000-mal so gross wie die Hörschwelle p₀. Häufiger Fehler: L = 60 mit p/p₀ = 60 gleichzusetzen (lineares statt logarithmisches Denken). Pro 20 dB steigt p/p₀ um Faktor 10: 0 dB → 1, 20 dB → 10, 40 dB → 100, 60 dB → 1000.',
          hints: [
            '60 = 20·log(p/p₀) → log(p/p₀) = 3.',
            '10³ = ?',
          ],
          difficulty: 2,
          tags: [],
        },
        {
          ...
          options: [
            'A) Tiefe Frequenzen (< 500 Hz)',
            'B) Hohe Frequenzen (> 4000 Hz)',
            'C) Mittelfrequenzen (1000–2000 Hz)',
            'D) Alle Frequenzen gleichmässig',
            'E) Nur der Frequenzbereich 20–100 Hz',
          ],
          correctIndex: 1,
          explanation: 'Die Basilarmembran ist an der Basis (nahe dem ovalen Fenster) schmal und steif – sie resoniert bei hohen Frequenzen (> 4 kHz). Am Apex (Spitze der Cochlea) ist sie breit und elastisch – sie resoniert bei tiefen Frequenzen (20–100 Hz). Diese räumliche Frequenzauftrennung (Tonotopie) ermöglicht dem Gehirn, Töne nach Frequenz zu unterscheiden. Das Cochlea-Implantat nutzt dieses Prinzip: Elektroden nahe der Basis stimulieren höhere Frequenzen, Elektroden nahe dem Apex tiefere.',
          hints: [
        ...
        {
          question: 'Der Schallpegel steigt von 60 dB auf 80 dB. Um welchen Faktor steigt die Schallintensität?',
          options: [
            'A) Faktor 2',
            'B) Faktor 10',
            'C) Faktor 20',
          ...
          correctIndex: 3,
          explanation: 'L = 10·log(I/I₀). Eine Differenz von 20 dB: ΔL = 10·log(I₂/I₁) → 20 = 10·log(I₂/I₁) → log(I₂/I₁) = 2 → I₂/I₁ = 10² = 100. Ein Anstieg von 10 dB entspricht einem 10-fachen Intensitätsanstieg; 20 dB entsprechen dem 100-fachen. Der Schalldruck steigt dabei nur um Faktor 10 (weil I ∝ p²).',
          hints: [
        ...
        {
          question: 'Was unterscheidet Schallleitungsschwerhörigkeit von Schallempfindungsschwerhörigkeit?',
          options: [
            'A) Schallleitungsschwerhörigkeit betrifft das Innenohr; Schallempfindungsschwerhörigkeit das Mittelohr.',
            'B) Bei Schallleitungsschwerhörigkeit ist die Knochenleitung intakt; bei Schallempfindungsschwerhörigkeit sind Knochen- und Luftleitung gleich betroffen.',
            'C) Beide Typen sind nicht unterscheidbar.',
            'D) Schallleitungsschwerhörigkeit betrifft nur tiefe Frequenzen.',
            'E) Schallempfindungsschwerhörigkeit ist immer reversibel.',
          ],
          correctIndex: 1,
          explanation: 'Schallleitungsschwerhörigkeit entsteht durch Störungen im Aussenohr oder Mittelohr (Cerumen, Trommelfellriss, Otosklerose): Der Schall gelangt nicht normal zum Innenohr. Die Knochenleitung (Schall direkt über Knochen zum Innenohr) ist ungestört → Weberscher Versuch: Lateralisation zur betroffenen Seite. Schallempfindungsschwerhörigkeit (SNHL) betrifft Haarzellen oder Hörnerv: Knochen- und Luftleitung sind gleichermassen reduziert. SNHL ist meist irreversibel (Haarzellen regenerieren nicht). Lärmschwerhörigkeit ist eine SNHL.',
          hints: [
        ...
        {
          question: 'Warum klingt ein Ton bei 1000 Hz subjektiv lauter als ein gleich starker Ton bei 100 Hz (gleicher Schalldruckpegel)?',
          options: [
            'A) Weil 1000 Hz eine höhere Ausbreitungsgeschwindigkeit hat.',
            'B) Weil das menschliche Ohr bei 1000–4000 Hz empfindlicher ist als bei tiefen Frequenzen.',
            'C) Weil tiefe Töne weniger Energie transportieren.',
            'D) Weil 100 Hz im Infraschallbereich liegt.',
            'E) Weil 1000 Hz Licht-interferiert.',
          ],
          correctIndex: 1,
          explanation: 'Die Empfindlichkeit des menschlichen Gehörs ist stark frequenzabhängig. Im Bereich 1–4 kHz ist das Ohr am empfindlichsten (evolutionäre Anpassung für Sprachkommunikation). Bei tiefen Frequenzen (100 Hz) muss der Schalldruckpegel deutlich höher sein, um gleich laut zu klingen (Fletcher-Munson-Kurven / isophones Lautheitsdiagramm). Bei 100 Hz liegt die Wahrnehmungsschwelle etwa 40 dB über der bei 1000 Hz. 100 Hz ist kein Infraschall – Infraschall liegt unter 20 Hz.',
          hints: [
        ...
        {
          question: 'Ein Audiogramm zeigt bei einem Patienten eine tiefe Senke bei 4 kHz, während die restlichen Frequenzen normal sind. Was ist die wahrscheinlichste Ursache?',
          options: [
            'A) Mittelohrentzündung',
            'B) Cerumen im Gehörgang',
            'C) Lärminduzierte Schallempfindungsschwerhörigkeit (C5-Senke)',
            'D) Borreliose',
            'E) Kongenitale Schallleitungsschwerhörigkeit',
          ],
          correctIndex: 2,
          explanation: 'Die klassische C5-Senke (Hörverlust bei ca. 4 kHz) ist das pathognomonische Muster einer lärminduzierte Schallempfindungsschwerhörigkeit. Die äusseren Haarzellen bei 4 kHz sind besonders vulnerabel für Lärmschäden, da dieser Bereich der maximalen Empfindlichkeit des Ohrs entspricht. Mittelohrentzündung und Cerumen verursachen eine Schallleitungsschwerhörigkeit mit flachem Abfall über alle Frequenzen (keine spezifische Senke). Eine kongenitale Schallempfindungsschwerhörigkeit betrifft meist alle Frequenzen gleichmässig oder bevorzugt hohe Frequenzen.',
          hints: [
