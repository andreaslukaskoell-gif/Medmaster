...
**Sepsis** ist ein Beispiel für versagende Homöostase auf Systemebene: Eine unkontrollierte Immunantwort auf Infektion führt zu einem "Cytokinsturm", SIRS (Systemisches Inflammatorisches Response-Syndrom) und Multiorganversagen. Die Emergenz des Sepsissyndroms aus molekularen Interaktionen ist paradigmatisch für systembiologisches Denken in der Medizin.`,
      ...
      selfTest: [
        ...
        },
        {
          ...
          correctIndex: 2,
          explanation: 'Negative Rückkopplung ist der zentrale Mechanismus der Homöostase. Der Effekt wirkt dem auslösenden Reiz entgegen und führt das System zurück zum Sollwert. Beispiel: Hoher Blutzucker → Insulin → Blutzucker sinkt → weniger Insulin. Positive Rückkopplung (Option A) verstärkt dagegen den ursprünglichen Reiz – Beispiele: Wehen, Blutgerinnung, Aktionspotential. Positive Rückkopplung ist physiologisch sinnvoll, wenn ein schnelles "Alles-oder-Nichts"-Signal erwünscht ist.',
          hints: [
        ...
        },
        {
          ...
          correctIndex: 2,
          explanation: 'Die hierarchische Organisation lautet: Atome → Moleküle → Organellen → Zellen → Gewebe → Organe → Organsysteme → Organismus. Gewebe bestehen aus gleichartigen Zellen mit gemeinsamer Funktion (z.B. Epithelgewebe, Muskelgewebe). Auf jeder Ebene entstehen emergente Eigenschaften: Einzelne Muskelzellen kontrahieren, aber erst das Muskelgewebe erzeugt koordinierte Kraftentwicklung.',
          hints: [
...
**Cave:** Mitochondrien haben 70S-Ribosomen → manche Antibiotika in hohen Dosen → mitochondriale Toxizität (z.B. Chloramphenicol → aplastische Anämie; Aminoglykoside → Nephrotoxizität, Ototoxizität durch Schädigung mitochondrienreicher Zellen).`,
      ...
      selfTest: [
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: 'Penicillin (und andere Beta-Laktame: Cephalosporine, Carbapeneme) hemmen Penicillin-bindende Proteine (PBPs), die die Transpeptidierung (Quervernetzung der Peptidoglykan-Peptidbrücken) katalysieren. Ohne Quervernetzung wird die Zellwand strukturell instabil – osmotischer Druck führt zur Bakterienlyse. Tetracyclin (A) und Streptomycin (D) hemmen die 30S-Untereinheit, Chloramphenicol (C) und Erythromycin (E) die 50S-Untereinheit der prokaryotischen Ribosomen.',
          hints: [
...
**Mukoviszidose (Cystische Fibrose):** CFTR (Cystic Fibrosis Transmembrane Conductance Regulator) ist ein integrales Membranprotein und Cl--Kanal. Die häufigste Mutation deltaF508 führt zu Fehlfaltung → ERAD (ER-assoziierter Abbau) → kein CFTR an der Membran → Cl--Transport gestört → visköser Schleim → chronische Atemwegsinfektionen, Pankreasinsuffizienz.`,
      ...
      sections: [
        {
          ...
          merksatz: 'Phospholipid = amphiphil: hydrophiler Kopf + hydrophobe Schwänze → spontane Bilayer-Bildung im Wasser durch hydrophoben Effekt.',
        },
        {
      ...
      selfTest: [
        ...
        },
        {
          ...
          correctIndex: 2,
          explanation: 'Cholesterin ist zwischen den Phospholipiden eingelagert und reguliert die Membranfluidität bidirektional. Bei hohen Temperaturen begrenzt es die Beweglichkeit der Fettsäureketten (verhindert übermäßige Verflüssigung); bei tiefen Temperaturen verhindert es die dichte Packung (verhindert Erstarrung). Cholesterin ist nicht der Hauptbestandteil (das sind Phospholipide, A falsch) und transportiert keine Ionen direkt (B falsch). Steroidhormone binden an intrazelluläre Kernrezeptoren, nicht an Cholesterin (D falsch).',
          hints: [
...
**Krebs:** Veränderungen der Kernmorphologie (irreguläre Kernform, prominente Nucleoli, erhöhte Kern-Zytoplasma-Ratio) sind wichtige histopathologische Malignitätskriterien. Tumorzellen zeigen oft chromosomale Instabilität und veränderte Chromatin-Organisation. HDAC-Inhibitoren (Vorinostat, Romidepsin) reprogrammieren das Epigenom und werden bei hämatologischen Malignomen eingesetzt.`,
      ...
      sections: [
        {
          ...
          merksatz: 'Kernporen: <40 kDa frei, >40 kDa nur mit NLS (Import) oder NES (Export). RanGTP-Gradient treibt Transport.',
        },
        {
        ...
        },
        {
          ...
          merksatz: 'Großer Nucleolus = viel Proteinsynthese (viele Ribosomen) = Zeichen aktiver/proliferierender Zellen. Wichtiges Malignitätsmerkmal!',
        },
      ],
      merksätze: [
      ...
      selfTest: [
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: 'Der Nucleolus ist der Ort der rRNA-Synthese (28S, 18S, 5.8S rRNA durch RNA-Pol I) und der Assemblierung ribosomaler Untereinheiten. Die fertigen Untereinheiten (40S und 60S) werden durch Kernporen ins Zytoplasma exportiert. Der Nucleolus ist nicht membranumschlossen, sondern eine Phasenseparations-Kondensatstruktur (organized around NOR-Regionen auf Chromosomen 13, 14, 15, 21, 22).',
          hints: [
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: 'Eukaryoten haben drei RNA-Polymerasen: RNA-Pol I synthetisiert die 45S-prä-rRNA (→ 28S, 18S, 5.8S rRNA) im Nucleolus. RNA-Pol II synthetisiert prä-mRNA (Protein-kodierende Gene), snRNA und microRNA im Nukleoplasma. RNA-Pol III synthetisiert tRNA, 5S rRNA und andere kleine RNAs. Alpha-Amanitin (Knollenblätterpilz-Toxin) hemmt spezifisch RNA-Pol II → keine mRNA-Synthese → Leberversagen (RNA-Pol I und III werden nicht gehemmt).',
          hints: [
