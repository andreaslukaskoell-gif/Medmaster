...
export const biologieKapitel: Kapitel[] = [
  ...
  { ...bioKapAnatomieGewebe, sequence: 2, sequenceTitle: 'Gewebe',     linkedChapters: ['bio-kap1', 'bio-kap3'] },
  { ...bioKapEntwicklung,   sequence: 3, sequenceTitle: 'Entwicklung', linkedChapters: ['bio-kap4'] },
  { ...bioKapGenetik,       sequence: 4, sequenceTitle: 'Genetik',     linkedChapters: ['bio-kap3', 'bio-kap5'] },
