  ...
  unterkapitel: [
    ...
    // ──────────────────────────────────────────────
    {
      ...
      merksaetze: [
        ...
        'Entzündungszeichen (5 Kardinalsymptome): Rubor (Rötung), Calor (Wärme), Tumor (Schwellung), Dolor (Schmerz), Functio laesa (Funktionseinschränkung).',
      ],
      altfrage: {
    ...
    // ──────────────────────────────────────────────
    {
      ...
      merksaetze: [
        'Antikörperklassen MADGE: IgM (Pentamer, Erstantwort, Komplementaktivierung), IgA (Dimer, Schleimhäute, Muttermilch), IgD (B-Zell-Rezeptor), IgG (häufigstes Ig, plazentagängig, Sekundärantwort), IgE (Allergie, Parasiten, Mastzellen).',
