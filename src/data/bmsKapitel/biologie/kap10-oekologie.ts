...
Das **Saprobiensystem** klassifiziert Gewässer nach dem organischen Belastungsgrad anhand von Indikatororganismen in vier Saprobiezonen (oligosaprob bis polysaprob).`,
      ...
      sections: [
        {
          ...
          merksatz: 'Euryök = breite Amplitude, Generalist, widerstandsfähig. Stenök = enge Amplitude, Spezialist, gefährdet, Bioindikator.',
        },
        {
          ...
          merksatz: 'Liebigs Gesetz gilt für alle Ökosystemebenen: der knappste essentielle Faktor begrenzt das System, nicht die reichlichen. Shelford: auch Überschuss kann limitieren.',
        },
      ],
      merksätze: [
      ...
      selfTest: [
        {
          question: 'Wie nennt man Arten mit einem sehr engen Toleranzbereich, die nur unter spezifischen Umweltbedingungen überleben können und deshalb als Umweltzeiger genutzt werden?',
          options: [
        ...
        {
          question: 'Ein Landwirt fügt seinem Weizenfeld mehr Wasser, Licht und Kalium hinzu, der Ertrag steigt kaum. Nach Zugabe von Stickstoffdünger steigt der Ertrag stark. Was erklärt dieses Phänomen am besten?',
          options: [
        ...
        {
          question: 'Die Brennnessel (Urtica dioica) wächst bevorzugt auf Dungplätzen, Komposthaufen und stark gedüngten Flächen. Welche Funktion übernimmt sie dabei ökologisch?',
          options: [
        ...
        {
          question: 'Ein Süßwassersee hat hohe Stickstoff- und Lichtmengen, aber sehr niedrige Phosphorkonzentrationen. Trotz Stickstoffdüngung steigt die Algenmasse nicht. Was ist der limitierende Faktor?',
          options: [
        ...
        {
          question: 'Shelfords Toleranzgesetz erweitert Liebigs Minimumgesetz. Was ist der entscheidende Unterschied?',
          options: [
        ...
        {
          question: 'Flechten sind bekannte Bioindikatoren für Luftverschmutzung. In stark verschmutzten Städten fehlen Flechten fast vollständig ("Flechtenwüste"). Welches Prinzip erklärt dies am besten?',
          options: [
          ...
          correctIndex: 1,
          explanation: 'Flechten (Symbiose aus Pilz und Alge/Cyanobakterium) sind extrem sensitive Bioindikatoren für SO₂-Belastung. Als stenöke Organismen haben sie einen sehr engen Toleranzbereich für Luftschadstoffe, insbesondere SO₂. Das Shelfords Toleranzgesetz zeigt: SO₂ überschreitet den oberen Toleranzpunkt der Flechten — die Konzentration übersteigt das Maximum, was lethal ist. "Flechtenwüsten" in Städten waren historisch wichtige Indikatoren für Luftverschmutzung. Nach der Einführung von Entschwefelungsanlagen in Kraftwerken (ab 1980er Jahre) sind Flechten in vielen europäischen Städten wieder aufgetaucht.',
          hints: [
        ...
        },
        {
          ...
          correctIndex: 3,
          explanation: 'Das Optimum ist der Bereich der Toleranzkurve, in dem der Organismus maximale Fitness, Wachstum und Reproduktionsrate zeigt. Hier laufen physiologische Prozesse mit höchster Effizienz ab, der Energieaufwand für Stressanpassung ist minimal, und die verfügbare Energie kann vollständig in Wachstum und Fortpflanzung investiert werden. Das Optimum ist daher evolutionär optimal für das Überleben und Fortpflanzen unter natürlichen Bedingungen. Das Pessimum ist das ungünstigste noch überlebbaren Bedingungen, und der Todespunkt markiert die physiologische Grenze.',
          hints: [
        ...
        {
          question: 'Ein Arzt bemerkt, dass ein unterernährter Patient trotz normalisierter Makronährstoffversorgung (Kohlenhydrate, Proteine, Fette) schwache Wundheilung und Immunsuppression zeigt. Welches ökologische Prinzip findet hier klinische Anwendung?',
          options: [
...
**Koevolution zwischen Parasit und Wirt:** Evolutionäre Arme-Rennen (evolutionary arms race) — Wirt entwickelt Resistenz, Parasit umgeht sie. Historisches Beispiel: Sichelzellmutation (HbS) schützt heterozygot gegen *Plasmodium falciparum* (Malaria) — Kompromiss zwischen Malariaschutz und Sichelzellanämie-Risiko.`,
      ...
      sections: [
        {
          ...
          merksatz: 'Lotka-Volterra: Räuber- und Beute-Populationen bilden versetzte Zyklen. Räuber hinkt Beute zeitlich nach. Klassisch: Luchs-Schneehasezyklus (10 Jahre).',
        },
        {
          ...
          merksatz: 'Darmmikrobiom = mutualistisches Ökosystem: Bakterien liefern Vitamine, Butyrat, Immunmodulation; Mensch liefert Nahrung und Habitat. Antibiotika stören das Ökosystem → C. difficile.',
        },
      ],
      merksätze: [
      ...
      selfTest: [
        {
          question: 'Zwei Paramecium-Arten (*P. aurelia* und *P. caudatum*) werden in Mischkultur gehalten und nutzen dieselbe Nahrung. Nach einigen Wochen überlebt nur noch *P. aurelia*. Welches Prinzip erklärt das?',
          options: [
        ...
        {
          question: 'Bei Räuber-Beute-Zyklen nach dem Lotka-Volterra-Modell: Wenn die Beutepopulation ihren Höhepunkt erreicht, was passiert mit der Räuberpopulation?',
          options: [
        ...
        {
          question: 'Mykorrhizapilze und Pflanzenwurzeln unterhalten eine enge Beziehung. Welche Kategorie der Symbiose und welches Vorzeichen trifft am besten zu?',
          options: [
        ...
        {
          question: 'Das 1995 in Yellowstone wiedereingeführte Wolf-Rudel führte zu drastischen Veränderungen der Vegetation und sogar der Flussmorphologie, obwohl Wölfe Pflanzenfresser sind, keine Pflanzen. Wie nennt man diesen Effekt?',
          options: [
        ...
        {
          question: 'Worin besteht der entscheidende Unterschied zwischen Parasitismus und Prädation?',
          options: [
        ...
        {
          question: 'Die Sichelzellmutation (HbS) ist in Malaria-Endemiegebieten (Subsahara-Afrika) besonders häufig. Welcher ökologisch-evolutionäre Mechanismus erklärt das?',
          options: [
        ...
        {
          question: 'Welche Symbioseform zeigen Epiphyten (z. B. Orchideen, Bromelien), die auf Baumästen wachsen, um mehr Licht zu bekommen?',
          options: [
          ...
          correctIndex: 2,
          explanation: 'Epiphyten (von griech. epi = auf, phyton = Pflanze) sind Kommensalisten (+/0): Sie wachsen auf Baumästen oder -stämmen, nutzen den erhöhten Standort für besseren Lichtzugang, sind aber keine Parasiten — sie haben keine Haustoria (parasitische Saugorgane) und zapfen den Baum nicht an. Der Baum trägt lediglich das zusätzliche Gewicht, was bei sehr schwerer Beladung leicht negativ sein kann, ansonsten aber neutralen Einfluss hat. In tropischen Regenwäldern können Epiphyten bis zu 50% der Blattbiomasse eines Baumes ausmachen.',
          hints: [
