  ...
  sections: [
    {
      ...
      content:
        "Du erhaelst einen längeren Text (wissenschaftlich oder allgemeinmedizinisch) und musst zu verschiedenen Aussagen entscheiden, ob sie aus dem Text ableitbar sind oder nicht. Wichtig: Es geht NICHT darum, ob die Aussage generell wahr ist, sondern ob sie aus dem GEGEBENEN TEXT hervorgeht.",
    },
    {
      heading: "Strategie: Dreistufiges Lesen",
      content: `1. UEBERFLIEGEN (1-2 Min): Lies den Text einmal schnell durch. Verstehe das Hauptthema und die Grundstruktur. Markiere gedanklich die Absaetze.
...
- Die Information steht woertlich oder sinngemaess im Text
...
export const tvTexts: TVText[] = [
  {
    ...
    content: `Antibiotikaresistenz ist eines der größten Gesundheitsprobleme unserer Zeit. Die Weltgesundheitsorganisation (WHO) hat sie als eine der zehn größten globalen Bedrohungen fuer die oeffentliche Gesundheit eingestuft. Jährlich sterben weltweit schätzungsweise 700.000 Menschen an Infektionen mit resistenten Keimen. Prognosen gehen davon aus, dass diese Zahl bis 2050 auf 10 Millionen pro Jahr ansteigen koennte, wenn keine Gegenmaßnahmen ergriffen werden.

Die Hauptursache fuer die Entstehung von Resistenzen ist der uebermaeessige und unsachgemaesse Einsatz von Antibiotika - sowohl in der Humanmedizin als auch in der Tierhaltung. In vielen Ländern sind Antibiotika ohne Rezept erhältlich, was zu Selbstmedikation und falscher Dosierung führt. In der Landwirtschaft werden Antibiotika häufig nicht nur zur Behandlung kranker Tiere eingesetzt, sondern auch prophylaktisch zur Wachstumsförderung.

Bakterien entwickeln Resistenzen durch verschiedene Mechanismen: Enzymatische Inaktivierung des Antibiotikums, Veränderung der Zielstruktur, aktives Herauspumpen des Wirkstoffs (Effluxpumpen) oder verminderte Aufnahme. Diese Resistenzgene können durch horizontalen Gentransfer auch auf andere Bakterienarten uebertragen werden, was die Ausbreitung beschleunigt.

Besonders problematisch sind multiresistente Erreger wie MRSA (Methicillin-resistenter Staphylococcus aureus) und multiresistente gramnegative Bakterien. In Krankenhaeusern verursachen sie schwer behandelbare nosokomiale Infektionen. Neue Antibiotika werden kaum noch entwickelt, da die Forschung fuer Pharmaunternehmen wirtschaftlich wenig attraktiv ist.`,
    statements: [
      {
        id: "tv-1-s1",
      ...
      },
      {
        ...
        isDerivable: false,
        explanation:
          "Der Text spricht von 'Prognosen' und 'koennte', nicht von einer definitiven Aussage. Die Einschraenkung 'wenn keine Gegenmaßnahmen ergriffen werden' fehlt ebenfalls.",
      },
      {
        id: "tv-1-s3",
      ...
      },
      {
        ...
        isDerivable: false,
        explanation:
          "Der Text nennt MRSA und multiresistente gramnegative Bakterien als separate Kategorien. MRSA (Staphylococcus aureus) ist tatsaechlich grampositiv, und der Text ordnet es nicht als gramnegativ ein.",
      },
      {
        id: "tv-1-s5",
      ...
      },
      {
        ...
        isDerivable: false,
        explanation:
          "Der Text sagt das Gegenteil: 'Neue Antibiotika werden kaum noch entwickelt, da die Forschung fuer Pharmaunternehmen wirtschaftlich wenig attraktiv ist.'",
      },
    ],
  },
  {
...
Besonders der Tiefschlaf (N3) ist fuer die körperliche Erholung wichtig. In dieser Phase werden Wachstumshormone ausgeschüttet, das Immunsystem gestärkt und Gewebe repariert. Der REM-Schlaf hingegen spielt eine zentrale Rolle bei der Gedaechtniskonsolidierung und der emotionalen Verarbeitung. Studien haben gezeigt, dass Probanden, die nach dem Lernen ausreichend REM-Schlaf erhielten, bei Gedaechtnistests deutlich besser abschnitten.

Chronischer Schlafmangel (weniger als 6 Stunden pro Nacht über längere Zeit) hat weitreichende gesundheitliche Folgen. Er erhöht das Risiko fuer Herz-Kreislauf-Erkrankungen, Diabetes Typ 2, Adipositas und Depressionen. Auch die kognitive Leistungsfähigkeit leidet: Reaktionszeit, Aufmerksamkeit und Entscheidungsfähigkeit verschlechtern sich messbar. Nach 17 Stunden Wachsein entspricht die kognitive Beeintraechtigung etwa der bei 0,5 Promille Blutalkohol.

Die empfohlene Schlafdauer fuer Erwachsene beträgt laut der National Sleep Foundation 7-9 Stunden pro Nacht. Interessanterweise ist nicht nur zu wenig, sondern auch zu viel Schlaf (regelmäßig mehr als 10 Stunden) mit erhöhter Mortalität assoziiert, wobei hier die Kausalität nicht abschließend geklaert ist.`,
    statements: [
      {
        id: "tv-2-s1",
      ...
      {
        id: "tv-2-s2",
        text: "Wachstumshormone werden hauptsaechlich während des REM-Schlafs ausgeschüttet.",
        isDerivable: false,
        explanation: "Der Text sagt, dass Wachstumshormone im Tiefschlaf (N3) ausgeschüttet werden, NICHT im REM-Schlaf.",
      },
      {
        id: "tv-2-s3",
        text: "17 Stunden ohne Schlaf beeintraechtigt die Kognition ähnlich wie 0,5 Promille Blutalkohol.",
        isDerivable: true,
      ...
      },
      {
        ...
        isDerivable: false,
        explanation:
          "Der Text sagt, es ist 'assoziiert' mit erhöhter Mortalität, und die 'Kausalität ist nicht abschließend geklaert'. 'Verursacht' würde Kausalität implizieren.",
      },
      {
        id: "tv-2-s5",
        text: "REM-Schlaf ist wichtig fuer die Gedaechtniskonsolidierung.",
        isDerivable: true,
        explanation: "Steht direkt im zweiten Absatz.",
      },
      {
        id: "tv-2-s6",
        text: "Die National Sleep Foundation empfiehlt fuer Erwachsene 7-9 Stunden Schlaf pro Nacht.",
        isDerivable: true,
    ...
    statements: [
      {
        ...
        isDerivable: false,
        explanation:
          "Der Text beschreibt mRNA-Impfstoffe als einen 'anderen Ansatz': Sie liefern die genetische Bauanleitung fuer ein Erregerprotein. Abgeschwächte Erreger sind der klassische Ansatz, nicht der mRNA-Ansatz.",
      },
      {
        id: "tv-3-s2",
        text: "Fuer Herdenimmunität gegen Masern muessen etwa 95 Prozent der Bevölkerung geimpft sein.",
        isDerivable: true,
        explanation:
          "Im zweiten Absatz steht, dass die nötige Durchimpfungsrate fuer Masern bei etwa 95 Prozent liegt.",
      },
      {
        id: "tv-3-s3",
        ...
        isDerivable: true,
        explanation:
          "Im dritten Absatz heißt es woertlich: 'Es ist die einzige Infektionskrankheit des Menschen, die durch Impfung vollständig eliminiert werden konnte.'",
      },
      {
        id: "tv-3-s4",
      ...
      {
        id: "tv-3-s5",
        text: "In Deutschland gibt es eine Masern-Impfpflicht fuer Kinder in Gemeinschaftseinrichtungen.",
        isDerivable: true,
        explanation:
          "Steht direkt im vierten Absatz: 'In Deutschland besteht seit 2020 eine Masern-Impfpflicht fuer Kinder in Gemeinschaftseinrichtungen und bestimmtes medizinisches Personal.'",
      },
      {
        id: "tv-3-s6",
        ...
        isDerivable: false,
        explanation:
          "Der Text nennt R0 von 12-18 fuer Masern, nicht fuer Polio. Fuer Polio wird nur die nötige Durchimpfungsrate von 80-85 Prozent genannt, nicht die Basisreproduktionszahl.",
      },
    ],
  },
  {
    ...
    content: `Die Epigenetik beschaeftigt sich mit vererbbaren Veränderungen der Genaktivität, die nicht auf Änderungen der DNA-Sequenz selbst beruhen. Während die DNA-Sequenz den genetischen Bauplan darstellt, bestimmt die Epigenetik, welche Gene in einer Zelle tatsaechlich abgelesen werden. Dies erklaert, warum alle Körperzellen zwar dieselbe DNA besitzen, aber eine Leberzelle völlig andere Eigenschaften hat als eine Nervenzelle. Die wichtigsten epigenetischen Mechanismen sind die DNA-Methylierung und die Histonmodifikation.

Bei der DNA-Methylierung werden Methylgruppen an bestimmte Stellen der DNA angehängt, typischerweise an Cytosin-Basen in sogenannten CpG-Inseln. Eine starke Methylierung in der Promotorregion eines Gens führt in der Regel zur Stilllegung dieses Gens - es wird quasi ausgeschaltet. Histonmodifikationen wirken über einen anderen Weg: DNA ist um Histonproteine gewickelt, und durch chemische Veränderungen dieser Proteine (Acetylierung, Methylierung, Phosphorylierung) kann die DNA enger oder lockerer gepackt werden. Locker gepackte DNA ist fuer die Transkriptionsmaschinerie zugaenglich, eng gepackte nicht.

Umweltfaktoren können epigenetische Markierungen erheblich beeinflussen. Ernährung, Stress, Schadstoffe und körperliche Aktivität hinterlassen messbare Spuren im Epigenom. Eine bahnbrechende Studie zum niederlaendischen Hungerwinter 1944/45 zeigte, dass pränatale Unterernährung zu dauerhaften epigenetischen Veränderungen führte, die mit einem erhöhten Risiko fuer Herz-Kreislauf-Erkrankungen und Stoffwechselstörungen im Erwachsenenalter verbunden waren. Diese Veränderungen konnten noch sechs Jahrzehnte später nachgewiesen werden.

Besonders faszinierend ist die Frage der transgenerationalen Epigenetik: Können epigenetische Veränderungen an nachfolgende Generationen weitergegeben werden? Tierstudien, insbesondere an Maeusen, haben Hinweise darauf geliefert, dass bestimmte epigenetische Markierungen die Keimzellen ueberdauern und somit die nächste Generation beeinflussen können. Beim Menschen ist die Evidenz jedoch noch begrenzt, und die Forschung steht in diesem Bereich noch am Anfang. Klar ist aber bereits, dass die Epigenetik das traditionelle Verständnis von Vererbung grundlegend erweitert.`,
    statements: [
      {
        id: "tv-4-s1",
        ...
        isDerivable: false,
        explanation:
          "Der Text definiert Epigenetik ausdrücklich als Veränderungen, die 'nicht auf Änderungen der DNA-Sequenz selbst beruhen'. Mutationen waeren aber Änderungen der DNA-Sequenz.",
      },
      {
        id: "tv-4-s2",
      ...
      {
        id: "tv-4-s3",
        text: "Die Studie zum niederlaendischen Hungerwinter zeigte epigenetische Veränderungen, die noch 60 Jahre später nachweisbar waren.",
        isDerivable: true,
        explanation:
...
Eine der spannendsten Entdeckungen der letzten Jahre ist die sogenannte Darm-Hirn-Achse. Darmbakterien kommunizieren über verschiedene Wege mit dem Gehirn: über den Vagusnerv, über Immunbotenstoffe und über Stoffwechselprodukte wie kurzkettige Fettsäuren. Tierstudien haben gezeigt, dass keimfreie Maeuese ein verändertes Angst- und Stressverhalten aufweisen. Beim Menschen gibt es zunehmend Hinweise, dass die Zusammensetzung des Darmmikrobioms mit psychischen Erkrankungen wie Depressionen und Angststörungen in Zusammenhang steht, wobei die genauen Mechanismen noch erforscht werden.

Das Mikrobiom spielt eine entscheidende Rolle fuer das Immunsystem. Etwa 70 Prozent der Immunzellen des Körpers befinden sich im Darm-assoziierten lymphatischen Gewebe (GALT). Darmbakterien trainieren das Immunsystem, zwischen harmlosen und gefährlichen Eindringlingen zu unterscheiden. Eine gestörte Darmflora (Dysbiose) wird mit Autoimmunerkrankungen, chronisch-entzuendlichen Darmerkrankungen und Allergien in Verbindung gebracht.

Antibiotika können das Darmmikrobiom erheblich schädigen, da sie nicht nur pathogene, sondern auch nützliche Bakterien abtöeten. Nach einer Antibiotikabehandlung kann es Wochen bis Monate dauern, bis sich die Darmflora wieder erholt hat - in manchen Fällen normalisiert sie sich nie vollständig. Probiotika, also lebende Mikroorganismen, die in ausreichender Menge einen gesundheitlichen Nutzen bringen sollen, werden häufig zur Unterstützung der Darmflora eingesetzt. Ihre Wirksamkeit ist allerdings je nach Stamm und Anwendungsgebiet sehr unterschiedlich, und nicht alle kommerziell erhältlichen Probiotika haben einen wissenschaftlich nachgewiesenen Nutzen.`,
    statements: [
      {
        id: "tv-5-s1",
      ...
      {
        id: "tv-5-s2",
        text: "Die Darm-Hirn-Achse kommuniziert ausschliesslich über den Vagusnerv.",
        isDerivable: false,
        explanation:
          "Der Text nennt im zweiten Absatz drei Kommunikationswege: den Vagusnerv, Immunbotenstoffe und Stoffwechselprodukte. 'Ausschliesslich' ist daher falsch.",
      },
      {
        id: "tv-5-s3",
