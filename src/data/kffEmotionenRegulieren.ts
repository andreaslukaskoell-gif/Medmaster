...
export const emotionenRegulierenScenarios: EmotionenRegulierenScenario[] = [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        strategy: "Situationsmodifikation",
        description:
          "David bittet den Kursleiter, zürst nur zuschauen zu dürfen, bevor er selbst präpariert.",
      },
      {
        strategy: "Aufmerksamkeitslenkung",
        description:
  ...
  },
  {
    id: "er-18",
    scenario:
      "Rafäl steht an einem Sonntag in der Bibliothek und sieht, wie alle Plätze besetzt sind. Er muss dringend für die Klausur am Montag lernen und spürt aufsteigende Frustration und Zeitdruck.",
    unwantedEmotion: "Frustration",
    options: [
      {
        strategy: "Situationsauswahl",
        description:
          "Rafäl geht nach Hause und lernt dort, obwohl er weiß, dass er sich dort schlecht konzentrieren kann.",
      },
      {
        strategy: "Situationsmodifikation",
        description:
          "Rafäl fragt an einem Gruppentisch, ob noch ein Platz frei ist, oder weicht in einen leeren Seminarraum aus.",
      },
      {
        strategy: "Aufmerksamkeitslenkung",
        description: "Rafäl holt sich erst mal einen Kaffee und versucht, sich zu beruhigen.",
      },
      {
        strategy: "Kognitive Veränderung",
        description:
          "Rafäl denkt: 'Volle Bibliothek bedeutet, dass viele fleißig sind — ich bin nicht allein mit dem Lernstress.'",
      },
      {
        strategy: "Reaktionsmodulation",
        description:
          "Rafäl unterdrückt seinen Ärger und stellt sich geduldig in die Warteschlange.",
      },
    ],
    correctAnswer: 1,
    explanation:
      "Situationsmodifikation ist hier am besten: Rafäls Problem ist konkret und lösbar — er braucht einen Lernplatz. Einen Platz zu finden oder einen Seminarraum zu nutzen löst das Problem direkt, statt die Emotion nur umzudeuten.",
    difficulty: 1,
  },
  {
    id: "er-19",
