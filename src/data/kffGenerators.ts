...
const WORD_POOL_MITTEL = [
  ...
  "PARASIT",
  "VITAMIN",
  // Zusammengesetzte med./wiss. Wörter (wie StudyMed/VMC-Niveau)
  "HERZKAMMER",
  "RIPPENFELL",
  "BLUTDRUCK",
  "TAUCHER",
...
const TRAINING_WF_WORDS: Record<1 | 2 | 3, string[]> = {
  1: [
    // 7-letter words — everyday German, Duden-standard (305 words)
    "FENSTER", "FLASCHE", "PFLICHT", "TROPFEN", "STEMPEL",
    "SCHRANK", "STIEFEL", "NAHRUNG", "BILDUNG", "KAPITEL",
    "STRUMPF", "KOLONNE", "KONTAKT", "GEDICHT", "KLOSTER",
    ...
    "STRECKE", "KNOCHEN", "SCHWERT", "KLINGEN", "SCHLUND",
    "SPINDEL", "SCHWUNG", "KRAPFEN", "WECHSEL", "VORGANG",
    "SPIELER", "LEUCHTE", "DREHUNG", "WIRKUNG", "MELDUNG",
    "HEILUNG", "HALTUNG", "LEITUNG", "NEIGUNG", "KREISEL",
    "PLUNDER", "SCHWAMM", "SCHRECK", "PFLANZE", "SCHMUTZ",
    "SPRUDEL", "SPROSSE", "ZWEIFEL", "KRIEGER", "STRIPPE",
    "FLUNDER", "SCHNAPS", "MERKMAL", "ZUSTAND", "ABSICHT",
    "ZAHNRAD", "SCHLEIM", "KNOEDEL", "STRUDEL", "EINSATZ",
    "ABSTURZ", "ZUKUNFT", "EINWURF", "ZUGRIFF", "UMBRUCH",
    "ABGRUND", "AUFTRAG", "EINTRAG", "ANTRIEB", "BETRIEB",
    "VERTRAG", "UMSTURZ", "ABSTIEG", "UMSTIEG", "VORFELD",
    "AUFRUHR", "ABSTAND", "EINWAND", "AUSWAHL", "BEIWERK",
    "EINGANG", "ABFAHRT", "ZUFAHRT", "ABBRUCH", "AUSWURF",
    "BEIFALL", "EINFALL", "VORWORT", "AUFSATZ", "LENKRAD",
    "AUSGANG", "UMFRAGE", "KLOPFER", "FLECKEN", "WARNUNG",
    "ORDNUNG", "ZEITUNG", "WERBUNG", "KLINGEL", "TRAUBEN",
    "PLAUSCH", "PRALINE", "KREMPEL", "BRISANT", "STROPHE",
    "SPENDER", "STREBEN", "SCHWARM", "SPINNEN", "BREMSEN",
    "KRUSTEN", "WANDELN", "ZAHLUNG", "GATTUNG", "KLAFTER",
    "BLINKER", "BRETZEL", "SCHMIED", "SCHWEIN", "PFOSTEN",
    "BLITZEN", "SCHMELZ", "SCHLITZ", "SCHNEID", "PFEIFEN",
    "KLEMMEN", "SPANGEN", "KREISEN", "BLENDEN", "SCHWEBE",
    "SCHRITT", "KLIRREN", "GLIEDER", "KLEIDER", "KNARREN",
    "KUERBIS", "DUENKEL", "PILGRIM", "SCHNELL", "SPREIZE",
    "SCHIPPE", "SCHNITT", "KNALLEN", "KLAPPEN", "FORMUNG",
    "LOESUNG", "FALTUNG", "IMPULSE", "NEULING", "PENDLER",
    "QUARTAL", "RUMPELN", "TRAMPEL", "UMSCHAU", "VORLAGE",
    "FELDWEG", "WALDSEE", "FRIEDEN", "GESTALT", "PLASTIK",
    "TREIBER", "SCHLEPP", "KURBELN", "PFROPFE", "SPITZEN",
    "BLICKEN", "KNEBELN", "HANDELN", "MUNDART", "ANFRAGE",
    "ATEMZUG", "BAUWERK", "BERGBAU", "BESTAND", "KLAVIER",
    "ERDBALL", "ERDTEIL", "FLIEDER", "HINWEIS", "KERAMIK",
    "GARDINE", "GESTEIN", "GEWINDE", "KOMPLEX", "SEGMENT",
    "EISLAUF", "FESTZUG", "AUSLAGE", "GEBIRGE", "KULISSE",
    "MATROSE", "METZGER", "MINERAL", "REIBUNG", "ROTWEIN",
    "KOLIBRI", "POLSTER", "PANTHER", "SCHMAUS", "PRAEMIE",
    "KABINEN", "PORTION", "DENKMAL", "RESPEKT", "ANBLICK",
    "EINHEIT", "SCHLUCK", "ECKBANK", "UMSTAND", "MUSCHEL",
    "OBSTLER", "VORLAUF", "ANKUNFT", "HOCHMUT", "FESTAKT",
    "BALKONE", "AUSFLUG", "ABFLUSS", "HOCHAMT", "KLAUSEL",
    "SCHOBER", "TURBINE", "VERKEHR", "WALDWEG", "INHABER",
    "NACHBAR", "CHRONIK", "AUSWEIS", "EICHUNG", "ANSPORN",
    "AUFLAGE", "DENKART", "EISWAND", "GEDANKE", "METHODE",
    "VIELECK", "SEILZUG", "ZEITNOT", "TUEMPEL", "BLEICHE",
    "SCHOPFE", "KLAMPFE", "THYMIAN", "ZUFLUSS", "ANSTOSS",
    "EINKAUF", "GELDNOT", "SCHERBE", "DREIECK", "BISCHOF",
    "ENDSIEG", "ANSTALT", "AUFGABE", "ROTWILD", "XYLOFON",
    "HAMSTER", "DELPHIN", "LEOPARD", "BRUECKE", "FISCHER",
    "DICHTER", "RICHTER", "MEISTER", "EMPFANG", "GIRAFFE",
    "PINGUIN", "ELEFANT", "VERBAND", "ROHLING", "BEILAGE",
    "NOTFALL", "BILDNIS", "SATZBAU", "OBERARM", "HEILBAD",
  ],
  2: [
    // 8-9 letter words — compound words, everyday German (300 words)
    "HANDWERK", "BAUSTEIN", "FAHRPLAN", "RATGEBER", "MAHLZEIT",
    "FREIHEIT", "FREIZEIT", "BEGABUNG", "WERKZEUG", "DACHBODEN",
    "HALSKETTE", "LANDKARTE", "TRINKGLAS", "WERKSTATT", "SPIELFELD",
    "BACKBLECH", "TURNHALLE", "KRISTALL", "SIEDLUNG", "HALBMOND",
    "RECHNUNG", "HANDLUNG", "STIFTUNG", "DICHTUNG", "LEISTUNG",
    "RICHTUNG", "NACHRICHT", "FAHRSTUHL", "BERGWERK", "FLUGBLATT",
    "GRUNDRISS", "KREUZUNG", "HANDSCHUH", "STOCKWERK", "RATSCHLAG",
    "SCHUBLADE", "DREHBUCH", "KIRCHTURM", "STIRNBAND", "BROTKORB",
    "LAUFSCHUH", "RUCKSACK", "DORFPLATZ", "WANDERUNG", "ERHOLUNG",
    "ZEICHNUNG", "WOHNSITZ", "HOLZBRETT", "FLUGHAFEN", "BUSFAHRT",
    "KAUFPREIS", "PFLASTER", "SCHAUFEL", "TROMPETE", "WERKBANK",
    "KLAPPRAD", "SCHNALLE", "SPLITTER", "SPIELZEUG", "NACHTRUHE",
    "ZEITGEIST", "WERKSTOFF", "SPIELPLAN", "KLEINGELD", "FARBSTOFF",
    "LICHTBAND", "KUNSTWERK", "BLICKFELD", "BAHNSTEIG", "GRUNDSATZ",
    "SPIELBALL", "BRENNHOLZ", "NACHTLUFT", "FAHRKARTE", "PLATTFORM",
    "SCHALTUNG", "KREUZWORT", "STEINMETZ", "DICHTRING", "LAUFSTALL",
    "GLASKUGEL", "NACHTISCH", "DICHTWERK", "GRUNDBUCH", "STEINKRUG",
    "BLATTGOLD", "SPIELDOSE", "KREISLAUF", "FELDSTEIN", "GRUNDKURS",
    "HOLZTAFEL", "SPIELHAUS", "GRUNDWORT", "SPIELGELD", "LICHTFELD",
    "SPIELWERK", "GRUNDFORM", "SPIELFILM", "GRUNDWERT", "FARBSTEIN",
    "NACHTWIND", "GRUNDZEIT", "HANDGRIFF", "SICHTFELD", "NACHTMAHL",
    "LICHTMAST", "SPIELKIND", "NACHTLIED", "GRUNDBAND", "HALSREIFE",
    "GRUNDLIED", "GRUNDTEIL", "LICHTBILD", "GRUNDFEST", "SPIELFEST",
    "LESEPROBE", "BLECHDOSE", "KALKSTEIN", "BLICKFANG", "SAEGEWERK",
    "SANDSTEIN", "BACKSTEIN", "DACHSTEIN", "ERDKRUSTE", "HALBKREIS",
    "INSCHRIFT", "ROHRSTOCK", "GOLDSTAUB", "VORMARSCH", "ZAUNPFAHL",
    "DACHSTUHL", "TURNSCHUH", "VORSCHLAG", "BRUSTKORB", "FRACHTGUT",
    "GOLDPREIS", "TRINKHORN", "ROHRBRUCH", "SALZLAGER", "STEINWAND",
    "GRENZLAND", "BAUMSTAMM", "VIEHSTALL", "WALDPFADE", "LAUBBLATT",
    "MARKTBUDE", "NACHTCLUB", "SALZSTEIN", "FILZSTIFT", "PACHTLAND",
    "REITPFERD", "GRUNDHOLZ", "SPIELHOLZ", "GRUNDBAUM", "SPIELBAUM",
    "GRUNDLAND", "SPIELLAND", "GRUNDHAIN", "SPIELHAIN", "GRUNDWAND",
    "SPIELWAND", "GRUNDDACH", "SPIELDACH", "GRUNDTURM", "SPIELTURM",
    "GRUNDSAUM", "SPIELSAUM", "GRUNDSTEG", "SPIELSTEG", "GRUNDSITZ",
    "SPIELSITZ", "GRUNDSTAB", "SPIELSTAB", "GRUNDKEIL", "SPIELKEIL",
    "GRUNDSPUR", "SPIELSPUR", "GRUNDMAST", "SPIELMAST", "GRUNDRING",
    "SPIELRING", "GRUNDSEIL", "SPIELSEIL", "GRUNDHALT", "SPIELHALT",
    "GRUNDTAKT", "SPIELTAKT", "GRUNDHERD", "SPIELHERD", "GRUNDBLEI",
    "SPIELBLEI", "GRUNDKORN", "SPIELKORN", "GRUNDNETZ", "SPIELNETZ",
    "GRUNDLOCH", "SPIELLOCH", "GRUNDROST", "SPIELROST", "ABENDROT",
    "BANKRAUB", "BERGLAND", "BLUTMOND", "DUDELSACK", "DURCHWAHL",
    "EISENBAHN", "FELSBLOCK", "FLUGPLATZ", "FLUSSBETT", "GELDMARKT",
    "GLASPERLE", "GRENZWERT", "GRUNDLAGE", "HALBINSEL", "HOERSPIEL",
    "HOLZKOHLE", "JAHRMARKT", "KIESGRUBE", "LAUBSAEGE", "LUSTSPIEL",
    "MARKTLAGE", "MILCHGLAS", "NACHTWERK", "PRACHTBAU", "REISEZIEL",
    "SPIELRAUM", "STANDZEIT", "STRAFGELD", "TAGESWERK", "ABENDWIND",
    "ZUGPFERDE", "WERKZEUGE", "FUNDGRUBE", "VERFAHREN", "DREHPUNKT",
    "BRENNWERT", "TRANSPORT", "FERNROHR", "KURZWELLE", "MAULKORB",
    "OBSTKORB", "LEINWAND", "BACKWAREN", "LICHTKERN", "WALDRANKE",
    "LAUFBAND", "SCHILDBAU", "GRABSTEIN", "MAULWURF", "BUCHSTABE",
    "ANSCHRIFT", "ABENDMAHL", "DORFTEICH", "TURMFALKE", "VIEHWEIDE",
    "ABSCHNITT", "VIEHZUCHT", "HALBSCHUH", "BERGFRIED", "DACHFIRST",
    "FLINTGLAS", "EISGROTTE", "INSELWELT", "DAMPFBADE", "BROETCHEN",
    "SCHMIEDE", "GELAENDE", "HOCHHAUS", "FLUGZEUG", "HOLZHAUS",
    "TAGEBUCH", "LAUFWERK", "SPIELART", "NACHTBUS", "POSTFACH",
    "WACHTURM", "SANDBURG", "LUFTPOST", "WINDPARK", "SALZWERK",
    "GRENZTURM", "HAUPTSITZ", "INSELBURG", "LICHTBURG", "ROSENDUFT",
    "SALZGRUBE", "VOGELFANG", "WALDKRAUT", "FELSWAND", "SCHALTER",
    "DORFKERN", "BERGKUPPE", "PARKBANK", "FALTBLATT", "TREIBHOLZ",
    "LEUCHTGAS", "HOLZSTUHL", "KALKGRUBE", "ERDMANTEL", "BIERDECKE",
  ],
  3: [
    // 10+ letter words — long compound words, everyday German (360 words)
    "GRUNDSTEIN", "FORTSCHRITT", "WIDERSTAND", "SICHERHEIT", "STANDPUNKT",
    "HANDARBEIT", "SCHLAGWORT", "SPRACHKURS", "WOHNGEBIET", "HAUPTFIGUR",
    "GESICHTSPUNKT", "BLICKWINKEL", "WINDSCHUTZ", "FLUGVERKEHR", "ERDGESCHOSS",
    "DRUCKSACHE", "BRUCHSTELLE", "LICHTSTRAHL", "SCHRIFTBILD", "GRUNDGESETZ",
    "BAUANLEITUNG", "LICHTQUELLE", "SCHALTKREIS", "FRUEHJAHRSPUTZ", "WANDERSCHUH",
    "GARTENZAUN", "TISCHDECKE", "BROTMESSER", "KLEIDERSCHRANK", "BLUMENSTRAUSS",
    "SONNENSCHIRM", "HANDTASCHE", "BRIEFMARKE", "KUGELSCHREIBER", "STRASSENBAHN",
    "SCHREIBTISCH", "GEBURTSTAG", "WOHNZIMMER", "SCHLAFZIMMER", "FRUEHSTUECK",
    "NACHMITTAG", "BUCHHANDLUNG", "WERKSTATTLEITER", "SCHWIMMBAD", "REGENSCHIRM",
    "STAUBSAUGER", "WASCHMITTEL", "PFLICHTBEWUSST", "SCHAUFENSTER", "MITTERNACHT",
    "LEUCHTTURM", "SCHILDERWALD", "STRUMPFHOSE", "KINDERGARTEN", "ROLLTREPPE",
    "DAMPFSCHIFF", "BRUNSTZEIT", "KABELROLLE", "BILDSCHIRM", "REIHENFOLGE",
    "GOLDSCHATZ", "STEINBRUCH", "WINDMUEHLE", "TAGESSCHAU", "BRIEFKASTEN",
    "WETTBEWERB", "SCHNEEBALL", "LANDSCHAFT", "WUNSCHKIND", "FLUGTICKET",
    "HERBSTWIND", "WORTSCHATZ", "NACHTSCHICHT", "TREPPENSTUFE", "FEUERWEHRMANN",
    "BRIEFTRAEGER", "HANDWERKSZEUG", "SCHLUESSELBLUME", "SCHORNSTEINFEGER", "FAHRRADSCHLOSS",
    "STREICHHOLZ", "WEIHNACHTSBAUM", "KINDERSPIELPLATZ", "OBSTGARTEN", "NACHTFALTER",
    "SPIELWIESE", "LANDSTREICHER", "STUNDENPLAN", "TASCHENBUCH", "WOLKENKRATZER",
    "TASCHENMESSER", "STROHBLUME", "SCHULFREUND", "HANDWERKER", "NACHTFROST",
    "DACHGESCHOSS", "ZEITSCHRIFT", "HANDTUCHHALTER", "FENSTERBRETT", "DRACHENFLIEGER",
    "SCHLUESSELBUND", "FEDERHALTER", "FARBKASTEN", "KLEIDERSTANGE", "FRACHTSCHIFF",
    "SCHRAUBSTOCK", "SCHNELLZUG", "LEUCHTSCHRIFT", "SPRACHSCHULE", "SCHLAGZEUG",
    "PFERDESPORT", "KUNSTHANDWERK", "TASCHENTUCH", "SPIELPLATZ", "TAGESORDNUNG",
    "ELTERNABEND", "BAHNHOFSTRASSE", "HAUSSCHLUESSEL", "GLUECKWUNSCH", "FEIERABEND",
    "KERZENLICHT", "BLUMENVASE", "DRUCKERPATRONE", "GLASSCHERBE", "STRANDKORB",
    "PLATTENSPIELER", "MORGENGRAUEN", "SCHREIBBLOCK", "BIENENSTOCK", "WANDTEPPICH",
    "NACHTKERZE", "BLUMENWIESE", "ZIEGELSTEIN", "WERKZEUGKISTE", "LICHTSCHALTER",
    "WANDERSCHAFT", "GLASSCHEIBE", "HANDSCHRIFT", "FEDERKISSEN", "SPRINGBRUNNEN",
    "FROSTSCHUTZ", "BLECHSCHMIED", "STRICKNADEL", "SCHLAGKRAFT", "FARBMISCHUNG",
    "KUPFERDRAHT", "LICHTERKETTE", "PFLASTERSTEIN", "KLANGFARBE", "FLICKENTEPPICH",
    "SCHRANKWAND", "BRIEFUMSCHLAG", "TUERKLINKE", "DACHGIEBEL", "FEUERSTELLE",
    "SANDSTRAND", "BERGSTEIGER", "STERNSCHNUPPE", "KIRCHENFENSTER", "LAUBHAUFEN",
    "MARKTPLATZ", "WINDRICHTUNG", "GARTENSCHERE", "KLEIDERHAKEN", "FAHRGESTELL",
    "TISCHLEUCHTE", "STACHELDRAHT", "MONDSCHEIN", "HOLZSCHNITT", "GLASMALEREI",
    "FLICKSCHUSTER", "DAMPFWALZE", "SCHNEIDERIN", "WANDMALEREI", "LAUFMASCHE",
    "KUPFERSTICH", "LEINENBAND", "SCHRAUBENDREHER", "NADELKISSEN", "WANDERRUCKSACK",
    "PFLANZENTOPF", "TASCHENLAMPE", "TROCKENBLUME", "SCHNEIDEBRETT", "FELSBROCKEN",
    "BERGLANDSCHAFT", "STEINMAUER", "KREISVERKEHR", "BRUNNENFIGUR", "DACHTERRASSE",
    "SEIDENBAND", "HAFENSTADT", "LEUCHTFEUER", "BLITZABLEITER", "KLANGSPIEL",
    "SCHORNSTEIN", "BLUMENKASTEN", "GARTENBANK", "TUERSCHLOSS", "FINGERSPITZE",
    "TREPPENHAUS", "KRISTALLGLAS", "BERNSTEINKETTE", "MONDFINSTERNIS", "STERNWARTE",
    "MARKTSTAND", "WALDLICHTUNG", "SCHIFFFAHRT", "GARTENLAUBE", "KLANGKOERPER",
    "HANDGELENK", "SCHNEEFLOCKE", "REGENTROPFEN", "FENSTERBANK", "HOLZBALKEN",
    "KIRCHENGLOCKE", "MORGENROETE", "BRUNNENRAND", "MARKIERUNG", "STRICKJACKE",
    "FENSTERLADEN", "DACHFENSTER", "KRONLEUCHTER", "STERNZEICHEN", "REGENRINNE",
    "GLASFENSTER", "DACHSPARREN", "STEINPLATTE", "DACHSCHINDEL", "KERZENSCHEIN",
    "LICHTSCHEIN", "SANDKASTEN", "HOLZSPLITTER", "FAHRRADKETTE", "STEINBODEN",
    "GARTENTEICH", "HOLZGELAENDER", "BLUMENERDE", "HOLZSCHEIT", "KIRCHTURMUHR",
    "SCHREIBFEDER", "WANDLEUCHTE", "GARTENARBEIT", "TUERSCHWELLE", "LICHTSCHUTZ",
    "WINDKRAFTANLAGE", "HANDELSPLATZ", "SCHREIBMASCHINE", "WERKZEUGKASTEN", "SCHNEESCHAUFEL",
    "KIRCHENORGEL", "MORGENSTUNDE", "HANDELSWARE", "NACHTSCHRANK", "BLUMENLADEN",
    "STEINTREPPE", "FENSTERSCHEIBE", "SONNENSCHUTZ", "BLUMENZWIEBEL", "HERBSTLAUB",
    "TISCHPLATTE", "FAHRRADHELM", "SCHUHKARTON", "LICHTKUPPEL", "GRUNDWASSER",
    "SPIELSTRASSE", "BERGSTATION", "DORFBRUNNEN", "HAUSORDNUNG", "POSTLEITZAHL",
    "SCHLAGBOHRER", "BRUNNENSTEIN", "LEUCHTMITTEL", "PFLANZKASTEN", "FAHRRADTOUR",
    "FENSTERGRIFF", "KIRCHENSTEUER", "HANDELSSCHIFF", "HANDWERKSKUNST", "PFLANZENSCHUTZ",
    "FAHRRADSTAENDER", "WANDERSCHUHE", "TREPPENGELAENDER", "FENSTERBAUER", "GARTENSPRENGER",
    "TUERKLOPFER", "LICHTSPEKTRUM", "DACHRINNENFALL", "BRUNNENPLATZ", "SPIELPLATZBAU",
    "KIRCHENFEST", "HANDELSROUTE", "LEUCHTTURMBAU", "WANDERPFADE", "FENSTERRAHMEN",
    "GARTENHECKE", "HOLZSCHUPPEN", "BRUNNENRING", "KIRCHENPORTAL", "LICHTGESTALT",
    "GARTENPARTIE", "FENSTERPUTZER", "STEINSCHLEUDER", "ABENTEUERFILM", "BLEISTIFTMINE",
    "BUCHSTABENFOLGE", "DACHBODENLUKE", "DACHBODENFUND", "DAMPFMASCHINE", "DORFBEWOHNER",
    "EINKAUFSLISTE", "FENSTERKREUZ", "GARTENMOEBEL", "GELDAUTOMAT", "GLASBAUSTEINE",
    "HANDELSPARTNER", "HOLZBEARBEITUNG", "HUNDERTSCHAFT", "KIRCHTURMSPITZE", "KOPFSTEINPFLASTER",
    "KRISTALLKUGEL", "LANDSCHAFTSBILD", "MITTAGSPAUSE", "NADELHOLZWALD", "OBSTBAUMSCHNITT",
    "PARKETTBODEN", "REGENMANTEL", "SCHLITTSCHUH", "SCHMUCKKASTEN", "SCHUTZSCHIRM",
    "SEIDENSTRUMPF", "SPIRALBLOCK", "STOFFHANDSCHUH", "STURMLATERNE", "TAFELSILBER",
    "TASCHENRECHNER", "TREPPENWITZ", "VOGELSCHEUCHE", "WASSERLEITUNG", "WEIHNACHTSKARTE",
    "ZEITUNGSARTIKEL", "ZUCKERDOSE", "SCHREIBTISCHLAMPE", "SCHWIMMFLOSSEN", "SONNENBRILLEN",
    "HOLZKNECHT", "KUPFERMINE", "NACHTSCHATTEN", "BLUMENGARTEN", "FAHRRADPUMPE",
    "KIRCHENSTUHL", "MITTAGSSCHLAF", "PFLANZENWELT", "TASCHENDIEB", "VOGELSTIMME",
    "WEIHNACHTSMARKT", "ZEITUNGSKIOSK", "FAHRRADLAMPE", "GARTENPFLEGE", "BAUMSCHNEIDEN",
  ],
};
