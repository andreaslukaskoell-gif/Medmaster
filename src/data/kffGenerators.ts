...
const TRAINING_WF_WORDS: Record<1 | 2 | 3, string[]> = {
  1: [
    ...
    "SCHWALB", "BLINKER", "KLAFTER", "SPINWEB", "SPINDEL",
    "SCHLEIF", "SCHWUNG", "KRAPFEN", "BRETZEL", "HANDELN",
    "WECHSEL", "VORGANG", "SPIELER", "SCHIESS", "SCHLUCK",
    "TRAMPEN", "KNIPSER", "SPRECHE", "PFLEGEN", "SCHWEIN",
    "SCHMIED", "KURBELN", "BRATPFN", "SCHOBER", "SCHIPPE",
    "KLEMPNE", "KNUEPFE", "LEUCHTE", "DREHUNG", "WIRKUNG",
    "MELDUNG", "HEILUNG", "HALTUNG", "FORMUNG", "LEITUNG",
    "NEIGUNG", "KOEPFIG", "KREISEL", "PLUNDER", "KUMPANE",
    ...
    "FLUNDER", "DUENKEL", "PILGRIM", "SCHNELL", "GLOCKEL",
    "SCHNAPS", "BLINDER", "DREIFAC", "KLAGERL", "MISCHEL",
    "SCHLAFE", "SCHWUND", "KOENIGS", "KRIECHD", "SCHIERL",
    "KLINKER", "PLEURIT", "BLITZIG", "SCHNEID", "WANDELN",
    "BLECHRE", "KREUZWG", "SCHNAPF", "TRACHTE", "MERKMAL",
    "ZUSTAND", "UMSTAND", "ABSICHT", "AUSGANG", "KUNDIGE",
    "UMFRAGE", "BUECHER", "ZAHNRAD", "SCHLEIM", "SCHEMEN",
    "HUEPFER", "KNUEPFL", "SCHREIB", "SCHWARZ", "BLITZEN",
    "KESSLER", "SCHNUER", "PFLUECK", "BREMSEN", "SCHREIT",
    "KRUSTEN", "SPITZEL", "GLETSCK", "KNOEDEL", "SCHALER",
    "DRECKIG", "PLUMPER", "BLECHIG", "KLIRREN", "STROPHE",
    "SPENDER", "GLIEDER", "KLEIDER", "SPREITE", "BLICKEN",
    "BRAUCHT", "KNEIFEN", "SCHLEPP", "PFEIFEN", "KREMPLE",
    "STRUDEL", "KNARREN", "BLUTARM", "SCHWING", "KLEMMEN",
    "SPREIZE", "STREBEN", "SCHRILL", "SCHWARM", "SPANGEN",
    "BROSAME", "KNIRSCK", "PFLANZT", "BLASERT", "KLEIDEN",
    "BRUECHE", "SCHNITT", "ZUFLUSS", "SCHWACH", "KREISEN",
    "PLAUSCH", "AMEISEN", "PRALINE", "FREUNDE", "SCHOPFE",
    "KLOPFER", "BLENDEN", "KNULLER", "SCHWEBE", "KUECHEL",
    "SPITZEN", "KNARZER", "PECHVGL", "SCHRITT", "SPINNEN",
    "FLECKEN", "BRUNFTL", "DREMPEL", "KLUEGEL", "LENKRAD",
    "ABFLUSS", "UMGRIFF", "EINSATZ", "HOCHAMT", "ANBAUER",
    "ABSTURZ", "ZUKUNFT", "EINWURF", "VORWERK", "ZUGRIFF",
    "UMBRUCH", "ENDSIEL", "GRUNDIG", "VORRANG", "ABGRUND",
    "AUFTRAG", "EINTRAG", "VORLAUF", "UMGANGS", "EINZAHL",
    "UMBRISE", "ZIELORT", "ANTRIEB", "BETRIEB", "VERTRAG",
    "UMSTURZ", "ANKTURM", "BEGRENZ", "ABSTIEG", "AUFSTEG",
    "EINSTEG", "UMSTIEG", "VORFELD", "ABSTEIG", "UMFANGS",
    "EINFLUS", "AUFRUHR", "UMWELTS", "ZUFLUCH", "ABSTAND",
    "VORBAND", "EINWAND", "AUSWAHL", "BEIWERK", "ZULETZT",
    "EINGANG", "ABFAHRT", "ZUFAHRT", "UMFANGT", "EINSITZ",
    "VORSTUP", "ABBRUCH", "ZUBRUCH", "AUSWURF", "AUFZUGS",
    "ABSATZE", "BEIFALL", "EINFALL", "VORWORT", "ABWARTS",
    "AUFSATZ", "ANSPRUC", "EINZUGS", "ABGANGS", "SENDUNG",
    "BINDUNG", "WANDUHR",
  ],
  2: [
    "STREIFEN", "KLETTERN", "GRASLAND", "AUSDRUCK", "BEISPIEL",
    "WACHSTUM", "PFUSCHER", "MITGLIED", "MEHRZAHL", "HANDWERK",
    "BAUSTEIN", "FAHRPLAN", "RATGEBER", "MAHLZEIT", "FREIHEIT",
    "FREIZEIT", "BEGABUNG", "WERKZEUG", "DACHBODEN", "HALSKETTE",
    "LANDKARTE", "TRINKGLAS", "WERKSTATT", "SPIELFELD", "BACKBLECH",
    "TURNHALLE", "KRISTALL", "SIEDLUNG", "HALBMOND", "RECHNUNG",
    "HANDLUNG", "STIFTUNG", "DICHTUNG", "LEISTUNG", "RICHTUNG",
    "NACHRICHT", "FAHRSTUHL", "BERGWERK", "FLUGBLATT", "GRUNDRISS",
    "KREUZUNG", "HANDSCHUH", "STOCKWERK", "RATSCHLAG", "SCHUBLADE",
    "DREHBUCH", "KIRCHTURM", "STIRNBAND", "BROTKORB", "LAUFSCHUH",
    "RUCKSACK", "DORFPLATZ", "WANDERUNG", "ERHOLUNG", "ZEICHNUNG",
    "WOHNSITZ", "HOLZBRETT", "FLUGHAFEN", "BUSFAHRT", "KAUFPREIS",
    "PFLASTER", "SCHAUFEL", "TROMPETE", "WERKBANK", "KLAPPRAD",
    "SCHNALLE", "SPLITTER", "DARSTELL", "LOCHBAND", "SCHILDERN",
    "WERKZEUGE", "SICHTBAR", "HANDGRIFF", "BAUKLOTZE", "KLARLICHT",
    ...
    "BRENNHOLZ", "NACHTLUFT", "FAHRKARTE", "LOCHSTEIN", "SCHILDBAU",
    "BAUKUNSTW", "SPIELTAGE", "LICHTFLUT", "GRUNDZAHL", "SCHILDFES",
    "BAUDENKMA", "KUNSTLICH", "SPIELORTS", "HANDARBEI", "NACHTWIND",
    "PLATTFORM", "SCHALTUNG", "KREUZWORT", "HOLZWURMS", "SCHILDMAI",
    "GRUNDSTEL", "LICHTTURM", "BLICKFANG", "STANDUHRS", "SCHILDWAL",
    "ZEITPLANS", "NACHTWACH", "GRUNDFORM", "SCHALTJHR", "STEINMETZ",
    "DICHTRING", "LAUFSTALL", "GLASKUGEL", "NACHTISCH", "DICHTWERK",
    "FELDSTEIG", "GRUNDZUGS", "SCHILFMEI", "NACHTLAGE", "SPIELRAUS",
    "LICHTFEST", "GRUNDWERT", "NACHTMAHL", "STANDLOCH", "GRUNDBUCH",
    "STEINKRUG", "SPIELWELT", "BLATTGOLD", "SCHILDEIN", "GRUNDHOLZ",
    "GRUNDLAST", "SCHILDBLD", "SPIELDOSE", "SCHILDTUR", "LICHTMAST",
    "GRUNDSTCK", "NACHTRUHS", "BRUNNENKR", "SCHILDPLT", "SPIELKIND",
    "SCHILDHEI", "LICHTSCHF", "WALDPFADE", "FROSTBILD", "DAMPFBADE",
    "SCHLAGKRF", "NACHTLIED", "STANDTIER", "SPIELFILM", "GRUNDRECH",
    "SCHILDLEU", "FELDSTEIN", "GRUNDKURS", "LICHTSPAN", "SPIELWEIS",
    "HOLZTAFEL", "SCHILDGRP", "GRUNDLEHR", "SCHILDFLD", "LICHTKRAN",
    "SPIELTIER", "SCHILDHAU", "GRUNDWERK", "LICHTTAFL", "SCHILDBER",
    "SPIELHAUS", "HALSREIFE", "GRUNDLIED", "SCHILDECK", "LICHTROHM",
    "GRUNDWORT", "SCHILDWEG", "LICHTSEIL", "SPIELGELD", "GRUNDZEIT",
    "SCHILDORT", "LICHTFELD", "GRUNDBAND", "SPIELWERK", "SCHILDTON",
    "LICHTKRAF", "GRUNDSTEG", "LICHTFORM", "SPIELFEST", "GRUNDBILD",
    "LICHTWERK", "SCHILDGRD", "GRUNDFEST", "LICHTBILD", "FARBSTEIN",
    "GRUNDFLUR", "SPIELPARK", "SCHALTBLD", "GRUNDPARK", "SPIELSCHF",
    "GRUNDROST", "SPIELROST", "GRUNDLAND", "SPIELLAND", "GRUNDFELD",
    "GRUNDBAUM", "SPIELBAUM", "GRUNDHAIN", "SPIELHAIN", "GRUNDWAND",
    "SPIELWAND", "GRUNDDACH", "SPIELDACH", "GRUNDTURM", "SPIELTURM",
    "GRUNDHALT", "SPIELHALT", "GRUNDSEIL", "SPIELSEIL", "GRUNDTAKT",
    "SPIELTAKT", "GRUNDBLCK", "SPIELBLCK", "GRUNDSITZ", "SPIELSITZ",
    "GRUNDPFAD", "SPIELPFAD", "GRUNDMAST", "SPIELMAST", "GRUNDRING",
    "SPIELRING", "GRUNDSPUR", "SPIELSPUR", "GRUNDKEIL", "SPIELKEIL",
    "GRUNDSTAB", "SPIELSTAB", "GRUNDSPAN", "GRUNDTEIL", "SPIELTEIL",
    "GRUNDSAUM", "SPIELSAUM", "GRUNDNETZ", "SPIELNETZ", "GRUNDLOCH",
    "SPIELLOCH", "SPIELSTEG", "GRUNDHERD", "SPIELHERD", "GRUNDBLEI",
    "SPIELBLEI", "GRUNDKORN", "SPIELKORN", "FUNDGRUBE", "TRANSPORT",
    "GRENZWERT", "DACHRINNE", "BLECHDOSE", "WALDBODEN", "FINGERHUT",
    "FLUSSBETT", "STECKDOSE", "WOLLDECKE", "BRUSTBILD", "BAUERNHOF",
    "KOCHBUCH", "NADELWALD", "BERNSTEIN", "DACHSTUHL", "GRABSTEIN",
    "STRANDGUT", "FALTBLATT", "BLEISTIFT", "HOLZFIGUR", "BERGFRIED",
    "SONNENUHR",
  ],
  3: [
    "SCHILFGRAS", "SCHILDWAND", "MUNDSCHUTZ", "SCHAFWOLLE", "GRUNDSTEIN",
    "FORTSCHRITT", "WIDERSTAND", "SICHERHEIT", "STANDPUNKT", "HANDARBEIT",
    "SCHLAGWORT", "SPRACHKURS", "WOHNGEBIET", "HAUPTFIGUR", "GESICHTSPUNKT",
    "BLICKWINKEL", "WINDSCHUTZ", "FLUGVERKEHR", "ERDGESCHOSS", "DRUCKSACHE",
    "BRUCHSTELLE", "LICHTSTRAHL", "SCHRIFTBILD", "GRUNDGESETZ", "BAUANLEITUNG",
    "LICHTQUELLE", "SCHALTKREIS", "FRUEHJAHRSPUTZ", "WANDERSCHUH", "GARTENZAUN",
    "TISCHDECKE", "BROTMESSER", "KLEIDERSCHRANK", "BLUMENSTRAUSS", "SONNENSCHIRM",
    "HANDTASCHE", "BRIEFMARKE", "KUGELSCHREIBER", "STRASSENBAHN", "SCHREIBTISCH",
    "GEBURTSTAG", "WOHNZIMMER", "SCHLAFZIMMER", "FRUEHSTUECK", "NACHMITTAG",
    "BUCHHANDLUNG", "WERKSTATTLEITER", "SCHWIMMBAD", "REGENSCHIRM", "STAUBSAUGER",
    "WASCHMITTEL", "PFLICHTBEWUSST", "SCHAUFENSTER", "MITTERNACHT", "LEUCHTTURM",
    "SCHILDERWALD", "STRUMPFHOSE", "KINDERGARTEN", "ROLLTREPPE", "DAMPFSCHIFF",
    "BRUNSTZEIT", "KABELROLLE", "BILDSCHIRM", "REIHENFOLGE", "GOLDSCHATZ",
    "STEINBRUCH", "WINDMUEHLE", "TAGESSCHAU", "BRIEFKASTEN", "WETTBEWERB",
    "SCHNEEBALL", "LANDSCHAFT", "GRUNDLAGEN", "SPIELRAUMS", "VERFAHRENS",
    "BRENNWERTS", "DREHPUNKTS", "WUNSCHKIND", "FLUGTICKET", "HERBSTWIND",
    "WORTSCHATZ", "NACHTSCHICHT", "TREPPENSTUFE", "FEUERWEHRMANN", "BRIEFTRAEGER",
    "HANDWERKSZEUG", "SCHLUESSELBLUME", "SCHORNSTEINFEGER", "FAHRRADSCHLOSS", "STREICHHOLZ",
    "WEIHNACHTSBAUM", "KINDERSPIELPLATZ", "OBSTGARTEN", "NACHTFALTER", "SPIELWIESE",
    "LANDSTREICHER", "STUNDENPLAN", "TASCHENBUCH", "WOLKENKRATZER", "TASCHENMESSER",
    "STROHBLUME", "SCHULFREUND", "HANDWERKER", "NACHTFROST", "DACHGESCHOSS",
    "ZEITSCHRIFT", "HANDTUCHHALTER", "FENSTERBRETT", "DRACHENFLIEGER", "SCHLUESSELBUND",
    "FEDERHALTER", "FARBKASTEN", "KLEIDERSTANGE", "FRACHTSCHIFF", "BERNSTEINFARBE",
    "SCHRAUBSTOCK", "SCHNELLZUG", "WINDMUEHLEN", "LEUCHTSCHRIFT", "SPRACHSCHULE",
    "SCHLAGZEUG", "PFERDESPORT", "KUNSTHANDWERK", "TASCHENTUCH", "SPIELPLATZ",
    "TAGESORDNUNG", "ELTERNABEND", "BAHNHOFSTRASSE", "HAUSSCHLUESSEL", "GLUECKWUNSCH",
    "FEIERABEND", "KERZENLICHT", "BLUMENVASE", "FAHRSTUHLSCHACHT", "DRUCKERPATRONE",
    "GLASSCHERBE", "STRANDKORB", "PLATTENSPIELER", "MORGENGRAUEN", "SCHREIBBLOCK",
    "BIENENSTOCK", "WANDTEPPICH", "NACHTKERZE", "BLUMENWIESE", "BREITSCHULTER",
    "ZIEGELSTEIN", "WERKZEUGKISTE", "LICHTSCHALTER", "WANDERSCHAFT", "GLASSCHEIBE",
    "HANDSCHRIFT", "FEDERKISSEN", "SPRINGBRUNNEN", "FROSTSCHUTZ", "BLATTSCHNEIDER",
    "BLECHSCHMIED", "STRICKNADEL", "SCHLAGKRAFT", "FARBMISCHUNG", "BRENNHOLZSTAPEL",
    ...
    "MARKTPLATZ", "WINDRICHTUNG", "HERBSTLAUB", "GARTENSCHERE", "KLEIDERHAKEN",
    "HAEKELNADEL", "FELSGESTEIN", "FAHRGESTELL", "TISCHLEUCHTE", "STACHELDRAHT",
    "MONDSCHEIN", "HOLZSCHNITT", "GLASMALEREI", "KREUZSTICKE", "FLICKSCHUSTER",
    "DAMPFWALZE", "SCHNEIDERIN", "WANDMALEREI", "LAUFMASCHE", "BLATTGOLDRAHMEN",
    ...
    "BERGLANDSCHAFT", "HERBSTFEST", "STEINMAUER", "KREISVERKEHR", "BRUNNENFIGUR",
    "DACHTERRASSE", "SEIDENBAND", "HAFENSTADT", "KUNSTBLUMEN", "LEUCHTFEUER",
    "BLITZABLEITER", "KLANGSPIEL", "SCHORNSTEIN", "BLUMENKASTEN", "GARTENBANK",
    "STRASSENLAMP", "TUERSCHLOSS", "FINGERSPITZE", "TREPPENHAUS", "KRISTALLGLAS",
    "BERNSTEINKETTE", "MONDFINSTERNIS", "STERNWARTE", "MARKTSTAND", "WALDLICHTUNG",
    "SCHIFFFAHRT", "FLUGPLATZTURM", "GARTENLAUBE", "STEINBRUCKE", "FAHRRADWEG",
    "DORFSTRASSE", "KLANGKOERPER", "HANDGELENK", "WORTSTELLUNG", "SPIELKARTEN",
    "LICHTBOGEN", "SCHNEEFLOCKE", "REGENTROPFEN", "FENSTERBANK", "HOLZBALKEN",
    "KIRCHENGLOCKE", "MORGENROETE", "BRUNNENRAND", "WALDSTUECK", "MARKIERUNG",
    "KLEIDUNGSSTUECK", "STRICKJACKE", "FENSTERLADEN", "KLEIDERSACK", "PFLANZGEFAESS",
    "BRUNNENWASSER", "HEIZKOERPER", "BRENNPUNKT", "STUECKZAHL", "DACHFENSTER",
    "KRONLEUCHTER", "STERNZEICHEN", "BROTSCHNEIDEMASCHINE", "FUSSBODENVASE", "REGENRINNE",
    "GLASFENSTER", "DACHSPARREN", "HANDTUCHRING", "STEINPLATTE", "DACHSCHINDEL",
    "KERZENSCHEIN", "HANDSCHUHE", "LICHTSCHEIN", "SANDKASTEN", "HOLZSPLITTER",
    "STECKNADELKOPF", "FAHRRADKETTE", "STEINBODEN", "GARTENTEICH", "FENSTERGLAS",
    "BLUMENERDE", "HOLZSCHEIT", "KIRCHTURMUHR", "SCHREIBFEDER", "WANDLEUCHTE",
    "KLANGKOERP", "DACHZIEGELST", "GARTENARBEIT", "TUERSCHWELLE", "LICHTSCHUTZ",
    "WINDKRAFTANLAGE", "HANDELSPLATZ", "PFLICHTGEFUEHL", "SCHREIBMASCHINE", "WERKZEUGKASTEN",
    "SCHNEESCHAUFEL", "KIRCHENORGEL", "BRUNNENPLATZ", "STEINBILDHAUER", "FAHRPLANWECHSEL",
    "MORGENSTUNDE", "HANDELSWARE", "KLEIDERSTUECK", "SCHREIBHEFT", "NACHTSCHRANK",
    "DACHGIEBELFENSTER", "BLUMENLADEN", "STEINTREPPE", "GARTENHANDSCHUH", "HOLZBEARBEITUNG",
    "KIRCHENTURMUHR", "FENSTERSCHEIBE", "DACHGESCHOSSRAUM", "SONNENSCHUTZ", "MORGENSPAZIERGANG",
