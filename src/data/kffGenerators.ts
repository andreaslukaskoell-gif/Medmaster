...
const TRAINING_WF_WORDS: Record<1 | 2 | 3, string[]> = {
  1: [
    ...
    "RECHNER", "SCHLOSS", "TRAKTOR", "KOERPER", "PFLASTER",
    "SCHMUCK", "BRUNNEN", "VORHANG", "TEPPICH", "BRANCHE",
    "DAMPFER", "KNORPEL", "BALLADE", "WACHTEL", "FESTUNG",
    "DRACHEN", "LEITFADEN", "KNACKER", "SPLITTER", "PFLEGER",
    "GLOCKEN", "SCHAUFEL", "TROMPETE", "KARTOFFEL", "LATERNE",
    "STURMFLUT", "WERKBANK", "SCHARNIER", "KLAPPRAD", "SCHNALLE",
  ],
  2: [
    // 8-9 letter words — compound words, everyday German
    "HANDWERK", "ERDBEERE", "BAUSTEIN", "FAHRPLAN", "RATGEBER",
    ...
    "BROTKORB", "LAUFSCHUH", "RUCKSACK", "BRUNSTZEIT", "DORFPLATZ",
    "KABELROLLE", "WANDERUNG", "ERHOLUNG", "SENDUNG", "BINDUNG",
    "ZEICHNUNG", "WOHNSITZ", "BILDSCHIRM", "REIHENFOLGE", "GOLDSCHATZ",
    "STEINBRUCH", "HOLZBRETT", "WINDMUEHLE", "FLUGHAFEN", "TAGESSCHAU",
    "BRIEFKASTEN", "BUSFAHRT", "KAUFPREIS", "WETTBEWERB", "SCHNEEBALL",
  ],
  3: [
    // 10+ letter words — long compound words, everyday German
    "GRUNDSTEIN", "FORTSCHRITT", "WIDERSTAND", "FUNDAMENT",
    "GRUNDLAGE", "LANDSCHAFT", "TRANSPORT", "SICHERHEIT",
    "STANDPUNKT", "HANDARBEIT", "SPIELRAUM", "VERFAHREN",
    "SCHLAGWORT", "SPRACHKURS", "WOHNGEBIET", "HAUPTFIGUR",
    "DREHPUNKT", "BRENNWERT", "GESICHTSPUNKT", "BLICKWINKEL",
