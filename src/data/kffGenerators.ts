 ...
 * Difficulty 1: 5–6 Buchstaben, Difficulty 2: 7–8 Buchstaben, Difficulty 3: 9+ Buchstaben. */
const TRAINING_WF_WORDS: Record<1 | 2 | 3, string[]> = {
  1: [
    // 5-letter words — clear, common German words
    "MILCH",
    "LAMPE",
    "STUHL",
    "TISCH",
  ...
  2: [
    ...
    "SUBSTANZ",
    "KONTAKT",
    // 8-letter words — common letter combos that could form multiple near-words
    "DIAGNOSE",
    "THERAPIE",
    "ANATOMIE",
    "HANDWERK",
