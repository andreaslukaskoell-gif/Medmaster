...
export const flashcardDecks: Record<string, Flashcard[]> = {
  "bio-zellbiologie": [
    ...
    { id: "fc-bio-3", front: "Nenne die Phasen der Mitose (PMAT).", back: "1. Prophase: Chromatin kondensiert\n2. Metaphase: Chromosomen in Aequatorialebene\n3. Anaphase: Chromatiden zu den Polen\n4. Telophase: Kernhüllen neu, Dekondensation", category: "bio", topic: "Zellbiologie", difficulty: "leicht" },
    { id: "fc-bio-4", front: "Was besagt die Endosymbiontentheorie?", back: "Mitochondrien und Chloroplasten stammen von aufgenommenen Prokaryoten ab. Belege: eigene 70S-Ribosomen, Doppelmembran, eigene ringfoermige DNA.", category: "bio", topic: "Zellbiologie", difficulty: "mittel" },
    { id: "fc-bio-5", front: "Welche Funktion hat der Golgi-Apparat?", back: "Sortierung, Modifikation und Verpackung von Proteinen. Cis-Seite empfaengt vom ER, Trans-Seite versendet in Vesikel.", category: "bio", topic: "Zellbiologie", difficulty: "leicht" },
  ...
  "bio-genetik": [
    ...
    { id: "fc-bio-g3", front: "Was sind die Stopp-Codons?", back: "UAA, UAG, UGA — Fuer sie gibt es keine passende tRNA → Termination der Translation.", category: "bio", topic: "Genetik", difficulty: "mittel" },
    { id: "fc-bio-g4", front: "Mendel: Spaltungsregel (F2)?", back: "In F2 spalten sich Merkmale:\n- Phaenotypisch: 3:1 (dominant:rezessiv)\n- Genotypisch: 1:2:1 (AA:Aa:aa)", category: "bio", topic: "Genetik", difficulty: "leicht" },
  ...
  "bio-humanbiologie": [
    ...
    { id: "fc-bio-h2", front: "Erregungsleitung des Herzens?", back: "Sinusknoten (Schrittmacher, ~70/min) → AV-Knoten (Verzoegerung) → His-Bündel → Tawara-Schenkel → Purkinje-Fasern", category: "bio", topic: "Herz-Kreislauf", difficulty: "mittel" },
    ...
    { id: "fc-bio-h4", front: "IgG vs IgM Antikörper?", back: "IgG: häufigster Ak, Sekundärantwort, plazentagaengig\nIgM: Erstantwort, größter Ak (Pentamer), nicht plazentagaengig", category: "bio", topic: "Immunsystem", difficulty: "schwer" },
  ...
  "chemie-bindungen": [
    { id: "fc-ch-b1", front: "Ionenbindung vs Kovalente Bindung?", back: "Ionenbindung: Metall + Nichtmetall, EN-Diff > 1,7, Elektronenuebertragung\nKovalent: Nichtmetall + Nichtmetall, EN-Diff < 1,7, geteilte Elektronenpaare", category: "chemie", topic: "Bindungen", difficulty: "leicht" },
    { id: "fc-ch-b2", front: "Wasserstoffbrückenbindung?", back: "H gebunden an F, O oder N\nStärkste zwischenmolekulare Kraft\nErklaert: hoher Sdp. von H₂O, Dichteanomalie, DNA-Basenpaarung", category: "chemie", topic: "Bindungen", difficulty: "mittel" },
