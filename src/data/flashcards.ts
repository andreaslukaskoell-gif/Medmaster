...
const baseDecks: Record<string, Flashcard[]> = {
  ...
  "mathe-geometrie": [
    ...
    { id: "fc-ma-g2", front: "Kreis: Fläche und Umfang?", back: "Fläche: A = π × r²\nUmfang: U = 2π × r = π × d\nKreißektor: A = α/360 × πr²", category: "mathe", topic: "Geometrie", difficulty: "leicht" },
