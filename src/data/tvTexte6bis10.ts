...
Stammzellen werden nach ihrem Differenzierungspotenzial klassifiziert. Totipotente Zellen – wie die befruchtete Eizelle und die ersten Teilungsprodukte – können einen vollständigen Organismus einschließlich extraembryonaler Gewebe bilden. Pluripotente Stammzellen können sich in alle Zelltypen der drei Keimblätter differenzieren, jedoch nicht in extraembryonales Gewebe. Embryonale Stammzellen (ES-Zellen), gewonnen aus der inneren Zellmasse der Blastozyste, sind das klassische Beispiel für pluripotente Zellen. Multipotente Stammzellen besitzen ein eingeschränkteres Differenzierungspotenzial – hämatopoetische Stammzellen im Knochenmark beispielsweise können alle Blutzelltypen bilden, aber keine Neuronen oder Muskelzellen.
