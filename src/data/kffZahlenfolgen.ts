export type ZahlenfolgenPattern =
  | "simple"
  | "zweiersprung"
  | "dreiersprung"
  | "vierersprung"
...
export const zahlenfolgenTasks: ZahlenfolgenTask[] = [
  ...
  // Sequence: 3, 7, 11, 15, 19, 23, 27, 31
  {
    ...
    pattern: "simple",
    explanation:
      "Konstante Differenz +4: 3, 7, 11, 15, 19, 23, 27, 31. Jede Zahl ist um 4 größer als die vorherige.",
    difficulty: 1,
    hints: [
  ...
  // Sequence: 2, 8, 14, 20, 26, 32, 38, 44
  {
    ...
    pattern: "simple",
    explanation:
      "Konstante Differenz +6: 2, 8, 14, 20, 26, 32, 38, 44. Jede Zahl ist um 6 größer als die vorherige.",
    difficulty: 1,
    hints: [
      "Mustertyp: Einfache arithmetische Folge",
  ...
  // Sequence: 50, 45, 40, 35, 30, 25, 20, 15
  {
    ...
    pattern: "simple",
    explanation:
      "Konstante Differenz -5: 50, 45, 40, 35, 30, 25, 20, 15. Jede Zahl ist um 5 kleiner als die vorherige.",
    difficulty: 1,
    hints: [
  ...
  // Sequence: 1, 2, 4, 7, 11, 16, 22, 29
  {
    ...
    pattern: "simple",
    explanation:
      "Steigende Differenz +1, +2, +3, +4, +5, +6, +7: Die Differenz wächst bei jedem Schritt um 1.",
    difficulty: 1,
    hints: [
  ...
  // Sequence: 3, 6, 12, 24, 48, 96, 192, 384
  {
    ...
    pattern: "simple",
    explanation:
      "Geometrische Folge ×2: 3, 6, 12, 24, 48, 96, 192, 384. Jede Zahl ist das Doppelte der vorherigen.",
    difficulty: 1,
    hints: [
  ...
  // Sequence: 5, 12, 19, 26, 33, 40, 47, 54
  {
    ...
    pattern: "simple",
    explanation:
      "Konstante Differenz +7: 5, 12, 19, 26, 33, 40, 47, 54. Jede Zahl ist um 7 größer als die vorherige.",
    difficulty: 1,
    hints: [
      "Mustertyp: Einfache arithmetische Folge",
  ...
  // Sequence: 2, 6, 18, 54, 162, 486, 1458, 4374
  {
    ...
    pattern: "simple",
    explanation:
      "Geometrische Folge ×3: 2, 6, 18, 54, 162, 486, 1458, 4374. Jede Zahl ist das Dreifache der vorherigen.",
    difficulty: 1,
    hints: [
      "Mustertyp: Geometrische Folge",
  ...
  // Sequence: 1, 3, 7, 13, 21, 31, 43, 57
  {
    ...
    pattern: "simple",
    explanation:
      "Steigende Differenz +2, +4, +6, +8, +10, +12, +14: Die Differenz steigt jeweils um 2.",
    difficulty: 1,
    hints: [
      "Mustertyp: Steigende Differenz",
  ...
  // Sequence: 40, 37, 34, 31, 28, 25, 22, 19
  {
    ...
    pattern: "simple",
    explanation:
      "Konstante Differenz -3: 40, 37, 34, 31, 28, 25, 22, 19. Jede Zahl ist um 3 kleiner als die vorherige.",
    difficulty: 1,
    hints: [
      "Mustertyp: Einfache arithmetische Folge (absteigend)",
  ...
  // Sequence: 4, 13, 22, 31, 40, 49, 58, 67
  {
    ...
    pattern: "simple",
    explanation:
      "Konstante Differenz +9: 4, 13, 22, 31, 40, 49, 58, 67. Jede Zahl ist um 9 größer als die vorherige.",
    difficulty: 1,
    hints: [
      "Mustertyp: Einfache arithmetische Folge",
  ...
  // Odd  (1,3,5,7): 5, 10, 15, 20 (+5)
  {
    ...
    explanation:
      "Zweiersprung: Gerade Positionen (2, 5, 8, 11) steigen um +3. Ungerade Positionen (5, 10, 15, 20) steigen um +5.",
    difficulty: 1,
    hints: [
  ...
  // Odd  (1,3,5,7): 10, 20, 30, 40 (+10)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (1, 5, 9, 13) steigen um +4. Ungerade Positionen (10, 20, 30, 40) steigen um +10.",
    difficulty: 1,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7): 2, 4, 8, 16 (×2)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (3, 9, 15, 21) steigen um +6. Ungerade Positionen (2, 4, 8, 16) verdoppeln sich (×2).",
    difficulty: 2,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7,9): 30, 27, 24, 21, 18 (-3)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (10, 15, 20, 25, 30) steigen um +5. Ungerade Positionen (30, 27, 24, 21, 18) sinken um -3.",
    difficulty: 1,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7): 1, 3, 5, 7 (+2)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (4, 12, 20, 28) steigen um +8. Ungerade Positionen (1, 3, 5, 7) steigen um +2.",
    difficulty: 1,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7): 4, 11, 18, 25 (+7)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (3, 6, 12, 24) verdoppeln sich (×2). Ungerade Positionen (4, 11, 18, 25) steigen um +7.",
    difficulty: 2,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7,9): 2, 8, 14, 20, 26 (+6)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (5, 8, 11, 14, 17) steigen um +3. Ungerade Positionen (2, 8, 14, 20, 26) steigen um +6.",
    difficulty: 1,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7): 3, 12, 21, 30 (+9)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (36, 32, 28, 24) sinken um -4. Ungerade Positionen (3, 12, 21, 30) steigen um +9.",
    difficulty: 2,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7): 5, 9, 13, 17 (+4)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (2, 13, 24, 35) steigen um +11. Ungerade Positionen (5, 9, 13, 17) steigen um +4.",
    difficulty: 2,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7,9): 20, 18, 16, 14, 12 (-2)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (5, 15, 25, 35, 45) steigen um +10. Ungerade Positionen (20, 18, 16, 14, 12) sinken um -2.",
    difficulty: 1,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7,9): 6, 9, 12, 15, 18 (+3)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (1, 4, 9, 16, 25) sind Quadratzahlen (1², 2², 3², 4², 5²). Ungerade Positionen (6, 9, 12, 15, 18) steigen um +3.",
    difficulty: 2,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7): 1, 3, 9, 27 (×3)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (2, 9, 16, 23) steigen um +7. Ungerade Positionen (1, 3, 9, 27) verdreifachen sich (×3).",
    difficulty: 2,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7,9): 1, 9, 17, 25, 33 (+8)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (50, 44, 38, 32, 26) sinken um -6. Ungerade Positionen (1, 9, 17, 25, 33) steigen um +8.",
    difficulty: 2,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7): 40, 35, 30, 25 (-5)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (6, 18, 30, 42) steigen um +12. Ungerade Positionen (40, 35, 30, 25) sinken um -5.",
    difficulty: 2,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // Odd  (1,3,5,7,9): 10, 25, 40, 55, 70 (+15)
  {
    ...
    pattern: "zweiersprung",
    explanation:
      "Zweiersprung: Gerade Positionen (3, 8, 13, 18, 23) steigen um +5. Ungerade Positionen (10, 25, 40, 55, 70) steigen um +15.",
    difficulty: 1,
    hints: [
      "Mustertyp: Zweiersprung (zwei verschränkte Teilfolgen)",
  ...
  // pos%3==2 (2,5,8): 10, 15, 20 (+5)
  {
    ...
    explanation:
      "Dreiersprung mit drei Teilfolgen: Positionen 0,3,6 (2, 6, 10) steigen um +4. Positionen 1,4,7 (5, 8, 11) steigen um +3. Positionen 2,5,8 (10, 15, 20) steigen um +5.",
    difficulty: 2,
    hints: [
  ...
  // pos%3==2 (2,5,8): 20, 18, 16 (-2)
  {
    ...
    pattern: "dreiersprung",
    explanation:
      "Dreiersprung mit drei Teilfolgen: Positionen 0,3,6 (3, 9, 15) steigen um +6. Positionen 1,4,7 (10, 20, 30) steigen um +10. Positionen 2,5,8 (20, 18, 16) sinken um -2.",
    difficulty: 2,
    hints: [
      "Mustertyp: Dreiersprung (drei verschränkte Teilfolgen)",
  ...
  // pos%3==2 (2,5,8): 1, 8, 15 (+7)
  {
    ...
    pattern: "dreiersprung",
    explanation:
      "Dreiersprung mit drei Teilfolgen: Positionen 0,3,6 (4, 9, 14) steigen um +5. Positionen 1,4,7 (3, 6, 12) verdoppeln sich (×2). Positionen 2,5,8 (1, 8, 15) steigen um +7.",
    difficulty: 2,
    hints: [
      "Mustertyp: Dreiersprung (drei verschränkte Teilfolgen)",
  ...
  // pos%3==2 (2,5,8): 5, 8, 11 (+3)
  {
    ...
    pattern: "dreiersprung",
    explanation:
      "Dreiersprung mit drei Teilfolgen: Positionen 0,3,6 (1, 9, 17) steigen um +8. Positionen 1,4,7 (30, 26, 22) sinken um -4. Positionen 2,5,8 (5, 8, 11) steigen um +3.",
    difficulty: 2,
    hints: [
      "Mustertyp: Dreiersprung (drei verschränkte Teilfolgen)",
  ...
  // pos%3==2 (2,5,8): 35, 30, 25 (-5)
  {
    ...
    pattern: "dreiersprung",
    explanation:
      "Dreiersprung mit drei Teilfolgen: Positionen 0,3,6 (2, 11, 20) steigen um +9. Positionen 1,4,7 (4, 10, 16) steigen um +6. Positionen 2,5,8 (35, 30, 25) sinken um -5.",
    difficulty: 2,
    hints: [
      "Mustertyp: Dreiersprung (drei verschränkte Teilfolgen)",
  ...
  // ============================================================
  // DREIERSPRUNG continüd (zf-031 to zf-035) — Difficulty 2
  // ============================================================
  ...
  // pos%3==2: 18, 15, 12 (-3)
  {
    ...
    pattern: "dreiersprung",
    explanation:
      "Dreiersprung: Pos 0,3,6 (2, 4, 8) verdoppeln sich (×2). Pos 1,4,7 (3, 7, 11) steigen um +4. Pos 2,5,8 (18, 15, 12) sinken um -3.",
    difficulty: 2,
    hints: [
      "Mustertyp: Dreiersprung (drei verschränkte Teilfolgen)",
  ...
  // pos%3==2: 3, 5, 7 (+2)
  {
    ...
    pattern: "dreiersprung",
    explanation:
      "Dreiersprung: Pos 0,3,6 (5, 12, 19) steigen um +7. Pos 1,4,7 (25, 20, 15) sinken um -5. Pos 2,5,8 (3, 5, 7) steigen um +2.",
    difficulty: 2,
    hints: [
      "Mustertyp: Dreiersprung (drei verschränkte Teilfolgen)",
  ...
  // pos%3==2: 4, 13, 22 (+9)
  {
    ...
    pattern: "dreiersprung",
    explanation:
      "Dreiersprung: Pos 0,3,6 (1, 4, 7) steigen um +3. Pos 1,4,7 (2, 8, 14) steigen um +6. Pos 2,5,8 (4, 13, 22) steigen um +9.",
    difficulty: 2,
    hints: [
      "Mustertyp: Dreiersprung (drei verschränkte Teilfolgen)",
  ...
  // pos%3==2: 24, 20, 16 (-4)
  {
    ...
    pattern: "dreiersprung",
    explanation:
      "Dreiersprung: Pos 0,3,6 (3, 13, 23) steigen um +10. Pos 1,4,7 (2, 4, 8) verdoppeln sich (×2). Pos 2,5,8 (24, 20, 16) sinken um -4.",
    difficulty: 2,
    hints: [
      "Mustertyp: Dreiersprung (drei verschränkte Teilfolgen)",
  ...
  // pos%3==2: 10, 15, 20 (+5)
  {
    ...
    pattern: "dreiersprung",
    explanation:
      "Dreiersprung: Pos 0,3,6 (20, 18, 16) sinken um -2. Pos 1,4,7 (1, 9, 17) steigen um +8. Pos 2,5,8 (10, 15, 20) steigen um +5.",
    difficulty: 2,
    hints: [
      "Mustertyp: Dreiersprung (drei verschränkte Teilfolgen)",
  ...
  // pos%4==0: 1, 4 (+3) | pos%4==1: 4, 9 (+5) | pos%4==2: 6, 8 (+2) | pos%4==3: 10, 20 (+10)
  {
    ...
    explanation:
      "Vierersprung mit 4 Teilfolgen: Pos 0,4 (1, 4) +3. Pos 1,5 (4, 9) +5. Pos 2,6 (6, 8) +2. Pos 3,7 (10, 20) +10.",
    difficulty: 2,
    hints: [
  ...
  // pos%4==0: 2, 7, 12 (+5) | pos%4==1: 20, 17, 14 (-3) | pos%4==2: 3, 6, 12 (×2) | pos%4==3: 1, 5, 9 (+4)
  {
    ...
    pattern: "vierersprung",
    explanation:
      "Vierersprung: Pos 0,4,8 (2, 7, 12) +5. Pos 1,5,9 (20, 17, 14) -3. Pos 2,6,10 (3, 6, 12) ×2. Pos 3,7,11 (1, 5, 9) +4.",
    difficulty: 3,
    hints: [
      "Mustertyp: Vierersprung (vier verschränkte Teilfolgen)",
  ...
  // pos%4==0: 5, 11 (+6) | pos%4==1: 3, 5 (+2) | pos%4==2: 24, 20 (-4) | pos%4==3: 2, 10 (+8)
  {
    ...
    pattern: "vierersprung",
    explanation:
      "Vierersprung: Pos 0,4 (5, 11) +6. Pos 1,5 (3, 5) +2. Pos 2,6 (24, 20) -4. Pos 3,7 (2, 10) +8.",
    difficulty: 2,
    hints: [
      "Mustertyp: Vierersprung (vier verschränkte Teilfolgen)",
  ...
  // pos%4==0: 3, 7, 11 (+4) | pos%4==1: 1, 3, 9 (×3) | pos%4==2: 5, 12, 19 (+7) | pos%4==3: 18, 16, 14 (-2)
  {
    ...
    pattern: "vierersprung",
    explanation:
      "Vierersprung: Pos 0,4,8 (3, 7, 11) +4. Pos 1,5,9 (1, 3, 9) ×3. Pos 2,6,10 (5, 12, 19) +7. Pos 3,7,11 (18, 16, 14) -2.",
    difficulty: 3,
    hints: [
      "Mustertyp: Vierersprung (vier verschränkte Teilfolgen)",
  ...
  // pos%4==0: 3, 6 (×2) | pos%4==1: 2, 8 (+6) | pos%4==2: 10, 9 (-1) | pos%4==3: 5, 8 (+3)
  {
    ...
    pattern: "vierersprung",
    explanation:
      "Vierersprung: Pos 0,4 (3, 6) ×2. Pos 1,5 (2, 8) +6. Pos 2,6 (10, 9) -1. Pos 3,7 (5, 8) +3.",
    difficulty: 2,
    hints: [
      "Mustertyp: Vierersprung (vier verschränkte Teilfolgen)",
  ...
  // 2, 3, 5, 8, 13, 21, 34, 55
  {
    ...
    pattern: "rekursiv",
    explanation:
      "Fibonacci-artig: Jede Zahl ist die Summe der beiden vorherigen. 2+3=5, 3+5=8, 5+8=13, 8+13=21, 13+21=34, 21+34=55.",
    difficulty: 2,
    hints: [
  ...
  // 1, 4, 5, 9, 14, 23, 37, 60
  {
    ...
    pattern: "rekursiv",
    explanation:
      "Fibonacci-artig: 1+4=5, 4+5=9, 5+9=14, 9+14=23, 14+23=37, 23+37=60. Jede Zahl = Summe der beiden vorherigen.",
    difficulty: 2,
    hints: [
      "Mustertyp: Rekursive Folge (Fibonacci-artig)",
  ...
  // 2, 3, 6, 10, 17, 28, 46, 75
  {
    ...
    pattern: "rekursiv",
    explanation:
      "Modifizierte Fibonacci-Folge: a + b + 1 = c. 2+3+1=6, 3+6+1=10, 6+10+1=17, 10+17+1=28, 17+28+1=46, 28+46+1=75.",
    difficulty: 3,
    hints: [
  ...
  // 1, 2, 2, 4, 8, 32, 256
  {
    ...
    pattern: "rekursiv",
    explanation:
      "Produkt-Rekursion: Jede Zahl ist das Produkt der beiden vorherigen. 1×2=2, 2×2=4, 2×4=8, 4×8=32, 8×32=256.",
    difficulty: 3,
    hints: [
  ...
  // 10, 8, 12, 16, 20, 24, 28, 32
  {
    ...
    pattern: "rekursiv",
    explanation:
      "Rekursion 2b - a = c: 2×8-10=6... Tatsächlich: Differenzen +(-2), +4, +4, +4, +4, +4, +4. Oder besser: ab Position 2 konstante Differenz +4: 12, 16, 20, 24, 28, 32.",
    difficulty: 2,
    hints: [
  ...
  // 3, 7, 10, 17, 27, 44, 71, 115
  {
    ...
    pattern: "rekursiv",
    explanation:
      "Fibonacci-artig: 3+7=10, 7+10=17, 10+17=27, 17+27=44, 27+44=71, 44+71=115. Summe der vorherigen zwei.",
    difficulty: 2,
    hints: [
      "Mustertyp: Rekursive Folge (Fibonacci-artig)",
      "Jede Zahl ist die Summe der beiden vorherigen: a + b = c",
  ...
  // Rule: a + b + c = d (tribonacci)
  {
    ...
    pattern: "rekursiv",
    explanation:
      "Tribonacci: Jede Zahl ist die Summe der DREI vorherigen. 1+1+2=4, 1+2+4=7, 2+4+7=13, 4+7+13=24, 7+13+24=44.",
    difficulty: 3,
    hints: [
  ...
  // Diff: 1, 2, 3, 4, 5, 6, 7
  {
    ...
    pattern: "rekursiv",
    explanation:
      "Die Differenzen steigen um 1: +1, +2, +3, +4, +5, +6, +7. Jede Differenz ist um 1 größer als die vorherige.",
    difficulty: 2,
    hints: [
  ...
  // 1+2×2=5, 2+2×5=12, 5+2×12=29, 12+2×29=70
  {
    ...
    pattern: "rekursiv",
    explanation:
      "Rekursion a + 2b = c: 1+2×2=5, 2+2×5=12, 5+2×12=29, 12+2×29=70. Die nächste Zahl = vorvorherige + 2 × vorherige.",
    difficulty: 3,
    hints: [
  ...
  // 3, 6, 5, 10, 9, 18, 17, 34
  {
    ...
    pattern: "komplex",
    explanation:
      "Wechselnde Operationen: ×2, -1, ×2, -1, ... → 3×2=6, 6-1=5, 5×2=10, 10-1=9, 9×2=18, 18-1=17, 17×2=34.",
    difficulty: 3,
    hints: [
  ...
  // 2, 3, 6, 7, 14, 15, 30, 31
  {
    ...
    pattern: "komplex",
    explanation:
      "Wechselnde Operationen: +1, ×2, +1, ×2, ... → 2+1=3, 3×2=6, 6+1=7, 7×2=14, 14+1=15, 15×2=30, 30+1=31.",
    difficulty: 3,
    hints: [
      "Mustertyp: Komplexe Folge (wechselnde Operationen)",
  ...
  // Diff: 2, 3, 5, 8, 13, 19
  {
    ...
    pattern: "komplex",
    explanation:
      "Die Differenzen bilden eine Fibonacci-Folge: +2, +3, +5, +8, +13, +19 (jede Diff. = Summe der zwei vorherigen Diff.). 3+3=6, 19+13=32.",
    difficulty: 3,
    hints: [
  ...
  // ×2, +3, ×2, +3, ×2, +3, ×2
  {
    ...
    pattern: "komplex",
    explanation:
      "Wechselnde Operationen: ×2, +3, ×2, +3, ... → 1×2=2, 2+3=5, 5×2=10, 10+3=13, 13×2=26, 26+3=29, 29×2=58.",
    difficulty: 3,
    hints: [
      "Mustertyp: Komplexe Folge (wechselnde Operationen)",
  ...
  // 1²+1, 2²+1, 3²+1, 4²+1, 5²+1, 6²+1, 7²+1, 8²+1
  {
    ...
    pattern: "komplex",
    explanation:
      "n² + 1: 1²+1=2, 2²+1=5, 3²+1=10, 4²+1=17, 5²+1=26, 6²+1=37, 7²+1=50, 8²+1=65. Quadratzahlen plus 1.",
    difficulty: 3,
    hints: [
  ...
  // 2¹-1, 2²-1, 2³-1, 2⁴-1, ...
  {
    ...
    pattern: "komplex",
    explanation:
      "Zweierpotenzen minus 1: 2¹-1=1, 2²-1=3, 2³-1=7, 2⁴-1=15, 2⁵-1=31, 2⁶-1=63, 2⁷-1=127, 2⁸-1=255. Oder: jede Zahl = vorherige × 2 + 1.",
    difficulty: 3,
    hints: [
  ...
  // Diffs: 2, 4, 8, 16, 32 (×2)
  {
    ...
    pattern: "komplex",
    explanation:
      "Die Differenzen verdoppeln sich: +2, +4, +8, +16, +32. Oder: 2ⁿ - 1. 1+2=3, 3+4=7, 7+8=15, 15+16=31, 31+32=63.",
    difficulty: 3,
    hints: [
  ...
  // Diffs: +2, +3, +4, +5, +6, +7, +8
  {
    ...
    pattern: "komplex",
    explanation:
      "Dreieckszahlen: Differenzen +2, +3, +4, +5, +6, +7, +8. Jede Differenz steigt um 1. Die n-te Dreieckszahl = n(n+1)/2.",
    difficulty: 3,
    hints: [
  ...
  // Use: alternating +5, -2: 3, 8, 6, 11, 9, 14, 12, 17
  {
    ...
    pattern: "komplex",
    explanation:
      "Wechselnde Operationen: +5, -2, +5, -2, ... → 3+5=8, 8-2=6, 6+5=11, 11-2=9, 9+5=14, 14-2=12, 12+5=17.",
    difficulty: 3,
    hints: [
      "Mustertyp: Komplexe Folge (wechselnde Operationen)",
