...
export const physikPool21: Question[] = [
  ...
  q(
    ...
    ["J (Joule, Energie)", "J/", "J·mol·K", "K/J (einfaches Verhältnis der Größen)", "mol/J"],
    1,
    "R ≈ 8,314 J/(mol·K).",
    "leicht",
  ...
  q(
    ...
    ["P = F·s", "P = W/t", "P = E·t", "P = F·v nur (ohne andere Mechanismen)", "P = m·v"],
    1,
    "P = W/t = dW/dt.",
    "leicht",
    ["Leistung", "Definition"]
  ...
  q(
    ...
    KAP[3],
    "Ein Voltmeter misst:",
    ["die Stromstärke", "die Spannung", "den Widerstand", "die Ladung", "die Kapazität"],
    1,
  ...
  q(
    ...
    ["p·V = const", "p/T = const", "V/T = const", "p = const", "V = const (Kraftgesetz)"],
    0,
    "Isotherm: p·V = const.",
    "mittel",
  ...
  q(
    ...
    ["hoch zu runter", "runter zu hoch", "nicht", "nur die Stromstärke", "nur bei Gleichstrom"],
    0,
