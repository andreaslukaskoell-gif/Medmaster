...
export const physikPool21: Question[] = [
  ...
  q(
    ...
    [
      "J (Joule, Energie)",
      "W/",
      "W·m (einfaches Verhältnis der Größen)",
  ...
  q(
    ...
    [
      "J (Joule, Energie)",
      "J/",
      "J·mol·K (als mögliche Antwort)",
      "K/J (einfaches Verhältnis der Größen)",
      "mol/J (als mögliche Antwort)",
    ],
    1,
    "R ≈ 8,314 J/(mol·K).",
    "leicht",
  ...
  q(
    ...
    [
      "P = F·s (einfacher Zusammenhang)",
      "P = W/t",
      "P = E·t (einfacher Zusammenhang)",
      "P = F·v nur (ohne andere Mechanismen)",
      "P = m·v (einfacher Zusammenhang)",
    ],
    1,
    "P = W/t = dW/dt.",
    "leicht",
  ...
  q(
    ...
    [
      "1 kg",
      "1 kg·m/s²",
      "1 J (als Zahlenwert mit Einheit)",
      "1 W (als Zahlenwert mit Einheit)",
