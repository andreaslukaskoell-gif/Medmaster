...
export const physikPool21: Question[] = [
  ...
  q(
    ...
    [
      ...
      "nur longitudinal (als einziger Beitrag)",
      "kreisförmig nur",
  ...
  q(
    ...
    ["J (Joule, Energie)", "W/", "W·m (einfaches Verhältnis der Größen)", "J/K (Joule pro Kelvin, Entropie)", "K/m (einfaches Verhältnis der Größen)"],
    1,
    "λ in W/(m·K).",
    "leicht",
  ...
  q(
    ...
    ["R₁ + R₂ (als mögliche Antwort)", "1/", "R₁·R₂ (als mögliche Antwort)", "R₁/R₂ (als mögliche Antwort)", "R₁ − R₂ (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    ["J (Joule, Energie)", "J/", "J·mol·K (als mögliche Antwort)", "K/J (einfaches Verhältnis der Größen)", "mol/J (als mögliche Antwort)"],
    1,
    "R ≈ 8,314 J/(mol·K).",
    "leicht",
  ...
  q(
    ...
    [
      ...
      "der Dichte mal Volumen (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    ["P = F·s (einfacher Zusammenhang)", "P = W/t", "P = E·t (einfacher Zusammenhang)", "P = F·v nur (ohne andere Mechanismen)", "P = m·v (einfacher Zusammenhang)"],
    1,
    "P = W/t = dW/dt.",
    "leicht",
    ["Leistung", "Definition"]
  ...
  q(
    ...
    [
      ...
      "die Kapazität (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Papier (ausschließlich, ohne weitere Beiträge)",
      "dichte Materialien (Blei, Beton) in ausreichender Dicke",
      "nur Luft (ausschließlich, ohne weitere Beiträge)",
      "nur Kunststoff (ausschließlich, ohne weitere Beiträge)",
  ...
  q(
    ...
    ["p·V = const", "p/T = const (als mögliche Antwort)", "V/T = const (als mögliche Antwort)", "p = const (als mögliche Antwort)", "V = const (Kraftgesetz)"],
    0,
    "Isotherm: p·V = const.",
    "mittel",
  ...
  q(
    ...
    ["1 kg", "1 kg·m/s²", "1 J (als Zahlenwert mit Einheit)", "1 W (als Zahlenwert mit Einheit)", "1 Pa (als Zahlenwert mit Einheit)"],
    1,
    "1 N = 1 kg·m/s².",
    "leicht",
    ["Newton", "Einheit"]
  ...
  q(
    ...
    [
      "hoch zu runter",
      "runter zu hoch (als mögliche Antwort)",
