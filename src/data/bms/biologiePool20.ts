...
export const biologiePool20: Question[] = [
  q(
    ...
    1,
    "DNA: A, T, G, C. RNA: Uracil statt Thymin.",
    "leicht",
    ["DNA", "Genetik"]
  ),
  q(
  ...
  q(
    ...
    1,
    "Transkription erfolgt im Zellkern.",
    "leicht",
  ...
  q(
    ...
    1,
    "Bei der Gastrulation entstehen die Keimblätter.",
    "mittel",
  ...
  q(
    ...
    1,
    "Hinterhauptsbein bildet die Schädelbasis.",
    "mittel",
    ["Skelett", "Schädel"]
  ),
  q(
    ...
    2,
    "Rezessiv: nur bei Homozygotie (aa).",
    "leicht",
    ["Genetik", "rezessiv"]
  ),
  q(
  ...
  q(
    ...
    1,
    "Nabelschnur enthält Nabelvene und Nabelarterien.",
    "leicht",
  ...
  q(
    ...
    1,
    "Genom = gesamte DNA eines Organismus.",
    "leicht",
    ["Genetik", "Genom"]
  ),
  q(
  ...
  q(
    ...
    1,
    "Zwerchfell = wichtigster Inspirationsmuskel.",
    "leicht",
    ["Atmung", "Zwerchfell"]
  ),
  q(
