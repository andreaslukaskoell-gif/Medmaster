...
export const physikPool13: Question[] = [
  q(
    ...
    ["Kilogramm", "Newton (SI-Einheit der Kraft)", "Pascal (SI-Einheit des Drucks)", "Joule (SI-Einheit der Energie)", "Watt (SI-Einheit der Leistung)"],
    0,
  ...
  q(
    ...
    [
      "die Wärmemenge (als mögliche Antwort)",
      "die mittlere kinetische Energie der Teilchen",
      "den Druck (als einzige relevante Größe)",
      "das Volumen (als einzige relevante Größe)",
      "die Entropie (als einzige relevante Größe)",
    ],
    1,
  ...
  q(
    ...
    ["F · v (Produkt bzw. Quotient der Größen)", "F / s (Produkt bzw. Quotient der Größen)", "F · s", "m · v (Produkt bzw. Quotient der Größen)", "P · t (Produkt bzw. Quotient der Größen)"],
    2,
  ...
  q(
    ...
    ["Ampere (SI-Einheit der Stromstärke)", "Volt (als mögliche Antwort)", "Coulomb", "Ohm (als mögliche Antwort)", "Tesla (als mögliche Antwort)"],
    2,
  ...
  q(
    ...
    "Ein Positron ist:",
    [
      "ein Proton (als physikalische Größe)",
      "das Antiteilchen des Elektrons",
      "ein Neutron (als physikalische Größe)",
      "ein Alpha-Teilchen",
      "ein Photon (als physikalische Größe)",
    ],
    1,
  ...
  q(
    ...
    [
      "die Dichte (als einzige relevante Größe)",
      "das Verhältnis der Lichtgeschwindigkeit im Vakuum zu der im Medium",
      "die Wellenlänge (als physikalische Erklärung)",
      "die Frequenz (als einzige relevante Größe)",
      "die Intensität (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["N · m (Produkt bzw. Quotient der Größen)", "N / m (Produkt bzw. Quotient der Größen)", "W · s (Produkt bzw. Quotient der Größen)", "A und C sind richtig", "nur A (ausschließlich, ohne weitere Beiträge)"],
    3,
  ...
  q(
    ...
    [
      ...
      "nur bei Gleichstrom (als einziger Beitrag)",
  ...
  q(
    ...
    [
      "nur schwere Kerne (als einziger Beitrag)",
      "leichte Kerne",
      "nur Neutronen (ausschließlich, ohne weitere Beiträge)",
      "nur Elektronen (ausschließlich, ohne weitere Beiträge)",
      "nur Photonen (ausschließlich, ohne weitere Beiträge)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Abhängigkeit der Brechung von der Wellenlänge",
      "Totalreflexion (als mögliche Antwort)",
      "Absorption (Aufnahme von Strahlung durch Materie)",
      "Polarisation (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["Henry (als mögliche Antwort)", "Weber (als mögliche Antwort)", "Tesla (T)", "Farad (als mögliche Antwort)", "Ohm (als mögliche Antwort)"],
    2,
  ...
  q(
    ...
    [
      "die Beugung an Hindernissen (als physikalische Erklärung)",
      "die Frequenzänderung bei Bewegung von Quelle und/oder Beobachter",
      "Resonanz (verstärkte Schwingung bei Eigenfrequenz)",
      "stehende Wellen",
      "Dämpfung (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Alpha-Strahlung (als einziger Beitrag)",
      "ionisierender Strahlung",
      "nur sichtbarem Licht (als einziger Beitrag)",
      "nur Röntgenstrahlung (als einziger Beitrag)",
      "Ultraschall (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["ω = v · r", "ω = v / r", "ω = 2π · f", "B und C sind richtig", "nur B (ausschließlich, ohne weitere Beiträge)"],
    3,
  ...
  q(
    ...
    [
      ...
      "Nutzleistung / zugeführte Leistung",
  ...
  q(
    ...
    [
      ...
      "der kritische Punkt (als physikalische Erklärung)",
      "immer bei 0 °C (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      "die Masse des Kerns (als physikalische Erklärung)",
      "die Differenz zwischen der Summe der Nukleonenmassen und der Kernmasse",
      "die Neutronenzahl (als physikalische Größe)",
      "die Protonenzahl (als physikalische Größe)",
  ...
  q(
    ...
    [
      "Rollreibung (als mögliche Antwort)",
      "Gleitreibung oder Haftreibung",
      "Strömungswiderstand",
      "Luftreibung (als mögliche Antwort)",
      "Viskosität (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["Hz (Hertz, Schwingungen/s)", "dB (Dezibel) für den Pegel", "m/s (Meter pro Sekunde, Geschwindigkeit)", "Pa (Pascal, Druck)", "N (Newton, Kraft)"],
    1,
  ...
  q(
    ...
    [
      ...
      "nur Wärme von außen (als einziger Beitrag)",
      "nur Konvektion (ausschließlich, ohne weitere Beiträge)",
  ...
  q(
    ...
    ["R (Ohm) (als mögliche Antwort)", "X_L = ω · L", "1/(ωC)", "null (kein Beitrag, verschwindet)", "immer konstant (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    [
      ...
      "Massenzahl",
      "Neutronenzahl (als mögliche Antwort)",
      "Elektronenzahl (als mögliche Antwort)",
  ...
  q(
    ...
    [
      "hohe Intensität",
      "feste Phasenbeziehung zwischen Wellen",
  ...
  q(
    ...
    [
      "nur Gitterschwingungen (als einziger Beitrag)",
      "freie Elektronen und Gitterschwingungen",
      "nur Konvektion (ausschließlich, ohne weitere Beiträge)",
      "nur Strahlung (ausschließlich, ohne weitere Beiträge)",
  ...
  q(
    ...
    [
      "wenige Zentimeter",
      "einige Meter (als mögliche Antwort)",
      "viele Meter bis einige zehn Meter",
      "nur Mikrometer (ausschließlich, ohne weitere Beiträge)",
      "unendlich (unbegrenzt groß)",
    ],
    2,
