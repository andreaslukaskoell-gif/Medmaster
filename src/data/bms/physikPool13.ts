...
export const physikPool13: Question[] = [
  q(
    ...
    ["Kilogramm", "Newton", "Pascal", "Joule", "Watt"],
    0,
  ...
  q(
    ...
    ["R (Ohm)", "X_L = ω · L", "1/(ωC)", "null", "immer konstant"],
    1,
  ...
  q(
    ...
    ["Ordnungszahl (Protonenzahl)", "Massenzahl", "Neutronenzahl", "Elektronenzahl", "Ladung"],
    1,
