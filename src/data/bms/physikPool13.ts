...
export const physikPool13: Question[] = [
  ...
  q(
    ...
    [
      "F · v (Produkt bzw. Quotient der Größen)",
      "F / s (Produkt bzw. Quotient der Größen)",
      "F · s",
      "m · v (Produkt bzw. Quotient der Größen)",
      "P · t (Produkt bzw. Quotient der Größen)",
    ],
    2,
  ...
  q(
    ...
    [
      "Ampere (SI-Einheit der Stromstärke)",
      "Volt (als mögliche Antwort)",
      "Coulomb",
  ...
  q(
    ...
    [
      "N · m (Produkt bzw. Quotient der Größen)",
      "N / m (Produkt bzw. Quotient der Größen)",
      "W · s (Produkt bzw. Quotient der Größen)",
      "A und C sind richtig",
      "nur A (ausschließlich, ohne weitere Beiträge)",
    ],
    3,
  ...
  q(
    ...
    ["L = m · v", "L = m · v · r", "L = I · ω nur bei Scheiben", "L = F · r", "L = p / r"],
    1,
  ...
  q(
    ...
    [
      ...
      "nur B (ausschließlich, ohne weitere Beiträge)",
    ],
    3,
  ...
  q(
    ...
    [
      "R (Ohm) (als mögliche Antwort)",
      "X_L = ω · L",
      "1/(ωC)",
      "null (kein Beitrag, verschwindet)",
      "immer konstant (als mögliche Antwort)",
    ],
    1,
