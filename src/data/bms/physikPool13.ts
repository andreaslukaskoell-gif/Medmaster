...
export const physikPool13: Question[] = [
  ...
  q(
    ...
    ["Ampere (SI-Einheit der Stromstärke)", "Volt", "Coulomb", "Ohm", "Tesla"],
    2,
  ...
  q(
    ...
    ["nur schwere Kerne", "leichte Kerne", "nur Neutronen", "nur Elektronen", "nur Photonen"],
    1,
  ...
  q(
    ...
    ["R (Ohm)", "X_L = ω · L", "1/(ωC)", "null (kein Beitrag, verschwindet)", "immer konstant"],
    1,
