...
export const chemiePool4: Question[] = [
  ...
  q(
    ...
    [
      "Entfernung eines Elektrons aus dem neutralen Atom (Ionisierung)",
      "Hinzufügen eines Elektrons zum neutralen Atom",
      "Ionisierung (Abtrennung eines Elektrons, stets endotherm)",
      "Bindungsbildung (Zusammenschluss von Atomen durch Elektronenpaare)",
      "Anregung (Elektron springt auf ein höheres Energieniveau)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "ein Feststoff bei der Schmelztemperatur flüssig wird",
      "Wasser bei 100 °C und 1 bar Druck zu sieden beginnt",
      "eine chemische Reaktion durch Energiezufuhr gestartet wird",
      "ein Katalysator die Aktivierungsenergie der Reaktion senkt",
    ],
    0,
  ...
  q(
    ...
    [
      ...
      "Ester haben die funktionelle Gruppe −OH (wie Alkohole).",
      "Ester sind keine Carbonsäurederivate, sondern eigenständige Stoffklasse.",
      "Ester sind immer fest und nicht flüchtig bei Raumtemperatur.",
      "Ester enthalten kein Sauerstoffatom in ihrer funktionellen Gruppe.",
    ],
    0,
