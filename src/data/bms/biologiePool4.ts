...
export const biologiePool4: Question[] = [
  ...
  q(
    ...
    [
      ...
      "Morbus haemolyticus neonatorum (Erythroblastose)",
  ...
  q(
    ...
    ["Antihistaminika (oral)", "Kortison (i.v.)", "Adrenalin", "Acetylsalicylsäure", "Atropin"],
    2,
  ...
  q(
    ...
    [
      ...
      "Grampositive erscheinen blau/violett, gramnegative rot/rosa",
