...
export const biologiePool4: Question[] = [
  ...
  q(
    ...
    [
      "Spontane Verdopplung des Chromosomensatzes",
      "Eine kleine Gründerpopulation trägt nur einen Ausschnitt des Genpools der Ursprungspopulation",
      "Gezielte Selektion durch den Menschen",
      "Mutation durch UV-Strahlung in der Gründergeneration",
      "Horizontaler Gentransfer zwischen Spezies",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Grampositive erscheinen blau/violett (dicke Mureinschicht), gramnegative rot/rosa (dünne Mureinschicht + äußere Membran)",
  ...
  q(
    ...
    [
      ...
      "Den normalen Ablauf der Anaphase",
      "Die Fusion von zwei Gameten",
      "Die Trennung von Euchromatin und Heterochromatin",
      "Den Abbau fehlgefalteter Proteine",
    ],
    0,
  ...
  q(
    ...
    [
      ...
      "Ein Allel ist nur bei Männern aktiv",
      "Beide Allele sind rezessiv",
    ],
    1,
