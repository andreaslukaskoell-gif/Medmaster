...
export const biologiePool4: Question[] = [
  ...
  q(
    ...
    [
      "Spontane Verdopplung des gesamten Chromosomensatzes (Polyploidie durch Endoreduplikation)",
  ...
  q(
    ...
    3,
    "In der Meiose II werden Schwesterchromatiden getrennt (wie bei der Mitose). Die Trennung homologer Chromosomen erfolgt in der Meiose I (Reduktions­teilung).",
    "leicht",
  ...
  q(
    ...
    2,
    "p53 ist ein Tumorsuppressorprotein, das bei DNA-Schäden den Zellzyklus in G1 arretiert oder Apoptose einleitet. Es wird daher als \u201EWächter des Genoms\u201C (guardian of the genome) bezeichnet.",
    "mittel",
  ...
  q(
    ...
    2,
    "Genomisches Imprinting ist ein epigenetischer Mechanismus, bei dem bestimmte Gene abhängig von der elterlichen Herkunft (maternal oder paternal) durch DNA-Methylierung stillgelegt werden. Das Prader-Willi- und das Angelman-Syndrom sind Beispiele für Imprinting-Störungen.",
    "schwer",
  ...
  q(
    ...
    1,
    "AUG ist das universelle Startcodon und codiert für die Aminosäure Methionin. Der genetische Code ist degeneriert (mehrere Codons pro Aminosäure), nahezu universell und besteht aus Tripletts (3 Nukleotide).",
    "leicht",
  ...
  q(
    ...
    2,
    "T-Lymphozyten reifen im Thymus heran (daher das \u201ET\u201C). B-Lymphozyten reifen hingegen im Knochenmark (Bone Marrow). Im Thymus durchlaufen T-Zellen die positive und negative Selektion.",
    "leicht",
  ...
  q(
    ...
    2,
    "T-Helferzellen (CD4⁺) setzen Zytokine (z. B. IL-2, IFN-γ) frei und aktivieren damit B-Zellen, Makrophagen und zytotoxische T-Zellen. Sie sind die \u201EDirigenten\u201C der adaptiven Immunantwort.",
    "mittel",
  ...
  q(
    ...
    2,
    "Nach dem Erstkontakt mit einem Antigen entstehen langlebige Gedächtniszellen (Memory-B- und Memory-T-Zellen). Bei erneutem Kontakt reagieren diese schneller und stärker (Sekundärantwort).",
    "leicht",
  ...
  q(
    ...
    [
      "Anti-A und Anti-B (Isoagglutinine beider Spezifitäten im Serum)",
      "Nur Anti-A (Isoagglutinin gegen Blutgruppe-A-Erythrozyten im Serum)",
      "Nur Anti-B (Isoagglutinin gegen Blutgruppe-B-Erythrozyten im Serum)",
      "Keine Isoagglutinine (Anti-A/Anti-B)",
      "Anti-D (Rhesus-Antikörper gegen das D-Antigen der Erythrozytenoberfläche)",
    ],
    3,
    "Personen mit Blutgruppe AB besitzen beide Antigene (A und B) auf ihren Erythrozyten und bilden daher keine Isoagglutinine (Anti-A oder Anti-B). AB-Träger sind Universalempfänger für Erythrozytenkonzentrate.",
    "leicht",
  ...
  q(
    ...
    ["A", "B", "AB", "0", "A oder B"],
    3,
    "Blutgruppe 0 besitzt weder A- noch B-Antigene auf den Erythrozyten. Daher werden diese Erythrozyten von keinem Anti-A- oder Anti-B-Antikörper des Empfängers angegriffen (Universalspender für EK).",
    "leicht",
  ...
  q(
    ...
    [
      ...
      "Sichelzellanämie des Neugeborenen (hämolytische Anämie durch HbS-Mutation)",
      "Polyzythämie der Mutter (pathologische Erhöhung der Erythrozytenzahl)",
    ],
    1,
  ...
  q(
    "bio-pool-278",
    "bio-kap5",
    "Zwei Eltern haben beide die Blutgruppe A (Genotypen IA i × IA i). Welche Blutgruppen sind bei ihren Kindern möglich?",
    ["Nur A", "A und 0", "A, B und 0", "A und AB", "Nur 0"],
    1,
    "IA i × IA i ergibt: IA IA (25 %, Blutgruppe A), IA i (50 %, Blutgruppe A) und ii (25 %, Blutgruppe 0). Blutgruppe B oder AB ist nicht möglich, da kein IB-Allel vorhanden ist.",
    "mittel",
  ...
  q(
    ...
    1,
    "Immunologische Toleranz bezeichnet das Ausbleiben einer Immunreaktion gegen körpereigene Antigene. Sie wird durch zentrale Toleranz (klonale Deletion im Thymus/Knochenmark) und periphere Toleranz (regulatorische T-Zellen, Anergie) aufrechterhalten.",
    "mittel",
  ...
  q(
    ...
    2,
    "Bei Myasthenia gravis blockieren und zerstören Autoantikörper die nikotinischen Acetylcholin-Rezeptoren an der motorischen Endplatte. Die Folge ist eine belastungsabhängige Muskelschwäche (Ptosis, Doppelbilder, generalisierte Schwäche).",
    "schwer",
  ...
  q(
    ...
    2,
    "Viren sind obligat intrazelluläre Parasiten: Sie besitzen keinen eigenen Stoffwechsel und benötigen die Maschinerie der Wirtszelle zur Replikation. Nicht alle Viren sind behüllt (z. B. Adenoviren sind unbehüllt).",
    "leicht",
  ...
  q(
    ...
    1,
    "Bei der Konjugation überträgt ein Donor-Bakterium (F⁺ oder Hfr) DNA über einen Sexpilus auf ein Empfänger-Bakterium (F⁻). Transformation = freie DNA-Aufnahme; Transduktion = DNA-Übertragung durch Phagen.",
    "mittel",
  ...
  q(
    ...
    1,
    "Horizontaler Gentransfer (v. a. Konjugation mit R-Plasmiden) ist der Hauptmechanismus für die rasche Ausbreitung von Antibiotikaresistenzgenen zwischen Bakterien — auch über Speziesgrenzen hinweg.",
    "schwer",
  ...
  q(
    ...
    2,
    "Pilze sind eukaryotische, heterotrophe Organismen mit einer Zellwand aus Chitin (im Gegensatz zu Cellulose bei Pflanzen). Sie bilden ein eigenes Reich (Fungi) und können sich sowohl sexuell als auch asexuell (Sporen) vermehren.",
    "leicht",
  ...
  q(
    ...
    [
      "Bei hohem Blutdruck (arterieller Hypertonie mit Gefäßschäden)",
      "Bei Immunsuppression (z. B. nach Organtransplantation, HIV/AIDS)",
      "Bei Vitaminüberschuss (Hypervitaminose, z. B. Vitamin A oder D)",
      "Bei sportlicher Überanstrengung (Overtraining-Syndrom mit Erschöpfung)",
      "Bei erhöhtem Cholesterin (Hypercholesterinämie mit Atheroskleroserisiko)",
    ],
    1,
    "Candida albicans ist ein opportunistischer Hefepilz, der bei geschwächtem Immunsystem (Immunsuppression, Antibiotikatherapie, Diabetes, HIV/AIDS) zu Infektionen führt — von Soor (Mundhöhle) bis zur invasiven Candidämie.",
    "mittel",
  ...
  q(
    ...
    [
      "Artbildung durch Polyploidisierung (Vervielfachung des gesamten Chromosomensatzes)",
      "Artbildung durch räumliche Trennung von Populationen und anschließende genetische Divergenz",
      "Artbildung innerhalb eines gemeinsamen Lebensraums (sympatrische Speziation durch ökologische Nischen)",
      "Artbildung durch horizontalen Gentransfer (Übertragung genetischen Materials zwischen Spezies)",
      "Artbildung durch gezielte Zucht (künstliche Selektion in der Tier- und Pflanzenzucht)",
    ],
    1,
  ...
  q(
    ...
    1,
    "Homologe Organe haben den gleichen evolutionären Ursprung (gleicher Grundbauplan), erfüllen aber unterschiedliche Funktionen (z. B. Arm des Menschen, Flosse des Wals, Flügel der Fledermaus). Analoge Organe haben verschiedenen Ursprung, aber ähnliche Funktion.",
    "leicht",
  ...
  q(
    ...
    1,
    "Trisomie 21 bedeutet, dass Chromosom 21 dreifach vorhanden ist (47,XX,+21 oder 47,XY,+21). Ursache ist meist eine Non-Disjunction während der Meiose. Das Risiko steigt mit dem mütterlichen Alter.",
    "leicht",
  ...
  q(
    ...
    [
      ...
      "Die Fusion von zwei Gameten (Ei- und Samenzelle) bei der Befruchtung",
    ...
    0,
    "Non-Disjunction ist die fehlerhafte Nicht-Trennung von homologen Chromosomen (Meiose I) oder Schwesterchromatiden (Meiose II/Mitose). Sie führt zu Aneuploidie (z. B. Trisomie, Monosomie).",
    "mittel",
  ...
  q(
    ...
    1,
    "Mukoviszidose folgt einem autosomal-rezessiven Erbgang. Beide Eltern sind phänotypisch gesund (heterozygote Träger). Nur homozygot Betroffene (ca. 25 % der Kinder zweier Träger) erkranken.",
    "mittel",
  ...
  q(
    ...
    [
      "Alle Söhne (100 % der männlichen Nachkommen dieser Kreuzung)",
      "Alle Töchter (100 % der weiblichen Nachkommen dieser Kreuzung)",
      "Keines der Kinder in dieser Generation",
      "50 % der Söhne (die Hälfte der männlichen Nachkommen statistisch)",
      "50 % der Töchter (die Hälfte der weiblichen Nachkommen statistisch)",
    ],
    2,
  ...
  q(
    ...
    [
      ...
      "Sie codieren für ribosomale RNA (rRNA-Gene als Tandemwiederholungen)",
  ...
  q(
    ...
    2,
    "Die PCR umfasst drei Schritte pro Zyklus: Denaturierung (~95 °C, Strangtrennung), Annealing (~55–65 °C, Primer-Bindung) und Elongation (~72 °C, DNA-Synthese durch Taq-Polymerase). Sie ist eine In-vitro-Methode.",
    "mittel",
