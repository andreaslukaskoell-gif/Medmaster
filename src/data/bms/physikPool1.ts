...
export const physikPool1: Question[] = [
  ...
  q(
    ...
    ["Masse (Trägheitseigenschaft, Einheit Kilogramm)", "Temperatur (Maß für die mittlere kinetische Energie)", "Druck (Kraft pro Fläche, Einheit Pascal)", "Geschwindigkeit", "Energie (Fähigkeit, Arbeit zu verrichten)"],
    3,
  ...
  q(
    ...
    [
      ...
      "keine Welle. (als mögliche Antwort)",
    ],
    0,
  ...
  q(
    ...
    [
      ...
      "Ladung pro Zeit. (als Verhältnisgröße)",
      "Kraft pro Ladung. (als Verhältnisgröße)",
      "Ladung pro Fläche. (als Verhältnisgröße)",
      "Strom mal Zeit.",
    ],
    0,
  ...
  q(
    ...
    ["Elektronen (als mögliche Antwort)", "Protonen (als mögliche Antwort)", "Heliumkernen", "Neutronen (als mögliche Antwort)", "Photonen (Lichtquanten, masselose Teilchen)"],
    2,
  ...
  q(
    ...
    [
      ...
      "Die Entropie nimmt immer zu. (als physikalische Erklärung)",
  ...
  q(
    ...
    [
      ...
      "hat eine positive Brennweite. (unter Standardbedingungen)",
  ...
  q(
    ...
    [
      ...
      "wird in Watt angegeben. (unter Standardbedingungen)",
  ...
  q(
    ...
    [
      ...
      "die Änderung der wahrgenommenen Frequen",
