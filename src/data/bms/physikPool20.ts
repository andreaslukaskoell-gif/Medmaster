...
export const physikPool20: Question[] = [
  ...
  q(
    ...
    [
      "beliebig (als mögliche Antwort)",
      "die Elementarladung e",
      "1 C (Temperaturwert)",
      "0",
      "die Protonenladung nur (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    [
      "Papier nur (ohne andere Mechanismen)",
      "dünne Metallschicht oder Plexiglas",
      "nur Blei (ausschließlich, ohne weitere Beiträge)",
      "nur Luft (ausschließlich, ohne weitere Beiträge)",
      "nicht möglich (als mögliche Antwort)",
    ],
    1,
