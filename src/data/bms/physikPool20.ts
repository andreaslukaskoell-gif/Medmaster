...
export const physikPool20: Question[] = [
  ...
  q(
    ...
    [
      "alle Kerne zerfallen sind (als physikalischer Prozess)",
      "die Hälfte der ursprünglich vorhandenen Kerne noch nicht zerfallen ist",
      "die Aktivität verdoppelt ist (als physikalische Erklärung)",
      "die Masse null ist (als physikalische Erklärung)",
      "die Temperatur halbiert ist (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "einem Elektron (als mögliche Antwort)",
      "zwei Neutronen (als mögliche Antwort)",
      "zwei Protonen (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["J (Joule, Energie)", "J/K", "K (Kelvin, Temperatur)", "W (Watt, Leistung)", "J·K (einfaches Verhältnis der Größen)"],
    1,
    "S in J/K.",
    "leicht",
    ["Entropie", "Einheit"]
  ...
  q(
    ...
    ["beliebig (als mögliche Antwort)", "die Elementarladung e", "1 C (Temperaturwert)", "0", "die Protonenladung nur (als physikalische Erklärung)"],
    1,
  ...
  q(
    ...
    [
      "die Temperatur zu erhöhen (als physikalische Erklärung)",
      "die flüssige in die gasförmige Phase zu überführen",
      "den Druck zu erhöhen",
      "die Dichte zu erhöhen (als physikalische Erklärung)",
      "die Wärmekapazität zu ändern (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    ["Papier nur (ohne andere Mechanismen)", "dünne Metallschicht oder Plexiglas", "nur Blei (ausschließlich, ohne weitere Beiträge)", "nur Luft (ausschließlich, ohne weitere Beiträge)", "nicht möglich (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    [
      ...
      "gerades Vielfaches von λ",
      "beliebiges Vielfaches von λ/4",
      "nur λ/2 (als einziger Beitrag)",
  ...
  q(
    ...
    [
      "die Gesamtenergie (als physikalische Größe)",
      "die Anzahl der Zerfälle pro Zeiteinheit",
      "die Halbwertszeit (als physikalische Größe)",
      "die Reichweite (als einzige relevante Größe)",
      "die Masse (als einzige relevante Größe)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "der Temperatur",
      "dem Druck nur (ohne andere Mechanismen)",
  ...
  q(
    ...
    [
      "den Prozess (als einzige relevante Größe)",
      "den Zustand des Systems zu einem Zeitpunkt",
      "nur die Wärme (als einziger Beitrag)",
      "nur die Arbeit (als einziger Beitrag)",
      "nur die Entropie (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Reibung (Kraft zwischen berührenden Flächen)",
      "Wärme (Energieübertragung bei Temperaturdifferenz)",
      "Licht (als mögliche Antwort)",
    ],
    1,
