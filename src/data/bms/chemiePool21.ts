...
export const chemiePool21: Question[] = [
  ...
  q(
    ...
    [
      "es läuft keine Reaktion mehr ab (vollständiger Stillstand)",
      "Hin- und Rückreaktion laufen weiter, mit gleicher Geschwindigkeit",
      "nur die Hinreaktion läuft weiter (Rückreaktion gestoppt)",
      "nur die Rückreaktion läuft weiter (Hinreaktion gestoppt)",
      "die Konzentrationen aller Stoffe sind auf null gesunken",
    ],
    1,
  ...
  q(
    ...
    [
      "Temperatur (thermodynamische Zustandsgröße in Kelvin)",
      "Molalität des gelösten Stoffs",
      "Dichte (Masse pro Volumen der Lösung in g/mL)",
      "Verdampfungsenthalpie (Energie für den Phasenübergang flüssig→gasförmig)",
      "Oberflächenspannung (Kraft an der Grenzfläche Flüssigkeit/Gas)",
    ],
    1,
  ...
  q(
    ...
    [
      "wird bei exothermen Reaktionen als Wärme freigesetzt (ΔH < 0)",
      "muss von den Reaktanden aufgebracht werden, um den Übergangszustand zu erreichen",
      "ist immer null, da die Energiebarriere nicht existiert",
      "bestimmt die Gleichgewichtslage und damit den Umsatz der Reaktion",
      "ist unabhängig von der Temperatur (konstanter Wert für jede Reaktion)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur eine Carboxylgruppe (−COOH) ohne weitere funktionelle Gruppe",
      "mindestens eine Amino- und eine Carboxylgruppe",
      "nur eine Aminogruppe (−NH₂) ohne weitere funktionelle Gruppe",
      "nur Ester (−COOR) als funktionelle Gruppe in der Seitenkette",
      "nur Ether (−O−) als Verknüpfung im Kohlenstoffgerüst",
    ],
    1,
  ...
  q(
    ...
    [
      "vergrößert (die Reaktion wird stärker in Richtung Produkte verschoben)",
      "nicht geändert (K ist konstant bei fester T)",
      "verkleinert (die Rückreaktion wird bevorzugt durch den Katalysator)",
      "verdoppelt (proportionaler Anstieg mit der Katalysatormenge)",
      "auf null gesetzt (keine Gleichgewichtsbildung mehr möglich)",
    ],
    1,
  ...
  q(
    ...
    [
      "die Aktivierungsenergie senkt (wie ein normaler Katalysator wirkt)",
      "den Katalysator oder das aktive Zentrum blockiert bzw. die Reaktion hemmt",
      "die Gleichgewichtslage auf die Produktseite verschiebt (K verändert)",
      "ΔH ändert (die Reaktionsenthalpie wird durch Inhibitor beeinflusst)",
      "die Temperatur erhöht (exothermer Effekt durch Inhibitorbindung)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Abkühlung (Senkung der Temperatur unter den Sättigungspunkt)",
      "Erwärmung (oft), Rühren, feinere Verteilung",
      "nur Druck (Erhöhung des äußeren Drucks auf die Lösung)",
      "nur Zugabe von mehr Feststoff (der sich nicht weiter löst)",
      "nur Verdünnung (Zugabe von reinem Lösungsmittel zur Lösung)",
    ],
    1,
  ...
  q(
    ...
    [
      "die Gleichgewichtslage sich auf die Produktseite verschiebt (K ändert)",
      "mehr Teilchen die Aktivierungsenergie überschreiten (Boltzmann)",
      "der Katalysator erst bei höherer Temperatur seine Wirkung entfaltet",
      "die Konzentration der Edukte automatisch mit der Temperatur steigt",
      "ΔH sich ändert (Reaktionsenthalpie wird temperaturabhängig verschoben)",
    ],
    1,
  ...
  q(
    ...
    [
      "der Neutronenzahl (Anzahl der Neutronen im Atomkern, N = A − Z)",
      "der Protonenzahl (Ordnungszahl Z)",
      "der Massenzahl (Summe aus Protonen und Neutronen, A = Z + N)",
      "immer 8 (unabhängig vom Element, Edelgaskonfiguration für alle)",
      "der doppelten Protonenzahl (eine empirische Näherungsformel, 2Z)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Ionen (geladene Teilchen durch Elektronentransfer)",
      "Radikale (Cl·, R·) in Start-, Ketten- und Abbruchschritten",
      "nur Gleichgewicht (Hin- und Rückreaktion mit gleicher Geschwindigkeit)",
      "nur Addition (Anlagerung an eine Mehrfachbindung des Substrats)",
      "nur Eliminierung (Abspaltung von Atomen unter Doppelbindungsbildung)",
    ],
    1,
