...
export const physikPool2: Question[] = [
  ...
  q(
    ...
    ["Kraft (Masse mal Beschleunigung, Einheit Newton)", "Druck (Kraft pro Fläche, Einheit Pascal)", "Arbeit", "Leistung (Energie pro Zeit, Einheit Watt)", "Frequenz (Schwingungen pro Sekunde, Einheit Hz)"],
    2,
  ...
  q(
    ...
    [
      "der Gegenstandsweite. (als physikalische Erklärung)",
      "der Bildweite. (als mögliche Antwort)",
  ...
  q(
    ...
    ["m · v (Produkt bzw. Quotient der Größen)", "m · v² (als mögliche Antwort)", "(1/2) · m · v²", "m · g · h (als mögliche Antwort)", "F · s (Produkt bzw. Quotient der Größen)"],
    2,
  ...
  q(
    ...
    [
      ...
      "steigt die Temperatur sofort. (unter diesen Bedingungen)",
      "wird keine Energie umgesetzt. (unter Standardbedingungen)",
  ...
  q(
    ...
    [
      ...
      "Doppler-Effekt.",
      "Dispersion. (als mögliche Antwort)",
      "Brechung. (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["Strom (als mögliche Antwort)", "Ladung", "Magnetfeld (als mögliche Antwort)", "Wärme (Energieübertragung bei Temperaturdifferenz)", "nur Spannung (ausschließlich, ohne weitere Beiträge)"],
    1,
  ...
  q(
    ...
    [
      ...
      "Strahlung nur (ohne andere Mechanismen)",
