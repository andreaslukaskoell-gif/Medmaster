...
export const physikPool2: Question[] = [
  ...
  q(
    ...
    [
      "Kraft (Masse mal Beschleunigung, Einheit Newton)",
      "Druck (Kraft pro Fläche, Einheit Pascal)",
      "Arbeit",
      "Leistung (Energie pro Zeit, Einheit Watt)",
  ...
  q(
    ...
    [
      ...
      "m · v² (als mögliche Antwort)",
      "(1/2) · m · v²",
      "m · g · h (als mögliche Antwort)",
