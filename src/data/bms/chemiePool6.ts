...
export const chemiePool6: Question[] = [
  ...
  q(
    ...
    [
      "die Geschwindigkeit der Hin- und Rückreaktion (kinetische Größe)",
      "die molaren Verhältnisse der Edukte und Produkte",
      "die Aktivierungsenergie (Energiebarriere der Gesamtreaktion)",
      "den Katalysator (Art und Menge des verwendeten Katalysators)",
      "die Gleichgewichtslage (Verhältnis von Produkten zu Edukten bei T)",
    ],
    1,
  ...
  q(
    ...
    [
      "Ein Stoff, der bei der Reaktion stöchiometrisch verbraucht wird.",
      "Ein Stoff, der die Reaktionsgeschwindigkeit ändert, ohne verbraucht zu werden.",
      "Ein Stoff, der nur bei hoher Temperatur als Aktivator wirkt.",
      "Ein Oxidationsmittel, das Elektronen von anderen Stoffen aufnimmt.",
      "Immer ein Enzym, also ein Protein mit katalytischer Funktion.",
    ],
    1,
  ...
  q(
    ...
    [
      "NaCl aus gasförmigen Atomen durch Kompression entsteht",
      "die Bildung des Gitters aus gasförmigen Ionen Energie freisetzt",
      "NaCl beim Erwärmen schmilzt (Phasenübergang fest→flüssig)",
      "NaCl in Wasser löslich ist (Hydratation der Na⁺ und Cl⁻ Ionen)",
      "NaCl als Feststoff in einem Kristallgitter vorliegt (Ionengitter)",
    ],
    1,
  ...
  q(
    ...
    [
      "alle Edukte vollständig verbraucht sind (kein Rückstand)",
      "die Geschwindigkeiten von Hin- und Rückreaktion gleich sind",
      "nur C und D als Produkte vorhanden sind (kein Edukt übrig)",
      "die Temperatur konstant gehalten wird (isotherm, ΔT = 0)",
      "ein Katalysator zugegeben wird (Senkung der Aktivierungsenergie)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Die Raumtemperatur (ca. 20–25 °C, Standardlaborbedingung)",
    ],
    1,
  ...
  q(
    ...
    [
      "die Stöchiometrie allein (molare Verhältnisse in der Gleichung)",
      "Experimente (Konzentration vs. Geschwindigkeit)",
      "die Gleichgewichtskonstante K (thermodynamische Größe bei T)",
      "den Katalysator (Art und Menge, die eingesetzt werden)",
      "die Temperatur (Arrhenius: k hängt exponentiell von T ab)",
    ],
    1,
  ...
  q(
    ...
    [
      "Das chemische Gleichgewicht (Massenwirkungsgesetz, K-Ausdruck)",
      "Die Abhängigkeit der Geschwindigkeitskonstante k von der Temperatur",
      "Die Neutralisation (Reaktion von Säure und Base zu Salz + Wasser)",
      "Die Oxidationszahl (formale Ladung eines Atoms in einer Verbindung)",
      "Die Löslichkeit (maximal lösbare Menge eines Stoffs pro Liter)",
    ],
    1,
  ...
  q(
    ...
    [
      "immer sauer, da Wasser H⁺-Ionen an das Gleichgewicht abgibt",
      "neutral (wenn [H₃O⁺] = [OH⁻])",
      "immer basisch, weil OH⁻-Ionen in reinem Wasser überwiegen",
      "ein Puffer (hält den pH-Wert bei Säure-/Basenzugabe konstant)",
      "immer eine starke Säure mit einem pH-Wert deutlich unter 7",
    ],
    1,
