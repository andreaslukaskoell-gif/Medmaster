...
export const biologiePool3: Question[] = [
  ...
  q(
    ...
    [
      "Er besteht aus einem einzigen großen Membransack.",
      "Er modifiziert, sortiert und verpackt Proteine für den intrazellulären Transport oder die Sekretion.",
      "Er ist der Ort der DNA-Replikation.",
      "Er produziert ATP durch Chemiosmose.",
      "Er baut Fettsäuren durch β-Oxidation ab.",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Speicherung von Kalziumionen für die Muskelkontraktion",
      "Synthese von ribosomaler RNA",
  ...
  q(
    ...
    [
      ...
      "Das Hardy-Weinberg-Gleichgewicht beschreibt eine Population, in der sich die Allelfrequenzen von Generation zu Generation ändern.",
  ...
  q(
    ...
    [
      ...
      "Gendrift ist eine zufällige Veränderung der Allelfrequenzen, die vor allem in kleinen Populationen bedeutsam ist.",
