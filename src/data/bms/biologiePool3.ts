...
export const biologiePool3: Question[] = [
  ...
  q(
    ...
    ["pH 7,4 (neutral)", "pH 8,0", "pH 4,5–5,0 (sauer)", "pH 2,0", "pH 6,8–7,0 (nahezu neutral)"],
    2,
  ...
  q(
    ...
    [
      "Synthese von Steroidhormonen im glatten ER",
      ...
      "Synthese von ribosomaler RNA (rRNA)",
      "Bildung der Mitosespindel aus Mikrotubuli durch das Centrosom",
    ],
    1,
    "Peroxisomen bauen sehr langkettige Fettsäuren durch β-Oxidation ab und entgiften H₂O₂ mithilfe des Enzyms Katalase. Die Steroidhormonsynthese findet im glatten ER statt, die Kalziumspeicherung im sarkoplasmatischen Retikulum, rRNA-Synthese im Nukleolus.",
    "mittel",
  ...
  q(
    ...
    2,
    "Terminal differenzierte Zellen verlassen den Zellzyklus und treten in die G0-Phase ein. Die S-Phase ist die Phase der DNA-Synthese, nicht der Teilung. Die G1-Phase dient dem Zellwachstum. Die M-Phase ist meist die kürzeste Phase. Cycline aktivieren CDKs und treiben den Zellzyklus voran.",
    "mittel",
  ...
  q(
    ...
    2,
    "Der Hämatokrit gibt den Volumenanteil der Erythrozyten am Gesamtblut an. Erythrozyten sind keine Leukozyten; Thrombozyten sind kernlose Zellfragmente aus dem Knochenmark; Blutplasma besteht zu ~91 % aus Wasser und ~7 % Proteinen; die häufigsten Leukozyten sind neutrophile Granulozyten.",
    "leicht",
  ...
  q(
    ...
    2,
    "Der Sympathikus bewirkt eine Bronchodilatation zur besseren Sauerstoffaufnahme in Stresssituationen. Der Sympathikus nutzt postganglionär v. a. Noradrenalin (nicht nur Acetylcholin). Der Parasympathikus senkt die Herzfrequenz und ist das Rest-and-Digest-System.",
    "mittel",
  ...
  q(
    ...
    1,
    "Epithelgewebe zeichnet sich durch dicht gepackte Zellen mit sehr wenig Interzellularsubstanz aus. Es ist avaskulär und sitzt auf einer Basalmembran. Die Zellerneuerungsrate ist oft hoch.",
    "leicht",
  ...
  q(
    ...
    1,
    "Allopatrische Artbildung entsteht durch geografische Isolation: Eine Population wird physisch getrennt, und die Teilpopulationen entwickeln sich unabhängig weiter, bis sie reproduktiv isoliert sind. Sympatrische Artbildung geschieht ohne geografische Trennung.",
    "leicht",
  ...
  q(
    ...
    1,
    "Gendrift (genetische Drift) bezeichnet die zufällige Veränderung von Allelfrequenzen in einer Population. Der Effekt ist in kleinen Populationen besonders stark (Flaschenhals-Effekt, Gründereffekt). Gendrift ist NICHT adaptiv und kann zur Fixierung oder zum Verlust von Allelen führen.",
    "mittel",
  ...
  q(
    ...
    1,
    "Beim Flaschenhals-Effekt wird eine Population durch ein katastrophales Ereignis drastisch reduziert. Die überlebenden Individuen repräsentieren nur einen kleinen Teil der ursprünglichen genetischen Vielfalt. Der Gründereffekt (Option D) ist ein verwandtes, aber anderes Phänomen.",
    "leicht",
  ...
  q(
    ...
    1,
    "Auf jeder Trophieebene wird der größte Teil der aufgenommenen Energie (ca. 90 %) durch Zellatmung als Wärme abgegeben. Nur etwa 10 % werden als Biomasse an die nächste Trophieebene weitergegeben. Deshalb haben Nahrungsketten selten mehr als 4–5 Stufen.",
    "mittel",
  ...
  q(
    ...
    [
      ...
      "Die CO₂-Fixierung findet im Calvin-Zyklus (Dunkelreaktion)",
  ...
  q(
    ...
    1,
    "Die DNA-Polymerase synthetisiert den neuen Strang ausschließlich in 5'→3'-Richtung. Die Replikation ist semikonservativ. Am Folgestrang entstehen Okazaki-Fragmente, die von der DNA-Ligase verbunden werden. Die Helikase trennt den Doppelstrang.",
    "mittel",
  ...
  q(
    ...
    1,
    "Das zentrale Dogma der Molekularbiologie (Francis Crick, 1958) beschreibt den Informationsfluss: DNA wird in RNA transkribiert, die RNA wird in Protein translatiert. Ausnahmen wie die Reverse Transkription ändern die grundlegende Richtung nicht.",
    "leicht",
  ...
  q(
    ...
    0,
    "Beim Crossing-over tauschen homologe Chromosomen reziprok Abschnitte nicht-schwesterlicher Chromatiden aus. Dies führt zu einer Rekombination des genetischen Materials und erhöht die genetische Vielfalt der Nachkommen erheblich.",
    "mittel",
  ...
  q(
    ...
    2,
    "Viren enthalten entweder DNA oder RNA als genetisches Material, niemals beides. Sie haben keinen eigenen Stoffwechsel und sind obligat intrazelluläre Parasiten. Nicht alle Viren sind behüllt. Viren sind meist 20–300 nm groß. Antibiotika wirken nur gegen Bakterien.",
    "leicht",
  ...
  q(
    ...
    [
      ...
      "Bakterien können Plasmide tragen, die zusätzliche Gene enthalten.",
  ...
  q(
    ...
    [
      ...
      "Translokation von Chromosom 21 auf Chromosom 14",
  ...
  q(
    ...
    1,
    "Bei der aktiven Immunisierung wird dem Körper ein abgeschwächter oder inaktivierter Erreger zugeführt. Das adaptive Immunsystem bildet spezifische B- und T-Gedächtniszellen, die bei erneutem Kontakt eine schnelle und starke Immunantwort ermöglichen. Die passive Immunisierung (Option A) liefert fertige Antikörper.",
    "leicht",
  ...
  q(
    ...
    2,
    "HIV (humanes Immundefizienzvirus) befällt primär CD4⁺-T-Helferzellen, da das Virus den CD4-Rezeptor als Hauptrezeptor für den Zelleintritt nutzt. Die Zerstörung der T-Helferzellen führt zum Immundefekt (AIDS).",
    "mittel",
  ...
  q(
    ...
    1,
    "Die Taq-Polymerase stammt aus dem thermophilen Bakterium Thermus aquaticus und ist hitzestabil. Sie übersteht den Denaturierungsschritt bei ~95 °C und muss daher nicht nach jedem Zyklus neu zugegeben werden. Reverse Transkriptase (nicht Taq) schreibt RNA in DNA um.",
    "mittel",
  ...
  q(
    ...
    2,
    "MHC-I-Moleküle kommen auf fast allen kernhaltigen Zellen vor und präsentieren intrazelluläre Peptide an CD8⁺-T-Zellen. MHC-II-Moleküle kommen nur auf professionellen Antigen-präsentierenden Zellen (APCs) vor und präsentieren extrazelluläre Antigene an CD4⁺-T-Helferzellen. MHC-Moleküle sind zentral für die Transplantatabstoßung.",
    "schwer",
