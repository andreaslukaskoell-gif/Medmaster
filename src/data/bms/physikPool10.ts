...
export const physikPool10: Question[] = [
  ...
  q(
    ...
    [
      ...
      "60° (Sechstelperiode Verschiebung)",
      "30° (Zwölftelperiode Verschiebung)",
    ],
    1,
  ...
  q(
    ...
    "Alpha-Teilchen = …",
    [
      "Elektron (als mögliche Antwort)",
      "Heliumkern",
      "Proton (als mögliche Antwort)",
      "Neutron (als mögliche Antwort)",
      "Photon (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    "Zustandsgröße ist …",
    [
      "Wärme Q (als mögliche Antwort)",
      "Arbeit W (als mögliche Antwort)",
      "innere Energie U",
  ...
  q(
    ...
    [
      "größer als (als mögliche Antwort)",
      "kleiner als",
      "gleich (identischer Betrag)",
      "90° (Viertelperiode Verschiebung)",
      "0° (gleichphasig, keine Verschiebung)",
