...
export const physikPool10: Question[] = [
  ...
  q(
    ...
    ["kleiner (geringerer Betrag)", "größer", "gleich (identischer Betrag)", "null (kein Beitrag, verschwindet)", "halb (skalierter Wert)"],
    1,
  ...
  q(
    ...
    ["90° (Viertelperiode Verschiebung)", "ca. 41,8°", "0° (gleichphasig, keine Verschiebung)", "60° (Sechstelperiode Verschiebung)", "30° (Zwölftelperiode Verschiebung)"],
    1,
  ...
  q(
    ...
    "phys-kap7",
    "Alpha-Teilchen = …",
    ["Elektron (als mögliche Antwort)", "Heliumkern", "Proton (als mögliche Antwort)", "Neutron (als mögliche Antwort)", "Photon (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    "phys-kap4",
    "Zustandsgröße ist …",
    ["Wärme Q (als mögliche Antwort)", "Arbeit W (als mögliche Antwort)", "innere Energie U", "alle (sämtliche genannten Größen)", "keine (keiner der genannten Beiträge)"],
    2,
  ...
  q(
    ...
    "phys-kap7",
    "Becquerel (Bq) = …",
    ["1 J/kg", "1 Zerfall/s", "1 C/kg", "1 eV (als Zahlenwert mit Einheit)", "1 Sv"],
    1,
  ...
  q(
    ...
    ["größer als (als mögliche Antwort)", "kleiner als", "gleich (identischer Betrag)", "90° (Viertelperiode Verschiebung)", "0° (gleichphasig, keine Verschiebung)"],
    1,
