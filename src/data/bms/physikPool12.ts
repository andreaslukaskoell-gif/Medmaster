...
export const physikPool12: Question[] = [
  ...
  q(
    ...
    [
      ...
      "die Wellenlänge (als physikalische Erklärung)",
      "die Amplitude (als einzige relevante Größe)",
      "die Energie (als einzige relevante Größe)",
    ],
    1,
  ...
  q(
    ...
    ["Elektronen (als mögliche Antwort)", "Heliumkerne", "Photonen (Lichtquanten, masselose Teilchen)", "Neutronen (als mögliche Antwort)", "Positronen (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    [
      "Elektronen (als mögliche Antwort)",
      "Heliumkernen (als mögliche Antwort)",
      "Photonen",
      "Neutronen (als mögliche Antwort)",
      "Protonen (als mögliche Antwort)",
    ],
    2,
  ...
  q(
    ...
    [
      "vom optisch dünneren ins optisch dichtere Medium übergeht",
      "von Wasser in Luft geht und der Einfallswinkel größer als der Grenzwinkel ist",
      "senkrecht auf eine Grenzfläche zwischen zwei Medien einfällt",
      "von einem ebenen oder gekrümmten Spiegel reflektiert wird",
      "durch eine konvexe oder konkave Sammellinse hindurchgeht",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Wärmeübertragung durch mitbewegte Materie",
      "nur in Festkörpern (als einziger Beitrag)",
      "gleich Leitung (als mögliche Antwort)",
  ...
  q(
    ...
    [
      "Konvektion (Wärmetransport durch Strömung)",
      "Photonen (Lichtquanten, masselose Teilchen)",
      "Schwingungen der Atome/Gitter",
      "Strömung (gerichtete Bewegung eines Fluids)",
  ...
  q(
    ...
    [
      ...
      "Proton + Positron",
      "Alpha-Teilchen (als mögliche Antwort)",
      "zwei Neutronen (als mögliche Antwort)",
      "Proton + Neutrino",
    ],
    0,
  ...
  q(
    ...
    [
      "nur der Dicke (als einziger Beitrag)",
      "Brechungsindex und Krümmungsradien",
      "nur der Farbe des Lichts (als einziger Beitrag)",
      "der Lichtintensität (als physikalische Erklärung)",
      "nur der Größe der Linse (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      "die Temperaturänderung (als physikalische Erklärung)",
      "die Wärme, die ohne Temperaturänderung zugeführt wird",
      "immer null (als mögliche Antwort)",
      "die spezifische Wärmekapazität",
      "nur bei Gasen (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      "existiert nicht",
      "ist radial vom Leiter weg (unter Standardbedingungen)",
      "umgibt den Leiter ringförmig",
      "ist nur im Leiter (unter Standardbedingungen)",
      "ist immer konstant (unter Standardbedingungen)",
    ],
    2,
  ...
  q(
    ...
    [
      "an einem Hindernis oder Spalt abgelenkt wird",
      "reflektiert wird (als physikalischer Prozess)",
      "absorbiert wird",
      "sich in Vakuum ausbreitet",
      "nur bei Licht (als einziger Beitrag)",
    ],
    0,
  ...
  q(
    ...
    [
      "die Kräfte auf beiden Seiten sind stets betragsmäßig gleich",
      "bei Gleichgewicht: Kraft mal Hebelarm auf beiden Seiten gleich",
      "der Hebelarm r ist bei jedem Gleichgewicht stets null",
      "das Gesetz gilt nur bei geraden, nicht bei gebogenen Hebeln",
      "F₁ = F₂ unabhängig von den jeweiligen Hebelarmlängen",
    ],
    1,
  ...
  q(
    ...
    [
      "V / T = const (als mögliche Antwort)",
      "p · V = const",
      "p / T = const (als mögliche Antwort)",
      "n · R = const (als mögliche Antwort)",
      "p + V = const (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    "Ein Transformator:",
    [
      "erzeugt Gleichstrom aus einer beliebigen Energiequelle",
      "ändert die Wechselspannung durch elektromagnetische Induktion",
      "speichert elektrische Ladung in seinem Eisenkern",
      "verstärkt ausschließlich den Strom ohne Spannungsänderung",
      "funktioniert mit Gleich- und Wechselspannung gleich gut",
    ],
    1,
  ...
  q(
    ...
    ["m/s (Meter pro Sekunde, Geschwindigkeit)", "m/s²", "N (Newton, Kraft)", "J (Joule, Energie)", "kg (Kilogramm, Masse)"],
    1,
  ...
  q(
    ...
    [
      "immer 1 (als mögliche Antwort)",
      "η = abgegebene Nutzleistung / zugeführte Wärmeleistung",
      "immer 0 (als mögliche Antwort)",
  ...
  q(
    ...
    ["Ohm (als mögliche Antwort)", "Farad (F)", "Henry (als mögliche Antwort)", "Tesla (als mögliche Antwort)", "Weber (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    [
      "radioaktive Kerne spontan in leichtere Fragmente zerfallen",
      "schnelle Elektronen abgebremst werden oder Elektronen in inneren Schalen springen",
      "die Temperatur des Materials einen kritischen Schwellenwert übersteigt",
      "sichtbares Licht an metallischen Oberflächen reflektiert wird",
      "Alpha-Teilchen auf Materie treffen und dort ionisieren",
    ],
    1,
  ...
  q(
    ...
    [
      "die Temperatur (als einzige relevante Größe)",
      "die innere Energie (als physikalische Erklärung)",
      "die Unordnung / Anzahl der Mikrozustände",
      "die Wärme (als mögliche Antwort)",
      "den Druck (als einzige relevante Größe)",
    ],
    2,
  ...
  q(
    ...
    [
      ...
      "Festlegung der Schwingungsrichtung",
      "nur bei Laserlicht (als einziger Beitrag)",
      "Absorption (Aufnahme von Strahlung durch Materie)",
      "Dispersion (frequenzabhängige Ausbreitungsgeschwindigkeit)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Permanentmagnete (als einziger Beitrag)",
      "stromdurchflossene Spule",
      "nur Gleichstrom (als einziger Beitrag)",
      "nur Wechselstrom (als einziger Beitrag)",
      "ungeladene Körper",
    ],
    1,
