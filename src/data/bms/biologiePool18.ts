...
export const biologiePool18: Question[] = [
  ...
  q(
    ...
    [
      ...
      "Sie vereint Darwins Selektionstheorie mit der Genetik (Mendel), Populationsgenetik und Mutationsforschung",
  ...
  q(
    ...
    [
      ...
      "Sexuelle Selektion durch Partnerwahl (intersexuelle Selektion)",
  ...
  q(
    ...
    [
      ...
      "Sie waren an kaltes Klima angepasst (robuster Körperbau)",
    ],
    3,
  ...
  q(
    ...
    ["1", "2", "3", "4", "0 (Eizellen entstehen anders)"],
    0,
  ...
  q(
    ...
    [
      ...
      "Sie findet in den Samenkanälchen (Tubuli seminiferi) des Hodens statt",
  ...
  q(
    ...
    [
      ...
      "Die Fähigkeit einer Zelle, einen kompletten Organismus inklusive extraembryonaler Gewebe (z. B. Plazenta) zu bilden",
  ...
  q(
    ...
    [
      ...
      "Embryonalperiode (Woche 3–8), da hier die Organogenese stattfindet",
      "Fetalperiode (ab Woche 9), da hier das Wachstum erfolgt",
      "Kurz vor der Geburt (ab Woche 36)",
    ],
    2,
