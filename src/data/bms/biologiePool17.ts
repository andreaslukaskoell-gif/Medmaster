...
export const biologiePool17: Question[] = [
  ...
  q(
    ...
    [
      ...
      "Gastrulation (Keimblattbildung mit Ektoderm, Mesoderm und Entoderm)",
      "Geburt (Partus am Ende der Schwangerschaft nach ca. 40 Wochen)",
      "Organogenese (Differenzierung und Anlage der embryonalen Organsysteme)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Haploid (einfacher Chromosomensatz, n, wie in reifen Keimzellen)",
      "Ein Allel (eine Variante eines Gens an einem bestimmten Locus)",
      "Rezessiv (Merkmal zeigt sich nur bei homozygotem Genotyp, z. B. aa)",
    ],
    1,
