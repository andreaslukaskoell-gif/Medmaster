...
export const physikPool19: Question[] = [
  ...
  q(
    ...
    ["Stromstärke", "Arbeit pro Ladung", "Ladung", "Kapazität", "Feldstärke mal Zeit"],
    1,
  ...
  q(
    ...
    ["kg (Kilogramm, Masse)", "N (Newton)", "J", "W (Watt, Leistung)", "Pa (Pascal, Druck)"],
    1,
  ...
  q(
    ...
    ["nur Reflexion", "Aufspaltung in Farben", "Totalreflexion", "Absorption", "Polarisation"],
    1,
