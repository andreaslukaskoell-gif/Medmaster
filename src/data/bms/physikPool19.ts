...
export const physikPool19: Question[] = [
  ...
  q(
    ...
    [
      "Stromstärke (als mögliche Antwort)",
      "Arbeit pro Ladung",
      "Ladung (elektrische Grundeigenschaft, Einheit Coulomb)",
      "Kapazität (Ladungsspeichervermögen, Einheit Farad)",
      "Feldstärke mal Zeit",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "ist die kinetische Energie nicht erhalten",
      "ist der Impuls nicht erhalten (unter Standardbedingungen)",
      "bleibt die Geschwindigkeit gleich",
      "ist die Masse nicht erhalten (unter Standardbedingungen)",
    ],
    1,
  ...
  q(
    ...
    ["E = f (einfacher Zusammenhang)", "E = h·f", "E = h/f (einfacher Zusammenhang)", "E = c·f (einfacher Zusammenhang)", "E = m·c² (Kraftgesetz)"],
    1,
  ...
  q(
    ...
    [
      ...
      "sinkt die Temperatur (unter diesen Bedingungen)",
      "wird Wärme abgegeben (unter Standardbedingungen)",
  ...
  q(
    ...
    ["kg (Kilogramm, Masse)", "N (Newton)", "J (Joule, Energie)", "W (Watt, Leistung)", "Pa (Pascal, Druck)"],
    1,
  ...
  q(
    ...
    [
      "ist null (unabhängig von den Bedingungen)",
      "ist sehr klein",
      "ist unendlich (als mögliche Antwort)",
      "ist gleich der von Alpha (unter Standardbedingungen)",
  ...
  q(
    ...
    [
      ...
      "nur die Reichweite (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      "der Anodenspannung nur (als physikalische Erklärung)",
      "der Art des Anodenmaterials",
      "nur der Stromstärke (als einziger Beitrag)",
      "nur der Brennfleckgröße (als einziger Beitrag)",
      "der Fokus-Weite (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "nur Dispersion (ausschließlich, ohne weitere Beiträge)",
      "nur Absorption (ausschließlich, ohne weitere Beiträge)",
      "nur Streuung (ausschließlich, ohne weitere Beiträge)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "nicht messbar (unterhalb der Nachweisgrenze)",
    ],
    1,
