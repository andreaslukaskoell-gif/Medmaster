...
export const biologiePool5: Question[] = [
  ...
  q(
    ...
    [
      ...
      "Der MAC bildet Poren in Zellmembranen.",
  ...
  q(
    ...
    [
      ...
      "Retroviren nutzen Reverse Transkriptase.",
    ],
    3,
  ...
  q(
    ...
    [
      ...
      "Zytokine wirken ausschließlich systemisch (endokrin)",
  ...
  q(
    ...
    [
      ...
      "Die Fovea centralis hat die höchste Zapfendichte.",
  ...
  q(
    ...
    [
      "Zentrale Toleranz findet im Thymus (T-Zellen)",
  ...
  q(
    ...
    [
      ...
      "Checkpoint-Inhibitoren verstärken die Antitumor-Immunantwort.",
