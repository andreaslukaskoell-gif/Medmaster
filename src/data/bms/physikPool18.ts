...
export const physikPool18: Question[] = [
  ...
  q(
    ...
    [
      "der Gewichtskraft des Körpers (als physikalische Erklärung)",
      "der Gewichtskraft der verdrängten Flüssigkeit",
      "null (kein Beitrag, verschwindet)",
      "der Masse des Körpers (als physikalische Erklärung)",
  ...
  q(
    ...
    [
      ...
      "zwei Gamma-Quanten",
      "nur einem Photon (als einziger Beitrag)",
      "Beta-Strahlung (als mögliche Antwort)",
  ...
  q(
    ...
    ["g·sin(α) = λ (als mögliche Antwort)", "g·sin(α) = k·λ", "sin(α) = g·λ (als mögliche Antwort)", "g = λ (als mögliche Antwort)", "keine Maxima (als physikalische Größe)"],
    1,
    "Gitter: g·sin(α) = k·λ.",
    "mittel",
    ["Gitter", "Beugung"]
  ...
  q(
    ...
    [
      "Bleiwand (als mögliche Antwort)",
      "dünnem Papier oder wenigen cm Luft",
      "Beton (als mögliche Antwort)",
      "Wasser mehreren Metern",
      "nur Vakuum (ausschließlich, ohne weitere Beiträge)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "ruhenden Körpern",
      "fallenden Körpern",
      "schwingenden Körpern (als physikalischer Prozess)",
    ],
    1,
  ...
  q(
    ...
    [
      "von hoch zu runter",
      "von runter zu hoch",
      "nicht (als mögliche Antwort)",
      "nur bei Gleichstrom (als einziger Beitrag)",
      "nur die Stromstärke (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    ["p = E_kin·v (als mögliche Antwort)", "p = m·v, E_kin = ½·m·v²", "p = E_kin/m (als mögliche Antwort)", "p = 2·E_kin·v (als mögliche Antwort)", "E_kin = p·v (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    ["m (Meter, Länge)", "mm (Millimeter, 10⁻³ m)", "nm bis pm", "km (Kilometer, 10³ m)", "µm nur (ohne andere Mechanismen)"],
    2,
  ...
  q(
    ...
    [
      "kleiner (geringerer Betrag)",
      "größer",
      "gleich (identischer Betrag)",
      "unbestimmt (als mögliche Antwort)",
      "nur bei 0 °C größer (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    ["q·B (einfaches Verhältnis der Größen)", "q·v·B", "q/v·B (als mögliche Antwort)", "q + v + B (als mögliche Antwort)", "nur B (ausschließlich, ohne weitere Beiträge)"],
    1,
  ...
  q(
    ...
    [
      "nur künstlichen Quellen (als einziger Beitrag)",
      "kosmischer Strahlung, Radon, terrestrischer Strahlung",
      "nur Röntgen (als einziger Beitrag)",
      "nur Kernkraftwerken (als einziger Beitrag)",
  ...
  q(
    ...
    [
      "nur virtuelle Bilder (als einziger Beitrag)",
      "reelle und virtuelle Bilder",
      "keine Bilder (als physikalische Größe)",
      "nur vergrößerte Bilder (als einziger Beitrag)",
      "nur verkleinerte Bilder (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Permanentmagnet (als einziger Beitrag)",
      "stromdurchflossener Spule",
      "nur Kondensator (als einziger Beitrag)",
      "nur Widerstand (ausschließlich, ohne weitere Beiträge)",
      "nur Batterie (ausschließlich, ohne weitere Beiträge)",
    ],
    1,
