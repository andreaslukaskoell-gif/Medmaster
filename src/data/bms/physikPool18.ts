...
export const physikPool18: Question[] = [
  ...
  q(
    ...
    [
      "g·sin(α) = λ (als mögliche Antwort)",
      "g·sin(α) = k·λ",
      "sin(α) = g·λ (als mögliche Antwort)",
      "g = λ (als mögliche Antwort)",
  ...
  q(
    ...
    [
      "p = E_kin·v (als mögliche Antwort)",
      "p = m·v, E_kin = ½·m·v²",
      "p = E_kin/m (als mögliche Antwort)",
      "p = 2·E_kin·v (als mögliche Antwort)",
      "E_kin = p·v (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "nm bis pm",
      "km (Kilometer, 10³ m)",
      "µm nur (ohne andere Mechanismen)",
    ],
    2,
  ...
  q(
    ...
    [
      "q·B (einfaches Verhältnis der Größen)",
      "q·v·B",
      "q/v·B (als mögliche Antwort)",
      "q + v + B (als mögliche Antwort)",
