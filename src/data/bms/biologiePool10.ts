...
export const biologiePool10: Question[] = [
  ...
  q(
    ...
    ["dominant-rezessiv", "intermediär", "X-chromosomal", "polygen", "mitochondrial"],
    1,
    "Bei intermediärer Vererbung zeigt der Heterozygote einen Mischphänotyp. Dominant-rezessiv: Heterozygote wie Dominante.",
    "mittel",
    ["Vererbung", "Genetik"]
  ),
  q(
  ...
  q(
    ...
    1,
    "Die ökologische Amplitude ist der Toleranzbereich einer Art gegenüber einem Umweltfaktor.",
    "mittel",
    ["Ökologie"]
  ),
  q(
  ...
  q(
    ...
    2,
    "Mitochondrien haben eigene ringförmige DNA – Endosymbiontentheorie.",
    "leicht",
    ["Zelle", "Mitochondrien"]
  ),
  q(
  ...
  q(
    ...
    2,
    "Die oxidative Phosphorylierung liefert mit Abstand die meisten ATP. Glykolyse allein nur 2 ATP netto.",
    "mittel",
    ["Stoffwechsel", "ATP"]
  ),
  q(
  ...
  q(
    ...
    1,
    "In der 4.–8. Woche laufen Organogenese und frühe Differenzierung ab; hier sind Fehlbildungen durch Noxen besonders häufig.",
    "mittel",
  ...
  q(
    ...
    1,
    "Der Karyotyp ist die Darstellung der Chromosomen, z. B. zur Erkennung von Chromosomenanomalien.",
    "mittel",
    ["Genetik", "Chromosomen"]
  ),
  q(
  ...
  q(
    ...
    "Was ist die Morula?",
    [
      "Ein frühes Entwicklungsstadium mit solidem Zellhaufen",
  ...
  q(
    ...
    1,
    "Der Gasaustausch erfolgt in den Lungenbläschen (Alveolen) über die Blut-Luft-Schranke.",
    "leicht",
    ["Atmung", "Lunge"]
  ),
  q(
  ...
  q(
    ...
    4,
    "Blutserum ist Plasma ohne Gerinnungsfaktoren – z. B. nach Gerinnung. E ist also falsch.",
    "mittel",
    ["Blut", "FALSCH"]
  ),
  q(
  ...
  q(
    "bio-pool-10-057",
    "bio-kap2",
    "Welche Struktur im Auge enthält die Photorezeptoren?",
    [
  ...
  q(
    "bio-pool-10-058",
    "bio-kap4",
    "Ein Mann mit Blutgruppe A und eine Frau mit Blutgruppe B können ein Kind mit welcher Blutgruppe haben?",
  ...
  q(
    ...
    1,
    "Die Leber bildet Harnstoff im Harnstoffzyklus aus Ammoniak. Die Niere scheidet ihn aus.",
    "mittel",
    ["Stoffwechsel", "Leber"]
  ),
  q(
    ...
    0,
    "Die Blastozyste entsteht aus der Morula; sie hat eine Keimhöhle (Blastocele) und eine innere Zellmasse sowie den Trophoblasten (Plazentaanteil).",
    "mittel",
    ["Embryologie"]
  ),
];
