...
export const biologiePool10: Question[] = [
  q(
    ...
    [
      "Mitochondrienmatrix (innerer Raum mit Citratzyklus-Enzymen und mtDNA)",
      "Innere Mitochondrienmembran",
      "Zytosol (wässriges Kompartiment des Zytoplasmas außerhalb der Organellen)",
  ...
  q(
    ...
    [
      "den Magen (Gaster) mit seiner Salzsäureproduktion",
      "das Duodenum (Zwölffingerdarm)",
      "das Jejunum (Leerdarm) im mittleren Dünndarmabschnitt",
      "den Dickdarm (Colon) mit seinen Haustren",
      "die Leber (Hepar) als zentrales Stoffwechselorgan",
    ],
    1,
  ...
  q(
    ...
    [
      "Trikuspidalklappe (dreisegelig, rechtes Herz, AV-Klappe)",
      "Pulmonalklappe (Taschenklappe am Truncus pulmonalis)",
      "Aortenklappe (Taschenklappe am Aortenbulbus)",
      "Mitralklappe (Bikuspidalklappe)",
      "Vena-cava-Klappe (rudimentäre Eustachi-Klappe)",
    ],
    3,
  ...
  q(
    ...
    [
      "dominant-rezessiv (ein Allel bestimmt den Phänotyp vollständig)",
      "intermediär (kodominant bei Ausprägung)",
      "X-chromosomal (geschlechtsgebundene Vererbung über das X)",
      "polygen (mehrere Gene bestimmen ein Merkmal additiv)",
      "mitochondrial (maternale Vererbung über die mtDNA-Linie)",
    ],
    1,
  ...
  q(
    ...
    [
      "Trennung der Schwesterchromatiden in der Anaphase der Mitose",
      "Austausch von Chromosomenabschnitten zwischen homologen Chromosomen",
      "Verdopplung der DNA in der S-Phase vor der Zellteilung",
      "Kondensation der Chromosomen durch Histonkompaktierung in der Prophase",
  ...
  q(
    ...
    [
      "Glykolyse",
      "Citratzyklus (Krebszyklus in der mitochondrialen Matrix)",
  ...
  q(
    ...
    [
      "vor den Produzenten an der Basis der trophischen Pyramide",
      "auf der gleichen trophischen Stufe wie die Destruenten",
      "nach den Produzenten und ernähren sich von diesen oder anderen Konsumenten",
      "nur am Ende der Nahrungskette als Endkonsumenten",
      "nur von abgestorbenem Material wie die Destruenten",
    ],
    2,
  ...
  q(
    ...
    [
      ...
      "Im 3. Trimenon (27.–40. Schwangerschaftswoche)",
      "Nur bei der Geburt (perinatale Phase des Kindes)",
      "Nach der Geburt (in der postnatalen Entwicklungsphase)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Die RNA einer Zelle (Transkriptom mit mRNA, rRNA, tRNA)",
      "Die Proteine im Zytoplasma (das Proteom einer Zelle)",
      "Die Mitochondrien-DNA (zirkuläres Genom in der Matrix)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur phänotypisch gesunde Kinder ohne Anlageträgerschaft haben",
      "nur phänotypisch erkrankte Kinder mit Symptomausprägung haben",
      "kranke Kinder haben, wenn beide heterozygot (Konduktoren) sind",
      "keine lebensfähigen Kinder haben aufgrund der Genveränderung",
      "nur heterozygote (mischerbige) Kinder als Anlageträger haben",
    ],
    2,
  ...
  q(
    ...
    "Was ist ein Codon?",
    [
      "Eine dreifache Basenabfolge auf der DNA (Triplett im codogenen Strang)",
      "Eine dreifache Basenabfolge auf der mRNA, die für eine Aminosäure codiert",
      "Ein Abschnitt auf der tRNA (Anticodon-Schleife mit drei Basen)",
      "Ein Gen (codierender DNA-Abschnitt für ein Genprodukt)",
      "Ein Chromosomenabschnitt (Band in der zytogenetischen Kartierung)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Aus Ektoderm und Mesoderm",
      "Aus Entoderm und Mesoderm",
    ],
    2,
  ...
  q(
    ...
    [
      ...
      "Im Mitochondrium",
      "Im Golgi-Apparat (Zisternenstapel für posttranslationale Modifikation)",
  ...
  q(
    ...
    [
      "Lederhaut (Sklera) als äußere Bindegewebshülle",
      "Hornhaut (Kornea) als lichtbrechendes Medium",
      "Netzhaut (Retina)",
      "Linse (kristalline Struktur hinter der Iris)",
  ...
  q(
    ...
    [
      ...
      "Die Plazenta (Mutterkuchen als materno-fetales Austauschorgan)",
      "Die Fruchtblase (Amnionhöhle mit Fruchtwasser zum Schutz)",
      "Die Morula (kompakter Zellhaufen vor der Blastozystenbildung)",
    ],
    0,
