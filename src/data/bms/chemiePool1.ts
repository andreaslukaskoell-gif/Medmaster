...
export const chemiePool1: Question[] = [
  ...
  q(
    ...
    [
      "MgO ist kovalent gebunden und bildet kein Ionengitter.",
      "Mg²⁺ und O²⁻ haben höhere Ionenladungen und kleinere Radien als Na⁺ und Cl⁻.",
      "NaCl ist ein Molekül mit gerichteten Bindungen.",
      "MgO enthält weniger Ionen pro Formeleinheit im Gitter.",
      "NaCl hat eine höhere Gitterenergie als MgO aufgrund der Struktur.",
    ],
    1,
  ...
  q(
    ...
    [
      "nur H₃O⁺ als einziges Produkt der Dissoziation",
      "nur OH⁻ als einziges Produkt der Dissoziation",
      "H₃O⁺ und OH⁻ zu gleichen Konzentrationen in reinem Wasser",
      "O₂ und H₂ durch homolytische Spaltung der Bindungen",
      "H₂O₂",
    ],
    2,
  ...
  q(
    ...
    [
      ...
      "HCl ist eine schwache Säure mit pKs-Wert über 4.",
      "Eine Base nimmt H⁺ nicht auf, sondern gibt sie ab.",
      "Der pH einer starken Säure beträgt unabhängig von c immer 7.",
      "Säuren enthalten per Definition keine austauschbaren H-Atome.",
    ],
    0,
  ...
  q(
    ...
    [
      "Neopentan hat eine Doppelbindung zwischen den mittleren C-Atomen.",
      "n-Pentan hat eine größere Kontaktfläche und stärkere van-der-Waals-Kräfte.",
      "Neopentan ist polar aufgrund seiner verzweigten Struktur.",
      "n-Pentan hat intermolekulare H-Brücken zwischen CH-Gruppen.",
      "Neopentan hat mehr C-Atome als n-Pentan in der Kette.",
    ],
    1,
  ...
  q(
    ...
    [
      "er keine H⁺-Ionen enthält und so den pH stabilisiert",
      "er nur aus reinem Wasser besteht und daher neutral bleibt",
      "er eine konjugierte Säure-Base-Paar enthält, die H⁺ abfängt oder abgibt",
      "der pH im Pufferbereich unabhängig von der Zugabe immer 7 ist",
      "er keine Base enthält und daher keine OH⁻-Ionen bildet",
    ],
    2,
  ...
  q(
    ...
    [
      "ist die Energie, die zum Schmelzen des Gitters bei 1 bar nötig ist",
      "ist die bei der Bildung des Gitters aus gasförmigen Ionen freigesetzte Energie",
      "ist unabhängig von den Ionenradien und Ladungen der Ionen",
      "ist bei NaCl größer als bei MgO wegen der Koordinationszahl",
      "kann direkt kalorimetrisch gemessen werden ohne Kreisprozess",
    ],
    1,
