...
export const chemiePool20: Question[] = [
  q(
    ...
    [
      "nur der Masse (gemessen in Gramm oder Kilogramm)",
      "der Teilchenzahl N (n = N/N_A)",
      "nur dem Volumen (Liter oder Kubikmeter der Probe)",
      "nur dem Druck (Pascal oder Bar, als Zustandsgröße)",
      "der Temperatur (Kelvin oder Grad Celsius des Systems)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "nur die Periode (Zeile im PSE, gibt die Schalenanzahl an)",
      "nur die Isotopie (verschiedene Neutronenzahl bei gleichem Z)",
  ...
  q(
    ...
    [
      "maximal (alle Mikrozustände gleich wahrscheinlich bei 0 K)",
      "minimal (3. Hauptsatz: S → 0 für T → 0)",
      "immer gleich, unabhängig von der Temperatur des Systems",
      "unabhängig von T, da die Entropie nur vom Volumen abhängt",
      "immer null (per Definition, ohne physikalische Begründung)",
    ],
    1,
  ...
  q(
    ...
    [
      "ist die Reaktion im Gleichgewicht (keine Nettoreaktion mehr)",
      "läuft die Reaktion freiwillig in die angegebene Richtung ab",
      "läuft die Reaktion nicht ab (kinetisch gehemmt, keine Produkte)",
      "ist ΔH immer null (kein Wärmeaustausch mit der Umgebung)",
      "ist ΔS immer null (keine Änderung der Unordnung im System)",
    ],
    1,
  ...
  q(
    ...
    [
      "Alkohol und Ester (durch Umesterungsreaktion)",
      "Carbonsäure und Amin/Ammoniak",
      "nur Alkohol (durch Dehydratisierung zu Ether)",
      "Aldehyd und Keton (Aldolkondensationsreaktion)",
      "Ether (gebildet aus zwei Alkoholen unter Säurekatalyse)",
    ],
    1,
  ...
  q(
    ...
    "Ein Lactam ist:",
    [
      "ein Lacton (cyclischer Ester mit intramolekularer O−C=O-Gruppe)",
      ...
      "ein Keton (Carbonylgruppe C=O zwischen zwei Kohlenstoffatomen)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur die Stöchiometrie (molare Verhältnisse in der Reaktionsgleichung)",
      "Variation der Anfangskonzentrationen und Messung der Anfangsgeschwindigkeit",
      "nur die Temperatur (Arrhenius-Gleichung, Geschwindigkeitskonstante)",
      "nur den Katalysator (Einfluss auf die Aktivierungsenergie der Reaktion)",
      "die Gleichgewichtskonstante K (thermodynamisches Gleichgewicht bei T)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Volumenänderung (Expansion oder Kompression des Systems)",
      "Wärme Q und Arbeit W (ΔU = Q + W)",
      "nur Temperatur (kinetische Energie der Teilchen im System)",
      "nur Druck (äußere Kraft pro Fläche auf das System)",
      "nur Stoffmenge (Anzahl der Mole im betrachteten System)",
    ],
    1,
  ...
  q(
    ...
    [
      "Sie haben immer pH 7 (exakt neutral bei jeder Zusammensetzung)",
      "Sie halten den pH bei Zugabe von wenig Säure oder Base annähernd konstant",
      "Sie enthalten keine Säure oder Base als Bestandteil im System",
      "Sie ändern den pH stark bei Zugabe von Säure oder Base",
      "Sie sind immer stark sauer mit einem pH-Wert deutlich unter 7",
    ],
    1,
  ...
  q(
    ...
    [
      "keinen Katalysator (die Reaktion läuft spontan ohne Hilfe)",
      "einen Katalysator (z. B. FeBr₃ oder Fe)",
      "nur UV-Licht (photolytische Spaltung zur Radikalbildung)",
      "nur hohe Temperatur (thermische Aktivierung der Aromaten)",
      "nur Druck (mechanische Aktivierung der Bindungsspaltung)",
    ],
    1,
  ...
  q(
    ...
    [
      "Metalle sind nicht leitfähig, weil keine freien Ladungsträger existieren",
      "Die Leitfähigkeit beruht auf beweglichen (delokalisierten) Elektronen",
      "Es gibt nur Ionen im Metallgitter, keine Elektronen als Ladungsträger",
      "Metalle haben keine Valenzelektronen und sind daher elektrisch inert",
      "Die Bindung in Metallen ist rein kovalent (Elektronenpaarbindung)",
    ],
    1,
  ...
  q(
    ...
    [
      "der Katalysator die Gleichgewichtskonzentrationen direkt festlegt",
      "die Konzentrationen im Gleichgewicht durch das Massenwirkungsgesetz verknüpft sind",
      "der Druck sie festlegt (unabhängig von Temperatur und Konzentration)",
      "sie immer 1 ist, egal bei welcher Temperatur und welchem System",
      "die Reaktion dann vollständig stoppt und keine Umsetzung mehr erfolgt",
    ],
    1,
  ...
  q(
    ...
    [
      "Addition an eine C=C-Doppelbindung (elektrophile Anlagerung)",
      "substituiertem Aromat (Alkylrest wird eingeführt)",
      "Oxidation eines Aromaten (Elektronenabgabe an Oxidationsmittel)",
      "Reduktion des Aromaten (Elektronenaufnahme, Hydrierung des Rings)",
      "Esterbildung aus Carbonsäure und aromatischem Alkohol (Phenol)",
    ],
    1,
