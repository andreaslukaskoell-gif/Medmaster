...
export const physikPool5: Question[] = [
  ...
  q(
    ...
    [
      ...
      "der Wellenlänge (als physikalische Erklärung)",
      "der Periode (als einzige relevante Größe)",
      "1/f (als Kehrwert der Größe)",
    ],
    1,
  ...
  q(
    ...
    [
      "D = f (einfacher Zusammenhang)",
      "D = 1/f",
      "D = f² (einfacher Zusammenhang)",
      "D = 2f (einfacher Zusammenhang)",
      "D = f/2 (einfacher Zusammenhang)",
    ],
    1,
  ...
  q(
    ...
    [
      "2 m/s (als Geschwindigkeitswert)",
      "ca. 6,3 m/s",
