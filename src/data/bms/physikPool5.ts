...
export const physikPool5: Question[] = [
  ...
  q(
    ...
    [
      "8,31 J/(mol·K)",
      "0,082 L·atm/(mol·K)",
      "8,31 J/mol (als physikalischer Wert)",
      "A und B sind beide gebräuchlich",
      "1 J/K (als physikalischer Wert)",
    ],
    3,
  ...
  q(
    ...
    [
      "tangential (als mögliche Antwort)",
      "radial nach außen",
      "radial nach innen",
  ...
  q(
    ...
    ["der Frequenz (als einzige relevante Größe)", "dem Quadrat der Amplitude", "der Wellenlänge (als physikalische Erklärung)", "der Periode (als einzige relevante Größe)", "1/f (als Kehrwert der Größe)"],
    1,
  ...
  q(
    ...
    [
      "nur abnehmen (ausschließlich, ohne weitere Beiträge)",
      "nur zunehmen oder konstant bleiben",
      "beliebig abnehmen",
      "nur bei Wärmezufuhr zunehmen",
      "null werden (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "nur die Dosisrate (als einziger Beitrag)",
  ...
  q(
    ...
    [
      ...
      "immer bei Schall",
      "nur in Flüssigkeiten (als einziger Beitrag)",
      "die Amplitude null ist (als physikalische Erklärung)",
  ...
  q(
    ...
    [
      "nur Impuls (ausschließlich, ohne weitere Beiträge)",
      "Impuls und kinetische Energie",
      "nur Energie (ausschließlich, ohne weitere Beiträge)",
      "nur Masse (ausschließlich, ohne weitere Beiträge)",
      "nur Geschwindigkeit (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    ["D = f (einfacher Zusammenhang)", "D = 1/f", "D = f² (einfacher Zusammenhang)", "D = 2f (einfacher Zusammenhang)", "D = f/2 (einfacher Zusammenhang)"],
    1,
  ...
  q(
    ...
    ["2 m/s (als Geschwindigkeitswert)", "ca. 6,3 m/s", "10 m/s (als Geschwindigkeitswert)", "4 m/s (als Geschwindigkeitswert)", "20 m/s (als Geschwindigkeitswert)"],
    1,
