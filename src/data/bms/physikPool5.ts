...
export const physikPool5: Question[] = [
  ...
  q(
    ...
    ["tangential", "radial nach außen", "radial nach innen", "in Bewegungsrichtung", "gar nicht"],
    2,
  ...
  q(
    ...
    ["Energiedosis", "Aktivität", "Äquivalentdosis", "Ladung", "Stromstärke"],
    1,
