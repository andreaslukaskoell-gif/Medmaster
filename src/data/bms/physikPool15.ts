...
export const physikPool15: Question[] = [
  ...
  q(
    ...
    [
      "J (Joule, Energie)",
      "J/",
      "J/K (Joule pro Kelvin, Entropie)",
      "kg/J (als mögliche Antwort)",
  ...
  q(
    ...
    [
      "0",
      "λ/2",
      "λ (eine vollständige Wellenlänge)",
      "2λ (doppelte Wellenlänge)",
      "λ/4 (Viertel der Wellenlänge)",
    ],
    1,
  ...
  q(
    ...
    [
      "H/m",
      "F/m (Farad pro Meter, Permittivität)",
  ...
  q(
    ...
    [
      "der Frequenz (als einzige relevante Größe)",
      "dem Quadrat der Amplitude",
      "der Masse allein (als physikalische Erklärung)",
      "der Zeit (als einzige relevante Größe)",
      "der Dämpfung (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      "maximal (als mögliche Antwort)",
      "minimal",
      "null (kein Beitrag, verschwindet)",
      "unendlich (unbegrenzt groß)",
      "gleich X_L (als mögliche Antwort)",
    ],
    1,
