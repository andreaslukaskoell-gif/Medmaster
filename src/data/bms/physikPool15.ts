...
export const physikPool15: Question[] = [
  ...
  q(
    ...
    ["J (Joule, Energie)", "J/", "J/K (Joule pro Kelvin, Entropie)", "kg/J (als mögliche Antwort)", "W/s (einfaches Verhältnis der Größen)"],
    1,
  ...
  q(
    ...
    [
      ...
      "nur Dämpfung (als einziger Beitrag)",
      "nur Resonanz (ausschließlich, ohne weitere Beiträge)",
      "nur Beugung (ausschließlich, ohne weitere Beiträge)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "den Schmelzpunkt",
      "die Wärmeleitfähigkeit (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    [
      "ist immer 90° (unabhängig von den Bedingungen)",
      "ist kleiner als der Einfallswinkel",
  ...
  q(
    ...
    [
      "nur an den Innenraum (als einziger Beitrag)",
      "an die Umgebung",
      "gar nicht (als mögliche Antwort)",
      "nur durch Strahlung (als einziger Beitrag)",
      "nur bei 0 °C (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "ein Alpha-Teilchen",
      "zwei Photonen (als mögliche Antwort)",
  ...
  q(
    ...
    [
      "E = m·g·h (Kraftgesetz)",
      "E = −G·m₁·m₂/r",
      "E = G·m₁·m₂·r (Kraftgesetz)",
      "E = m·v²/r (Kraftgesetz)",
      "E = F·r (einfacher Zusammenhang)",
    ],
    1,
  ...
  q(
    ...
    [
      "steigt linear mit der Zeit (unter diesen Bedingungen)",
      "stellt sich bei konstanter Temperatur auf einen konstanten Sättigungswert ein",
      "ist immer null (unabhängig von den Bedingungen)",
  ...
  q(
    ...
    [
      ...
      "dem Widerstand (als einzige relevante Größe)",
      "der Ladung (als einzige relevante Größe)",
  ...
  q(
    ...
    [
      ...
      "Aktivität",
      "Äquivalentdosis",
      "Halblebenszeit (skalierter Wert)",
  ...
  q(
    ...
    [
      "größer (höherer Betrag)",
      "kleiner",
      "gleich (identischer Betrag)",
      "unbestimmt (als mögliche Antwort)",
  ...
  q(
    ...
    [
      ...
      "der Innenwiderstand null ist (als physikalische Erklärung)",
  ...
  q(
    ...
    ["0", "λ/2", "λ (eine vollständige Wellenlänge)", "2λ (doppelte Wellenlänge)", "λ/4 (Viertel der Wellenlänge)"],
    1,
  ...
  q(
    ...
    [
      ...
      "wird gespeichert (im System verbleibend)",
      "verschwindet (vollständig umgewandelt)",
      "wird in Masse umgewandelt (unter Standardbedingungen)",
  ...
  q(
    ...
    ["H/m", "F/m (Farad pro Meter, Permittivität)", "N·m (Newtonmeter, Drehmoment)", "T (Tesla, magn. Flussdichte)", "C (Coulomb, Ladung)"],
    0,
    "μ₀ in H/m; 4π·10⁻⁷ H/m.",
    "mittel",
  ...
  q(
    ...
    [
      "nur der Dichte (als einziger Beitrag)",
      "der Temperatur und der Molmasse (c ∝ √(T/M))",
      "nur dem Druck (als einziger Beitrag)",
      "nur der Frequenz (als einziger Beitrag)",
      "der Amplitude (als einzige relevante Größe)",
    ],
    1,
    "c_Gas ∝ √(γ·R·T/M).",
    "mittel",
  ...
  q(
    ...
    [
      ...
      "hat keine Brennweite (unter Standardbedingungen)",
      "erzeugt nur virtuelle Bilder",
      "hat f < 0 (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      "ist immer 1 (unabhängig von den Bedingungen)",
      "ist ≥ 1 und beschreibt die Erhöhung der Kapazität gegenüber dem Vakuum",
      "ist immer 0 (unabhängig von den Bedingungen)",
      "hat die Einheit Farad (unter Standardbedingungen)",
      "ist nur für Metalle definiert (unter Standardbedingungen)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "der Kern keine Neutronen hat (als physikalische Erklärung)",
      "die Ordnungszahl 82 ist (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur gleichförmige horizontale Bewegung ohne vertikalen Anteil",
      "Überlagerung von gleichförmiger horizontaler und beschleunigter vertikaler Bewegung",
      "nur gleichmäßig beschleunigte vertikale Bewegung ohne horizontalen Anteil",
      "gleichförmige Kreisbewegung mit konstanter Winkelgeschwindigkeit",
      "konstante Beschleunigung in Wurfrichtung ohne Gravitationseinfluss",
    ],
    1,
  ...
  q(
    ...
    ["der Frequenz (als einzige relevante Größe)", "dem Quadrat der Amplitude", "der Masse allein (als physikalische Erklärung)", "der Zeit (als einzige relevante Größe)", "der Dämpfung (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    ["maximal (als mögliche Antwort)", "minimal", "null (kein Beitrag, verschwindet)", "unendlich (unbegrenzt groß)", "gleich X_L (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    [
      ...
      "die Entropie abnimmt (als physikalische Erklärung)",
