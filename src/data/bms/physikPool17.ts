...
export const physikPool17: Question[] = [
  ...
  q(
    ...
    ["100 Pa", "1000 Pa", "100 000 Pa", "10 000 Pa", "1 Pa"],
    2,
  ...
  q(
    ...
    ["der Masse", "ω und v", "nur r", "der Zeit", "g (Gramm, Masse)"],
    1,
    "Coriolis: a_C ∝ ω×v.",
    "schwer",
  ...
  q(
    ...
    ["p·V = const", "p·V^κ = const", "T·V = const", "p/T = const", "V/T = const"],
    1,
