...
export const physikPool17: Question[] = [
  ...
  q(
    ...
    [
      "Geschwindigkeit (Weg pro Zeit, Einheit m/s)",
      "Normalkraft F_N: F_R = μ·F_N",
      "Masse (Trägheitseigenschaft, Einheit Kilogramm)",
      "Fläche (als mögliche Antwort)",
  ...
  q(
    ...
    [
      "100 Pa (als Zahlenwert mit Einheit)",
      "1000 Pa (als Zahlenwert mit Einheit)",
      "100 000 Pa",
      "10 000 Pa",
      "1 Pa (als Zahlenwert mit Einheit)",
    ],
    2,
  ...
  q(
    ...
    [
      "A·d/ΔT (als mögliche Antwort)",
      "A·ΔT/d",
      "d/(A·ΔT) (als mögliche Antwort)",
      "A + ΔT (als mögliche Antwort)",
      "1/A",
    ],
    1,
    "Q̇ = λ·A·ΔT/d (Fourier).",
  ...
  q(
    ...
    [
      "0° (gleichphasig, keine Verschiebung)",
      "90°",
      "180° (gegenphasig, Phasenumkehr)",
      "−90° (Phasenverschiebung)",
      "45° (halbe Viertelperiode Verschiebung)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "J/K",
      "K (Kelvin, Temperatur)",
      "J·K (einfaches Verhältnis der Größen)",
      "W (Watt, Leistung)",
    ],
    1,
    "S in J/K.",
  ...
  q(
    ...
    [
      "0",
      "λ/b (einfaches Verhältnis der Größen)",
      "k·λ/b mit k = 1, 2, 3, …",
      "b/λ (einfaches Verhältnis der Größen)",
      "λ·b (einfaches Verhältnis der Größen)",
    ],
    2,
  ...
  q(
    ...
    [
      ...
      "p·V^κ = const",
      "T·V = const (als mögliche Antwort)",
