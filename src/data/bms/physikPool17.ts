...
export const physikPool17: Question[] = [
  ...
  q(
    ...
    [
      ...
      "Masse m und Federkonstante D: T = 2π√",
      "nur der Masse (als einziger Beitrag)",
      "nur D (ausschließlich, ohne weitere Beiträge)",
      "der Reibung (als einzige relevante Größe)",
    ],
    1,
  ...
  q(
    ...
    [
      "die Stromstärke (als physikalische Erklärung)",
      "die pro Ladungseinheit verrichtete Arbeit",
      "den Widerstand (als einzige relevante Größe)",
      "die Leistung (als einzige relevante Größe)",
      "die Ladung (als einzige relevante Größe)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "nur Helium übrig ist (als einziger Beitrag)",
      "keine Fusion mehr stattfindet",
      "der Stern explodiert (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    [
      "sind dasselbe (als mögliche Antwort)",
      "Q ist Energie, T ist Zustandsgröße",
  ...
  q(
    ...
    [
      "unter 20 Hz (charakteristischer thermodynamischer Zustand)",
      "oberhalb des hörbaren Bereichs",
      "genau 1000 Hz (als mögliche Antwort)",
      "von 20 Hz bis 20 kHz",
      "von 0 Hz (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["+1,6·10⁻¹⁹ C", "−1,6·10⁻¹⁹ C", "0 C (Temperaturwert)", "1 C (Temperaturwert)", "−1 C"],
    1,
  ...
  q(
    ...
    ["Geschwindigkeit (Weg pro Zeit, Einheit m/s)", "Normalkraft F_N: F_R = μ·F_N", "Masse (Trägheitseigenschaft, Einheit Kilogramm)", "Fläche (als mögliche Antwort)", "Temperatur (Maß für die mittlere kinetische Energie)"],
    1,
  ...
  q(
    ...
    [
      ...
      "die Entropieänderung beim Verdampfen",
      "die Wärmekapazität (als physikalische Erklärung)",
      "null (kein Beitrag, verschwindet)",
      "die Verdampfungswärme (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    [
      "die Masse des Protons angibt (als physikalische Erklärung)",
  ...
  q(
    ...
    ["100 Pa (als Zahlenwert mit Einheit)", "1000 Pa (als Zahlenwert mit Einheit)", "100 000 Pa", "10 000 Pa", "1 Pa (als Zahlenwert mit Einheit)"],
    2,
  ...
  q(
    ...
    [
      "der Kapazität (als mögliche Antwort)",
      "dem spezifischen Widerstand ρ: σ = 1/ρ",
      "der Induktivität (als physikalische Erklärung)",
      "der Stromstärke (als physikalische Erklärung)",
      "der Spannung (als einzige relevante Größe)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur die Energie (als einziger Beitrag)",
      "den Strahlentyp (Wichtungsfaktor w_R) für biologische Wirkung",
      "nur den Abstand (als einziger Beitrag)",
      "nur die Aktivität (als einziger Beitrag)",
      "nur die Halbwertszeit (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "tritt eine Phasenänderung von π auf",
      "wird die Welle absorbiert (unter Standardbedingungen)",
  ...
  q(
    ...
    ["A·d/ΔT (als mögliche Antwort)", "A·ΔT/d", "d/(A·ΔT) (als mögliche Antwort)", "A + ΔT (als mögliche Antwort)", "1/A"],
    1,
    "Q̇ = λ·A·ΔT/d (Fourier).",
    "mittel",
  ...
  q(
    ...
    [
      "Abschirmung (als mögliche Antwort)",
      "Strukturanalyse",
      "Therapie (als mögliche Antwort)",
      "Bildgebung nur (ohne andere Mechanismen)",
      "Dosimetrie (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      "zu",
      "ab",
      "bleibt konstant (bei dieser Veränderung)",
      "ist nicht definiert (unter Standardbedingungen)",
  ...
  q(
    ...
    ["0° (gleichphasig, keine Verschiebung)", "90°", "180° (gegenphasig, Phasenumkehr)", "−90° (Phasenverschiebung)", "45° (halbe Viertelperiode Verschiebung)"],
    1,
  ...
  q(
    ...
    ["s (Sekunde, Zeit)", "1/s", "Bq (Becquerel, Aktivität)", "J (Joule, Energie)", "kg (Kilogramm, Masse)"],
    1,
  ...
  q(
    ...
    [
      "der Masse (als einzige relevante Größe)",
      "ω und v",
      "nur r (ausschließlich, ohne weitere Beiträge)",
      "der Zeit (als einzige relevante Größe)",
      "g (Gramm, Masse)",
    ],
    1,
    "Coriolis: a_C ∝ ω×v.",
  ...
  q(
    ...
    [
      "ist immer Totalreflexion (unter Standardbedingungen)",
      "führt zum Lot hin",
      "führt vom Lot weg",
      "ändert die Frequenz",
  ...
  q(
    ...
    [
      ...
      "Wärme in Strom (als mögliche Antwort)",
      "Strom in Wärme (als mögliche Antwort)",
      "Licht in Strom (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["J (Joule, Energie)", "J/K", "K (Kelvin, Temperatur)", "J·K (einfaches Verhältnis der Größen)", "W (Watt, Leistung)"],
    1,
    "S in J/K.",
    "leicht",
    ["Entropie", "Einheit"]
  ...
  q(
    ...
    [
      "der Kern gespalten wird (als physikalische Erklärung)",
      "der Kern aus freien Nukleonen zusammengesetzt wird",
  ...
  q(
    ...
    ["0", "λ/b (einfaches Verhältnis der Größen)", "k·λ/b mit k = 1, 2, 3, …", "b/λ (einfaches Verhältnis der Größen)", "λ·b (einfaches Verhältnis der Größen)"],
    2,
  ...
  q(
    ...
    ["p·V = const (als mögliche Antwort)", "p·V^κ = const", "T·V = const (als mögliche Antwort)", "p/T = const (als mögliche Antwort)", "V/T = const (als mögliche Antwort)"],
    1,
