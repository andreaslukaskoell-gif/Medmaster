...
export const physikPool4: Question[] = [
  q(
    ...
    ["kg (Kilogramm, Masse)", "mol", "cd", "A (Ampere, Strom)", "K (Kelvin, Temperatur)"],
    1,
  ...
  q(
    ...
    ["gleich (identischer Betrag)", "kleiner", "größer (höherer Betrag)", "null (kein Beitrag, verschwindet)", "doppelt so groß"],
    1,
  ...
  q(
    ...
    ["C₁ + C₂ (als mögliche Antwort)", "1/C_ers = 1/C₁ + 1/C₂", "C₁ · C₂ (als mögliche Antwort)", "C₁ = C₂ (als mögliche Antwort)", "C₁ − C₂ (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    ["N (Newton, Kraft)", "V/m oder N/C", "C (Coulomb, Ladung)", "V·m (Voltmeter, Dipolmoment-Einheit)", "A/m (Ampere pro Meter, Magnetfeld)"],
    1,
    "E = F/q → N/C = V/m.",
    "leicht",
    ["Feldstärke", "Einheit"]
  ...
  q(
    ...
    ["p · V = const", "p / V = const (als mögliche Antwort)", "p + V = const (als mögliche Antwort)", "p = n·R", "V = 0 (einfacher Zusammenhang)"],
    0,
  ...
  q(
    ...
    ["Masse (Trägheitseigenschaft, Einheit Kilogramm)", "Reibungskoeffizient", "Geschwindigkeit (Weg pro Zeit, Einheit m/s)", "Weg (als mögliche Antwort)", "Energie (Fähigkeit, Arbeit zu verrichten)"],
    1,
  ...
  q(
    ...
    [
      "der Körper schneller wird (als physikalische Erklärung)",
      "der Körper angehoben wird",
      "die Masse abnimmt (als physikalische Erklärung)",
      "g abnimmt (als mögliche Antwort)",
      "der Körper fällt (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Licht auf ein Hindernis oder Spalt trifft",
      "nur bei Laserlicht (als einziger Beitrag)",
      "die Temperatur hoch ist (als physikalische Erklärung)",
      "Licht reflektiert wird (als physikalischer Prozess)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "kleiner als Einfallswinkel",
      "gleich Einfallswinkel",
      "immer 90° (als mögliche Antwort)",
  ...
  q(
    ...
    [
      "nur Leitung (ausschließlich, ohne weitere Beiträge)",
  ...
  q(
    ...
    [
      ...
      "Photon verhält sich wie Teilchen",
      "keine Wechselwirkung",
      "nur bei sichtbarem Licht (als einziger Beitrag)",
    ],
    2,
  ...
  q(
    ...
    ["größer (höherer Betrag)", "kleiner", "gleich (identischer Betrag)", "doppelt so groß", "null (kein Beitrag, verschwindet)"],
    1,
  ...
  q(
    ...
    ["Ω (Ohm, Widerstand)", "Ω²", "S (Siemens)", "V/A (Volt pro Ampere, Widerstand)", "A/V (einfaches Verhältnis der Größen)"],
    2,
  ...
  q(
    ...
    [
      "Reflexion (Zurückwerfen von Wellen an Grenzflächen)",
      "Dispersion",
