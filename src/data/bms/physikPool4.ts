...
export const physikPool4: Question[] = [
  ...
  q(
    ...
    [
      ...
      "V/m oder N/C",
      "C (Coulomb, Ladung)",
      "V·m (Voltmeter, Dipolmoment-Einheit)",
      "A/m (Ampere pro Meter, Magnetfeld)",
    ],
    1,
    "E = F/q → N/C = V/m.",
    "leicht",
  ...
  q(
    ...
    [
      ...
      "Ω²",
      "S (Siemens)",
      "V/A (Volt pro Ampere, Widerstand)",
      "A/V (einfaches Verhältnis der Größen)",
    ],
    2,
