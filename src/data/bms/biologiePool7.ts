...
export const biologiePool7: Question[] = [
  ...
  q(
    ...
    [
      "nur Stoffwechsel und Fortpflanzung (zwei von sieben Merkmalen des Lebens).",
      ...
      "nur Homöostase und Bewegung (zwei von sieben Merkmalen des Lebens).",
      "Zellwand und Chloroplasten (pflanzenspezifisch, kein allgemeines Merkmal).",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Es kommt nur in der Haut vor (Epidermis mit verhorntem Plattenepithel).",
  ...
  q(
    ...
    [
      "Sie sind stark vascularisiert (mit dichtem Kapillarnetz durchzogen).",
      "Sie sind polar (apikal/basolateral) und sitzen auf einer Basalmembran.",
      "Sie enthalten keine Zellkontakte (Desmosomen, Tight Junctions etc.).",
      "Sie kommen nur in der Haut vor (als Schutzepithel der Körperoberfläche).",
      "Sie sezernieren immer Hormone (endokrine Funktion in Richtung Blutgefäße).",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Eine Schicht aus Korneozyten in der Epidermis (Stratum corneum mit Keratin).",
      "Die Membran der Mitochondrien (innere und äußere Doppelmembran des Organells).",
      "Der Raum zwischen zwei Epithelzellen (Interzellularspalt mit Zellkontakten).",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Muzin (Schleim)",
      "Talg (Sebum) aus den holokrinen Talgdrüsen",
      "Schweiß (Sekret der ekkrinen und apokrinen Drüsen)",
      "Blut (Suspension aus Zellen und Plasma im Gefäßsystem)",
    ],
    1,
  ...
  q(
    ...
    "Was ist ein Allel?",
    [
      "Ein ganzes Chromosom (kondensierte Chromatinstruktur aus DNA und Histonen).",
      "Eine Variantenform eines Gens (z. B. A oder a).",
      "Ein Abschnitt der RNA (Ribonukleinsäure mit Uracil statt Thymin).",
      "Die Gesamtheit aller Gene eines Organismus (das komplette Genom).",
      "Ein Histon-Protein (basisches Kernprotein für die DNA-Kompaktierung).",
    ],
    1,
  ...
  q(
    ...
    [
      "Zwei homologe Chromosomen (je eines von Mutter und Vater stammend).",
      "Zwei identische Chromosomenkopien nach der DNA-Replikation, am Zentromer verbunden.",
      "Die beiden antiparallelen Stränge der DNA-Doppelhelix (5'→3' und 3'→5').",
      "Chromosomen in der Interphase (dekondensiert als Chromatin im Zellkern).",
  ...
  q(
    ...
    "Ein Gen ist …",
    [
      "ein ganzes Chromosom (kondensiertes Chromatin aus DNA und Histonproteinen).",
      "ein Abschnitt der DNA, der die Information für ein Merkmal oder ein Produkt trägt.",
      "eine Base (Adenin, Thymin, Guanin oder Cytosin) der DNA-Sequenz.",
      "ein Ribosom (Ribonukleoprotein-Komplex für die Translation von mRNA).",
      "eine Aminosäure (Grundbaustein der Proteine mit Amino- und Carboxylgruppe).",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Intermembranraum (zwischen innerer und äußerer Mitochondrienmembran)",
      "Innere Mitochondrienmembran",
      "Kernmembran (Doppelmembran des Zellkerns mit Kernporen-Komplexen)",
    ],
    3,
  ...
  q(
    ...
    [
      "Fortpflanzung (sexuelle oder asexuelle Reproduktion)",
      "Evolution (Veränderung der Allelfrequenzen über Generationen)",
      "Eigenständiger Stoffwechsel",
      "Reizbarkeit (Irritabilität) als Reaktion auf Umweltreize",
      "Bewegung (aktive Ortsveränderung durch Motorproteine)",
    ],
    2,
