...
export const chemiePool16: Question[] = [
  ...
  q(
    ...
    [
      "Dehydratisierung (Wasserabspaltung aus einem Alkohol)",
      "Addition von H₂ (Hydrierung)",
      "Oxidation (Elektronenabgabe an ein Oxidationsmittel)",
      "Veresterung (Reaktion von Alkohol mit Carbonsäure)",
  ...
  q(
    ...
    [
      "der Gleichgewichtskonstante K (Massenwirkungsgesetz)",
      "der Arrhenius-Gleichung (Geschwindigkeitskonstante k)",
      "der Nernst-Gleichung (Elektrodenpotential, Elektrochemie)",
      "dem Massenwirkungsgesetz (Verhältnis der Konzentrationen)",
      "der Henderson-Hasselbalch-Gleichung (pH-Berechnung von Puffern)",
    ],
    1,
  ...
  q(
    ...
    [
      "Es werden nur Elektronen von einem Partner abgegeben, vom anderen aufgenommen",
      "Ein Lewis-Säure (Akzeptor) nimmt ein Elektronenpaar einer Lewis-Base (Donor) auf",
      "Es entstehen ausschließlich Ionen ohne gemeinsame Elektronenpaare",
      "Sie sind deutlich stärker als gewöhnliche kovalente Bindungen",
      "Es gibt sie nur in organischen Molekülen mit Kohlenstoffgerüst",
    ],
    1,
  ...
  q(
    ...
    [
      "reagiert nur A zu B ohne weitere Umsetzung des Produkts",
      "B ist Zwischenprodukt und kann weiter zu C reagieren",
      "gibt es kein Zwischenprodukt B in der Reaktionsfolge",
      "ist C immer ein Katalysator, der A erneut umsetzt",
      "reagiert nur B zu C, ohne dass A beteiligt wäre",
    ],
    1,
  ...
  q(
    ...
    [
      "nur die Stöchiometrie der Bruttoreaktionsgleichung (Koeffizienten)",
      "wie die Geschwindigkeit von den Konzentrationen abhängt (Exponenten im Geschwindigkeitsgesetz)",
      "die Anzahl der Produkte, die bei der Reaktion entstehen",
      "die Temperatur, bei der die Reaktion optimal abläuft",
      "die Gleichgewichtslage und die Gleichgewichtskonstante K",
    ],
    1,
  ...
  q(
    ...
    "Ein Phenol enthält:",
    [
      "eine OH-Gruppe an einem aliphatischen C-Atom (Alkanol)",
      "eine OH-Gruppe direkt an einem aromatischen Ring",
      "keine OH-Gruppe, sondern eine Etherbrücke (C−O−C)",
      "nur eine COOH-Gruppe als einzige funktionelle Gruppe",
      "eine SH-Gruppe (Thiol) statt einer Hydroxylgruppe",
    ],
    1,
  ...
  q(
    ...
    [
      "enthält weniger gelösten Stoff als die Sättigungskonzentration erlaubt",
      "enthält vorübergehend mehr gelösten Stoff als im Gleichgewicht löslich ist",
      "ist immer fest und kann keine weiteren Stoffe aufnehmen",
      "kann thermodynamisch nicht existieren und zerfällt sofort",
      "hat immer pH 7 unabhängig vom gelösten Stoff darin",
    ],
    1,
  ...
  q(
    ...
    "Ein Autokatalysator:",
    [
      "wird nie gebildet und existiert nur als Hypothese",
      "ist ein Produkt, das die Reaktion katalysiert",
      "ist immer ein Enzym mit einem aktiven Zentrum",
      "wird nur von außen als Reagenz zugegeben (exogen)",
      "ändert die Stöchiometrie der Gesamtreaktion",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Alkanen (gesättigten Kohlenwasserstoffen)",
      "β-Hydroxycarbonylverbindungen (Aldole)",
      "nur Estern (Veresterungsprodukte aus R−COOH)",
      "nur Ketonen (mit zwei C-Substituenten am C=O)",
      "nur Säuren (Carbonsäuren mit −COOH-Gruppe)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Gruppe 1 und 2 (Alkali- und Erdalkalimetalle)",
      "Elemente der Nebengruppen (z. B. Fe, Cu, Zn)",
      "nur Lanthanoide (4f-Elemente nach Lanthan)",
      "nur Edelgase (Gruppe 18 mit vollen Schalen)",
      "nur Halogene (Gruppe 17 mit 7 Valenzelektronen)",
    ],
    1,
  ...
  q(
    ...
    [
      "verschiebt Druckänderung das Gleichgewicht auf die Produktseite",
      "verschiebt Druckänderung das Gleichgewicht nicht (K_p druckunabhängig)",
      "reagieren keine Gase miteinander in der betrachteten Phase",
      "ist K immer 1 unabhängig von den Konzentrationen",
      "gibt es kein Gleichgewicht, die Reaktion läuft vollständig",
    ],
    1,
  ...
  q(
    ...
    [
      "zwei Alkane zu einem längerkettigen Kohlenwasserstoff",
      "ein Alkoholat mit einem Halogenalkan zu einem Ether",
      "zwei Alkene in einer Metathese-Reaktion (Grubbs)",
      "Aldehyd mit Keton in einer gekreuzten Aldolreaktion",
      "zwei Carbonsäuren zu einem symmetrischen Anhydrid",
    ],
    1,
