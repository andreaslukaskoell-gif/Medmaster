...
export const biologiePool11: Question[] = [
  ...
  q(
    ...
    1,
    "Ein Gen ist ein DNA-Abschnitt mit der Information für ein Merkmal oder ein Genprodukt.",
    "leicht",
    ["Genetik", "Gen"]
  ),
  q(
  ...
  q(
    ...
    [
      ...
      "Destruenten stehen am Anfang der Nahrungskette",
    ],
    1,
    "Nährstoffe werden im Ökosystem recycelt. Energie fließt linear und geht als Wärme verloren.",
    "mittel",
    ["Ökologie"]
  ),
  q(
  ...
  q(
    ...
    1,
    "RNA enthält Adenin, Uracil, Guanin, Cytosin. In der DNA ersetzt Thymin das Uracil.",
    "leicht",
    ["RNA", "Genetik"]
  ),
  q(
  ...
  q(
    ...
    [
      "Ende der 8. Woche",
      "In der 3.–4. Woche",
      "In der 1. Entwicklungswoche (Furchungsstadium)",
      "Nach der Geburt",
      "Ende der 2. Woche",
    ],
    1,
  ...
  q(
    ...
    [
      "Erythrozyten mit langfristiger Antigenspeicherfunktion",
      "Lymphozyten, die nach Antigenkontakt bei erneutem Kontakt schneller reagieren",
      "Nervenzellen im Hippocampus als Langzeitspeicher",
      "Thrombozyten",
      "Mastzellen",
    ],
    1,
    "Gedächtniszellen entstehen nach Antigenkontakt und ermöglichen eine schnellere Immunantwort bei erneutem Kontakt.",
    "mittel",
    ["Immunologie"]
  ),
  q(
    ...
    [
      "Linse",
      "Hornhaut (Kornea) als lichtbrechendes Medium",
      "Iris (Regenbogenhaut)",
      "Netzhaut (Retina) mit Photorezeptoren",
      "Glaskörper (Corpus vitreum) als Stützmedium",
    ],
    2,
  ...
  q(
    ...
    [
      ...
      "Ein einziges Pyruvatmolekül als Glykolyseprodukt",
  ...
  q(
    ...
    [
      "Alle Lebewesen verschiedener Arten in einem Biotop (Biozönose)",
  ...
  q(
    ...
    [
      "sind ausschließlich Frauen mit beiden X-Allelen betroffen",
      "sind Männer häufiger betroffen, da sie nur ein X-Chromosom haben",
      "sind ausschließlich Männer mit dem Y-Chromosom betroffen",
      "können Frauen nicht als heterozygote Konduktorinnen auftreten",
      "sind Männer aufgrund ihres XY-Karyotyps niemals betroffen",
    ],
    1,
  ...
  q(
    ...
    2,
    "Neutrophile Granulozyten gehören zur unspezifischen Abwehr. B/T-Lymphozyten zur spezifischen.",
    "leicht",
    ["Immunologie", "Blut"]
  ),
  q(
    ...
    [
      "Ein Teil der befruchteten Eizelle nach den ersten Furchungsteilungen",
  ...
  q(
    ...
    [
      "DNA kommt ausschließlich im Zellkern der eukaryotischen Zelle vor",
      "DNA besteht aus zwei komplementären Strängen (Doppelhelix)",
      "DNA enthält Uracil anstelle von Thymin als Pyrimidinbase",
      "DNA wird direkt ohne mRNA-Zwischenschritt in Proteine übersetzt",
      "DNA ist ein Protein aus Aminosäuren mit enzymatischer Funktion",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Ein Chromosom",
      "Ein Allel",
      "Die Summe aller Gene eines Organismus",
    ],
    1,
  ...
  q(
    ...
    2,
    "In der Anaphase I der Meiose werden die homologen Chromosomen getrennt. In der Mitose trennen sich in der Anaphase die Schwesterchromatiden.",
    "mittel",
    ["Meiose", "Genetik"]
  ),
  q(
  ...
  q(
    ...
    0,
    "Homozygot = gleiche Allele. Heterozygot = verschiedene Allele (z. B. Aa).",
    "leicht",
    ["Genetik", "Vererbung"]
  ),
  q(
    "bio-pool-11-042",
    "bio-kap1",
    "Welcher Stoff wird bei der Gärung aus Pyruvat gebildet?",
    ["Ethanol", "Acetyl-CoA", "Laktat", "CO₂", "Oxalacetat"],
    2,
    "Bei der Milchsäuregärung entsteht aus Pyruvat Laktat. Bei alkoholischer Gärung Ethanol.",
    "mittel",
    ["Stoffwechsel", "Gärung"]
  ),
  q(
  ...
  q(
    ...
    [
      ...
      "Sie erfolgt ausschließlich in somatischen Körperzellen (nicht in Keimzellen)",
  ...
  q(
    ...
    [
      "Sie ist vollständig undurchlässig für alle Moleküle und Ionen",
      "Sie besteht aus einer Lipiddoppelschicht mit eingelagerten Proteinen",
      "Sie enthält nur Kohlenhydrate als Glykokalyxbestandteile auf der Oberfläche",
      "Sie hat keine eingelagerten Proteine in der Lipiddoppelschicht",
      "Sie umgibt ausschließlich den Zellkern als Kernhülle (Doppelmembran)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Sie kommen ausschließlich im Blut vor und migrieren nicht in Gewebe",
  ...
  q(
    ...
    [
      "Sie produziert ausschließlich Hormone für die endokrine Regulation",
      "Sie hat nur eine exokrine Drüsenfunktion mit Gangausführung",
      "Sie produziert Verdauungsenzyme (exokrin) und Hormone wie Insulin (endokrin)",
      "Sie liegt im Brustkorb (Thorax) hinter dem Brustbein geschützt",
      "Sie produziert hepatische Galle für die Fettemulgierung im Duodenum",
    ],
    2,
    "Die Bauchspeicheldrüse ist exokrin und endokrin (Langerhans-Inseln: Insulin, Glukagon).",
    "leicht",
