...
export const biologiePool11: Question[] = [
  ...
  q(
    ...
    [
      ...
      "Eine RNA-Art (z. B. mRNA, tRNA oder rRNA als Genprodukt)",
      "Ein Organell (membranumhülltes Kompartiment innerhalb der Zelle)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Geburt (Partus am Ende der Schwangerschaft nach ca. 40 Wochen)",
    ]
  ),
  q(
    "bio-pool-11-019",
  ...
  q(
    ...
    [
      ...
      "Der Gelbkörper (Corpus luteum als Progesteronquelle im Ovar)",
    ],
    1,
  ...
  q(
    ...
    [
      "Die genetische Ausprägung (Gesamtheit der Allele im Genotyp)",
      "Die sichtbare bzw. messbare Ausprägung eines Merkmals",
      "Ein Chromosom (kondensierte Chromatinstruktur aus DNA und Histonen)",
      "Ein Allel (eine Variante eines Gens an einem bestimmten Locus)",
      "Die Summe aller Gene eines Organismus (das gesamte Genom)",
    ],
    1,
  ...
  q(
    ...
    [
      "Die Höhle der Plazenta (Intervillöser Raum mit mütterlichem Blut)",
      "Der mit Fruchtwasser gefüllte Raum um den Embryo",
      "Die Gebärmutterhöhle (Cavum uteri, ausgekleidet mit Endometrium)",
      "Die Eileiterhöhle (Lumen der Tuba uterina mit Flimmerepithel)",
      "Die Keimhöhle der Blastozyste (Blastocoel als flüssigkeitsgefüllter Raum)",
    ],
    1,
