...
export const biologiePool6: Question[] = [
  ...
  q(
    ...
    [
      "Alle Arten in einem definierten Gebiet",
  ...
  q(
    ...
    1,
    "Bei intermediärem Erbgang zeigen Heterozygote ein mittleres Merkmal.",
    "schwer",
    ["Vererbung", "Genetik"]
  ),
  q(
  ...
  q(
    "bio-pool-6-033",
    "bio-kap4",
    "Bei einem dihybriden Erbgang (AaBb × AaBb) mit unabhängiger Verteilung: Wie viele der 16 möglichen Genotypkombinationen sind für beide Merkmale homozygot (reinerbig)?",
    ["1", "2", "4", "8", "16"],
    2,
    "Homozygot für beide Merkmale sind: AABB (1/16), AAbb (1/16), aaBB (1/16), aabb (1/16) = 4 von 16. Reinerbig bedeutet homozygot für jedes Merkmal.",
    "schwer",
  ...
  q(
    "bio-pool-6-037",
    "bio-kap2",
    "Ein Erythrozyt enthält etwa 270 Mio. Hämoglobinmoleküle. Welche Größenordnung entspricht dem am ehesten?",
  ...
  q(
    "bio-pool-6-038",
    "bio-kap5",
    "In einer Population sind 64 % einer Art homozygot für ein dominantes Allel (AA). Welcher Anteil ist heterozygote (Aa)?",
    ["32 %", "16 %", "8 %", "4 %", "20 %"],
    0,
  ...
  q(
    ...
    ["7", "14", "21", "28", "35"],
    3,
    "Der durchschnittliche Zyklus beträgt etwa 28 Tage.",
    "leicht",
  ...
  q(
    "bio-pool-6-041",
    "bio-kap2",
    "Das Herzzeitvolumen (HZV) berechnet sich aus Schlagvolumen × Herzfrequenz. Bei einem Schlagvolumen von 70 mL und einer Herzfrequenz von 80/min beträgt das HZV:",
    ["4,2 L/min", "5,6 L/min", "6,4 L/min", "7,0 L/min", "8,4 L/min"],
    1,
    "HZV = Schlagvolumen × Herzfrequenz = 70 mL × 80/min = 5600 mL/min = 5,6 L/min.",
    "mittel",
    ["rechenfrage", "Herz", "Kreislauf"]
  ),
  q(
    "bio-pool-6-042",
    "bio-kap4",
    ...
    ["0 %", "25 %", "50 %", "75 %", "100 %"],
    3,
    "Genotypen: 1 AA, 2 Aa, 1 aa → 75 % phänotypisch dominant.",
    "mittel",
  ...
  q(
    "bio-pool-6-043",
    "bio-kap1",
    "Wie viele Nukleotide codieren im Durchschnitt für eine Aminosäure?",
    ["1", "2", "3", "4", "5"],
    2,
