...
export const biologiePool6: Question[] = [
  ...
  q(
    ...
    [
      "Dominant-rezessiv (ein Allel überdeckt das andere phänotypisch)",
      "Intermediär (kodominant)",
      "Gonosomal (Vererbung über die Geschlechtschromosomen X/Y)",
      "Polygen (mehrere Gene bestimmen ein Merkmal additiv)",
      "Mitochondrial (maternale Vererbung über mtDNA)",
    ],
    1,
