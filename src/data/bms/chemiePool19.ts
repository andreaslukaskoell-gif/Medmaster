...
export const chemiePool19: Question[] = [
  ...
  q(
    ...
    [
      "die Schale (Hauptenergieniveau, bestimmt durch Hauptquantenzahl n)",
      "die räumliche Orientierung des Orbitals",
      "den Spin des Elektrons (Eigenrotation, Wert +½ oder −½)",
      "die Protonenzahl im Kern (Ordnungszahl, definiert das Element)",
      "die Masse des Atoms (Summe aller Protonen und Neutronen im Kern)",
    ],
    1,
  ...
  q(
    ...
    [
      "Es ist polar und bildet starke intermolekulare Wechselwirkungen",
      "Das Molekül ist linear und insgesamt unpolar",
      "Es bildet Wasserstoffbrücken mit benachbarten Molekülen",
      "Es hat eine gewinkelte Form mit einem Bindungswinkel von 104,5°",
      "Es ist ionisch aufgebaut und liegt als Ionenpaar vor",
    ],
    1,
  ...
  q(
    ...
    [
      "nur der Masse des betrachteten Stoffes (in Kilogramm)",
      "Masse und Temperaturdifferenz (Q = m·c·ΔT)",
      "nur der Temperatur (in Kelvin oder Grad Celsius gemessen)",
      "nur dem Volumen des Systems (Liter oder Kubikmeter)",
      "dem Druck (gemessen in Pascal, Bar oder Atmosphären)",
    ],
    1,
  ...
  q(
    ...
    [
      "immer gleich dem Gesamtdruck, unabhängig vom Molenbruch",
      "proportional zum Molenbruch (p_i = x_i · p_ges)",
      "unabhängig von der Stoffmenge des betrachteten Gases",
      "immer null, da Gase keinen eigenständigen Druck ausüben",
      "nur bei 0 °C definiert und nicht auf andere Temperaturen anwendbar",
    ],
    1,
  ...
  q(
    ...
    [
      "immer keine Einheit (dimensionslos, wie ein reines Verhältnis)",
      "kann dimensionslos sein oder von der Stöchiometrie abhängen",
      "immer mol/L, da Konzentrationen im Ausdruck stehen",
      "immer bar, da der Druck der Gase eingeht (Gasphase)",
      "immer J (Joule), da K mit der Enthalpie verknüpft ist",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Reduktionsmitteln (die selbst oxidiert werden)",
      "Oxidationsmitteln (z. B. KMnO₄, Tollens)",
      "nur Hitze (thermische Zersetzung ohne chemisches Reagenz)",
      "nur Druck (mechanische Beanspruchung des Moleküls)",
      "nur Katalysator ohne Sauerstoff (anaerobe Reaktionsbedingungen)",
    ],
    1,
  ...
  q(
    ...
    [
      "Es gibt nur Atomorbitale, keine Kombination zu Molekülorbitalen",
      "Bindende und antibindende MOs entstehen aus der Überlappung von AOs",
      "Es gibt keine π-Orbitale in der MO-Theorie (nur σ-Orbitale)",
      "MO-Theorie gilt nur für Ionen, nicht für neutrale Moleküle",
      "Alle MOs sind bindend, es gibt keine antibindenden Zustände",
    ],
    1,
  ...
  q(
    ...
    [
      "nur der Hinreaktion (die Rückreaktion bleibt unbeeinflusst)",
      "der Rückreaktion in gleichem Maße (K unverändert)",
      "nicht der Rückreaktion (Katalyse wirkt nur in eine Richtung)",
      "nur bei hoher Temperatur (Katalysator braucht thermische Aktivierung)",
      "nur in der Gasphase (in Lösung wirkt kein Katalysator)",
    ],
    1,
  ...
  q(
    ...
    [
      "immer kleiner als die 1. Ionisierungsenergie (leichter zu entfernen)",
      "die Energie zur Abtrennung eines weiteren Elektrons aus dem einfach positiv geladenen Ion",
      "gleich der 1. Ionisierungsenergie (beide Elektronen gleich gebunden)",
      "nur bei Edelgasen definiert, nicht bei Haupt- oder Nebengruppen",
      "immer null, weil das zweite Elektron spontan abgegeben wird",
    ],
    1,
  ...
  q(
    ...
    [
      "negativ (es wird Energie frei beim Verdampfen des Stoffes)",
      "positiv (Energie muss zugeführt werden)",
      "null (kein Energieaufwand für den Phasenübergang nötig)",
      "kleiner als die Schmelzenthalpie (Verdampfen kostet weniger Energie)",
      "unabhängig von der Substanz (gleicher Wert für alle Stoffe)",
    ],
    1,
  ...
  q(
    ...
    [
      "Wasserstoff hat immer Oxidationszahl +1 (auch in Hydriden)",
      "In Metallhydriden (z. B. NaH) hat Wasserstoff die Oxidationszahl −1",
      "Es gibt keine Ionenhydride in der anorganischen Chemie",
      "Hydride sind immer kovalent und enthalten keine Ionen",
      "Wasserstoff kann nicht als Anion vorkommen (nur Kation H⁺)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Start (Radikalbildung durch Homolyse der Bindung)",
      "Start, Kettenfortpflanzung, Abbruch",
      "nur Abbruch (Radikalkombination zu stabilen Produkten)",
      "nur Gleichgewicht (Hin- und Rückreaktionsgeschwindigkeit gleich)",
      "keine Radikale (ionischer Mechanismus ohne ungepaarte Elektronen)",
    ],
    1,
  ...
  q(
    ...
    [
      "Alkan und Alken durch Dehydrierung (Eliminierungsreaktion)",
      "Aldehyd/Keton + Alkohol (unter Säurekatalyse)",
      "zwei Carbonsäuren durch Anhydridbildung (Wasserabspaltung)",
      "Amin und Ester durch nucleophile Substitution am Carbonyl",
      "Alkohol und Base in einer Neutralisationsreaktion (Salzbildung)",
    ],
    1,
  ...
  q(
    ...
    [
      "Alle C−C-Bindungen sind unterschiedlich lang (alternierend kurz/lang)",
      "Alle C−C-Bindungen sind gleich lang (zwischen Einfach- und Doppelbindung)",
      "Es gibt keine π-Elektronen in Benzol (nur σ-Bindungen vorhanden)",
      "Es ist ein Alken mit einer lokalisierten C=C-Doppelbindung",
      "Es hat keine Resonanzstabilisierung (nur eine Lewis-Struktur)",
    ],
    1,
  ...
  q(
    ...
    "Die Umesterung ist:",
    [
      "die Bildung eines Esters aus Alkohol und Carbonsäure (Veresterung)",
      "der Austausch des Alkoholrests in einem Ester (Ester + Alkohol ⇌ anderer Ester)",
      "die Oxidation eines Alkohols zum Aldehyd oder zur Carbonsäure",
      "die Addition von HBr an ein unsymmetrisches Alken (Markovnikov)",
      "die Verseifung eines Esters mit Lauge zu Alkohol und Carboxylat",
    ],
    1,
