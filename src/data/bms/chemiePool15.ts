...
export const chemiePool15: Question[] = [
  ...
  q(
    ...
    [
      "ist in der gleichen Phase wie die Reaktanden (homogene Katalyse)",
      "befindet sich in einer anderen Phase (z. B. fest, Reaktanden gasförmig)",
      "wird ständig verbraucht und muss nachdosiert werden",
      "ändert die Gleichgewichtslage und verschiebt die Produkte",
      "reagiert stöchiometrisch mit den Edukten in fester Proportion",
    ],
    1,
  ...
  q(
    ...
    [
      "MgO weniger Ionen pro Formeleinheit im Gitter aufweist",
      "Mg²⁺ und O²⁻ kleinere Radien und höhere Ladungen haben",
      "NaCl schwerer ist und eine größere molare Masse besitzt",
      "MgO molekular aufgebaut ist und keine Ionen enthält",
      "NaCl keine Ionen hat, sondern kovalent gebunden vorliegt",
    ],
    1,
  ...
  q(
    ...
    [
      "1 Gramm gelöster Stoff pro Liter der fertigen Lösung",
      "1 Mol gelöster Stoff pro Liter Lösung",
      "1 Teilchen (Atom oder Molekül) pro Liter Lösungsmittel",
      "1 Liter Lösungsmittel pro Mol des gelösten Feststoffs",
      "1 Mol gelöster Stoff pro Kilogramm Lösungsmittel (Molalität)",
    ],
    1,
  ...
  q(
    ...
    [
      "die hohe Siedetemperatur von Wasser (Wasserstoffbrücken)",
      "dass Alkane mit zunehmender Kettenlänge höher sieden",
      "die Stabilität von Diamant (kovalentes 3D-Netzwerk aus Kohlenstoff)",
      "Ionenbindung zwischen Metall- und Nichtmetallionen im Gitter",
      "Wasserstoffbrücken zwischen Molekülen mit O−H- oder N−H-Gruppen",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "nur Wärme pro Masse, ohne Temperaturdifferenz als Bezugsgröße",
      "nur Temperatur des Stoffes, unabhängig von seiner Masse",
      "nur Druck, gemessen in Pascal oder Bar (keine Temperaturabhängigkeit)",
      "Volumen pro Masse, also die Dichte des betrachteten Stoffes",
    ],
    0,
  ...
  q(
    ...
    [
      "nur C und H (rein aliphatische Kohlenwasserstoffe)",
      "C, H und ein Halogen (F, Cl, Br, I)",
      "nur Halogen, ohne Kohlenstoff- oder Wasserstoffatome",
      "eine OH-Gruppe als funktionelle Gruppe (typisch für Alkohole)",
      "eine COOH-Gruppe als funktionelle Gruppe (typisch für Carbonsäuren)",
    ],
    1,
  ...
  q(
    ...
    [
      "seitliche Überlappung von p-Orbitalen (typisch für π-Bindungen)",
      "Überlappung von Orbitalen entlang der Bindungsachse",
      "nur Ionen, die durch vollständigen Elektronentransfer entstehen",
      "nur in Mehrfachbindungen zwischen gleichen Nichtmetallatomen",
      "nur zwischen gleichen Atomen, nicht zwischen verschiedenen Elementen",
    ],
    1,
  ...
  q(
    ...
    [
      "die beim Kondensieren von Dampf zu Flüssigkeit freigesetzte Energie",
      "die zum Verdampfen einer Flüssigkeit benötigte Energie",
      "die Schmelzenthalpie, die beim Übergang fest→flüssig benötigt wird",
      "die Reaktionsenthalpie, also die Differenz ΔH = H(Produkte) − H(Edukte)",
      "immer null, da Verdampfung kein energetischer Prozess ist",
    ],
    1,
