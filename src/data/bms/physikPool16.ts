...
export const physikPool16: Question[] = [
  ...
  q(
    ...
    [
      "J (Joule, Energie)",
      "W/",
      "W/s (einfaches Verhältnis der Größen)",
      "J/kg (als mögliche Antwort)",
      "K/m (einfaches Verhältnis der Größen)",
    ],
    1,
  ...
  q(
    ...
    [
      "L = p (einfacher Zusammenhang)",
      "L = 10·lg(I/I_0) mit Bezugsintensität I_0",
      "L = I/I_0 (Kraftgesetz)",
      "L = p² (einfacher Zusammenhang)",
      "L = f (einfacher Zusammenhang)",
    ],
    1,
  ...
  q(
    ...
    [
      "x = v·t",
      "x = A·cos",
      "x = A·t² (als mögliche Antwort)",
      "x = ω·t (als mögliche Antwort)",
      "x = A/ω (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      "W = F/s (einfacher Zusammenhang)",
      "W = F·s",
      "W = F·v (einfacher Zusammenhang)",
      "W = F·t (einfacher Zusammenhang)",
      "W = s/F (einfacher Zusammenhang)",
    ],
    1,
  ...
  q(
    ...
    [
      "Bq (Becquerel, Aktivität)",
      "Sv oder mSv",
      "Ci",
      "Gy/s (als mögliche Antwort)",
      "J (Joule, Energie)",
    ],
    1,
  ...
  q(
    ...
    [
      "50 s (als Zeitintervall)",
      "0,02 s (als Zeitintervall)",
      "1/50 s = 20 ms",
      "100 s (als Zeitintervall)",
      "0,05 s (als Zeitintervall)",
    ],
    2,
  ...
  q(
    ...
    [
      "Papier (als mögliche Antwort)",
      "dünnes Aluminium",
      "Blei oder Beton",
      "Luft (als mögliche Antwort)",
      "Kunststoff (als mögliche Antwort)",
    ],
    2,
