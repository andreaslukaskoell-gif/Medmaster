...
export const physikPool16: Question[] = [
  ...
  q(
    ...
    [
      ...
      "nur bei Licht definiert (als einziger Beitrag)",
      "immer c (als mögliche Antwort)",
  ...
  q(
    ...
    ["J (Joule, Energie)", "W/", "W/s (einfaches Verhältnis der Größen)", "J/kg (als mögliche Antwort)", "K/m (einfaches Verhältnis der Größen)"],
    1,
  ...
  q(
    ...
    ["L = p (einfacher Zusammenhang)", "L = 10·lg(I/I_0) mit Bezugsintensität I_0", "L = I/I_0 (Kraftgesetz)", "L = p² (einfacher Zusammenhang)", "L = f (einfacher Zusammenhang)"],
    1,
  ...
  q(
    ...
    [
      "ein freies Neutron aus dem Kern emittiert wird",
      "der Tochterkern in einem angeregten Zustand ist und in den Grundzustand übergeht",
      "ausschließlich ein Alpha-Teilchen ohne weiteren Übergang emittiert wird",
      "kein Beta-Zerfall stattfindet und der Kern im Grundzustand bleibt",
      "der Kern in zwei Fragmente spaltet und nur Neutronen freisetzt",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "nur bei Reibung (als einziger Beitrag)",
      "nur in einer Dimension (als einziger Beitrag)",
      "nur für schwere Körper (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur mechanische Prozesse (als einziger Beitrag)",
      "Gleichgewicht bei konstantem Druck und konstanter Temperatur",
      "nur adiabatische Prozesse",
      "nur isochore Prozesse (als einziger Beitrag)",
      "nur ideale Gase (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      "Energiedosis (als mögliche Antwort)",
      "Aktivität",
      "Äquivalentdosis",
      "Halbwertszeit (skalierter Wert)",
      "Reichweite (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      "kein Muster (als physikalische Größe)",
      "ein Interferenzmuster mit konstantem Abstand der Maxima",
      "nur ein Maximum (als einziger Beitrag)",
      "Absorption (Aufnahme von Strahlung durch Materie)",
      "nur Reflexion (ausschließlich, ohne weitere Beiträge)",
    ],
    1,
  ...
  q(
    ...
    [
      "Energie ist in jedem abgeschlossenen System erhalten (1. Hauptsatz)",
      "die Entropie eines idealen Kristalls am absoluten Nullpunkt ist null",
      "Wärme fließt spontan immer von warm nach kalt (2. Hauptsatz)",
      "die Entropie nimmt bei jedem Prozess irreversibel zu (2. Hauptsatz)",
      "es gibt kein Perpetuum mobile, weder erster noch zweiter Art",
    ],
    1,
  ...
  q(
    ...
    [
      "ein freies Neutron vom Kern eingefangen wird (Neutroneneinfang)",
      "ein Kern ein Hüllenelektron einfängt und ein Proton in ein Neutron umwandelt",
      "ein freies Proton von einem Neutron eingefangen wird",
      "ein Alpha-Teilchen vom Kern eingefangen und absorbiert wird",
      "ein hochenergetisches Photon vom Kern emittiert und absorbiert wird",
    ],
    1,
  ...
  q(
    ...
    ["x = v·t", "x = A·cos", "x = A·t² (als mögliche Antwort)", "x = ω·t (als mögliche Antwort)", "x = A/ω (als mögliche Antwort)"],
    1,
  ...
  q(
    ...
    ["W = F/s (einfacher Zusammenhang)", "W = F·s", "W = F·v (einfacher Zusammenhang)", "W = F·t (einfacher Zusammenhang)", "W = s/F (einfacher Zusammenhang)"],
    1,
  ...
  q(
    ...
    ["Bq (Becquerel, Aktivität)", "Sv oder mSv", "Ci", "Gy/s (als mögliche Antwort)", "J (Joule, Energie)"],
    1,
  ...
  q(
    ...
    [
      "Alpha-Zerfall (Emission eines He-4-Kerns)",
      "Beta-Plus-Zerfall oder K-Einfang",
      "Beta-Minus-Zerfall",
      "Spaltung (als mögliche Antwort)",
      "keinem Zerfall (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur hohe Intensität (als einziger Beitrag)",
      "Kohärenz, Monochromasie und Bündelung",
      "nur eine Wellenlänge (als einziger Beitrag)",
      "nur niedrige Divergenz (als einziger Beitrag)",
      "nur gepulst (ausschließlich, ohne weitere Beiträge)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "sie nur Wärme pumpt",
      "der 2. Hauptsatz nicht gilt (als physikalische Erklärung)",
      "sie reversibel ist",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "kinetische Energie von Elektron, Antineutrino und Rückstoßkern",
      "nur Gammastrahlung (als einziger Beitrag)",
      "nur Licht (ausschließlich, ohne weitere Beiträge)",
      "nur potentielle Energie (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur radial (ausschließlich, ohne weitere Beiträge)",
      "senkrecht zur Winkelgeschwindigkeit und zur Geschwindigkeit",
      "nur entgegen der Rotation",
      "nur in Äquatornähe (als einziger Beitrag)",
  ...
  q(
    ...
    [
      ...
      "kein Bild (als physikalische Größe)",
  ...
  q(
    ...
    [
      "am Tripelpunkt (charakteristischer thermodynamischer Zustand)",
      "oberhalb derer die Flüssigkeit nicht mehr durch Druck verflüssigt werden kann",
      "am Siedepunkt (charakteristischer thermodynamischer Zustand)",
      "bei 0 °C (charakteristischer thermodynamischer Zustand)",
      "am Schmelzpunkt (charakteristischer thermodynamischer Zustand)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "orientierte atomare Kreisströme",
      "nur Induktion (ausschließlich, ohne weitere Beiträge)",
      "nur Supraleitung (als einziger Beitrag)",
      "Wärme (Energieübertragung bei Temperaturdifferenz)",
    ],
    1,
  ...
  q(
    ...
    ["J (Joule, Energie)", "J·s (Joulesekunde, Wirkung)", "W (Watt) = J/s", "N (Newton, Kraft)", "Pa (Pascal, Druck)"],
    2,
    "P = W/t → [P] = J/s = W.",
    "leicht",
    ["Leistung", "Watt"]
  ...
  q(
    ...
    [
      ...
      "steigt die Temperatur (unter diesen Bedingungen)",
      "bleibt der Druck konstant",
      "wird Wärme zugeführt (unter Standardbedingungen)",
    ],
    1,
  ...
  q(
    ...
    [
      "nur vom Strom (als einziger Beitrag)",
      "Windungszahl, Querschnitt, Länge und Kernmaterial",
      "nur von der Spannung (als einziger Beitrag)",
      "nur vom Widerstand (als einziger Beitrag)",
      "nur von der Zeit (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      "keine Maxima (als physikalische Größe)",
      "scharfe Interferenzmaxima (Beugungsordnung k·λ = g·sin(α))",
      "nur ein Maximum (als einziger Beitrag)",
      "kontinuierliches Spektrum",
      "nur Absorption (ausschließlich, ohne weitere Beiträge)",
    ],
    1,
  ...
  q(
    ...
    ["50 s (als Zeitintervall)", "0,02 s (als Zeitintervall)", "1/50 s = 20 ms", "100 s (als Zeitintervall)", "0,05 s (als Zeitintervall)"],
    2,
  ...
  q(
    ...
    ["Papier (als mögliche Antwort)", "dünnes Aluminium", "Blei oder Beton", "Luft (als mögliche Antwort)", "Kunststoff (als mögliche Antwort)"],
    2,
