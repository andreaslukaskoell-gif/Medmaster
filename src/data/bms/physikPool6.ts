...
export const physikPool6: Question[] = [
  ...
  q(
    ...
    ["der Trägheit", "der Gravitation", "dem Magnetfeld", "der Reibung", "keiner Kraft"],
    1,
  ...
  q(
    ...
    [
      ...
      "hoher Kohärenz und oft schmalem Frequenzspektrum",
      "nur im IR",
      "nur gepulst",
    ],
    2,
  ...
  q(
    ...
    ["J (Joule, Energie)", "J/kg = Gray", "kg/J", "Sievert", "Becquerel"],
    1,
    "D = E/m → J/kg = Gray (Gy).",
    "leicht",
    ["Gray", "Energiedosis"]
  ...
  q(
    ...
    ["g (Gramm, Masse)", "g·sin(α)", "g·cos(α)", "g·tan(α)", "null (kein Beitrag, verschwindet)"],
    1,
