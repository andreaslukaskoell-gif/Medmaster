...
export const physikPool6: Question[] = [
  ...
  q(
    ...
    [
      ...
      "Spannung (Potentialdifferenz, Einheit Volt)",
      "Wärme",
      "Magnetfeld (als mögliche Antwort)",
      "Licht nur (ohne andere Mechanismen)",
    ],
    2,
  ...
  q(
    ...
    [
      "kleiner als (als mögliche Antwort)",
      "größer oder gleich",
      "immer gleich (als mögliche Antwort)",
      "null (kein Beitrag, verschwindet)",
      "90° (Viertelperiode Verschiebung)",
    ],
    1,
  ...
  q(
    ...
    [
      "0,5 h (als Zeitintervall)",
      "2 h (als Zeitintervall)",
      "30 min (als Zeitintervall)",
      "A und C sind richtig",
      "90 min (als Zeitintervall)",
    ],
    3,
  ...
  q(
    ...
    [
      ...
      "Sievert (als mögliche Antwort)",
      "Becquerel (als mögliche Antwort)",
    ],
    1,
    "D = E/m → J/kg = Gray (Gy).",
    "leicht",
  ...
  q(
    ...
    [
      "500 mm (als Längenwert)",
      "2 μm (als Längenwert)",
      "1/500 mm = 2 μm",
      "500 m (als Längenwert)",
      "0,5 mm (als Längenwert)",
    ],
    2,
  ...
  q(
    ...
    [
      "g (Gramm, Masse)",
      "g·sin(α)",
      "g·cos(α) (als mögliche Antwort)",
      "g·tan(α) (als mögliche Antwort)",
      "null (kein Beitrag, verschwindet)",
    ],
    1,
