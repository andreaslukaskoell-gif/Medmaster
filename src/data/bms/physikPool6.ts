...
export const physikPool6: Question[] = [
  ...
  q(
    ...
    [
      "bleibt p gleich (bei dieser Veränderung)",
      "verdoppelt sich die Druckdifferenz zur Oberfläche",
      "halbiert sich p (proportionale Änderung)",
      "p wird null (als mögliche Antwort)",
      "p = ρ (einfacher proportionaler Zusammenhang)",
    ],
    1,
  ...
  q(
    ...
    [
      "wird verletzt (bei dieser Veränderung)",
      "wird nicht verletzt",
      "gilt nur außen (als mögliche Antwort)",
      "gilt nur innen (als mögliche Antwort)",
      "spielt keine Rolle",
    ],
    1,
  ...
  q(
    ...
    ["Ladung (elektrische Grundeigenschaft, Einheit Coulomb)", "Spannung (Potentialdifferenz, Einheit Volt)", "Wärme", "Magnetfeld (als mögliche Antwort)", "Licht nur (ohne andere Mechanismen)"],
    2,
  ...
  q(
    ...
    [
      "Alpha-Strahlung",
      "Positronen (e⁺) und deren Vernichtungsstrahlung",
      "nur Röntgen (als einziger Beitrag)",
      "nur sichtbares Licht (als einziger Beitrag)",
  ...
  q(
    ...
    [
      "der Trägheit (als mögliche Antwort)",
      "der Gravitation",
      "dem Magnetfeld (als einzige relevante Größe)",
      "der Reibung (als einzige relevante Größe)",
      "keiner Kraft (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["kleiner als (als mögliche Antwort)", "größer oder gleich", "immer gleich (als mögliche Antwort)", "null (kein Beitrag, verschwindet)", "90° (Viertelperiode Verschiebung)"],
    1,
  ...
  q(
    ...
    [
      ...
      "p = V (einfacher proportionaler Zusammenhang)",
  ...
  q(
    ...
    [
      "Kernzerfall (als mögliche Antwort)",
      "Übergänge von Elektronen zwischen Schalen",
      "Bremsstrahlung nur (ohne andere Formen)",
      "Compton-Streuung",
      "Paarbildung (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "hoher Kohärenz und oft schmalem Frequen",
      "nur im IR (als einziger Beitrag)",
  ...
  q(
    ...
    ["0,5 h (als Zeitintervall)", "2 h (als Zeitintervall)", "30 min (als Zeitintervall)", "A und C sind richtig", "90 min (als Zeitintervall)"],
    3,
  ...
  q(
    ...
    [
      ...
      "Druck (Kraft pro Fläche, Einheit Pascal)",
  ...
  q(
    ...
    ["J (Joule, Energie)", "J/kg = Gray", "kg/J (als mögliche Antwort)", "Sievert (als mögliche Antwort)", "Becquerel (als mögliche Antwort)"],
    1,
    "D = E/m → J/kg = Gray (Gy).",
    "leicht",
    ["Gray", "Energiedosis"]
  ...
  q(
    ...
    ["500 mm (als Längenwert)", "2 μm (als Längenwert)", "1/500 mm = 2 μm", "500 m (als Längenwert)", "0,5 mm (als Längenwert)"],
    2,
  ...
  q(
    ...
    ["g (Gramm, Masse)", "g·sin(α)", "g·cos(α) (als mögliche Antwort)", "g·tan(α) (als mögliche Antwort)", "null (kein Beitrag, verschwindet)"],
    1,
