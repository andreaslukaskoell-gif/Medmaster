...
export const biologiePool12: Question[] = [
  ...
  q(
    ...
    [
      "Drei aufeinanderfolgende Basen der DNA (Triplett im codogenen Strang)",
      "Drei aufeinanderfolgende Basen der mRNA, die eine Aminosäure codieren",
      "Ein ganzes Gen (DNA-Abschnitt mit Promotor, Exons und Introns)",
      "Ein Ribosom (Ribonukleoprotein-Komplex aus rRNA und Proteinen)",
      "Ein tRNA-Molekül (Adapter-RNA mit Anticodon und Aminosäurebindestelle)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Eine tRNA (Transfer-RNA als Aminosäure-Adapter bei der Translation)",
      "Ein Ribosom (Ribonukleoprotein-Komplex aus rRNA und Proteinen)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Ein Hormon (Signalmolekül für die endokrine Fernwirkung im Körper)",
      "Ein Enzym (Biokatalysator für biochemische Reaktionen im Stoffwechsel)",
      "Eine Zellmembran (Lipiddoppelschicht mit integrierten Proteinen)",
    ],
    1,
  ...
  q(
    ...
    [
      "DNA",
      "tRNA (Transfer-RNA mit Anticodon und gebundener Aminosäure)",
      "mRNA (Boten-RNA als Kopie eines Gens für die Translation)",
      "rRNA (ribosomale RNA als Strukturkomponente der Ribosomen)",
      "ATP",
    ],
    2,
  ...
  q(
    ...
    [
      "Die Gesamtheit aller Arten in einem Biotop (die gesamte Biozönose)",
  ...
  q(
    ...
    [
      ...
      "Räuber (Prädatoren in der Nahrungskette)",
  ...
  q(
    ...
    [
      ...
      "Im Mitochondrium nur (mitochondriale Ribosomen für eigene Genprodukte)",
  ...
  q(
    ...
    [
      "Der Embryo (innere Zellmasse, Embryoblast der Blastozyste)",
      ...
      "Die innere Zellmasse (Embryoblast, aus dem der Embryo entsteht)",
      "Die Eihaut (Chorion oder Amnion als schützende Embryonalhülle)",
    ],
    1,
  ...
  q(
    ...
    "Was ist ein Genotyp?",
    [
      "Die sichtbare Ausprägung (Phänotyp) eines genetischen Merkmals",
      "Die genetische Ausstattung (Allele) eines Organismus",
      "Ein Chromosom (kondensierte Chromatinstruktur aus DNA und Histonen)",
      "Eine Umwelteigenschaft (abiotischer Faktor wie Temperatur oder Licht)",
      "Ein Protein (Polypeptidkette aus Aminosäuren mit Raumstruktur)",
    ],
    1,
  ...
  q(
    ...
    [
      "Sie produziert die Gallenflüssigkeit in den Hepatozyten der Leber",
      "Sie speichert und konzentriert die von der Leber produzierte Galle",
      "Sie produziert das fettspaltende Enzym Lipase im Pankreas",
      "Sie mündet direkt in den Dünndarm ohne Verbindung zur Leberproduktion",
      "Sie liegt eingebettet in der Bauchspeicheldrüse (Pankreas)",
    ],
    1,
