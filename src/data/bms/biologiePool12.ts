...
export const biologiePool12: Question[] = [
  ...
  q(
    ...
    1,
    "Antigene sind Strukturen, die vom Immunsystem erkannt werden und eine Antwort auslösen.",
    "leicht",
    ["Immunologie", "Antigen"]
  ),
  q(
  ...
  q(
    ...
    1,
    "Heterozygot = zwei verschiedene Allele (z. B. Aa). Homozygot = gleiche Allele.",
    "leicht",
    ["Genetik", "Vererbung"]
  ),
  q(
