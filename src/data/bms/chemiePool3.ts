...
export const chemiePool3: Question[] = [
  ...
  q(
    ...
    [
      "Alkohole haben keine OH-Gruppe und sind daher rein unpolar.",
      "Primäre Alkohole haben die OH-Gruppe an einem C mit einem C-Nachbarn.",
      "Alkohole sind immer gasförmig und können nicht kondensieren.",
      "Alkohole bilden keine Wasserstoffbrücken mit Wasser-Molekülen.",
      "Ethanol ist kein Alkohol, sondern gehört zu den Carbonsäuren.",
    ],
    1,
  ...
  q(
    ...
    [
      "Sie folgen immer exakt pV = nRT, ohne jede Abweichung.",
      "Bei hohem Druck und tiefer Temperatur weichen sie vom idealen Verhalten ab.",
      "Sie haben kein Eigenvolumen (Punktteilchen ohne Ausdehnung).",
      "Es gibt keine Anziehung zwischen den Teilchen (nur bei idealen Gasen korrekt).",
      "Der Kompressibilitätsfaktor Z ist immer exakt 1 (ideales Verhalten).",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "zwei Säuren in einer protolytischen Gleichgewichtsreaktion",
      "zwei Basen unter Bildung eines Salzes und Wassers",
      "nur Metalle (Redoxreaktion mit Elektronenübertragung)",
      "nur Nichtmetalle (kovalente Bindungsbildung durch Elektronenpaare)",
    ],
    0,
  ...
  q(
    ...
    [
      "nur zwischen C und H (rein unpolare kovalente Bindung)",
      "H-Atom (gebunden an O, N oder F) und O, N oder F",
      "zwischen allen Atomen unabhängig von Elektronegativitätsdifferenz",
      "nur in Ionen (geladene Teilchen im Kristallgitter, z. B. NaCl)",
      "nur in Festkörpern (intermolekular, nicht in Flüssigkeiten oder Gasen)",
    ],
    1,
  ...
  q(
    ...
    [
      "Druck und Volumen bei konstanter Temperatur (Boyle-Mariotte)",
      "Volumen und Stoffmenge bei konstantem p und T",
      "nur auf Flüssigkeiten bei Raumtemperatur und Normaldruck",
      "nur auf Feststoffe in kristalliner Form (Gitterstruktur)",
      "Temperatur und Druck bei konstantem Volumen (Gay-Lussac)",
    ],
    1,
  ...
  q(
    ...
    [
      "auf die Eduktseite (dort befinden sich mehr Gasteilchen)",
      "auf die Produktseite (weniger Gasteilchen)",
      "nicht, weil der Druck keinen Einfluss auf Gasreaktionen hat",
      "nur bei Katalysator, da dieser die Druckempfindlichkeit erhöht",
      "zu niedrigerer Temperatur, weil die Reaktion exotherm verläuft",
    ],
    1,
