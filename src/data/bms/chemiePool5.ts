...
export const chemiePool5: Question[] = [
  ...
  q(
    ...
    [
      "NaCl unpolar ist und keine Ionen-Dipol-Wechselwirkungen bildet",
      "die Hydratationsenthalpie die Gitterenergie überwindet",
      "NaCl keine Ionen hat und deshalb nicht dissoziieren kann",
      "Wasser nicht polar ist und keine Hydrathülle bilden kann",
      "NaCl gasförmig wird und sich dadurch nicht lösen lässt",
    ],
    1,
  ...
  q(
    ...
    [
      "niedriger als die von Ethanol (weniger Wasserstoffbrücken pro Molekül)",
      "sehr hoch im Vergleich zu anderen Flüssigkeiten",
      "null (Wasser bildet keine intermolekularen Wechselwirkungen aus)",
      "nur bei 4 °C definiert und ändert sich darüber hinaus stark",
      "immer konstant bei 0 °C und unabhängig vom äußeren Druck",
    ],
    1,
  ...
  q(
    ...
    [
      "Die Reaktionsgeschwindigkeit (kinetische Größe, v = k·[A]ⁿ)",
      "Das Gleichgewicht bei konstanter Temperatur",
      "Die Aktivierungsenergie (Barriere zum Übergangszustand, E_A)",
      "Die Reaktionsordnung (Exponent im Geschwindigkeitsgesetz, n)",
      "Die Katalyse (Beschleunigung der Reaktion durch Katalysator)",
    ],
    1,
  ...
  q(
    ...
    [
      "bestimmt die Geschwindigkeit der Reaktion (kinetische Größe)",
      "ist die Differenz der Enthalpien von Produkten und Edukten",
      "ist immer positiv (endotherme Reaktion, ΔH > 0 für alle Fälle)",
      "ändert sich durch Zugabe eines Katalysators (K beeinflusst ΔH)",
      "ist die Aktivierungsenergie (Energiebarriere zum Übergangszustand)",
    ],
    1,
