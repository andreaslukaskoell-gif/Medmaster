...
export const physikPool8: Question[] = [
  ...
  q(
    ...
    [
      "273 K (als Zahlenwert mit Einheit)",
      "0 °C (als Zahlenwert mit Einheit)",
      "32 °F (als Zahlenwert mit Einheit)",
      "A und B sind richtig",
      "100 °C (als Zahlenwert mit Einheit)",
    ],
    3,
    "0 °C = 273,15 K.",
    "leicht",
  ...
  q(
    ...
    [
      "eV (Elektronenvolt)",
      "keV bis MeV",
      "MeV nur (ohne andere Mechanismen)",
      "Joule (SI-Einheit der Energie)",
      "Kalorien (ältere Energieeinheit, 4,186 J)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "100 °C (als Zahlenwert mit Einheit)",
      "273 K (als Zahlenwert mit Einheit)",
      "373 K (als Zahlenwert mit Einheit)",
  ...
  q(
    ...
    [
      ...
      "V (Volt, Spannung)",
      "V/m oder N/C",
      "C/m (Coulomb pro Meter, Linienladung)",
