...
export const physikPool8: Question[] = [
  ...
  q(
    ...
    [
      "keine Arbeit (als physikalische Größe)",
      "Arbeit vom System nach außen",
      "Arbeit von außen auf das System",
      "Q = 0 (einfacher Zusammenhang)",
      "T constant (als mögliche Antwort)",
    ],
    2,
  ...
  q(
    ...
    [
      "Alpha-Zerfall nur",
      "Übergang zwischen Kernniveaus",
      "Beta-Zerfall nur",
      "Schmelzen (als mögliche Antwort)",
  ...
  q(
    ...
    [
      "ein festes Medium",
      "kein Medium",
      "nur Flüssigkeit (als einziger Beitrag)",
      "nur Gas (ausschließlich, ohne weitere Beiträge)",
  ...
  q(
    ...
    ["273 K (als Zahlenwert mit Einheit)", "0 °C (als Zahlenwert mit Einheit)", "32 °F (als Zahlenwert mit Einheit)", "A und B sind richtig", "100 °C (als Zahlenwert mit Einheit)"],
    3,
    "0 °C = 273,15 K.",
    "leicht",
    ["Schmelzpunkt", "Eis"]
  ...
  q(
    ...
    [
      ...
      "negativ werden (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["eV (Elektronenvolt)", "keV bis MeV", "MeV nur (ohne andere Mechanismen)", "Joule (SI-Einheit der Energie)", "Kalorien (ältere Energieeinheit, 4,186 J)"],
    1,
  ...
  q(
    ...
    ["0 °C (als Zahlenwert mit Einheit)", "100 °C (als Zahlenwert mit Einheit)", "273 K (als Zahlenwert mit Einheit)", "373 K (als Zahlenwert mit Einheit)", "B und D sind richtig"],
    4,
    "100 °C = 373,15 K.",
    "leicht",
    ["Siedepunkt", "Wasser"]
  ...
  q(
    ...
    ["J (Joule, Energie)", "J/K (Joule pro Kelvin, Entropie)", "J/", "kg/K (als mögliche Antwort)", "W (Watt, Leistung)"],
    2,
    "c in J/(kg·K).",
    "leicht",
  ...
  q(
    ...
    ["N (Newton, Kraft)", "V (Volt, Spannung)", "V/m oder N/C", "C/m (Coulomb pro Meter, Linienladung)", "A/m (Ampere pro Meter, Magnetfeld)"],
    2,
    "E = F/q → N/C = V/m.",
    "leicht",
    ["Feldstärke", "Einheit"]
  ...
  q(
    ...
    ["n-fache", "1/n (als Kehrwert der Größe)", "n²", "√n", "2n"],
    0,
