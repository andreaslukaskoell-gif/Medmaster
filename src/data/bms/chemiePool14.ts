...
export const chemiePool14: Question[] = [
  ...
  q(
    ...
    [
      "die Reaktionsenthalpie (Energiedifferenz zwischen Produkten und Edukten)",
      "die Energie, die zur Einleitung der Reaktion nötig ist",
      "die freie Enthalpie (Gibbs-Energie, bestimmt Spontaneität)",
      "immer null, da Energie erhalten bleibt (1. Hauptsatz)",
      "die Gleichgewichtskonstante K (Verhältnis der Konzentrationen)",
    ],
    1,
  ...
  q(
    ...
    [
      "Sie sind immer sauer, unabhängig von den Ausgangsreagenzien",
      "Sie entstehen bei Neutralisation aus Säure und Base",
      "Sie leiten nie Strom, auch nicht in wässriger Lösung",
      "Sie haben immer pH 7, da sie neutral reagieren müssen",
      "Sie sind immer organisch und enthalten stets Kohlenstoff",
    ],
    1,
  ...
  q(
    ...
    [
      "die Siedetemperatur einer Flüssigkeit bei einem Druck von 1 bar",
      "die Temperatur, oberhalb der ein Gas nicht mehr durch Druck verflüssigt werden kann",
      "0 °C, der Gefrierpunkt von reinem Wasser unter Normaldruck",
      "die Schmelztemperatur, bei der ein Feststoff flüssig wird",
      "immer 100 °C, da alle Stoffe bei dieser Temperatur sieden",
    ],
    1,
  ...
  q(
    ...
    [
      "stärker als kovalente Bindungen (höhere Bindungsenergie)",
      "schwache zwischenmolekulare Kräfte zwischen allen Molekülen",
      "nur zwischen polaren Molekülen mit permanentem Dipolmoment",
      "nur in Festkörpern vorhanden, nicht in Flüssigkeiten oder Gasen",
      "gleich stark wie Wasserstoffbrücken (identische Wechselwirkung)",
    ],
    1,
  ...
  q(
    ...
    [
      "der Siedepunkt einer Flüssigkeit bei Normaldruck (1013 hPa)",
      "der Punkt, an dem fest, flüssig und gasförmig im Gleichgewicht stehen",
      "der Schmelzpunkt bei 0 bar (unter vollständigem Vakuum)",
      "nur für Wasser definiert und nicht auf andere Stoffe anwendbar",
      "immer bei 0 °C und 1 bar für alle reinen Substanzen",
    ],
    1,
  ...
  q(
    ...
    [
      "Es gibt nur ein einziges Orbital pro Kohlenstoffatom",
      "Kohlenstoff bildet 4 gleichwertige Bindungen (z. B. in CH₄)",
      "Sie kommt nur bei Metallen mit d-Orbitalen vor (Übergangsmetalle)",
      "Es entstehen ausschließlich Doppelbindungen, keine Einfachbindungen",
      "Sie gilt nur für Sauerstoff, nicht für andere Hauptgruppenelemente",
    ],
    1,
  ...
  q(
    ...
    [
      "molekular gebunden in kleinen, diskreten Einheiten (z. B. CO₂)",
      "in einem Riesenmolekül (Netzwerk) kovalent verknüpft",
      "ionisch gebunden in einem regelmäßigen Kristallgitter (z. B. NaCl)",
      "nur durch van-der-Waals-Kräfte zwischen den Schichten zusammengehalten",
      "metallisch gebunden mit frei beweglichen Valenzelektronen",
    ],
    1,
  ...
  q(
    ...
    [
      "nur die Reaktionsgeschwindigkeit, nicht die Gleichgewichtslage",
      "die Richtung und das Gleichgewicht (bei konstantem p, T)",
      "nur die Aktivierungsenergie, ohne die Thermodynamik zu beeinflussen",
      "nur bei Katalysatoren, die den Reaktionsweg verändern",
      "nur in der Gasphase, nicht bei Reaktionen in Lösung",
    ],
    1,
  ...
  q(
    ...
    [
      "Atome an eine Doppelbindung addiert werden (Additionsreaktion)",
      "ein Molekül in zwei Teile gespalten wird und dabei oft eine Doppelbindung entsteht",
      "nur oxidiert wird (Abgabe von Elektronen an ein Oxidationsmittel)",
      "nur substituiert wird (Austausch eines Atoms oder einer Gruppe)",
      "ein Ester aus Carbonsäure und Alkohol gebildet wird (Veresterung)",
    ],
    1,
  ...
  q(
    ...
    [
      "niedrigem Druck und hoher Temperatur (expandiertes Gas)",
      "hohem Druck und tiefer Temperatur",
      "immer, unabhängig von äußeren Bedingungen wie Druck oder Temperatur",
      "nur bei Edelgasen, da diese einatomig und kugelförmig sind",
      "nur bei genau 0 °C und einem Druck von exakt 1 bar (Normalbedingung)",
    ],
    1,
  ...
  q(
    ...
    [
      "Sie sind rotationssymmetrisch um die Bindungsachse (typisch für σ)",
      "π-Bindungen entstehen durch Überlappung von p-Orbitalen seitlich zur Bindungsachse",
      "Es gibt sie nur in Ionen, nicht in neutralen Molekülen",
      "Sie sind stärker als σ-Bindungen (höhere Bindungsenergie)",
      "Sie kommen nur in Einfachbindungen vor (nicht in Mehrfachbindungen)",
    ],
    1,
