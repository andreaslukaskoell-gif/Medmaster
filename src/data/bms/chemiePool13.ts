...
export const chemiePool13: Question[] = [
  ...
  q(
    ...
    [
      "die Form des Orbitals (s, p, d, f nach Nebenquantenzahl l)",
      "die Schale bzw. Energie des Elektrons",
      "den Spin des Elektrons (Eigenrotation, Werte +½ oder −½)",
      "die Protonenzahl im Kern (bestimmt die Identität des Elements)",
      "die Neutronenzahl im Kern (Differenz aus A und Z)",
    ],
    1,
  ...
  q(
    ...
    [
      "ein Molekül aus zwei kovalent gebundenen Chloratomen",
      "ein Chlor-Isotop mit Massenzahl 35",
      "Chlor mit 35 Elektronen in der Elektronenhülle",
      "ein Ion (geladenes Teilchen nach Elektronenaufnahme)",
      "Chlorid (Anion nach Aufnahme eines Elektrons, Cl⁻)",
    ],
    1,
  ...
  q(
    ...
    [
      "Alkane mit Halogenen (radikalische Substitution)",
      "Alkene mit Halogenen oder H₂",
      "Säure mit Base (Neutralisationsreaktion zu Salz)",
      "Zersetzung (thermischer Zerfall eines Stoffs)",
      "Veresterung (Alkohol + Säure, Kondensation)",
    ],
    1,
  ...
  q(
    ...
    [
      "alle Bindungen unpolar sind und kein Dipolmoment entsteht",
      "ein Molekül polar ist (ungleichmäßige Ladungsverteilung)",
      "nur Ionen vorliegen und keine kovalenten Bindungen existieren",
      "das Molekül linear ist und sich alle Dipole aufheben",
      "nur Kohlenstoff und Wasserstoff vorkommen (rein unpolare Bindungen)",
    ],
    1,
  ...
  q(
    ...
    [
      "Säure und Base in einer Neutralisationsreaktion",
      "Oxidationsmittel und Reduktionsmittel in einer Redoxreaktion",
      "Oxidierte und reduzierte Form desselben Elements",
      "zwei Alkanen unterschiedlicher Kettenlänge (homologe Reihe)",
      "Katalysator und Inhibitor als Reaktionsbeeinflusser",
    ],
    2,
  ...
  q(
    ...
    [
      "Alkohol + Alken (Dehydratisierungsreaktion)",
      "Carbonsäure + Amin (bzw. Ammoniak)",
      "zwei Alkoholen (Etherbildung durch Kondensation)",
      "Aldehyd + Keton (gekreuzte Aldolreaktion)",
      "Ester + Säure (Umesterungsgleichgewicht)",
    ],
    1,
  ...
  q(
    ...
    [
      "Alkanen (gesättigte Kohlenwasserstoffe ohne funktionelle Gruppe)",
      "Alkenen (ungesättigte Kohlenwasserstoffe mit Doppelbindung)",
      "reduzierenden Zuckern bzw. Aldehyden",
      "Carbonsäuren (organische Säuren mit COOH-Gruppe)",
      "Alkoholen allgemein (Verbindungen mit Hydroxylgruppe)",
    ],
    2,
