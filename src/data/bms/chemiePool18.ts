...
export const chemiePool18: Question[] = [
  ...
  q(
    ...
    [
      "dass alle Elektronen in einem Orbital gleichen Spin haben müssen",
      "dass zwei Elektronen in einem Orbital unterschiedlichen Spin haben müssen",
      "dass es in der Elektronenhülle keine diskreten Orbitale gibt",
      "dass jede Schale immer vollständig mit Elektronen besetzt ist",
      "dass nur zwei Orbitale pro Schale im Atom existieren können",
    ],
    1,
  ...
  q(
    ...
    [
      "nur der Art des Lösungsmittels (chemische Zusammensetzung)",
      "der Molalität des gelösten Stoffs (kolligative Eigenschaft)",
      "nur der Dichte der Lösung (Masse pro Volumen in g/mL)",
      "nur dem Druck des Systems (gemessen in bar oder Pascal)",
      "der Farbe des gelösten Stoffs (Absorptionsspektrum, λ_max)",
    ],
    1,
  ...
  q(
    ...
    [
      "den pH-Wert (negativer Logarithmus der H₃O⁺-Konzentration)",
      "die Nernst-Gleichung bzw. das Elektrodenpotential",
      "nur die Konzentration der Edukte im Reaktionsgleichgewicht",
      "nur die Temperatur des Systems (in Kelvin oder Celsius)",
      "den pOH (negativer Logarithmus der Hydroxid-Konzentration)",
    ],
    1,
  ...
  q(
    ...
    [
      "Addition an eine C=C-Doppelbindung (elektrophil oder radikalisch)",
      "nitrierende Substitution (z. B. am Aromaten)",
      "Verseifung eines Esters mit Lauge zu Alkohol und Carboxylat",
      "Hydrierung einer Doppelbindung durch katalytische H₂-Anlagerung",
      "Veresterung von Carbonsäure und Alkohol unter Wasserabspaltung",
    ],
    1,
  ...
  q(
    ...
    [
      "zwei gleiche Lösungen gleicher Konzentration voneinander getrennt sind",
      "eine Lösung und reines Lösungsmittel durch eine semipermeable Membran getrennt sind",
      "nur Gase vorliegen und keine flüssige Phase beteiligt ist",
      "keine Membran vorhanden ist und die Phasen direkt mischen",
      "die Temperatur des gesamten Systems exakt bei 0 °C liegt",
    ],
    1,
  ...
  q(
    ...
    [
      "Es gibt mehrere getrennte Moleküle, die schnell ineinander umwandeln",
      "Die wahre Struktur ist eine Überlagerung (Mittel) mehrerer Grenzstrukturen",
      "Nur Ionen zeigen Resonanz, nicht kovalente neutrale Moleküle",
      "Die Bindungslängen sind immer unterschiedlich in jeder Grenzstruktur",
      "Es gibt keine Doppelbindungen in mesomeriestabilisierten Systemen",
    ],
    1,
  ...
  q(
    ...
    [
      "nur Kohlenhydrate (Monosaccharide wie Glucose oder Fructose)",
      "Fettsäuren, Glycerin, Phosphorsäure, Aminoalkohol",
      "nur Aminosäuren (Bausteine der Proteine mit NH₂ und COOH)",
      "nur Steroide (Ringsystem aus vier kondensierten Ringen)",
      "nur Zucker (Mono- und Disaccharide ohne Lipidanteil)",
    ],
    1,
  ...
  q(
    ...
    [
      "die Energie bei Abgabe eines Elektrons (Ionisierungsenergie, IE)",
      "die Energie bei Aufnahme eines Elektrons (oft freigesetzt)",
      "die Ionisierungsenergie (Abtrennung aus neutralem Atom, endotherm)",
      "die Bindungsenergie (Energie zur Spaltung einer kovalenten Bindung)",
      "die Gitterenergie (Bildung des Ionengitters aus gasförmigen Ionen)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "nur die Verdampfung einer Flüssigkeit (Phasenübergang flüssig→gas)",
      "nur Feststoffe und deren Löslichkeit in verschiedenen Lösungsmitteln",
      "die Reaktionsgeschwindigkeit chemischer Gleichgewichtsreaktionen",
      "den osmotischen Druck biologischer Membranen in wässrigen Systemen",
    ],
    0,
  ...
  q(
    ...
    [
      "K klein ist (Gleichgewicht liegt auf Seite der Edukte)",
      "K groß ist (viel C bei Gleichgewicht)",
      "K = 0 ist (überhaupt keine Produktbildung stattfindet)",
      "kein Katalysator vorhanden ist und die Reaktion langsam läuft",
      "die Temperatur niedrig ist und die Teilchen wenig Energie haben",
    ],
    1,
  ...
  q(
    ...
    [
      "Alkohol und Alken durch Dehydratisierung (Wasserabspaltung)",
      "Glycerin und drei Fettsäuren (Ester)",
      "zwei Aminosäuren durch Peptidbindung (Kondensationsreaktion)",
      "Aldehyd und Keton durch eine Aldolkondensationsreaktion",
      "zwei Zuckern durch glycosidische Bindung (Disaccharidbildung)",
    ],
    1,
  ...
  q(
    ...
    [
      "ist unabhängig von der gelösten Stoffmenge (reine Lösungsmitteleigenschaft)",
      "ist proportional zum Molenbruch des Lösungsmittels (Raoult)",
      "erhöht den Dampfdruck der Lösung über den des reinen Lösungsmittels",
      "gilt nur für Gase, nicht für Flüssigkeiten oder feste Lösungen",
      "ist immer null bei Lösungen mit gelösten Feststoffen (keine Verdampfung)",
    ],
    1,
  ...
  q(
    ...
    "Ein Lacton ist:",
    [
      "ein Lactam (cyclisches Amid mit N−C=O-Gruppe im Ring)",
      "ein cyclischer Ester (Ester mit intramolekularer Ringbildung)",
      "ein Ether (Verbindung mit C−O−C-Brücke, ohne Carbonylgruppe)",
      "ein Alkan (gesättigter Kohlenwasserstoff ohne funktionelle Gruppe)",
      "ein Keton (Carbonylgruppe zwischen zwei C-Atomen, R−CO−R)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "Metallbindung (delokalisierte Elektronen im Metallgitter)",
      "Wasserstoffbrücke (H zwischen O, N oder F und einem Akzeptor)",
      "Dipol-Dipol-Wechselwirkung (permanente Dipole benachbarter Moleküle)",
    ],
    1,
  ...
  q(
    ...
    [
      "hängt v nur von der Konzentration ab (v = k·[A]ⁿ, n ≥ 1)",
      "ist v unabhängig von der Konzentration der Edukte",
      "gibt es keine Reaktion und die Konzentration bleibt konstant",
      "ist v immer null, unabhängig von äußeren Bedingungen",
      "hängt v nur vom Druck ab und nicht von der Konzentration",
    ],
    1,
