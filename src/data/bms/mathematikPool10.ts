 ...
 *        mathe-kap5 (Funktionen & Analysis), mathe-kap6 (Vektoren), mathe-kap7 (Stochastik).
...
export const mathematikPool10: Question[] = [
  ...
  // ─── mathe-kap7: Stochastik (14 Fragen) ───

  q(
    "ma-pool-10-057",
    "mathe-kap7",
    "Bei autosomal-rezessiver Vererbung sind beide Elternteile heterozygot (Aa). Mit welcher Wahrscheinlichkeit ist ein Kind homozygot dominant (AA)?",
    ["10 %", "25 %", "50 %", "75 %", "12,5 %"],
    1,
    "Kreuzung Aa × Aa: AA (25 %), Aa (50 %), aa (25 %). P(AA) = 1/4 = 25 %.",
    "leicht",
    ["Stochastik", "Genetik", "Mendel", "Wahrscheinlichkeit"]
  ),
  q(
    "ma-pool-10-058",
    "mathe-kap7",
    "Ein Test hat Sensitivität 90 % und Spezifität 80 %. Prävalenz der Erkrankung: 10 %. Was ist der positive prädiktive Wert (PPV)? (Auf ganze % runden.)",
    ["33 %", "47 %", "50 %", "64 %", "90 %"],
    0,
    "Von 1000 Personen: 100 krank, 900 gesund. TP = 90. FP = 180 (20 % von 900). PPV = 90/(90+180) = 90/270 ≈ 33 %.",
    "schwer",
    ["Stochastik", "Diagnostik", "Sensitivität", "Spezifität", "PPV"]
  ),
  q(
    "ma-pool-10-059",
    "mathe-kap7",
    "Beide Eltern sind Träger eines autosomal-rezessiven Gens (Aa). Wie groß ist die Wahrscheinlichkeit, dass von 4 Kindern genau 2 betroffen (aa) sind? (p = 0,25)",
    ["9,8 %", "21,1 %", "26,4 %", "37,5 %", "42,2 %"],
    1,
    "P(X=2) = C(4,2)·0,25²·0,75² = 6·0,0625·0,5625 ≈ 0,211 = 21,1 %.",
    "schwer",
    ["Stochastik", "Binomialverteilung", "Genetik", "Wahrscheinlichkeit"]
  ),
  q(
    "ma-pool-10-060",
    "mathe-kap7",
    "Ein Arzt untersucht 5 unabhängige Patienten auf eine seltene Erkrankung (Prävalenz 20 %). Wie groß ist die Wahrscheinlichkeit, dass kein Patient erkrankt ist?",
    ["20 %", "32,8 %", "40 %", "80 %", "16,4 %"],
    1,
    "P(X=0) = (1−0,2)⁵ = 0,8⁵ = 0,32768 ≈ 32,8 %.",
    "mittel",
    ["Stochastik", "Binomialverteilung", "Prävalenz", "Epidemiologie"]
  ),
  q(
    "ma-pool-10-061",
    "mathe-kap7",
    "In einem Krankenhaus treten Infektionen mit Rate λ = 3 pro Woche auf (Poisson-Verteilung). Wie groß ist P(X=0), die Wahrscheinlichkeit für null Infektionen in einer Woche? (e⁻³ ≈ 0,0498)",
    ["5,0 %", "10,0 %", "15,0 %", "20,0 %", "3,0 %"],
    0,
    "P(X=0) = e^(−λ) = e⁻³ ≈ 0,0498 ≈ 5,0 %.",
    "schwer",
    ["Stochastik", "Poisson-Verteilung", "Infektionen", "Epidemiologie"]
  ),
  q(
    "ma-pool-10-062",
    "mathe-kap7",
    "Blutgruppen: P(A) = 0,45, P(B) = 0,11, P(AB) = 0,04, P(0) = 0,40. Zwei zufällig ausgewählte Personen: Wie groß ist die Wahrscheinlichkeit, dass beide Blutgruppe 0 haben?",
    ["4 %", "8 %", "16 %", "20 %", "40 %"],
    2,
    "P(beide 0) = 0,40 × 0,40 = 0,16 = 16 % (unabhängige Ereignisse).",
    "leicht",
    ["Stochastik", "Wahrscheinlichkeit", "Blutgruppen", "unabhängige Ereignisse"]
  ),
  q(
    "ma-pool-10-063",
    "mathe-kap7",
    "Die Normalverteilung der Körpergröße hat µ = 175 cm und σ = 10 cm. Welcher Anteil der Bevölkerung liegt innerhalb von ±1σ (165–185 cm)?",
    ["50 %", "68 %", "95 %", "99,7 %", "34 %"],
    1,
    "Bei Normalverteilung: µ ± 1σ enthält ca. 68 %; ±2σ ≈ 95 %; ±3σ ≈ 99,7 %.",
    "leicht",
    ["Stochastik", "Normalverteilung", "Sigma-Regel", "Epidemiologie"]
  ),
  q(
    "ma-pool-10-064",
    "mathe-kap7",
    "Ein Medikament wird mit 3 unabhängigen Tests geprüft. Jeder Test hat eine Fehlerquote (falsch negativ) von 10 %. Wie groß ist die Wahrscheinlichkeit, dass alle 3 Tests die Wirksamkeit korrekt bestätigen?",
    ["70,0 %", "72,9 %", "90,0 %", "97,0 %", "99,9 %"],
    1,
    "P(korrekt pro Test) = 0,9. P(alle 3 korrekt) = 0,9³ = 0,729 = 72,9 %.",
    "mittel",
    ["Stochastik", "Multiplikationsregel", "Diagnostik", "Unabhängigkeit"]
  ),
  q(
    "ma-pool-10-065",
    "mathe-kap7",
    "Aus 10 Patienten (7 geheilt, 3 nicht geheilt) werden zufällig 2 ausgewählt (ohne Zurücklegen). Wie groß ist die Wahrscheinlichkeit, dass beide geheilt sind?",
    ["49/100", "7/15", "21/100", "14/45", "42/100"],
    1,
    "P = (7/10) × (6/9) = 42/90 = 7/15 ≈ 46,7 %.",
    "mittel",
    ["Stochastik", "Kombinatorik", "Ziehen ohne Zurücklegen", "klinische Studie"]
  ),
  q(
    "ma-pool-10-066",
    "mathe-kap7",
    "Satz von Bayes: P(+) = P(+|K)·P(K) + P(+|¬K)·P(¬K). Sensitivität 95 %, Spezifität 90 %, Prävalenz 2 %. Wie groß ist P(+)?",
    ["0,019", "0,098", "0,117", "0,095", "0,180"],
    2,
    "P(+) = 0,95 × 0,02 + 0,10 × 0,98 = 0,019 + 0,098 = 0,117.",
    "schwer",
    ["Stochastik", "Bayes", "Diagnostik", "Sensitivität", "Spezifität"]
  ),
  q(
    "ma-pool-10-067",
    "mathe-kap7",
    "Aus einer Stichprobe (n = 100) von Allelfrequenzen beträgt die Standardabweichung s = 0,1. Wie groß ist der Standardfehler des Mittelwerts?",
    ["0,001", "0,01", "0,1", "1,0", "0,05"],
    1,
    "Standardfehler SE = s / √n = 0,1 / √100 = 0,1 / 10 = 0,01.",
    "mittel",
    ["Stochastik", "Standardfehler", "Statistik", "Genetik"]
  ),
  q(
    "ma-pool-10-068",
    "mathe-kap7",
    "In einer klinischen Studie werden 5 Medikamente auf Nebenwirkungen getestet. Jedes hat eine 5%-Wahrscheinlichkeit für eine falsch-positive Meldung. Wie groß ist die Wahrscheinlichkeit, mindestens eine falsch-positive Meldung zu erhalten?",
    ["5 %", "22,6 %", "25 %", "77,4 %", "95 %"],
    1,
    "P(mindestens 1) = 1 − P(keine) = 1 − 0,95⁵ = 1 − 0,7738 ≈ 0,226 = 22,6 %.",
    "schwer",
    ["Stochastik", "Gegenwahrscheinlichkeit", "Multiples Testen", "klinische Studie"]
  ),
  q(
    "ma-pool-10-069",
    "mathe-kap7",
    "Die Körpergröße von Männern sei normalverteilt: µ = 178 cm, σ = 7 cm. Wie viel Prozent der Männer sind größer als 192 cm (entspricht µ + 2σ)?",
    ["2,5 %", "5 %", "16 %", "34 %", "47,5 %"],
    0,
    "µ + 2σ liegt am rechten Rand des 95%-Intervalls. Oberhalb: (100 % − 95 %) / 2 = 2,5 %.",
    "mittel",
    ["Stochastik", "Normalverteilung", "Sigma-Regel", "Epidemiologie"]
  ),
  q(
    "ma-pool-10-070",
    "mathe-kap7",
    "Aus 6 Medikamenten sollen 2 für einen Kombinationstest ausgewählt werden (Reihenfolge irrelevant). Wie viele verschiedene Paare gibt es?",
    ["12", "15", "30", "36", "6"],
    1,
    "C(6,2) = 6! / (2! × 4!) = (6 × 5) / (2 × 1) = 15. Es gibt 15 verschiedene Medikamentenpaare.",
    "leicht",
    ["Stochastik", "Kombinatorik", "Binomialkoeffizient", "klinische Studie"]
  ),
];
