...
export const biologiePool2: Question[] = [
  ...
  q(
    ...
    [
      "Es ist der Hauptort der Lipidsynthese in der Zelle.",
      "Die Ribosomen auf seiner Oberfläche translatieren vor allem sekretorische und membranständige Proteine.",
      "Es besitzt keine direkte Verbindung zur Kernhülle.",
      "Es ist ausschließlich in Nervenzellen vorhanden.",
      "Seine Membran enthält keine Transmembranproteine.",
    ],
    1,
  ...
  q(
    ...
    [
      "Der Protonengradient über der inneren Mitochondrienmembran bleibt bestehen, aber ATP wird nicht mehr synthetisiert.",
      "Die Elektronentransportkette stoppt sofort vollständig.",
      "Der Citratzyklus wird direkt gehemmt.",
  ...
  q(
    ...
    [
      ...
      "Aktiver Transport benötigt Energie (z. B. ATP), um Stoffe gegen den Konzentrationsgradienten zu befördern.",
  ...
  q(
    ...
    ["Ösophagus", "Magen", "Duodenum und Jejunum", "Colon", "Rektum"],
    2,
  ...
  q(
    ...
    [
      ...
      "Arten sind Gruppen von Populationen, deren Mitglieder sich unter natürlichen Bedingungen untereinander fortpflanzen und fertile Nachkommen hervorbringen.",
  ...
  q(
    ...
    [
      ...
      "Sie kommen ausschließlich beim Menschen vor (z. B. Appendix).",
  ...
  q(
    ...
    [
      "Der Mensch hat 44 Autosomen und 2 Gonosomen (insgesamt 46 Chromosomen).",
  ...
  q(
    ...
    [
      ...
      "Ein erhöhtes Risiko für Trisomie 21 (Down-Syndrom) durch unbalancierte Segregation.",
  ...
  q(
    ...
    [
      ...
      "Er wird auf nahezu allen kernhaltigen Zellen exprimiert und präsentiert endogene Peptide den zytotoxischen T-Zellen.",
  ...
  q(
    ...
    [
      ...
      "Typ-IV-Überempfindlichkeit (verzögerte zellvermittelte Reaktion)",
  ...
  q(
    ...
    [
      ...
      "Es besteht aus Plasmaproteinen, die kaskadenartig aktiviert werden und zur Lyse von Erregern beitragen.",
