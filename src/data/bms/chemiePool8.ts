...
export const chemiePool8: Question[] = [
  ...
  q(
    ...
    [
      "Das zweite Elektron wird aus einem energiereichen 3p-Orbital entfernt",
      ...
      "Na kann nur ein Elektron abgeben, weil es nur eine Valenzschale besitzt",
      "Der Sprung ist auf die Pauli-Abstoßung zurückzuführen",
      "Das zweite Elektron liegt in einem 2s-Orbital mit höherer Hauptquantenzahl",
    ],
    1,
  ...
  q(
    ...
    [
      "Sehr hohe Wasserlöslichkeit, schlechte Membranpassage",
      "Gute Lipophilie (Verhältnis 100:1 in Octanol) → gute Membranpermeation, aber möglicherweise schlechte wässrige Löslichkeit",
      "logP = 2 entspricht einem hydrophilen Molekül",
      "Kein Einfluss auf Resorption, nur auf Clearance",
      "logP > 0 bedeutet vollständige Unlöslichkeit in Wasser",
    ],
    1,
  ...
  q(
    ...
    [
      "Respiratorische Alkalose; Niere scheidet mehr HCO₃⁻ aus",
      "Metabolische Azidose (Akkumulation von H⁺, HCO₃⁻↓); Kompensation: Hyperventilation (CO₂ abatmen)",
      "Metabolische Alkalose; Atemfrequenz sinkt",
      "Respiratorische Azidose; Niere kompensiert sofort",
      "Kein Säure-Base-Problem bei Nierenversagen",
    ],
    1,
  ...
  q(
    ...
    [
      "Enantiomere haben identische biochemische Wirkung",
      "Chirale Wirkstoffe interagieren enantioselektiv mit chiralen Rezeptoren/Enzymen → unterschiedliche biologische Aktivitäten",
      "Teratogenität ist unabhängig von Stereochemie",
      "Racematspaltung ist pharmazeutisch irrelevant",
      "Das S-Enantiomer ist stabiler und daher toxischer",
    ],
    1,
  ...
  q(
    ...
    [
      "3 Peptidbindungen, frei rotierbar",
      "3 Peptidbindungen, partieller Doppelbindungscharakter → planar, eingeschränkte Rotation",
      "4 Peptidbindungen, planar",
      "2 Peptidbindungen, vollständige Doppelbindungen",
      "3 Peptidbindungen, ausschließlich sp³-Charakter",
    ],
    1,
  ...
  q(
    ...
    [
      "α und β unterscheiden sich in der Konfiguration an C-6",
      "α-glycosidische Bindung (Stärke) vs. β-glycosidische Bindung (Cellulose) bestimmt, ob Menschen das Polymer verdauen können",
      "Beide sind identisch; Stärke und Cellulose unterscheiden sich nur in Kettenlänge",
      "α-Glucose hat 5 OH-Gruppen, β-Glucose nur 4",
      "Stärke enthält Fructose, Cellulose ausschließlich α-Glucose",
    ],
    1,
