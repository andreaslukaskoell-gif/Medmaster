...
export const physikPool3: Question[] = [
  ...
  q(
    ...
    [
      ...
      "die Periode (als einzige relevante Größe)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "ist die Brechzahl 1. (unter Standardbedingungen)",
      "gilt nur für Schall. (unter Standardbedingungen)",
    ],
    1,
  ...
  q(
    ...
    [
      "radioaktiven Zerfall (spontane Kernumwandlung)",
      "Abbremsung schneller Elektronen (Bremsstrahlung) oder Übergänge in der Elektronenhülle",
      "Kernspaltung (Zerfall schwerer Kerne in leichtere)",
      "Alpha-Zerfall (Emission eines He-4-Kerns)",
      "Beta-Zerfall (Umwandlung Neutron ↔ Proton)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "steigt der Druck auf 0. (unter diesen Bedingungen)",
      "wird keine Energie zugeführt. (unter Standardbedingungen)",
      "entsteht Eis. (als mögliche Antwort)",
    ],
    1,
  ...
  q(
    ...
    ["kg·m/s² (als mögliche Antwort)", "kg·m/s (Impuls, Bewegungsgröße)", "N·s (einfaches Verhältnis der Größen)", "B und C sind richtig", "J (Joule, Energie)"],
    3,
  ...
  q(
    ...
    ["4 m/s (als Geschwindigkeitswert)", "ca. 8,9 m/s", "10 m/s (als Geschwindigkeitswert)", "20 m/s (als Geschwindigkeitswert)", "0 m/s (als Geschwindigkeitswert)"],
    1,
  ...
  q(
    ...
    [
      "der Geschwindigkeit (linear) (als physikalische Erklärung)",
      "der Normalkraft und der Materialpaarung",
      "nur der Kontaktfläche (als einziger Beitrag)",
      "der Temperatur allein (als physikalische Erklärung)",
      "der Masse nicht (als physikalische Erklärung)",
    ],
    1,
  ...
  q(
    ...
    [
      "bei b = f (charakteristischer thermodynamischer Zustand)",
      "bei b = 2f",
      "bei b = ∞ (charakteristischer thermodynamischer Zustand)",
      "bei b < f (virtuell)",
  ...
  q(
    ...
    ["mm (Millimeter, 10⁻³ m)", "μm (Mikrometer, 10⁻⁶ m)", "nm", "m (Meter, Länge)", "km (Kilometer, 10³ m)"],
    2,
  ...
  q(
    ...
    [
      ...
      "nur Infrarot (ausschließlich, ohne weitere Beiträge)",
    ],
    1,
