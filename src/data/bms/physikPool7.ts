...
export const physikPool7: Question[] = [
  ...
  q(
    ...
    ["N (Newton, Kraft)", "kg·m/s (Impuls, Bewegungsgröße)", "J (Joule)", "W (Watt, Leistung)", "Pa (Pascal, Druck)"],
    2,
  ...
  q(
    ...
    ["nur positiv (ausschließlich, ohne weitere Beiträge)", "positiv, negativ oder null", "nur negativ (ausschließlich, ohne weitere Beiträge)", "nur null (ausschließlich, ohne weitere Beiträge)", "nur größer als Q (als einziger Beitrag)"],
    1,
  ...
  q(
    ...
    ["positive (als mögliche Antwort)", "keine", "negative (als mögliche Antwort)", "variable (als mögliche Antwort)", "1 u"],
    1,
  ...
  q(
    ...
    ["10 m/s (als Geschwindigkeitswert)", "ca. 10 m/s", "5 m/s (als Geschwindigkeitswert)", "2 m/s (als Geschwindigkeitswert)", "50 m/s (als Geschwindigkeitswert)"],
    1,
  ...
  q(
    ...
    ["90° (Viertelperiode Verschiebung)", "ca. 48,6°", "0° (gleichphasig, keine Verschiebung)", "45° (halbe Viertelperiode Verschiebung)", "60° (Sechstelperiode Verschiebung)"],
    1,
  ...
  q(
    ...
    ["m (Meter, Länge)", "cm (Zentimeter, 10⁻² m)", "nm bis pm", "km (Kilometer, 10³ m)", "μm (Mikrometer, 10⁻⁶ m)"],
    2,
