...
export const physikPool7: Question[] = [
  ...
  q(
    ...
    [
      "nur positiv (ausschließlich, ohne weitere Beiträge)",
      "positiv, negativ oder null",
      "nur negativ (ausschließlich, ohne weitere Beiträge)",
      "nur null (ausschließlich, ohne weitere Beiträge)",
      "nur größer als Q (als einziger Beitrag)",
    ],
    1,
  ...
  q(
    ...
    [
      ...
      "ca. 10 m/s",
      "5 m/s (als Geschwindigkeitswert)",
      "2 m/s (als Geschwindigkeitswert)",
      "50 m/s (als Geschwindigkeitswert)",
    ],
    1,
