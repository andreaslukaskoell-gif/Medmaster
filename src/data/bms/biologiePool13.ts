...
export const biologiePool13: Question[] = [
  ...
  q(
    ...
    [
      "Abwehr durch zelluläre Immunzellen",
      "Abwehr durch lösliche Antikörper im Blut und in Gewebeflüssigkeit",
      "Nur die angeborene unspezifische Abwehr",
      "Nur T-Zellen",
      "Nur Makrophagen",
    ],
    1,
  ...
  q(
    ...
    [
      "Ein einfacher Chromosomensatz (n)",
      "Ein doppelter Satz (2n)",
      "Nur in Keimzellen",
      "92 Chromosomen als Chromosomensatz beim Menschen",
      "Nur bei Pflanzen als Organisationsform",
    ],
    1,
  ...
  q(
    ...
    1,
    "Nach der Organogenese wird der Embryo als Fetus bezeichnet.",
    "leicht",
    ["Embryologie", "Fetus"]
  ),
  q(
  ...
  q(
    ...
    [
      ...
      "Nur abiotische Faktoren ohne Lebewesen",
  ...
  q(
    ...
    [
      "Nur ein einzelnes Gen beteiligt",
  ...
  q(
    ...
    [
      "Ein Produzent",
      "Ein Organismus, der organische Substanz von anderen aufnimmt",
      "Ein Zersetzer (Destruent) ohne Rolle als Konsument in der Nahrungskette",
      "Ein Pilz ohne autotrophe Ernährung",
      "Eine Pflanze",
    ],
    1,
