...
export const chemiePool17: Question[] = [
  ...
  q(
    ...
    [
      "Redoxreaktion (Elektronenübertragung zwischen Teilchen)",
  ...
  q(
    ...
    [
      ...
      "nur die Masse des betrachteten Stoffes, ohne Temperaturabhängigkeit",
      "nur die Temperatur des Systems, unabhängig von der Stoffmenge",
      "nur den Druck, gemessen in Pascal (bei konstanter Temperatur)",
      "das Volumen des Systems, unabhängig von Stoff und Temperatur",
    ],
    0,
  ...
  q(
    ...
    [
      "hat einen konstanten Siedepunkt, ähnlich einer reinen Substanz",
      "ändert sich beim Sieden nicht in der Zusammensetzung (Dampf = Flüssigkeit)",
  ...
  q(
    ...
    [
      "immer im Zähler des Massenwirkungsgesetzes",
  ...
  q(
    ...
    "Die Verseifung ist:",
    [
      "die Bildung eines Esters aus Alkohol und Carbonsäure (Kondensation)",
  ...
  q(
    ...
    [
      "die absolute Wassermenge in g/m³ (absolute Luftfeuchtigkeit)",
      ...
      "den Druck der Atmosphäre (Luftdruck in hPa oder bar)",
      "die Dichte der Luft (Masse pro Volumen, in kg/m³)",
    ],
    1,
  ...
  q(
    ...
    [
      "reagiert nur A (monomolekularer Zerfall ohne Stoßpartner)",
      "stoßen zwei Teilchen (A und B) für den Elementarschritt zusammen",
      "gibt es kein B als Reaktionspartner im Mechanismus",
      "reagiert der Stoff nur in wässriger Lösung (nicht in Gas)",
      "ist die Ordnung immer 0, also konzentrationsunabhängig",
    ],
    1,
