...
export const chemiePool9: Question[] = [
  ...
  q(
    ...
    [
      "Diethylether (symmetrischer Ether aus zwei Ethylresten)",
      "Ethylacetat (Essigsäureethylester)",
      "Acetaldehyd (Ethanal, einfachster Aldehyd mit 2 C-Atomen)",
      "Aceton (Propanon, einfachstes Keton mit Carbonylgruppe)",
      "Natriumacetat (Natriumsalz der Essigsäure, CH₃COONa)",
    ],
    1,
