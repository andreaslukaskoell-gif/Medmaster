...
export const biologiePool8: Question[] = [
  ...
  q(
    ...
    ["die Eizelle", "das Spermium", "die Gebärmutter", "die Eileiter", "beide Elternteile gleich"],
    1,
  ...
  q(
    ...
    1,
    "Kinozilien und Geißeln haben die 9+2-Struktur.",
    "schwer",
    ["Zilien", "Kap2"]
  ),
  q(
    ...
    1,
    "Chargaff: In einem Doppelstrang ist die Menge an A gleich der von T, die von G gleich der von C.",
    "mittel",
    ["DNA", "Chargaff", "Kap4"]
  ),
  q(
  ...
  q(
    ...
    2,
    "Homozygot = gleiche Allele; heterozygot = Aa. Dominant = großes A.",
    "leicht",
    ["Genetik", "Kap4"]
  ),
  q(
  ...
  q(
    ...
    1,
    "Diploid = zwei Chromosomensätze; pro Gen gibt es zwei Allele.",
    "leicht",
    ["Genetik", "Kap4"]
  ),
  q(
