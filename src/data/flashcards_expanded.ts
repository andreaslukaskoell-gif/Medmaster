...
export const bioEvolution: Flashcard[] = [
  {
    ...
    back: "Individün mit vorteilhaften Merkmalen überleben und pflanzen sich häufiger fort.\nDarwin: 'Survival of the fittest' = Überleben der Bestangepassten (nicht der Stärksten!).",
    category: "bio",
    topic: "Evolution",
    difficulty: "leicht",
  },
...
export const chemieBiochemie: Flashcard[] = [
  ...
  {
    id: "fc-ch-bc4",
    front: "Enzyme: Michälis-Menten-Kinetik?",
