...
export const bioEvolution: Flashcard[] = [
  { id: "fc-bio-ev1", front: "Was ist natürliche Selektion?", back: "Individuen mit vorteilhaften Merkmalen überleben und pflanzen sich häufiger fort.\nDarwin: 'Survival of the fittest' = Überleben der Bestangepassten (nicht der Stärksten!).", category: "bio", topic: "Evolution", difficulty: "leicht" },
...
export const bioMuskelSystem: Flashcard[] = [
  ...
  { id: "fc-bio-mu6", front: "ATP-Quellen im Muskel?", back: "1. Kreatinphosphat → ATP (sofort, ~10 s)\n2. Anaerobe Glykolyse (Glukose → Laktat, ~1–2 min)\n3. Aerobe Oxidation (Fettsäuren + Glukose, Minuten–Stunden)\nMuskelfasertypen:\nTyp I (rot, slow-twitch): Ausdauer, viele Mitochondrien, aerob\nTyp II (weiß, fast-twitch): Kraft/Schnelligkeit, anaerob, schnell ermüdend.", category: "bio", topic: "Muskelsystem", difficulty: "mittel" },
...
export const bioStoffwechsel: Flashcard[] = [
  ...
  { id: "fc-bio-sw8", front: "Cori-Zyklus: Laktat-Recycling?", back: "Muskel (anaerob): Glucose → Pyruvat → Laktat (Lactatdehydrogenase)\nLaktat → Blut → Leber\nLeber: Laktat → Pyruvat → Glucose (Gluconeogenese)\nGlucose → Blut → Muskel\nEnergetisch 'teuer': Muskel gewinnt 2 ATP, Leber verbraucht 6 ATP\nBedeutung: Ermöglicht anaerobe Muskelarbeit ohne Laktat-Akkumulation.", category: "bio", topic: "Stoffwechsel", difficulty: "mittel" },
...
export const expandedDecks: Record<string, Flashcard[]> = {
  ...
  "chemie-stoechiometrie": chemieStoechiometrie,
  ...
  "physik-waermelehre": physikWaerme,
  "physik-wellen": physikWellen,
  "physik-atomphysik": physikAtomphysik,
  "physik-elektrizitaet-extra": physikElektExtra,
...
export const expandedDeckLabels: Record<string, string> = {
  ...
  "chemie-stoechiometrie": "Chemie: Stöchiometrie",
  ...
  "physik-waermelehre": "Physik: Wärmelehre",
  "physik-wellen": "Physik: Wellen & Optik",
  "physik-atomphysik": "Physik: Atomphysik",
  "physik-elektrizitaet-extra": "Physik: Elektrizität II",
