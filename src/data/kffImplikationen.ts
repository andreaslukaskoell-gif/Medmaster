...
const IMPLIKATION_PRACTICE_TASKS: ImplikationTask[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "Einige Pflanzen sind keine Rosen.",
    ...
    correctAnswer: 2,
    explanation:
      "Disamis: Einige Blumen sind Rosen + Alle Blumen sind Pflanzen. Da einige Blumen Rosen sind und alle Blumen Pflanzen, müssen einige Pflanzen auch Rosen sein. Regel 5: Eine 'einige'-Prämisse erfordert 'einige' im Schluss.",
    difficulty: 1,
    rulesApplied: [5],
  },
  {
  ...
  {
    id: "imp-06",
    premise1: "Einige Instrumente sind keine Violinen.",
    premise2: "Alle Instrumente sind Gegenstände.",
    options: [
      "Alle Gegenstände sind Violinen.",
      "Einige Gegenstände sind keine Violinen.",
      "Alle Gegenstände sind keine Violinen.",
      "Einige Gegenstände sind Violinen.",
      "Keine der Schlussfolgerungen ist richtig.",
    ],
    correctAnswer: 1,
    explanation:
      "Bocardo: Einige Instrumente sind keine Violinen + Alle Instrumente sind Gegenstände. Da einige Instrumente keine Violinen sind und alle Instrumente Gegenstände, gibt es Gegenstände (nämlich diese Instrumente), die keine Violinen sind. Regel 4+5: 'keine' + 'einige' im Schluss.",
    difficulty: 1,
    rulesApplied: [4, 5],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      "Einige Mineralien sind Diamanten.",
      "Einige Diamanten sind keine Mineralien.",
      "Keine der Schlussfolgerungen ist richtig.",
    ],
    correctAnswer: 2,
    explanation:
      "Disamis: Einige Edelsteine sind Diamanten + Alle Edelsteine sind Mineralien. Da einige Edelsteine Diamanten sind und alle Edelsteine Mineralien, müssen einige Mineralien Diamanten sein. Regel 5: 'einige' erfordert 'einige' im Schluss.",
    difficulty: 1,
    rulesApplied: [5],
  },
  {
  ...
  {
    id: "imp-10",
    premise1: "Einige Früchte sind Bananen.",
    premise2: "Alle Früchte sind Lebensmittel.",
    options: [
      "Alle Lebensmittel sind Bananen.",
      "Einige Lebensmittel sind keine Bananen.",
      "Einige Lebensmittel sind Bananen.",
      "Alle Bananen sind keine Lebensmittel.",
      "Keine der Schlussfolgerungen ist richtig.",
    ],
    correctAnswer: 2,
    explanation:
      "Disamis: Einige Früchte sind Bananen + Alle Früchte sind Lebensmittel. Da einige Früchte Bananen sind und alle Früchte Lebensmittel, gibt es Lebensmittel, die Bananen sind. Regel 5: 'einige' im Schluss.",
    difficulty: 1,
    rulesApplied: [5],
  },
  {
    id: "imp-11",
    premise1: "Einige Vögel sind keine Pinguine.",
    premise2: "Alle Vögel sind Tiere.",
    options: [
      "Alle Tiere sind Pinguine.",
      "Einige Tiere sind keine Pinguine.",
      "Alle Tiere sind keine Pinguine.",
      "Einige Tiere sind Pinguine.",
      "Keine der Schlussfolgerungen ist richtig.",
    ],
    correctAnswer: 1,
    explanation:
      "Bocardo: Einige Vögel sind keine Pinguine + Alle Vögel sind Tiere. Da einige Vögel keine Pinguine sind und alle Vögel Tiere, gibt es Tiere (nämlich diese Vögel), die keine Pinguine sind. Regel 4+5: 'keine' + 'einige' im Schluss.",
    difficulty: 1,
    rulesApplied: [4, 5],
  },
  {
...
const NOUN_TRIPLETS: [string, string, string][] = [
  ...
  ["Kometen", "Himmelskörper", "Phänomene"],
  ["Sterne", "Himmelskörper", "Lichtquellen"],
  ["Bakterien", "Mikroorganismen", "Lebewesen"],
  ["Viren", "Erreger", "Pathogene"],
  ...
  ["Seen", "Gewässer", "Ökosysteme"],
  ["Wüsten", "Landschaften", "Ökosysteme"],
  ...
  ["Gemälde", "Kunstwerke", "Bilder"],
  ["Skulpturen", "Kunstwerke", "Objekte"],
  ...
  ["Nerven", "Leitungen", "Gewebe"],
  ["Zellen", "Einheiten", "Lebensformen"],
...
const SYLLOGISM_PATTERNS: SyllogismPattern[] = [
  ...
  // Difficulty 1: Darii — Alle B sind C + Einige A sind B → Einige A sind C
  {
    quantifier1: "Alle",
    quantifier2: "Einige",
    structure: "chain",
  ...
  // Difficulty 1: Ferio — Keine B sind C + Einige A sind B → Einige A sind keine C
  {
    quantifier1: "Keine",
    quantifier2: "Einige",
    structure: "chain",
  ...
  // Difficulty 1: Cesare — Keine B sind C + Alle A sind C → Keine A sind B
  {
    quantifier1: "Keine",
    quantifier2: "Alle",
    structure: "reverse",
  ...
  // Difficulty 1: Disamis — Einige B sind C + Alle B sind A → Einige A sind C
  {
    quantifier1: "Einige",
    quantifier2: "Alle",
    structure: "chain",
  ...
  // Difficulty 1: Disamis reverse — Einige A sind B + Alle B sind C → Einige A sind C
  {
    quantifier1: "Einige",
    quantifier2: "Alle",
    structure: "reverse",
  ...
  // Difficulty 1: Einige+Keine chain → Einige sind keine (Ferio variant)
  {
    quantifier1: "Einige",
    quantifier2: "Keine",
    structure: "chain",
