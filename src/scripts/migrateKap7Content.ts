...
async function migrateKap7Content() {
  ...
  for (const mapping of UNTERKAPITEL_MAPPING) {
    try {
      ...
      if (subchapters.length > 1) {
        console.warn(`   ⚠️  Multiple subchapters found for "${mapping.title}", updating first one`);
      }
  ...
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log(`✅ Successfully updated: ${updatedCount}/${UNTERKAPITEL_MAPPING.length} Unterkapitel`);
