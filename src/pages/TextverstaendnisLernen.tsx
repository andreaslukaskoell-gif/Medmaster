...
function Seite1() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-lg p-5">
        ...
        <ul className="space-y-2 text-sm text-indigo-700 dark:text-indigo-400">
          <li className="flex items-start gap-2">
            ...
            <span>
              Du bekommst <span className="font-bold">1 wissenschaftlichen Text</span> (500-800
              W&ouml;rter)
            </span>
          </li>
          <li className="flex items-start gap-2">
            ...
            <span>
              Dazu <span className="font-bold">4-6 MC-Fragen</span> mit jeweils 4
          ...
          <li className="flex items-start gap-2">
            ...
            <span>
              Du darfst <span className="font-bold">w&auml;hrend der Fragen im Text nachlesen</span>
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="bg-indigo-200 dark:bg-indigo-800 text-indigo-800 dark:text-indigo-200 text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5">
            ...
            <span>
              Zeitlimit: ca. <span className="font-bold">6 Minuten pro Text</span> (Text + Fragen)
            </span>
          </li>
        </ul>
      </div>
      ...
      <Merksatz>
        Der TV-Untertest testet ausschlie&szlig;lich dein Leseverst&auml;ndnis — NICHT dein
        Vorwissen! Alle Antworten m&uuml;ssen sich aus dem Text ableiten lassen.
      </Merksatz>
    </div>
  );
}
...
function Seite2() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-5 space-y-3">
        ...
        <div className="pl-11 grid grid-cols-1 sm:grid-cols-3 gap-2">
          {[
            ...
            {
              icon: BookOpen,
              label: "Struktur erfassen",
              desc: "Wie viele Absätze? Welche Gliederung?",
            },
      ...
      <Merksatz>
        Goldene Regel: &quot;Fragen zuerst, dann lesen!&quot; — Wer die Fragen kennt, liest 50%
        effizienter.
      </Merksatz>
    </div>
  );
...
function Seite3() {
  return (
    <div className="space-y-6">
      ...
      <Merksatz>
        Pro-Tipp: Wenn du bei einer Frage unsicher bist, geh im Text zur&uuml;ck zur relevanten
        Stelle. Das kostet 10 Sekunden, spart aber Punkte!
      </Merksatz>
    </div>
  );
}
