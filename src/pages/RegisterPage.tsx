...
import { Mail, Lock, User, Eye, EyeOff, ArrowRight, Calendar } from "lucide-react";
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const { error } = await signUp(email, password, username, birthDate);
    setLoading(false);
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label
                    ...
                    className="text-sm font-medium text-muted-foreground mb-1 block"
                  >
                    Geburtsdatum <span className="text-[var(--muted)] font-normal">(optional)</span>
                  </label>
                  <div className="relative">
