...
import WortfluessigkeitEndlos from "./WortfluessigkeitEndlos";

type TabKey = "lernen" | "ueben" | "simulation" | "endlos";
...
const tabs: { key: TabKey; label: string; icon: React.ElementType }[] = [
  ...
  { key: "endlos", label: "Endlos", icon: Flame },
];
...
{ label: "Dashboard", href: "/" },
  { label: "KFF Academy", href: "/kff" },
      ...
      {/* Tab content */}
      {activeTab === "lernen" && <WortfluessigkeitLernen />}
      {activeTab === "ueben" && <WortfluessigkeitUeben />}
      {activeTab === "simulation" && <WortfluessigkeitSimulation />}
      {activeTab === "endlos" && <WortfluessigkeitEndlos />}
    </div>
  );
}
