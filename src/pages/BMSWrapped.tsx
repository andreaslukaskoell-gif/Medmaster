  ...
  return (
    <div className="fixed inset-0 bg-black overflow-hidden">
      <AnimatePresence mode="wait">
        {currentSlide === 0 && <Slide0Intro key="s0" data={data} onNext={goNext} />}
        {currentSlide === 1 && (
        ...
        {currentSlide === 3 && <Slide3Level key="s3" data={data} onNext={goNext} onBack={goBack} />}
        {currentSlide === 4 && (
          <Slide4Aktivitaet key="s4" data={data} onNext={goNext} onBack={goBack} />
        )}
        {currentSlide === 5 && <Slide5Share key="s5" data={data} onBack={goBack} />}
      </AnimatePresence>
    </div>
  );
}
