...
export default function CovalentBond() {
  ...
  return (
    <div className="space-y-3">
      <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Kovalente Bindung — H\u2082O</h4>
      ...
      <svg viewBox="0 0 420 350" className="w-full max-w-lg mx-auto">
        ...
        <text x="130" y="114" textAnchor="middle" fontSize="16" fontWeight="bold" fill="#fff">O</text>

        {/* H atoms */}
        <circle cx="60" cy="165" r="18" fill="url(#hGrad)" stroke="#2563eb" strokeWidth="2" />
        <text x="60" y="169" textAnchor="middle" fontSize="14" fontWeight="bold" fill="#fff">H</text>

        <circle cx="200" cy="165" r="18" fill="url(#hGrad)" stroke="#2563eb" strokeWidth="2" />
        <text x="200" y="169" textAnchor="middle" fontSize="14" fontWeight="bold" fill="#fff">H</text>
        ...
        <text x="130" y="72" textAnchor="middle" fontSize="6" fill="#6b7280">Freie e\u207B-Paare</text>
        ...
        <text x="330" y="114" textAnchor="middle" fontSize="16" fontWeight="bold" fill="#fff">O</text>

        <circle cx="268" cy="168" r="20" fill="url(#hGrad)" stroke="#2563eb" strokeWidth="2" />
        <text x="268" y="172" textAnchor="middle" fontSize="13" fontWeight="bold" fill="#fff">H</text>

        <circle cx="392" cy="168" r="20" fill="url(#hGrad)" stroke="#2563eb" strokeWidth="2" />
        <text x="392" y="172" textAnchor="middle" fontSize="13" fontWeight="bold" fill="#fff">H</text>
