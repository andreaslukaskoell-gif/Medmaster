  ...
  return (
    <div className="space-y-3">
      ...
      <svg viewBox="0 0 540 380" className="w-full max-w-2xl mx-auto">
        ...
        >
          <circle cx="70" cy="110" r="38" fill="url(#sGrad)" stroke={active === "s" ? "#115e59" : "#0d9488"} strokeWidth={active === "s" ? 2.5 : 1.5} opacity="0.85" />
          <circle cx="70" cy="110" r="25" fill="none" stroke="#ccfbf1" strokeWidth="0.5" strokeDasharray="3 2" opacity="0.5" />
        ...
        <g
          ...
          onMouseLeave={() => setActive(null)}
        >
          <ellipse cx="177" cy="92" rx="14" ry="32" fill="url(#pGradPos)" stroke={active === "px" ? "#115e59" : "#0d9488"} strokeWidth={active === "px" ? 2.5 : 1.5} opacity="0.85" />
          ...
          <text x="249" y="96" fontSize="13" {...halo}>x</text>
        ...
        <g
          ...
          onMouseLeave={() => setActive(null)}
        >
          <ellipse cx="320" cy="78" rx="30" ry="13" fill="url(#pGradPos)" stroke={active === "py" ? "#115e59" : "#0d9488"} strokeWidth={active === "py" ? 2.5 : 1.5} opacity="0.85" transform="rotate(-45 320 78)" />
          <ellipse cx="320" cy="106" rx="30" ry="13" fill="url(#pGradNeg)" stroke={active === "py" ? "#115e59" : "#0d9488"} strokeWidth={active === "py" ? 2.5 : 1.5} opacity="0.85" transform="rotate(-45 320 106)" />
          <circle cx="320" cy="92" r="3" fill="#115e59" />
          <line x1="298" y1="70" x2="342" y2="114" stroke="#6b7280" strokeWidth="0.5" strokeDasharray="2 2" />
          {/* Axis label moved outside */}
          <line x1="342" y1="114" x2="350" y2="122" stroke="#9ca3af" strokeWidth="0.8" />
          <text x="354" y="126" fontSize="13" {...halo}>y</text>
          {/* Leader line to label below */}
        ...
        <g
          ...
          onMouseLeave={() => setActive(null)}
        >
          <ellipse cx="445" cy="92" rx="13" ry="30" fill="url(#pGradPos)" stroke={active === "pz" ? "#115e59" : "#0d9488"} strokeWidth={active === "pz" ? 2.5 : 1.5} opacity="0.85" />
          <ellipse cx="445" cy="92" rx="30" ry="13" fill="url(#pGradNeg)" stroke={active === "pz" ? "#115e59" : "#0d9488"} strokeWidth={active === "pz" ? 2.5 : 1.5} opacity="0.85" transform="rotate(90 445 92)" />
          <circle cx="445" cy="92" r="3" fill="#115e59" />
          <line x1="445" y1="55" x2="445" y2="129" stroke="#6b7280" strokeWidth="0.5" strokeDasharray="2 2" />
          {/* Axis label moved outside orbital top, with leader line */}
          <line x1="445" y1="55" x2="445" y2="44" stroke="#9ca3af" strokeWidth="0.8" />
          <text x="452" y="43" fontSize="13" {...halo}>z</text>
          {/* Leader line to label below */}
        ...
        >
          {/* Four lobes */}
          <ellipse cx="270" cy="278" rx="12" ry="28" fill="url(#dGrad1)" stroke={active === "d" ? "#115e59" : "#0d9488"} strokeWidth={active === "d" ? 2.5 : 1.5} opacity="0.85" transform="rotate(45 270 278)" />
          <ellipse cx="270" cy="278" rx="12" ry="28" fill="url(#dGrad2)" stroke={active === "d" ? "#115e59" : "#0d9488"} strokeWidth={active === "d" ? 2.5 : 1.5} opacity="0.85" transform="rotate(-45 270 278)" />
          <ellipse cx="270" cy="278" rx="28" ry="12" fill="url(#dGrad1)" stroke={active === "d" ? "#115e59" : "#0d9488"} strokeWidth={active === "d" ? 2.5 : 1.5} opacity="0.85" transform="rotate(45 270 278)" />
          <ellipse cx="270" cy="278" rx="28" ry="12" fill="url(#dGrad2)" stroke={active === "d" ? "#115e59" : "#0d9488"} strokeWidth={active === "d" ? 2.5 : 1.5} opacity="0.85" transform="rotate(-45 270 278)" />
          <circle cx="270" cy="278" r="4" fill="#115e59" />
          {/* Axes */}
          <line x1="232" y1="278" x2="308" y2="278" stroke="#6b7280" strokeWidth="0.5" strokeDasharray="2 2" />
          <line x1="270" y1="240" x2="270" y2="316" stroke="#6b7280" strokeWidth="0.5" strokeDasharray="2 2" />
          {/* Axis labels moved outside with leader lines */}
          <line x1="308" y1="278" x2="318" y2="278" stroke="#9ca3af" strokeWidth="0.8" />
          <text x="322" y="282" fontSize="13" {...halo}>x</text>
