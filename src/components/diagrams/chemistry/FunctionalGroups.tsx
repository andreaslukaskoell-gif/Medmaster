...
const groups: FunctionalGroup[] = [
  { id: "hydroxyl", name: "Hydroxylgruppe", formula: "-OH", foundIn: "Alkohole (Ethanol, Methanol)", detail: "Polare Gruppe, erhoet die Wasserlöslichkeit. Kann Wasserstoffbrücken bilden." },
  { id: "carbonyl", name: "Carbonylgruppe", formula: "C=O", foundIn: "Aldehyde / Ketone", detail: "Aldehyde: C=O am Kettenende. Ketone: C=O in der Kettenmitte. Wichtig in Zuckern." },
  { id: "carboxyl", name: "Carboxylgruppe", formula: "-COOH", foundIn: "Carbonsäuren (Essigsäure)", detail: "Kann ein Proton abgeben (saure Gruppe). Enthalten in Aminosäuren und Fettsäuren." },
  { id: "amino", name: "Aminogruppe", formula: "-NH\u2082", foundIn: "Aminosäuren, Amine", detail: "Basische Gruppe, kann ein Proton aufnehmen. Grundbaustein aller Aminosäuren." },
  { id: "phosphat", name: "Phosphatgruppe", formula: "-PO\u2084", foundIn: "ATP, DNA, Phospholipide", detail: "Negativ geladen bei pH 7. Energieträger (ATP). Rückgrat der DNA/RNA." },
  { id: "sulfhydryl", name: "Sulfhydrylgruppe", formula: "-SH", foundIn: "Cystein, Coenzym A", detail: "Thiolgruppe. Bildet Disulfidbrücken (S-S) bei Proteinstruktur. Redox-aktiv." },
];
    ...
    <div className="space-y-3">
        ...
        {groups.map((g, i) => {
          ...
          return (
            ...
            >
              ...
              <text x={x + 65} y={y + 80} textAnchor="middle" fontSize="6" fill="#6b7280">{g.foundIn}</text>
      ...
      {activeGroup && (
        <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 rounded-lg p-3">
          <p className="text-sm font-semibold text-teal-700 dark:text-teal-300">{activeGroup.name} ({activeGroup.formula})</p>
          <p className="text-xs text-gray-700 dark:text-gray-300 mt-1">{activeGroup.detail}</p>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Vorkommen: {activeGroup.foundIn}</p>
        </div>
      )}
    </div>
  );
