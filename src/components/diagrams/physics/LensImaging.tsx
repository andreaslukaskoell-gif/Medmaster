      ...
      {lens === "converging" ? (
        <svg viewBox="0 0 480 300" className="w-full max-w-lg mx-auto">
          ...
          <line
            ...
            strokeDasharray="4 3"
          />
          <text x="450" y="145" textAnchor="end" fontSize="7" fill="#6b7280">
            Optische Achse
          </text>
          ...
          <text x="155" y="168" textAnchor="middle" fontSize="13" fill="#f59e0b" fontWeight="bold">
            F
          </text>

          <circle cx="305" cy="150" r="4" fill="#f59e0b" stroke="#d97706" strokeWidth="1" />
          <text x="305" y="168" textAnchor="middle" fontSize="13" fill="#f59e0b" fontWeight="bold">
            F&apos;
          </text>

          {/* 2F points */}
          <circle cx="80" cy="150" r="3" fill="#d97706" opacity="0.5" />
          <text x="80" y="168" textAnchor="middle" fontSize="7" fill="#d97706">
            2F
          </text>
          <circle cx="380" cy="150" r="3" fill="#d97706" opacity="0.5" />
          <text x="380" y="168" textAnchor="middle" fontSize="7" fill="#d97706">
            2F&apos;
          </text>
          ...
          <text x="100" y="78" textAnchor="middle" fontSize="13" fill="#0f766e" fontWeight="bold">
            G
          </text>
          ...
          <line
            ...
            stroke="#22c55e"
            strokeWidth="1.5"
            markerEnd="url(#arrowRayC3)"
          />

          {/* Image (Bild) - inverted */}
          <line x1="365" y1="150" x2="365" y2="190" stroke="#ef4444" strokeWidth="2.5" />
          <polygon points="365,190 359,180 371,180" fill="#ef4444" />
          <text x="365" y="202" textAnchor="middle" fontSize="13" fill="#ef4444" fontWeight="bold">
            B
          </text>
          <text x="365" y="214" textAnchor="middle" fontSize="7" fill="#6b7280">
            (reell, umgekehrt)
          </text>

          {/* Legend */}
          <line x1="30" y1="260" x2="50" y2="260" stroke="#ef4444" strokeWidth="1.5" />
          <text x="55" y="263" fontSize="7" fill="#ef4444">
            Parallelstrahl
          </text>
          <line x1="130" y1="260" x2="150" y2="260" stroke="#3b82f6" strokeWidth="1.5" />
          <text x="155" y="263" fontSize="7" fill="#3b82f6">
            Brennpunktstrahl
          </text>
          <line x1="250" y1="260" x2="270" y2="260" stroke="#22c55e" strokeWidth="1.5" />
          <text x="275" y="263" fontSize="7" fill="#22c55e">
            Mittelpunktstrahl
          </text>

          {/* Formula */}
          <text x="240" y="285" textAnchor="middle" fontSize="13" fill="#0f766e">
        ...
        <svg viewBox="0 0 480 300" className="w-full max-w-lg mx-auto">
          ...
          <text x="170" y="168" textAnchor="middle" fontSize="13" fill="#f59e0b" fontWeight="bold">
            F
          </text>

          <circle cx="310" cy="150" r="4" fill="#f59e0b" stroke="#d97706" strokeWidth="1" />
          <text x="310" y="168" textAnchor="middle" fontSize="13" fill="#f59e0b" fontWeight="bold">
            F&apos;
          </text>
          ...
          <text x="170" y="108" textAnchor="middle" fontSize="13" fill="#ef4444" fontWeight="bold">
            B
          </text>
          <text x="170" y="185" textAnchor="middle" fontSize="7" fill="#6b7280">
            (virtuell, aufrecht,
          </text>
          <text x="170" y="196" textAnchor="middle" fontSize="7" fill="#6b7280">
            verkleinert)
          </text>
          ...
          <line
            ...
            strokeDasharray="4 3"
          />
          <text x="375" y="263" fontSize="7" fill="#6b7280">
            Virtuelle Verlängerung
          </text>

          {/* Formula */}
          <text x="240" y="285" textAnchor="middle" fontSize="13" fill="#0f766e">
            f &lt; 0 bei Zerstreuungslinse | 1/f = 1/g + 1/b
          </text>
        </svg>
      )}
