  ...
  return (
    <div className="space-y-3">
      ...
      <svg viewBox="0 0 480 320" className="w-full max-w-lg mx-auto">
        ...
        {/* Ambulance body */}
        <rect x="210" y="118" width="65" height="40" rx="5" fill="#fff" stroke="#0d9488" strokeWidth="2.5" />
        <rect x="215" y="123" width="18" height="12" rx="2" fill="#ccfbf1" stroke="#0d9488" strokeWidth="1" />
        {/* Red cross */}
        ...
        {/* Siren */}
        <rect x="237" y="112" width="18" height="7" rx="3" fill="#ef4444" stroke="#dc2626" strokeWidth="1" />
        ...
        <g>
          ...
          <text x="420" y="155" textAnchor="middle" fontSize="7" fill="#0f766e" fontWeight="bold">Beobachter A</text>
        </g>
        ...
        <g>
          ...
          <text x="55" y="155" textAnchor="middle" fontSize="7" fill="#ef4444" fontWeight="bold">Beobachter B</text>
        </g>

        {/* Labels for wave compression/stretching */}
        <rect x="290" y="45" width="130" height="30" rx="4" fill="#ccfbf1" stroke="#0d9488" strokeWidth="1" />
        <text x="355" y="57" textAnchor="middle" fontSize="7" fill="#0d9488" fontWeight="bold">Komprimierte Wellen</text>
        <text x="355" y="68" textAnchor="middle" fontSize="7" fill="#0f766e">Kürzeres \u03BB \u2192 Höheres f</text>

        <rect x="40" y="45" width="130" height="30" rx="4" fill="#f3f4f6" stroke="#6b7280" strokeWidth="1" />
        <text x="105" y="57" textAnchor="middle" fontSize="7" fill="#6b7280" fontWeight="bold">Gedehnte Wellen</text>
        <text x="105" y="68" textAnchor="middle" fontSize="7" fill="#6b7280">Längeres \u03BB \u2192 Niedrigeres f</text>
      ...
      <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 rounded-lg p-3">
        <p className="text-xs text-gray-700 dark:text-gray-300">
          Der Doppler-Effekt beschreibt die Änderung der wahrgenommenen Frequenz, wenn sich Quelle und Beobachter relativ zueinander bewegen.
          Bei Annäherung steigt die Frequenz (höherer Ton), bei Entfernung sinkt sie (tieferer Ton). Anwendung: Ultraschall-Doppler, Radar.
        </p>
      </div>
    </div>
  );
