  ...
  return (
    <div className="space-y-3">
      ...
      <svg viewBox="0 0 460 300" className="w-full max-w-lg mx-auto">
        ...
        {/* Frequency label */}
        <text x="30" y="70" fontSize="7" fill="#6b7280">Frequenz (Hz):</text>
        <text x="30" y="82" fontSize="7" fill="#7c3aed">10\u00B2\u2070</text>
        <text x="390" y="82" fontSize="7" fill="#eab308">10\u00B3</text>
        <line x1="48" y1="79" x2="388" y2="79" stroke="#d1d5db" strokeWidth="0.5" />

        {/* Wavelength label */}
        <text x="30" y="96" fontSize="7" fill="#6b7280">Wellenlänge:</text>
        <text x="100" y="96" fontSize="7" fill="#7c3aed">kurz \u2190</text>
        <text x="360" y="96" fontSize="7" fill="#eab308">\u2192 lang</text>
          ...
          return (
            ...
            >
              ...
              <text
                ...
                fontWeight="bold"
                transform={pos.w < 45 ? `rotate(-90, ${pos.x + pos.w / 2}, ${BAR_Y + BAR_H / 2 + 3})` : ""}
              >
                {b.label}
              </text>
            </g>
        ...
        <rect x="80" y="198" width="300" height="25" rx="4" fill="url(#visibleExpanded)" stroke="#374151" strokeWidth="1" />
        ...
        {[
          ...
          <g key={c.label}>
            <text x={c.x} y="216" textAnchor="middle" fontSize="6" fill="#fff" fontWeight="bold">{c.label}</text>
          </g>
        ))}
        <text x="80" y="238" fontSize="7" fill="#7c3aed">380 nm</text>
        <text x="380" y="238" textAnchor="end" fontSize="7" fill="#ef4444">780 nm</text>
        ...
        {(() => {
          ...
          return (
            <>
              <line x1={visBand.x} y1={BAR_Y + BAR_H} x2={80} y2={198} stroke="#d1d5db" strokeWidth="0.8" strokeDasharray="3 2" />
              <line x1={visBand.x + visBand.w} y1={BAR_Y + BAR_H} x2={380} y2={198} stroke="#d1d5db" strokeWidth="0.8" strokeDasharray="3 2" />
            </>
          );
        })()}
      ...
      {activeBand && (
        <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 rounded-lg p-3">
          <p className="text-sm font-semibold" style={{ color: activeBand.color }}>{activeBand.label}</p>
