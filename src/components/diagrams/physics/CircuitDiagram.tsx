    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2 mb-2">
        <button
          ...
          className={`text-xs px-3 py-1 rounded-full border transition-colors ${
            view === "series" ? "bg-teal-600 text-white border-teal-600" : "border-teal-300 text-teal-700 dark:text-teal-300 dark:border-teal-700"
          }`}
        >
          Reihenschaltung
        </button>
        <button
          ...
          className={`text-xs px-3 py-1 rounded-full border transition-colors ${
            view === "parallel" ? "bg-teal-600 text-white border-teal-600" : "border-teal-300 text-teal-700 dark:text-teal-300 dark:border-teal-700"
          }`}
        >
          Parallelschaltung
        </button>
      ...
      {view === "series" ? (
        <svg viewBox="0 0 460 300" className="w-full max-w-lg mx-auto">
          ...
          <text x="110" y="70" fontSize="7" fill="#ef4444" fontWeight="bold">I</text>
          ...
          <text x="340" y="215" fontSize="7" fill="#ef4444" fontWeight="bold">I</text>

          {/* Voltage labels */}
          <path d="M140,52 L200,52" stroke="#3b82f6" strokeWidth="1" />
          <text x="170" y="48" textAnchor="middle" fontSize="7" fill="#3b82f6">U\u2081</text>
          <path d="M260,52 L320,52" stroke="#3b82f6" strokeWidth="1" />
          <text x="290" y="48" textAnchor="middle" fontSize="7" fill="#3b82f6">U\u2082</text>
        ...
        <svg viewBox="0 0 460 320" className="w-full max-w-lg mx-auto">
          ...
          <text x="110" y="62" fontSize="7" fill="#ef4444" fontWeight="bold">I</text>

          {/* Current arrows - branches */}
          <polygon points="185,106 195,110 185,114" fill="#ef4444" />
          <text x="188" y="100" fontSize="7" fill="#ef4444">I\u2081</text>

          <polygon points="185,176 195,180 185,184" fill="#ef4444" />
          <text x="188" y="170" fontSize="7" fill="#ef4444">I\u2082</text>

          {/* Return current */}
          <polygon points="352,224 342,220 352,216" fill="#ef4444" />

          {/* Voltage labels */}
          <text x="250" y="88" textAnchor="middle" fontSize="7" fill="#3b82f6">U\u2081 = U</text>
          <text x="250" y="160" textAnchor="middle" fontSize="7" fill="#3b82f6">U\u2082 = U</text>
