  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-[var(--muted)]">
        Transversal- und Longitudinalwellen im Vergleich.
      </p>
      ...
      {view === "transversal" ? (
        <svg viewBox="0 0 460 280" className="w-full max-w-lg mx-auto">
          ...
          <text x="230" y="38" textAnchor="middle" fontSize="13" fill="#6b7280">
          ...
          <line
            ...
            markerEnd="url(#arrowAmpl)"
          />
          <text x="145" y="108" fontSize="13" fill="#ef4444" fontWeight="bold">
            Amplitude (A)
          </text>
          ...
          <text x="120" y="50" textAnchor="middle" fontSize="13" fill="#3b82f6" fontWeight="bold">
            Wellenlänge (\u03BB)
          </text>
          ...
          <line
            ...
            stroke="#0d9488"
            strokeWidth="2"
            markerEnd="url(#arrowTW)"
          />
          <text x="155" y="234" fontSize="13" fill="#0d9488" fontWeight="bold">
          ...
          <text x="18" y="102" fontSize="6" fill="#f59e0b">
            Schwingung
          </text>

          {/* Labels */}
          <text x="78" y="68" fontSize="7" fill="#0f766e">
            Wellenberg
          </text>
          <text x="158" y="218" fontSize="7" fill="#0f766e">
            Wellental
          </text>

          {/* Example */}
          <text x="230" y="265" textAnchor="middle" fontSize="13" fill="#6b7280">
            Beispiele: Lichtwellen, Seilwellen, Wasserwellen (Oberfläche)
          </text>
        </svg>
      ) : (
        <svg viewBox="0 0 460 280" className="w-full max-w-lg mx-auto">
          ...
          <text x="93" y="209" textAnchor="middle" fontSize="13" fill="#0f766e" fontWeight="bold">
            Verdichtung
          </text>

          <rect x="120" y="195" width="70" height="20" rx="3" fill="#99f6e4" opacity="0.3" />
          <text x="155" y="209" textAnchor="middle" fontSize="13" fill="#0f766e" fontWeight="bold">
            Verdünnung
          </text>
          ...
          <text x="109" y="55" textAnchor="middle" fontSize="13" fill="#3b82f6" fontWeight="bold">
            Wellenlänge (\u03BB)
          </text>
          ...
          <line
            ...
            stroke="#0d9488"
            strokeWidth="2"
            markerEnd="url(#arrowLW)"
          />
          <text x="155" y="239" fontSize="13" fill="#0d9488" fontWeight="bold">
            Ausbreitungsrichtung
          </text>
          ...
          <text x="240" y="248" textAnchor="middle" fontSize="7" fill="#f59e0b">
            Schwingungsrichtung = Ausbreitungsrichtung
          </text>

          {/* Example */}
          <text x="230" y="270" textAnchor="middle" fontSize="13" fill="#6b7280">
            Beispiele: Schallwellen in Luft, Druckwellen
          </text>
        </svg>
      )}
