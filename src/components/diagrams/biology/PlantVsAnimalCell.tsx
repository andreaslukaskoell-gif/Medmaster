...
const plantOnly = [
  {
    id: "zellwand",
    label: "Zellwand",
    detail: "Starre Hülle aus Cellulose. Gibt der Pflanzenzelle Form und Stabilität.",
  },
  {
    id: "chloroplast",
    label: "Chloroplasten",
    detail: "Ort der Fotosynthese. Enthalten Chlorophyll (gruener Farbstoff). Eigene DNA!",
  },
  {
    id: "vakuole",
    label: "Große Vakuole",
    detail: "Zentralvakuole speichert Wasser, Ionen, Farbstoffe. Erzeugt Turgor (Zellinnendruck).",
  },
];
...
const shared = [
  { id: "kern", label: "Zellkern", detail: "Enthält die DNA und steuert die Genexpression." },
  {
    id: "mito",
    label: "Mitochondrien",
    detail: "Kraftwerke der Zelle – ATP-Produktion durch Zellatmung.",
  },
  { id: "er", label: "ER", detail: "Endoplasmatisches Retikulum – Protein- und Lipidsynthese." },
  {
    id: "golgi",
    label: "Golgi-Apparat",
    detail: "Sortierung, Modifikation und Verpackung von Proteinen.",
  },
];
...
export default function PlantVsAnimalCell() {
  ...
  return (
    <div className="space-y-3">
      ...
      <svg role="img" viewBox="0 0 500 320" className="w-full max-w-xl mx-auto">
        <title>Pflanzenzelle vs. Tierzelle — Strukturvergleich</title>
        {/* Background */}
        <rect x="0" y="0" width="500" height="320" fill="none" />

        {/* ===== PLANT CELL (left) ===== */}
        <text x="125" y="20" textAnchor="middle" fontSize="13" fill="#0d9488" fontWeight="bold">
          Pflanzenzelle
        </text>
        ...
        <rect
          ...
          strokeWidth="4"
        />
        <text x="24" y="48" fontSize="7" fill="#0f766e" fontWeight="bold">
          Zellwand
        </text>
        ...
        />
        <text x="125" y="178" textAnchor="middle" fontSize="13" fill="#115e59" fontWeight="bold">
          Vakuole
        </text>
        ...
        <text x="70" y="80" textAnchor="middle" fontSize="7" fill="#16a34a">
          Chloroplast
        </text>
        ...
        <text x="125" y="108" textAnchor="middle" fontSize="7" fill="#115e59" fontWeight="bold">
          Kern
        </text>
        ...
        <ellipse
          ...
          onMouseLeave={() => setActive(null)}
        />
        <text x="80" y="262" textAnchor="middle" fontSize="6" fill="#f97316">
          Mito.
        </text>

        {/* ER */}
        <path
          d="M150,240 Q165,232 175,242 Q185,252 175,258"
          fill="none"
          stroke="#6366f1"
          strokeWidth="1.5"
        />
        <text x="168" y="270" textAnchor="middle" fontSize="6" fill="#6366f1">
          ER
        </text>
        ...
        {[0, 5, 10].map((dy) => (
          <path
            key={`pg-${dy}`}
            d={`M55,${225 + dy} Q70,${220 + dy} 85,${226 + dy}`}
            fill="none"
            stroke="#eab308"
            strokeWidth="2"
            strokeLinecap="round"
        ...
        <text x="70" y="218" textAnchor="middle" fontSize="6" fill="#eab308">
          Golgi
        </text>
        ...
        {/* ===== ANIMAL CELL (right) ===== */}
        <text x="375" y="20" textAnchor="middle" fontSize="13" fill="#0d9488" fontWeight="bold">
          Tierzelle
        </text>
        ...
        <text x="375" y="134" textAnchor="middle" fontSize="7" fill="#115e59" fontWeight="bold">
          Kern
        </text>
        ...
        />
        <path
          d="M325,200 Q333,194 340,200 Q347,206 355,200"
          fill="none"
          stroke="#f97316"
          strokeWidth="1"
        />
        <text x="340" y="218" textAnchor="middle" fontSize="6" fill="#f97316">
          Mito.
        </text>
        ...
        {/* ER */}
        <path
          d="M400,170 Q420,162 435,175 Q445,185 430,192 Q415,198 400,190"
          fill="none"
          stroke="#6366f1"
          strokeWidth="1.5"
        />
        <text x="420" y="160" textAnchor="middle" fontSize="6" fill="#6366f1">
          ER
        </text>
        ...
        {[0, 6, 12].map((dy) => (
          <path
            key={`ag-${dy}`}
            d={`M330,${240 + dy} Q355,${234 + dy} 370,${241 + dy}`}
            fill="none"
            stroke="#eab308"
            strokeWidth="2"
            strokeLinecap="round"
        ...
        <text x="350" y="237" textAnchor="middle" fontSize="6" fill="#eab308">
          Golgi
        </text>

        {/* Lysosome (animal only) */}
        <circle cx="420" cy="260" r="12" fill="#fef2f2" stroke="#ef4444" strokeWidth="1.5" />
        <text x="420" y="263" textAnchor="middle" fontSize="6" fill="#ef4444">
          Lysosom
        </text>
        ...
        <text x="375" y="72" textAnchor="middle" fontSize="6" fill="#06b6d4">
          Zentrosom
        </text>
