...
const parts = [
  {
    ...
    detail: "Kleine unpolare Moleküle (O₂, CO₂) diffundieren direkt durch die Lipiddoppelschicht entlang des Konzentrationsgradienten. Keine Energie erforderlich."
  },
  {
    id: "facilitated",
    label: "Erleichterte Diffusion",
    detail: "Polare Moleküle und Ionen nutzen Kanalproteine oder Carrierproteine. Entlang des Konzentrationsgradienten, keine ATP-Hydrolyse notwendig."
  },
  {
    id: "active",
    label: "Aktiver Transport",
    detail: "Pumpenproteine transportieren Stoffe gegen den Konzentrationsgradienten unter ATP-Verbrauch. Beispiel: Na⁺/K⁺-ATPase (3 Na⁺ raus, 2 K⁺ rein)."
  },
  {
    id: "vesicular",
    label: "Vesikulärer Transport",
    detail: "Große Moleküle und Partikel werden in Vesikeln transportiert. Endozytose (Aufnahme) und Exozytose (Abgabe) durch Membranfusion."
  },
];
...
export default function MembraneTransport() {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-gray-600 dark:text-gray-400">Klicke auf Transportarten für Details.</p>
      <svg viewBox="0 0 560 400" className="w-full max-w-xl mx-auto">
        ...
        <text x="10" y="30" fontSize="11" fill="#6b7280" fontWeight="600">extrazellulär</text>
        <text x="10" y="380" fontSize="11" fill="#6b7280" fontWeight="600">intrazellulär</text>

        {/* Dividing lines between transport types */}
        <line x1="140" y1="60" x2="140" y2="340" stroke="#e5e7eb" strokeWidth="1" strokeDasharray="4,4" />
        <line x1="280" y1="60" x2="280" y2="340" stroke="#e5e7eb" strokeWidth="1" strokeDasharray="4,4" />
        <line x1="420" y1="60" x2="420" y2="340" stroke="#e5e7eb" strokeWidth="1" strokeDasharray="4,4" />
        ...
        <g>
          ...
          <path d="M 50 120 L 50 150" stroke="#3b82f6" strokeWidth="2" markerEnd="url(#arrowBlue)" />
          <path d="M 90 250 L 90 280" stroke="#3b82f6" strokeWidth="2" markerEnd="url(#arrowBlue)" />
          ...
          {/* Label */}
          <line x1="70" y1="320" x2="70" y2="340" stroke="#3b82f6" strokeWidth="1" strokeDasharray="2,2" />
          <text x="70" y="355" fontSize="10" fill="#3b82f6" fontWeight="600" textAnchor="middle">Passive</text>
          <text x="70" y="368" fontSize="10" fill="#3b82f6" fontWeight="600" textAnchor="middle">Diffusion</text>
        </g>
        ...
        <g>
          ...
          <ellipse cx="180" cy="200" rx="15" ry="30" fill="#10b981" opacity="0.5" stroke="#059669" strokeWidth="2" />
          <circle cx="180" cy="200" r="4" fill="#fef3c7" />

          {/* Ions/molecules passing through */}
          <circle cx="235" cy="150" r="3.5" fill="#10b981" opacity="0.8" />
          <text x="235" y="152" fontSize="7" fill="white" fontWeight="bold" textAnchor="middle">+</text>
          <circle cx="235" cy="250" r="3.5" fill="#10b981" opacity="0.8" />
          <text x="235" y="252" fontSize="7" fill="white" fontWeight="bold" textAnchor="middle">+</text>

          {/* Gradient arrows */}
          <path d="M 180 130 L 180 160" stroke="#10b981" strokeWidth="2" markerEnd="url(#arrowGreen)" />
          ...
          {/* Label */}
          <line x1="210" y1="320" x2="210" y2="340" stroke="#10b981" strokeWidth="1" strokeDasharray="2,2" />
          <text x="210" y="355" fontSize="10" fill="#10b981" fontWeight="600" textAnchor="middle">Erleichterte</text>
          <text x="210" y="368" fontSize="10" fill="#10b981" fontWeight="600" textAnchor="middle">Diffusion</text>
        </g>
        ...
        <g>
          ...
          <text x="360" y="203" fontSize="6" fill="#991b1b" fontWeight="bold" textAnchor="middle">ATP</text>

          {/* Na+ ions (3 going out) */}
          <circle cx="360" cy="155" r="3" fill="#ef4444" />
          <text x="360" y="157" fontSize="6" fill="white" fontWeight="bold" textAnchor="middle">Na</text>
          <circle cx="355" cy="145" r="3" fill="#ef4444" />
          <text x="355" y="147" fontSize="6" fill="white" fontWeight="bold" textAnchor="middle">Na</text>
          <circle cx="365" cy="145" r="3" fill="#ef4444" />
          <text x="365" y="147" fontSize="6" fill="white" fontWeight="bold" textAnchor="middle">Na</text>

          {/* K+ ions (2 going in) */}
          <circle cx="360" cy="245" r="3" fill="#3b82f6" />
          <text x="360" y="247" fontSize="6" fill="white" fontWeight="bold" textAnchor="middle">K</text>
          <circle cx="355" cy="255" r="3" fill="#3b82f6" />
          <text x="355" y="257" fontSize="6" fill="white" fontWeight="bold" textAnchor="middle">K</text>

          {/* Gradient arrows (AGAINST gradient) */}
          <path d="M 350 165 L 350 135" stroke="#ef4444" strokeWidth="2" markerEnd="url(#arrowRed)" />
          <path d="M 370 265 L 370 235" stroke="#3b82f6" strokeWidth="2" markerEnd="url(#arrowBlue)" />
          ...
          {/* Label */}
          <line x1="350" y1="320" x2="350" y2="340" stroke="#ef4444" strokeWidth="1" strokeDasharray="2,2" />
          <text x="350" y="355" fontSize="10" fill="#ef4444" fontWeight="600" textAnchor="middle">Aktiver</text>
          <text x="350" y="368" fontSize="10" fill="#ef4444" fontWeight="600" textAnchor="middle">Transport</text>
        </g>
        ...
        <g>
          ...
          <circle cx="470" cy="150" r="15" fill="#8b5cf6" opacity="0.3" stroke="#7c3aed" strokeWidth="2" />
          <circle cx="470" cy="150" r="8" fill="#a78bfa" opacity="0.6" />
          <path d="M 460 165 Q 470 175 480 165" stroke="#7c3aed" strokeWidth="2" fill="none" strokeDasharray="3,2" />

          {/* Vesicle inside cell (endocytosis completed) */}
          <circle cx="500" cy="240" r="12" fill="#8b5cf6" opacity="0.4" stroke="#7c3aed" strokeWidth="2" />
          <circle cx="500" cy="240" r="6" fill="#a78bfa" opacity="0.7" />

          {/* Exocytosis (bottom) - vesicle fusing with membrane */}
          <circle cx="460" cy="260" r="12" fill="#8b5cf6" opacity="0.4" stroke="#7c3aed" strokeWidth="2" />
          <circle cx="460" cy="260" r="6" fill="#a78bfa" opacity="0.7" />
          <path d="M 452 248 Q 460 235 468 248" stroke="#7c3aed" strokeWidth="2" fill="none" strokeDasharray="3,2" />

          {/* Arrows */}
          <path d="M 485 155 L 495 155" stroke="#8b5cf6" strokeWidth="2" markerEnd="url(#arrowPurple)" />
          <text x="505" y="158" fontSize="8" fill="#7c3aed" fontWeight="600">Endo</text>
          <path d="M 475 265 L 485 265" stroke="#8b5cf6" strokeWidth="2" markerEnd="url(#arrowPurple)" />
          <text x="488" y="268" fontSize="8" fill="#7c3aed" fontWeight="600">Exo</text>
          ...
          {/* Label */}
          <line x1="490" y1="320" x2="490" y2="340" stroke="#8b5cf6" strokeWidth="1" strokeDasharray="2,2" />
          <text x="490" y="355" fontSize="10" fill="#8b5cf6" fontWeight="600" textAnchor="middle">Vesikulärer</text>
          <text x="490" y="368" fontSize="10" fill="#8b5cf6" fontWeight="600" textAnchor="middle">Transport</text>
        </g>
