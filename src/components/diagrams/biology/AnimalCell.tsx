...
const organelles = [
  {
    ...
    ry: 45,
    color: "#0d9488",
    detail: "Enthält die DNA, steuert Genexpression. Doppelmembran mit Kernporen.",
  },
  {
    id: "nucleolus",
    label: "Nukleolus",
    ...
    ry: 13,
    color: "#115e59",
    detail: "Bildungsort der ribosomalen RNA (rRNA). Liegt im Zellkern.",
  },
  {
    id: "mito",
    label: "Mitochondrium",
    ...
    ry: 19,
    color: "#f97316",
    detail: "Kraftwerk der Zelle. ATP-Produktion durch oxidative Phosphorylierung. Eigene DNA!",
  },
  {
    id: "mito2",
    label: "Mitochondrium",
    ...
    ry: 17,
    color: "#f97316",
    detail: "Doppelmembran mit Cristae (Einfaltungen der inneren Membran).",
  },
  {
    id: "er-rough",
    label: "Raues ER",
    ...
    ry: 27,
    color: "#6366f1",
    detail: "Mit Ribosomen besetzt. Proteinsynthese und -faltung.",
  },
  {
    id: "er-smooth",
    label: "Glattes ER",
    ...
    ry: 24,
    color: "#8b5cf6",
    detail: "Ohne Ribosomen. Lipidsynthese, Calciumspeicher, Entgiftung.",
  },
  {
    id: "golgi",
    label: "Golgi-Apparat",
    ...
    ry: 22,
    color: "#eab308",
    detail: "Sortierung, Modifikation und Verpackung von Proteinen in Vesikel.",
  },
  {
    id: "lysosome",
    label: "Lysosom",
    ...
    ry: 19,
    color: "#ef4444",
    detail: "Enthält hydrolytische Enzyme (pH 4-5). Intrazelluläre Verdauung.",
  },
  {
    id: "centrosome",
    label: "Zentrosom",
    ...
    ry: 13,
    color: "#06b6d4",
    detail: "Organisationszentrum der Mikrotubuli. Wichtig für die Zellteilung (Spindelapparat).",
  },
  {
    id: "ribosome",
    label: "Ribosomen",
    ...
    ry: 6,
    color: "#6366f1",
    detail: "Ort der Translation (Proteinsynthese). 80S bei Eukaryoten.",
  },
  {
    id: "peroxisome",
    label: "Peroxisom",
    ...
    ry: 15,
    color: "#a855f7",
    detail: "Abbau langkettiger Fettsäuren. Entgiftung von H₂O₂ durch Katalase.",
  },
  {
    id: "vesicle",
    label: "Vesikel",
    ...
    ry: 11,
    color: "#14b8a6",
    detail: "Membranumhüllte Transportbläschen für Stoffe innerhalb der Zelle.",
  },
];
  ...
  return (
    <div className="space-y-3">
      ...
      <svg viewBox="0 0 600 500" className="w-full max-w-2xl mx-auto">
        ...
        {/* Rough ER lines */}
        <path
          d="M335,150 Q360,138 385,155 Q405,172 385,188 Q360,200 335,188"
          fill="none"
          stroke="#6366f1"
          strokeWidth="2"
        />
        <path
          d="M341,158 Q362,148 382,160 Q398,173 382,183 Q362,193 341,183"
          fill="none"
          stroke="#6366f1"
          strokeWidth="1.5"
        />
        ...
        {/* Smooth ER */}
        <path
          d="M158,302 Q180,290 200,308 Q220,326 200,340 Q180,352 158,338 Z"
          fill="none"
          stroke="#8b5cf6"
          strokeWidth="2"
        />
        <path
          d="M165,309 Q183,300 197,312 Q213,324 197,334 Q183,343 165,333"
          fill="none"
          stroke="#8b5cf6"
          strokeWidth="1.5"
        />
        ...
        {[0, 9, 18].map((dy) => (
          <path
            key={`golgi-${dy}`}
            d={`M218,${346 + dy} Q250,${339 + dy} 282,${348 + dy}`}
            fill="none"
            stroke="#eab308"
            strokeWidth="3"
            strokeLinecap="round"
        ...
        />
        <path
          d="M148,160 Q163,149 180,160 Q197,171 212,160"
          fill="none"
          stroke="#f97316"
          strokeWidth="1.5"
        />
        ...
        />
        <path
          d="M352,310 Q366,301 380,310 Q394,319 408,310"
          fill="none"
          stroke="#f97316"
          strokeWidth="1.5"
        />
        ...
        {[0, 45, 90, 135, 180, 225, 270, 315].map((angle) => {
          ...
          return (
            <circle
              key={`pore-${angle}`}
              cx={280 + 62 * Math.cos(rad)}
              cy={230 + 47 * Math.sin(rad)}
              r="3.2"
              fill="white"
              stroke="#0d9488"
              strokeWidth="1"
        ...
        <text x="350" y="369" textAnchor="middle" fontSize="13" fill="#ef4444" fontWeight="bold">
          pH 4.5
        </text>
        ...
        <text x="290" y="30" textAnchor="middle" fontSize="14" fill="#1f2937" fontWeight="600">
          Zellmembran
        </text>
        <line
          x1="290"
      ...
      {activeOrganelle && (
        <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 rounded-lg p-3">
          <p className="text-sm font-semibold" style={{ color: activeOrganelle.color }}>
            {activeOrganelle.label}
          </p>
