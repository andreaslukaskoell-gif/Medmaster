...
const parts = [
  {
    ...
    detail: "Kann sich zu ALLEN Zelltypen entwickeln, inkl. extraembryonales Gewebe (Plazenta). Entsteht in den ersten Teilungen nach der Befruchtung."
  },
  {
    id: "pluripotent",
    label: "Pluripotente Stammzelle (Embryonale SZ)",
    detail: "Innere Zellmasse der Blastozyste. Kann sich zu allen 3 Keimblättern differenzieren, aber NICHT zu extraembryonalem Gewebe."
  },
  {
    id: "multipotent-haema",
    label: "Hämatopoetische Stammzelle",
    detail: "Multipotent. Differenziert sich zu allen Blutzellen: Erythrozyten, Leukozyten, Thrombozyten."
  },
  {
    id: "multipotent-mesen",
    label: "Mesenchymale Stammzelle",
    detail: "Multipotent. Differenziert sich zu Bindegewebszellen: Osteoblasten (Knochen), Chondrozyten (Knorpel), Adipozyten (Fett)."
  },
  {
...
export default function StemCells() {
  ...
  return (
    <div className="space-y-3">
      <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Stammzellen &amp; Differenzierung</h4>
      ...
      <svg viewBox="0 0 600 500" className="w-full max-w-2xl mx-auto">
        ...
        <text x="10" y="25" fontSize="11" fill="#6b7280" fontWeight="600">Totipotent</text>
        <text x="10" y="95" fontSize="11" fill="#6b7280" fontWeight="600">Pluripotent</text>
        <text x="10" y="195" fontSize="11" fill="#6b7280" fontWeight="600">Multipotent</text>
        <text x="10" y="330" fontSize="11" fill="#6b7280" fontWeight="600">Unipotent/Spezialisiert</text>
        ...
        />
        <circle cx="300" cy="50" r="16" fill="none" stroke="#a78bfa" strokeWidth="1.5" opacity="0.6" />
        <text x="300" y="55" fontSize="10" fill="white" textAnchor="middle" fontWeight="600">Z</text>
        <text x="350" y="50" fontSize="10" fill="#6b7280" className="pointer-events-none">Zygote</text>
        ...
        <circle
          ...
          onMouseLeave={() => setActive(null)}
        />
        <circle cx="300" cy="120" r="14" fill="none" stroke="#60a5fa" strokeWidth="1.5" opacity="0.6" />
        <text x="300" y="125" fontSize="9" fill="white" textAnchor="middle" fontWeight="600">ESZ</text>

        {/* Arrows to multipotent cells */}
        <path d="M 285 138 L 180 195" stroke="#9ca3af" strokeWidth="1.8" markerEnd="url(#arrowhead)" />
        <path d="M 300 140 L 300 195" stroke="#9ca3af" strokeWidth="1.8" markerEnd="url(#arrowhead)" />
        <path d="M 315 138 L 420 195" stroke="#9ca3af" strokeWidth="1.8" markerEnd="url(#arrowhead)" />
        ...
        <circle
          ...
          onMouseLeave={() => setActive(null)}
        />
        <circle cx="180" cy="220" r="12" fill="none" stroke="#34d399" strokeWidth="1.5" opacity="0.6" />
        <text x="180" y="224" fontSize="8" fill="white" textAnchor="middle" fontWeight="600">HSZ</text>
        <text x="180" y="242" fontSize="9" fill="#6b7280" textAnchor="middle" className="pointer-events-none">Hämatopoetisch</text>
        ...
        <circle
          ...
          onMouseLeave={() => setActive(null)}
        />
        <circle cx="300" cy="220" r="12" fill="none" stroke="#34d399" strokeWidth="1.5" opacity="0.6" />
        <text x="300" y="224" fontSize="8" fill="white" textAnchor="middle" fontWeight="600">MSZ</text>
        <text x="300" y="242" fontSize="9" fill="#6b7280" textAnchor="middle" className="pointer-events-none">Mesenchymal</text>
        ...
        <circle
          ...
          onMouseLeave={() => setActive(null)}
        />
        <circle cx="420" cy="220" r="12" fill="none" stroke="#34d399" strokeWidth="1.5" opacity="0.6" />
        <text x="420" y="224" fontSize="8" fill="white" textAnchor="middle" fontWeight="600">NSZ</text>
        <text x="420" y="242" fontSize="9" fill="#6b7280" textAnchor="middle" className="pointer-events-none">Neural</text>

        {/* Arrows from multipotent to specialized cells */}
        {/* From HSZ */}
        <path d="M 165 235 L 100 350" stroke="#9ca3af" strokeWidth="1.5" markerEnd="url(#arrowhead)" />
        <path d="M 180 238 L 180 350" stroke="#9ca3af" strokeWidth="1.5" markerEnd="url(#arrowhead)" />
        <path d="M 195 235 L 260 350" stroke="#9ca3af" strokeWidth="1.5" markerEnd="url(#arrowhead)" />

        {/* From MSZ */}
        <path d="M 285 235 L 280 350" stroke="#9ca3af" strokeWidth="1.5" markerEnd="url(#arrowhead)" />
        <path d="M 300 238 L 340 350" stroke="#9ca3af" strokeWidth="1.5" markerEnd="url(#arrowhead)" />
        <path d="M 315 235 L 400 350" stroke="#9ca3af" strokeWidth="1.5" markerEnd="url(#arrowhead)" />

        {/* From NSZ */}
        <path d="M 405 235 L 460 350" stroke="#9ca3af" strokeWidth="1.5" markerEnd="url(#arrowhead)" />
        <path d="M 435 235 L 520 350" stroke="#9ca3af" strokeWidth="1.5" markerEnd="url(#arrowhead)" />
        ...
        <text x="180" y="395" fontSize="8" fill="#6b7280" textAnchor="middle" className="pointer-events-none">Leukozyten</text>
        ...
        <text x="280" y="402" fontSize="8" fill="#6b7280" textAnchor="middle" className="pointer-events-none">Osteoblasten</text>
        ...
        <text x="340" y="395" fontSize="8" fill="#6b7280" textAnchor="middle" className="pointer-events-none">Chondrozyten</text>
        ...
        <text x="400" y="398" fontSize="8" fill="#6b7280" textAnchor="middle" className="pointer-events-none">Adipozyten</text>
