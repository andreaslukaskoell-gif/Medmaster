      ...
      <svg viewBox="0 0 600 520" className="w-full max-w-2xl mx-auto">
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="300" y="45" textAnchor="middle" fontSize="14" fontWeight="bold" fill="white">
            Nervensystem
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="150" y="125" textAnchor="middle" fontSize="13" fontWeight="bold" fill="white">
            ZNS
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="450" y="125" textAnchor="middle" fontSize="13" fontWeight="bold" fill="white">
            PNS
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="150" y="205" textAnchor="middle" fontSize="13" fontWeight="bold" fill="white">
            Gehirn
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="100" y="385" textAnchor="middle" fontSize="13" fontWeight="bold" fill="white">
            Rückenmark
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="75" y="272" textAnchor="middle" fontSize="11" fontWeight="600" fill="#1e3a8a">
            Großhirn
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="150" y="272" textAnchor="middle" fontSize="11" fontWeight="600" fill="#1e3a8a">
            Kleinhirn
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="220" y="272" textAnchor="middle" fontSize="11" fontWeight="600" fill="#1e3a8a">
            Hirnstamm
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="220" y="322" textAnchor="middle" fontSize="11" fontWeight="600" fill="#1e3a8a">
            Zwischenhirn
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="380" y="205" textAnchor="middle" fontSize="12" fontWeight="bold" fill="white">
            Somatisches NS
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="520" y="198" textAnchor="middle" fontSize="11" fontWeight="bold" fill="white">
            Vegetatives NS
          </text>
          <text x="520" y="213" textAnchor="middle" fontSize="10" fill="white">
            (Autonomes NS)
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="475" y="285" textAnchor="middle" fontSize="12" fontWeight="bold" fill="white">
            Sympathikus
          </text>
        </g>
        ...
        >
          <rect
            ...
            opacity="0.95"
          />
          <text x="510" y="345" textAnchor="middle" fontSize="11" fontWeight="bold" fill="white">
            Parasympathikus
          </text>
        </g>

        {/* Additional labels for functional keywords */}
        <text x="475" y="295" textAnchor="middle" fontSize="8" fill="#fee2e2" fontStyle="italic">
          fight or flight
        </text>
        <text x="510" y="355" textAnchor="middle" fontSize="8" fill="#ede9fe" fontStyle="italic">
          rest and digest
        </text>
      </svg>
      {active && (
