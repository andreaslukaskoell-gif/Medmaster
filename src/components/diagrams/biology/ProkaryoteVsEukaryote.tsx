...
const parts = [
  // Prokaryot (left)
  { id: "pro-zellwand", label: "Zellwand (Murein)", detail: "Peptidoglykan-Schicht. Gibt Stabilität und Form. Typisch für Bakterien." },
  { id: "pro-membran", label: "Zellmembran", detail: "Phospholipid-Doppelschicht. Reguliert Stoffaustausch." },
  { id: "pro-nucleoid", label: "Nucleoid", detail: "Ringförmige DNA (zirkulär), nicht membranumschlossen. Kein echter Zellkern." },
  { id: "pro-plasmid", label: "Plasmide", detail: "Kleine zirkuläre DNA-Moleküle. Enthalten oft Resistenzgene." },
  { id: "pro-ribosom", label: "Ribosomen (70S)", detail: "Proteinsynthese. Kleinere 70S-Ribosomen (50S + 30S Untereinheiten)." },
  { id: "pro-flagellum", label: "Flagellum", detail: "Bewegungsorganell. Rotation durch Protonengradienten angetrieben." },
  { id: "pro-pili", label: "Pili", detail: "Anheftungsstrukturen. Wichtig für Konjugation (DNA-Transfer)." },
  { id: "pro-kapsel", label: "Kapsel", detail: "Polysaccharid-Schicht außerhalb der Zellwand. Schutz vor Phagocytose." },

  // Eukaryot (right)
  { id: "euk-membran", label: "Zellmembran", detail: "Phospholipid-Doppelschicht. Reguliert Stoffaustausch." },
  { id: "euk-kern", label: "Zellkern", detail: "Doppelmembran (Kernhülle) mit Kernporen. Enthält lineare DNA in Chromosomen." },
  { id: "euk-dna", label: "DNA + Histone", detail: "Lineare DNA organisiert in Chromosomen. Mit Histonproteinen verpackt (Chromatin)." },
  { id: "euk-er-rau", label: "Raues ER", detail: "Endoplasmatisches Retikulum mit Ribosomen. Proteinsynthese und -modifikation." },
  { id: "euk-er-glatt", label: "Glattes ER", detail: "ER ohne Ribosomen. Lipidsynthese, Entgiftung, Ca²⁺-Speicherung." },
  { id: "euk-golgi", label: "Golgi-Apparat", detail: "Modifikation, Sortierung und Verpackung von Proteinen und Lipiden." },
  { id: "euk-mito", label: "Mitochondrien", detail: "Doppelmembran. ATP-Synthese (Zellatmung). Eigene DNA und Ribosomen (70S)." },
  { id: "euk-ribosom", label: "Ribosomen (80S)", detail: "Proteinsynthese. Größere 80S-Ribosomen (60S + 40S Untereinheiten)." },
];
...
export default function ProkaryoteVsEukaryote() {
  ...
  return (
    <div className="space-y-3">
      <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Prokaryot vs. Eukaryot</h4>
      ...
      <svg viewBox="0 0 700 420" className="w-full max-w-3xl mx-auto">
        ...
        <text x="140" y="25" fontSize="16" fontWeight="bold" fill="currentColor" textAnchor="middle" className="fill-gray-700 dark:fill-gray-300">
          Prokaryot
        </text>
        <text x="140" y="45" fontSize="11" fill="currentColor" textAnchor="middle" className="fill-gray-600 dark:fill-gray-400">
          (1-10 μm)
        </text>

        <text x="520" y="25" fontSize="16" fontWeight="bold" fill="currentColor" textAnchor="middle" className="fill-gray-700 dark:fill-gray-300">
          Eukaryot
        </text>
        <text x="520" y="45" fontSize="11" fill="currentColor" textAnchor="middle" className="fill-gray-600 dark:fill-gray-400">
          (10-100 μm)
        </text>

        {/* Divider line */}
        <line x1="340" y1="60" x2="340" y2="410" stroke="currentColor" strokeWidth="1" strokeDasharray="4,4" className="stroke-gray-300 dark:stroke-gray-600" />

        {/* ========== PROKARYOT (LEFT) ========== */}

        {/* Kapsel (outermost) */}
        <ellipse
          cx="140" cy="230" rx="95" ry="95"
          fill="none"
          stroke="#0891b2"
          strokeWidth="3"
          strokeDasharray="5,3"
        ...
        <ellipse cx="140" cy="230" rx="70" ry="70" fill="#e0f2fe" className="dark:fill-gray-800" opacity="0.6" />
        ...
        {/* Cytoplasma */}
        <ellipse cx="520" cy="240" rx="113" ry="113" fill="#d1fae5" className="dark:fill-gray-800" opacity="0.5" />
        ...
        >
          ...
          <circle cx="520" cy="240" r="45" fill="none" stroke="#8b5cf6" strokeWidth="3" strokeDasharray="2,2" />
          {/* Kernporen */}
        ...
        <g
          ...
          onMouseLeave={() => setActive(null)}
        >
          <path d="M 505 235 Q 515 230, 525 235 M 510 245 Q 520 240, 530 245" stroke="#7c3aed" strokeWidth="2" fill="none" />
        ...
        >
          {/* Mito 1 */}
          <ellipse cx="460" cy="200" rx="20" ry="12" fill="#f59e0b" opacity="0.3" stroke="#f59e0b" strokeWidth="2" />
          <path d="M 445 200 Q 450 195, 455 200 M 455 200 Q 460 195, 465 200 M 465 200 Q 470 195, 475 200" stroke="#f59e0b" strokeWidth="1" fill="none" />

          {/* Mito 2 */}
          <ellipse cx="580" cy="270" rx="20" ry="12" fill="#f59e0b" opacity="0.3" stroke="#f59e0b" strokeWidth="2" />
          <path d="M 565 270 Q 570 265, 575 270 M 575 270 Q 580 265, 585 270 M 585 270 Q 590 265, 595 270" stroke="#f59e0b" strokeWidth="1" fill="none" />
        </g>
        ...
        <g
          ...
          onMouseLeave={() => setActive(null)}
        >
          <path d="M 440 240 Q 430 245, 425 250 Q 430 255, 440 260" fill="none" stroke="#6366f1" strokeWidth="2" />
          <path d="M 445 245 Q 435 250, 430 255 Q 435 260, 445 265" fill="none" stroke="#6366f1" strokeWidth="2" />
          {/* Ribosomen on ER */}
        ...
        <g
          ...
          onMouseLeave={() => setActive(null)}
        >
          <path d="M 440 310 Q 430 315, 425 320 Q 430 325, 440 330" fill="none" stroke="#818cf8" strokeWidth="2" />
