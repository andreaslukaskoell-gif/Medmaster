...
const structures = [
  ...
  { id: "vc", label: "Hohlvenen (Vena cava)", detail: "Obere (V. cava superior) und untere (V. cava inferior) Hohlvene bringen sauerstoffarmes Blut zum rechten Vorhof." },
  { id: "tv", label: "Trikuspidalklappe", detail: "Zwischen rechtem Vorhof und rechtem Ventrikel. 3 Segel. Verhindert Rückfluss." },
  { id: "mv", label: "Mitralklappe (Bikuspidalklappe)", detail: "Zwischen linkem Vorhof und linkem Ventrikel. 2 Segel. Verhindert Rückfluss." },
  { id: "pklappe", label: "Pulmonalklappe", detail: "Taschenklappe am Abgang der Lungenarterie. Verhindert Rückfluss ins rechte Herz." },
  { id: "aklappe", label: "Aortenklappe", detail: "Taschenklappe am Abgang der Aorta. Verhindert Rückfluss ins linke Herz." },
];
    ...
    <div className="space-y-3">
      ...
      <svg viewBox="0 0 480 440" className="w-full max-w-xl mx-auto">
        ...
        <path
          ...
          fill="#fef2f2" stroke="#0d9488" strokeWidth="2.5"
        />
        ...
        <path d="M110,190 Q175,210 240,195 Q305,210 370,190" fill="none" stroke="#0d9488" strokeWidth="2" />
        ...
        {/* ===== VALVES ===== */}
        {/* Tricuspid */}
        <g className="cursor-pointer" onMouseEnter={() => hover(structures[8])} onMouseLeave={() => hover(null)}>
          <ellipse cx="185" cy="198" rx="22" ry="6" fill="#fbbf24" opacity="0.7" stroke="#d97706" strokeWidth="1.5" />
          <text x="185" y="201" textAnchor="middle" fontSize="6" fill="#92400e" fontWeight="bold">Trikusp.</text>
        </g>

        {/* Mitral */}
        <g className="cursor-pointer" onMouseEnter={() => hover(structures[9])} onMouseLeave={() => hover(null)}>
          <ellipse cx="295" cy="198" rx="22" ry="6" fill="#fbbf24" opacity="0.7" stroke="#d97706" strokeWidth="1.5" />
          <text x="295" y="201" textAnchor="middle" fontSize="6" fill="#92400e" fontWeight="bold">Mitral</text>
        </g>

        {/* ===== GREAT VESSELS ===== */}
        {/* Vena cava superior */}
        <g className="cursor-pointer" onMouseEnter={() => hover(structures[7])} onMouseLeave={() => hover(null)}>
          <rect x="110" y="20" width="28" height="70" rx="8" fill="#93c5fd" stroke="#3b82f6" strokeWidth="1.5" />
          <text x="87" y="52" textAnchor="end" fontSize="7" fill="#1e40af" fontWeight="bold">Obere</text>
          <text x="87" y="62" textAnchor="end" fontSize="7" fill="#1e40af" fontWeight="bold">Hohlvene</text>
          {/* Flow arrow */}
        ...
        {/* Vena cava inferior */}
        <g className="cursor-pointer" onMouseEnter={() => hover(structures[7])} onMouseLeave={() => hover(null)}>
          <rect x="130" y="310" width="24" height="50" rx="8" fill="#93c5fd" stroke="#3b82f6" strokeWidth="1.5" />
          <text x="115" y="340" textAnchor="end" fontSize="7" fill="#1e40af" fontWeight="bold">Untere</text>
          <text x="115" y="350" textAnchor="end" fontSize="7" fill="#1e40af" fontWeight="bold">Hohlvene</text>
          <polygon points="138,318 142,310 146,318" fill="#3b82f6" />
        </g>

        {/* Pulmonary artery */}
        <g className="cursor-pointer" onMouseEnter={() => hover(structures[5])} onMouseLeave={() => hover(null)}>
          <path d="M200,80 Q200,40 170,20 Q150,10 130,20" fill="none" stroke="#3b82f6" strokeWidth="8" strokeLinecap="round" />
          <path d="M200,80 Q200,40 170,20 Q150,10 130,20" fill="none" stroke="#93c5fd" strokeWidth="4" strokeLinecap="round" />
          {/* Pulmonary valve */}
          <g className="cursor-pointer" onMouseEnter={() => hover(structures[10])} onMouseLeave={() => hover(null)}>
            <ellipse cx="200" cy="80" rx="10" ry="5" fill="#fbbf24" opacity="0.7" stroke="#d97706" strokeWidth="1" />
          </g>
          <text x="155" y="12" textAnchor="middle" fontSize="7" fill="#1e40af" fontWeight="bold">Lungenarterie</text>
          <polygon points="135,24 127,18 133,16" fill="#3b82f6" />
        </g>

        {/* Pulmonary veins */}
        <g className="cursor-pointer" onMouseEnter={() => hover(structures[6])} onMouseLeave={() => hover(null)}>
          <path d="M360,90 Q390,70 410,50" fill="none" stroke="#ef4444" strokeWidth="6" strokeLinecap="round" />
          <path d="M360,90 Q390,70 410,50" fill="none" stroke="#fca5a5" strokeWidth="3" strokeLinecap="round" />
          <text x="420" y="45" fontSize="7" fill="#dc2626" fontWeight="bold">Lungenvenen</text>
          <polygon points="358,86 360,94 364,88" fill="#ef4444" />
        </g>

        {/* Aorta */}
        <g className="cursor-pointer" onMouseEnter={() => hover(structures[4])} onMouseLeave={() => hover(null)}>
          <path d="M280,80 Q280,30 310,15 Q340,5 370,15 Q400,30 400,55" fill="none" stroke="#ef4444" strokeWidth="8" strokeLinecap="round" />
          <path d="M280,80 Q280,30 310,15 Q340,5 370,15 Q400,30 400,55" fill="none" stroke="#fca5a5" strokeWidth="4" strokeLinecap="round" />
          {/* Aortic valve */}
