...
const stages = [
  {
    ...
    label: "Prophase I",
    detail:
      "Homologe Chromosomen paaren sich (Synapsis). Crossing-over tauscht Gensegmente aus. Erhöht genetische Vielfalt.",
  },
  {
    id: "metaphase1",
    label: "Metaphase I",
    detail:
      "Homologe Paare (Bivalente) reihen sich an der Metaphaseplatte auf. Zufällige Verteilung der Homologen.",
  },
  {
    id: "anaphase1",
    label: "Anaphase I",
    detail:
      "Homologe Chromosomen werden getrennt (Reduktion!). Schwesterchromatiden bleiben verbunden.",
  },
  {
    id: "division1",
    label: "1. Teilung",
    detail:
      "Ergebnis: Zwei haploide Zellen, je mit einem Chromosom aus jedem homologen Paar (noch 2 Chromatiden).",
  },
  {
    id: "division2",
    label: "2. Teilung",
    detail: "Wie Mitose: Schwesterchromatiden werden getrennt. Ergebnis: 4 haploide Zellen.",
  },
  {
    id: "result",
    label: "Ergebnis",
    detail:
      "4 genetisch verschiedene haploide Zellen (Gameten). Jede Zelle hat halben Chromosomensatz (1n).",
  },
];
  ...
  return (
    <div className="space-y-3">
      ...
      <svg viewBox="0 0 480 420" className="w-full max-w-xl mx-auto">
        ...
        <text x="240" y="50" textAnchor="middle" fontSize="13" fill="#115e59" fontWeight="bold">
          2n = 4
        </text>
        <text x="240" y="62" textAnchor="middle" fontSize="7" fill="#0f766e">
          Diploid
        </text>
        ...
        <g
          ...
          onClick={() => setActive("prophase1")}
          onMouseEnter={() => setActive("prophase1")}
        ...
        >
          <rect
            ...
            height="48"
            rx="8"
            fill={active === "prophase1" ? "#ccfbf1" : "#f0fdfa"}
            stroke="#0d9488"
            strokeWidth="1.5"
          />
          <text x="240" y="132" textAnchor="middle" fontSize="13" fill="#115e59" fontWeight="bold">
            Prophase I
          </text>
          {/* Crossing over illustration */}
          <path
            d="M200,140 Q215,138 225,148 Q235,158 250,155"
            stroke="#0f766e"
            strokeWidth="2.5"
            fill="none"
            strokeLinecap="round"
          />
          <path
            d="M200,155 Q215,158 225,148 Q235,138 250,140"
            stroke="#14b8a6"
            strokeWidth="2.5"
            fill="none"
            strokeLinecap="round"
          />
          <text x="275" y="152" fontSize="6" fill="#0f766e">
            Crossing-over
          </text>
        </g>
        ...
        <g
          className="cursor-pointer"
          onClick={() => setActive("anaphase1")}
          onMouseEnter={() => setActive("anaphase1")}
          onMouseLeave={() => setActive(null)}
        >
          <rect
            x="170"
            ...
            height="40"
            rx="8"
            fill={active === "anaphase1" ? "#ccfbf1" : "#f0fdfa"}
            stroke="#0d9488"
            strokeWidth="1.5"
          />
          <text x="240" y="210" textAnchor="middle" fontSize="13" fill="#115e59" fontWeight="bold">
            Anaphase I
          </text>
          <text x="240" y="224" textAnchor="middle" fontSize="7" fill="#0f766e">
            Homologe trennen sich
          </text>
        </g>
        ...
        {/* Meiosis II label */}
        <text x="240" y="268" textAnchor="middle" fontSize="13" fill="#0d9488" fontWeight="bold">
          Meiose II
        </text>
        ...
        <g
          className="cursor-pointer"
          onClick={() => setActive("division1")}
          onMouseEnter={() => setActive("division1")}
          onMouseLeave={() => setActive(null)}
        >
          <ellipse
            cx="140"
            ...
            rx="40"
            ry="22"
            fill={active === "division1" ? "#ccfbf1" : "#f0fdfa"}
            stroke="#14b8a6"
            strokeWidth="1.5"
          />
          <text x="140" y="296" textAnchor="middle" fontSize="7" fill="#115e59" fontWeight="bold">
            n = 2
          </text>
        ...
        >
          <ellipse
            ...
            strokeWidth="1.5"
          />
          <text x="340" y="296" textAnchor="middle" fontSize="7" fill="#115e59" fontWeight="bold">
            n = 2
          </text>
          <line
            x1="325"
        ...
        {[85, 195, 285, 395].map((cx, i) => (
          ...
          >
            <ellipse
              ...
              rx="32"
              ry="18"
              fill={active === "result" ? "#ccfbf1" : "#f0fdfa"}
              stroke="#0d9488"
              strokeWidth="1.5"
            />
            <text x={cx} y="382" textAnchor="middle" fontSize="7" fill="#115e59" fontWeight="bold">
              n = 2
            </text>
            {/* Single chromatids */}
            <line
        ...
        {/* Result label */}
        <text x="240" y="416" textAnchor="middle" fontSize="13" fill="#115e59" fontWeight="bold">
          4 haploide Zellen (Gameten)
        </text>
      </svg>
