...
const parts = [
  // Eye structures
  {
    ...
    label: "Kornea (Cornea)",
    detail:
      "Transparente äußere Schicht des Auges; bricht einfallendes Licht und schützt die inneren Strukturen.",
  },
  {
    id: "iris",
    label: "Iris/Pupille",
    detail:
      "Iris reguliert die Pupillengröße und steuert den Lichteinfall; Pupille ist die zentrale Öffnung.",
  },
  {
    id: "lens",
    label: "Linse",
    detail:
      "Akkommodation: ändert ihre Brechkraft, um Licht präzise auf die Netzhaut zu fokussieren.",
  },
  {
    id: "vitreous",
    label: "Glaskörper",
    detail:
      "Gallertartige Substanz, die das Auge ausfüllt und seine Form erhält; besteht hauptsächlich aus Wasser.",
  },
  {
    id: "retina",
    label: "Retina (Netzhaut)",
    detail:
      "Lichtempfindliche Schicht mit Photorezeptoren: Stäbchen (skotopisches Sehen, Hell-Dunkel) und Zapfen (photopisches Sehen, Farbsehen mit 3 Typen: rot/grün/blau).",
  },
  {
    id: "fovea",
    label: "Fovea centralis",
    detail:
      "Bereich des schärfsten Sehens; enthält ausschließlich Zapfen für hochauflösendes Farbsehen.",
  },
  {
    id: "optic",
    label: "N. opticus (Sehnerv)",
    detail:
      "Überträgt visuelle Informationen zur Sehrinde; Austrittstelle bildet den blinden Fleck (keine Photorezeptoren).",
  },
  {
    id: "sclera",
    label: "Sklera",
    detail: "Weiße, schützende äußere Hülle des Auges; gibt dem Augapfel Stabilität.",
  },

  // Ear structures
  {
    id: "pinna",
    label: "Ohrmuschel + Gehörgang",
    detail: "Äußeres Ohr: sammelt Schallwellen und leitet sie zum Trommelfell.",
  },
  {
    id: "tympanic",
    label: "Trommelfell",
    detail: "Dünne Membran, die durch Schallwellen in Schwingung versetzt wird.",
  },
  {
    id: "ossicles",
    label: "Gehörknöchelchen",
    detail:
      "Hammer, Amboss, Steigbügel: verstärken mechanische Schwingungen um das ~20-fache und übertragen sie auf das ovale Fenster.",
  },
  {
    id: "cochlea",
    label: "Cochlea (Schnecke)",
    detail:
      "Spiralförmiges Organ zur Frequenzanalyse; enthält das Corti-Organ mit Haarzellen, die mechanische Schwingungen in neuronale Signale umwandeln.",
  },
  {
    id: "vestibular",
    label: "Vestibularorgan",
    detail:
      "3 Bogengänge in verschiedenen Raumebenen; zuständig für Gleichgewichtssinn und räumliche Orientierung.",
  },
  {
    id: "vestibulocochlear",
    label: "N. vestibulocochlearis",
    detail:
      "VIII. Hirnnerv; überträgt auditorische und vestibuläre Informationen zur Hörrinde und zum Gleichgewichtszentrum.",
  },
];
      ...
      <svg viewBox="0 0 560 450" className="w-full max-w-2xl mx-auto">
        ...
        <g transform="translate(30, 40)">
          ...
          <line
            ...
            x2="10"
            y2="90"
            className="stroke-gray-400 dark:stroke-gray-500 stroke-1"
            strokeDasharray="2,2"
          />
          <text x="8" y="88" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Kornea
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="35" y="48" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Iris
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="95" y="33" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Linse
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="145" y="48" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Fovea
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="165" y="63" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Retina
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="195" y="170" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            N. opticus
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="90" y="210" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Glaskörper
          </text>
          ...
          <line
            ...
            x2="15"
            y2="160"
            className="stroke-gray-400 dark:fill-gray-500 stroke-1"
            strokeDasharray="2,2"
          />
          <text x="5" y="175" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Sklera
          </text>
        </g>
        ...
        <g transform="translate(300, 40)">
          ...
          >
            ...
            <circle
              ...
              cy="95"
              r="3.5"
              className="fill-green-300 dark:fill-green-600 stroke-green-700 dark:stroke-green-400 hover:stroke-2"
              strokeWidth="1"
            />
            <line
              x1="96"
          ...
          >
            ...
            <circle
              ...
              cy="100"
              r="8"
              className="fill-teal-200/40 dark:fill-teal-700/40 stroke-teal-500 dark:stroke-teal-400 hover:stroke-2"
              strokeWidth="1"
            />
          </g>
          ...
          >
            ...
            <ellipse
              ...
              rx="12"
              ry="8"
              className="fill-none stroke-blue-500 dark:stroke-blue-400 hover:stroke-blue-600 hover:stroke-2"
              strokeWidth="1.5"
            />
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="-15" y="38" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Ohrmuschel
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="55" y="53" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Trommelfell
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="80" y="30" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Gehörknöchelchen
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="125" y="160" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Cochlea
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="140" y="35" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            Vestibular
          </text>
          ...
          <line
            ...
            strokeDasharray="2,2"
          />
          <text x="135" y="180" className="fill-gray-600 dark:fill-gray-400 text-[9px]">
            N. vestibulocochlearis
          </text>
        </g>
      </svg>
