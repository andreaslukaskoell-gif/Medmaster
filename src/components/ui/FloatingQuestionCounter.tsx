...
export function FloatingQuestionCounter({ current, total, label = "Frage" }: Props) {
  ...
  return (
    <div className="fixed bottom-20 lg:bottom-4 left-1/2 -translate-x-1/2 z-40 flex items-center gap-3 px-4 py-2 rounded-full bg-[var(--card)]/80 backdrop-blur-sm shadow-lg border border-[var(--border)]/50">
