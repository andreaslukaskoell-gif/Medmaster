          ...
          <div className="text-center max-w-md w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 border border-[var(--border)] text-[var(--text-primary)] font-medium px-6 py-3 rounded-2xl bg-transparent hover:bg-[var(--surface)] transition-colors"
              >
