...
const TIER_STYLES: Record<BadgeTier, string> = {
  bronze:
    "bg-amber-700/90 text-amber-100 border-amber-600 shadow-amber-900/40",
  silver:
    "bg-slate-400/90 text-slate-100 border-slate-500 shadow-slate-600/40",
  gold:
    "bg-amber-400/95 text-amber-950 border-amber-500 shadow-amber-600/50",
};

const TIER_STYLES_LOCKED: Record<BadgeTier, string> = {
  bronze: "bg-slate-200 dark:bg-slate-700 text-slate-500 dark:text-slate-500 border-slate-300 dark:border-slate-600",
  silver: "bg-slate-200 dark:bg-slate-700 text-slate-500 dark:text-slate-500 border-slate-300 dark:border-slate-600",
