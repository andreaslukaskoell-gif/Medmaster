...
const OPTIONS: { value: Confidence; emoji: string; label: string; ring: string; bg: string }[] = [
  { value: 0, emoji: '🔴', label: 'Raten',    ring: 'ring-red-400',    bg: 'bg-red-50    dark:bg-red-900/20    text-red-700    dark:text-red-400' },
  { value: 1, emoji: '🟡', label: 'Unsicher', ring: 'ring-yellow-400', bg: 'bg-yellow-50 dark:bg-yellow-900/20 text-yellow-700  dark:text-yellow-400' },
  { value: 2, emoji: '🟢', label: 'Sicher',   ring: 'ring-green-400',  bg: 'bg-green-50  dark:bg-green-900/20  text-green-700   dark:text-green-400' },
];
