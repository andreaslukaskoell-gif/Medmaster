...
export function getReferralShareText(userId?: string): string {
  ...
  return `Hey! Ich bereite mich mit MedMaster auf den MedAT vor — 5.000+ Übungsfragen, KFF-Training und Prüfungssimulation. Über meinen Link sparst du €5 beim Kauf (und ich auch). Lass uns zusammen lernen!\n👉 ${link}`;
}
